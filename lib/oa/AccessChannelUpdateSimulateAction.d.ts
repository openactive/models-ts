 ...
 */
export declare type AccessChannelUpdateSimulateAction = {
 ...
 * etc.
 */
export declare type AccessChannelUpdateSimulateActionOrSubClass = AccessChannelUpdateSimulateAction;
/**
 ...
 * This type is derived from https://schema.org/Action, which means that any of this type's properties within schema.org may also be used.
 */
export declare const AccessChannelUpdateSimulateActionJoiSchema: Joi.ObjectSchema;
/**
 * test:AccessChannelUpdateSimulateAction - Validation schema (w/ JOI)
 *
 * [NOTICE: This class is part of the Open Booking API Test Interface, and MUST NOT be used in production.]
 ...
 * `SessionSeries`, etc.
 */
export declare const AccessChannelUpdateSimulateActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAccessChannelUpdateSimulateAction(maybeAccessChannelUpdateSimulateAction: unknown): AccessChannelUpdateSimulateAction | OaValidationError;
