 ...
 */
export declare type AccessCodeUpdateSimulateAction = {
 ...
 * etc.
 */
export declare type AccessCodeUpdateSimulateActionOrSubClass = AccessCodeUpdateSimulateAction;
/**
 ...
 * This type is derived from https://schema.org/Action, which means that any of this type's properties within schema.org may also be used.
 */
export declare const AccessCodeUpdateSimulateActionJoiSchema: Joi.ObjectSchema;
/**
 * test:AccessCodeUpdateSimulateAction - Validation schema (w/ JOI)
 *
 * [NOTICE: This class is part of the Open Booking API Test Interface, and MUST NOT be used in production.]
 ...
 * `SessionSeries`, etc.
 */
export declare const AccessCodeUpdateSimulateActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAccessCodeUpdateSimulateAction(maybeAccessCodeUpdateSimulateAction: unknown): AccessCodeUpdateSimulateAction | OaValidationError;
