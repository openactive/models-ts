 ...
 */
export declare type AccessPassUpdateSimulateAction = {
 ...
 * etc.
 */
export declare type AccessPassUpdateSimulateActionOrSubClass = AccessPassUpdateSimulateAction;
/**
 ...
 * This type is derived from https://schema.org/Action, which means that any of this type's properties within schema.org may also be used.
 */
export declare const AccessPassUpdateSimulateActionJoiSchema: Joi.ObjectSchema;
/**
 * test:AccessPassUpdateSimulateAction - Validation schema (w/ JOI)
 *
 * [NOTICE: This class is part of the Open Booking API Test Interface, and MUST NOT be used in production.]
 ...
 * `SessionSeries`, etc.
 */
export declare const AccessPassUpdateSimulateActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAccessPassUpdateSimulateAction(maybeAccessPassUpdateSimulateAction: unknown): AccessPassUpdateSimulateAction | OaValidationError;
