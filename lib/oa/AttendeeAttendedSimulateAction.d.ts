 ...
 */
export declare type AttendeeAttendedSimulateAction = {
 ...
 * etc.
 */
export declare type AttendeeAttendedSimulateActionOrSubClass = AttendeeAttendedSimulateAction;
/**
 ...
 * This type is derived from https://schema.org/Action, which means that any of this type's properties within schema.org may also be used.
 */
export declare const AttendeeAttendedSimulateActionJoiSchema: Joi.ObjectSchema;
/**
 * test:AttendeeAttendedSimulateAction - Validation schema (w/ JOI)
 *
 * [NOTICE: This class is part of the Open Booking API Test Interface, and MUST NOT be used in production.]
 ...
 * `SessionSeries`, etc.
 */
export declare const AttendeeAttendedSimulateActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAttendeeAttendedSimulateAction(maybeAttendeeAttendedSimulateAction: unknown): AttendeeAttendedSimulateAction | OaValidationError;
