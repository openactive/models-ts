...
exports.validateAuthenticatedPerson = exports.AuthenticatedPersonOrSubClassJoiSchema = exports.AuthenticatedPersonJoiSchema = void 0;
 ...
 */
exports.AuthenticatedPersonJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AuthenticatedPersonOrSubClassJoiSchema = Joi.alternatives().try([
 ...
 * ```
 */
function validateAuthenticatedPerson(maybeAuthenticatedPerson) {
    const { value, error } = exports.AuthenticatedPersonJoiSchema.validate(maybeAuthenticatedPerson);
    if (error) {
        return new oaValidationError_1.OaValidationError('AuthenticatedPerson', maybeAuthenticatedPerson, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAuthenticatedPerson = validateAuthenticatedPerson;
