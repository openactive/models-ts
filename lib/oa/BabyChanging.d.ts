 ...
 */
export declare type BabyChanging = {
    '@type': 'BabyChanging';
 ...
 * etc.
 */
export declare type BabyChangingOrSubClass = BabyChanging;
/**
 * BabyChanging - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/LocationFeatureSpecification, which means that any of this type's properties within schema.org may also be used.
 */
export declare const BabyChangingJoiSchema: Joi.ObjectSchema;
/**
 * BabyChanging - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/LocationFeatureSpecification, which means that any of this type's properties within schema.org may also be used.
 ...
 * `SessionSeries`, etc.
 */
export declare const BabyChangingOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBabyChanging(maybeBabyChanging: unknown): BabyChanging | OaValidationError;
