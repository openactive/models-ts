 ...
 * etc.
 */
export declare type BarOrSubClass = Bar;
/**
 ...
 * This type is derived from https://schema.org/LocationFeatureSpecification, which means that any of this type's properties within schema.org may also be used.
 */
export declare const BarJoiSchema: Joi.ObjectSchema;
/**
 * beta:Bar - Validation schema (w/ JOI)
 *
 * [NOTICE: This is a beta class, and is highly likely to change in future versions of this library.]
 ...
 * `SessionSeries`, etc.
 */
export declare const BarOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBar(maybeBar: unknown): Bar | OaValidationError;
