 ...
 */
export declare type BooleanFormFieldSpecification = {
 ...
 * etc.
 */
export declare type BooleanFormFieldSpecificationOrSubClass = BooleanFormFieldSpecification;
/**
 * BooleanFormFieldSpecification - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/PropertyValueSpecification, which means that any of this type's properties within schema.org may also be used.
 */
export declare const BooleanFormFieldSpecificationJoiSchema: Joi.ObjectSchema;
/**
 * BooleanFormFieldSpecification - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/PropertyValueSpecification, which means that any of this type's properties within schema.org may also be used.
 ...
 * `SessionSeries`, etc.
 */
export declare const BooleanFormFieldSpecificationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBooleanFormFieldSpecification(maybeBooleanFormFieldSpecification: unknown): BooleanFormFieldSpecification | OaValidationError;
