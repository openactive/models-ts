...
exports.validateBooleanFormFieldSpecification = exports.BooleanFormFieldSpecificationOrSubClassJoiSchema = exports.BooleanFormFieldSpecificationJoiSchema = void 0;
 ...
 */
exports.BooleanFormFieldSpecificationJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.BooleanFormFieldSpecificationOrSubClassJoiSchema = Joi.alternatives().try([
    exports.BooleanFormFieldSpecificationJoiSchema,
]);
/**
 ...
 * ```
 */
function validateBooleanFormFieldSpecification(maybeBooleanFormFieldSpecification) {
    const { value, error } = exports.BooleanFormFieldSpecificationJoiSchema.validate(maybeBooleanFormFieldSpecification);
    if (error) {
        return new oaValidationError_1.OaValidationError('BooleanFormFieldSpecification', maybeBooleanFormFieldSpecification, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateBooleanFormFieldSpecification = validateBooleanFormFieldSpecification;
