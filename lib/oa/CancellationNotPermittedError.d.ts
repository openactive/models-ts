 ...
 */
export declare type CancellationNotPermittedError = {
 ...
 * etc.
 */
export declare type CancellationNotPermittedErrorOrSubClass = CancellationNotPermittedError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const CancellationNotPermittedErrorJoiSchema: Joi.ObjectSchema;
/**
 * CancellationNotPermittedError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CancellationNotPermittedErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCancellationNotPermittedError(maybeCancellationNotPermittedError: unknown): CancellationNotPermittedError | OaValidationError;
