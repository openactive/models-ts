...
exports.validateCertificationScheme = exports.CertificationSchemeOrSubClassJoiSchema = exports.CertificationSchemeJoiSchema = void 0;
 ...
 */
exports.CertificationSchemeJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.CertificationSchemeOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CertificationSchemeJoiSchema,
]);
/**
 ...
 * ```
 */
function validateCertificationScheme(maybeCertificationScheme) {
    const { value, error } = exports.CertificationSchemeJoiSchema.validate(maybeCertificationScheme);
    if (error) {
        return new oaValidationError_1.OaValidationError('CertificationScheme', maybeCertificationScheme, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateCertificationScheme = validateCertificationScheme;
