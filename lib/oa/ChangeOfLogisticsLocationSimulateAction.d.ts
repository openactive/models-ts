 ...
 */
export declare type ChangeOfLogisticsLocationSimulateAction = {
 ...
 * etc.
 */
export declare type ChangeOfLogisticsLocationSimulateActionOrSubClass = ChangeOfLogisticsLocationSimulateAction;
/**
 ...
 * This type is derived from https://schema.org/Action, which means that any of this type's properties within schema.org may also be used.
 */
export declare const ChangeOfLogisticsLocationSimulateActionJoiSchema: Joi.ObjectSchema;
/**
 * test:ChangeOfLogisticsLocationSimulateAction - Validation schema (w/ JOI)
 *
 * [NOTICE: This class is part of the Open Booking API Test Interface, and MUST NOT be used in production.]
 ...
 * `SessionSeries`, etc.
 */
export declare const ChangeOfLogisticsLocationSimulateActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateChangeOfLogisticsLocationSimulateAction(maybeChangeOfLogisticsLocationSimulateAction: unknown): ChangeOfLogisticsLocationSimulateAction | OaValidationError;
