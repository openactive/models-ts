 ...
 */
export declare type ChangeOfLogisticsNameSimulateAction = {
 ...
 * etc.
 */
export declare type ChangeOfLogisticsNameSimulateActionOrSubClass = ChangeOfLogisticsNameSimulateAction;
/**
 ...
 * This type is derived from https://schema.org/Action, which means that any of this type's properties within schema.org may also be used.
 */
export declare const ChangeOfLogisticsNameSimulateActionJoiSchema: Joi.ObjectSchema;
/**
 * test:ChangeOfLogisticsNameSimulateAction - Validation schema (w/ JOI)
 *
 * [NOTICE: This class is part of the Open Booking API Test Interface, and MUST NOT be used in production.]
 ...
 * `SessionSeries`, etc.
 */
export declare const ChangeOfLogisticsNameSimulateActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateChangeOfLogisticsNameSimulateAction(maybeChangeOfLogisticsNameSimulateAction: unknown): ChangeOfLogisticsNameSimulateAction | OaValidationError;
