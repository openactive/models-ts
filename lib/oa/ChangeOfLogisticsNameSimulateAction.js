...
exports.validateChangeOfLogisticsNameSimulateAction = exports.ChangeOfLogisticsNameSimulateActionOrSubClassJoiSchema = exports.ChangeOfLogisticsNameSimulateActionJoiSchema = void 0;
 ...
 */
exports.ChangeOfLogisticsNameSimulateActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ChangeOfLogisticsNameSimulateActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ChangeOfLogisticsNameSimulateActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateChangeOfLogisticsNameSimulateAction(maybeChangeOfLogisticsNameSimulateAction) {
    const { value, error } = exports.ChangeOfLogisticsNameSimulateActionJoiSchema.validate(maybeChangeOfLogisticsNameSimulateAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('ChangeOfLogisticsNameSimulateAction', maybeChangeOfLogisticsNameSimulateAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateChangeOfLogisticsNameSimulateAction = validateChangeOfLogisticsNameSimulateAction;
