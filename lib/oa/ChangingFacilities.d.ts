 ...
 */
export declare type ChangingFacilities = {
 ...
 * etc.
 */
export declare type ChangingFacilitiesOrSubClass = ChangingFacilities;
/**
 * ChangingFacilities - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/LocationFeatureSpecification, which means that any of this type's properties within schema.org may also be used.
 */
export declare const ChangingFacilitiesJoiSchema: Joi.ObjectSchema;
/**
 * ChangingFacilities - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/LocationFeatureSpecification, which means that any of this type's properties within schema.org may also be used.
 ...
 * `SessionSeries`, etc.
 */
export declare const ChangingFacilitiesOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateChangingFacilities(maybeChangingFacilities: unknown): ChangingFacilities | OaValidationError;
