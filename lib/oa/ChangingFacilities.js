...
exports.validateChangingFacilities = exports.ChangingFacilitiesOrSubClassJoiSchema = exports.ChangingFacilitiesJoiSchema = void 0;
 ...
 */
exports.ChangingFacilitiesJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ChangingFacilitiesOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ChangingFacilitiesJoiSchema,
]);
/**
 ...
 *
 * ```ts
 * const maybeChangingFacilities = validateChangingFacilities(req.body); // `req.body` will have type `any` or `unknown`
 ...
 * ```
 */
function validateChangingFacilities(maybeChangingFacilities) {
    const { value, error } = exports.ChangingFacilitiesJoiSchema.validate(maybeChangingFacilities);
    if (error) {
        return new oaValidationError_1.OaValidationError('ChangingFacilities', maybeChangingFacilities, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateChangingFacilities = validateChangingFacilities;
