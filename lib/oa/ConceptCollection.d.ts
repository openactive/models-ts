 ...
 */
export declare type ConceptCollection = {
 ...
 * etc.
 */
export declare type ConceptCollectionOrSubClass = ConceptCollection;
/**
 ...
 * This type is derived from https://schema.org/CreativeWork, which means that any of this type's properties within schema.org may also be used.
 */
export declare const ConceptCollectionJoiSchema: Joi.ObjectSchema;
/**
 * beta:ConceptCollection - Validation schema (w/ JOI)
 *
 * [NOTICE: This is a beta class, and is highly likely to change in future versions of this library.]
 ...
 * `SessionSeries`, etc.
 */
export declare const ConceptCollectionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateConceptCollection(maybeConceptCollection: unknown): ConceptCollection | OaValidationError;
