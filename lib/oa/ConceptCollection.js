...
exports.validateConceptCollection = exports.ConceptCollectionOrSubClassJoiSchema = exports.ConceptCollectionJoiSchema = void 0;
 ...
 */
exports.ConceptCollectionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ConceptCollectionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ConceptCollectionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateConceptCollection(maybeConceptCollection) {
    const { value, error } = exports.ConceptCollectionJoiSchema.validate(maybeConceptCollection);
    if (error) {
        return new oaValidationError_1.OaValidationError('ConceptCollection', maybeConceptCollection, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateConceptCollection = validateConceptCollection;
