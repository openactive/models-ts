 ...
 * etc.
 */
export declare type CustomerAccountOrSubClass = CustomerAccount;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const CustomerAccountJoiSchema: Joi.ObjectSchema;
/**
 * CustomerAccount - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CustomerAccountOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCustomerAccount(maybeCustomerAccount: unknown): CustomerAccount | OaValidationError;
