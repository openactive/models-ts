 ...
 */
export declare type CustomerNoticeSimulateAction = {
 ...
 * etc.
 */
export declare type CustomerNoticeSimulateActionOrSubClass = CustomerNoticeSimulateAction;
/**
 ...
 * This type is derived from https://schema.org/Action, which means that any of this type's properties within schema.org may also be used.
 */
export declare const CustomerNoticeSimulateActionJoiSchema: Joi.ObjectSchema;
/**
 * test:CustomerNoticeSimulateAction - Validation schema (w/ JOI)
 *
 * [NOTICE: This class is part of the Open Booking API Test Interface, and MUST NOT be used in production.]
 ...
 * `SessionSeries`, etc.
 */
export declare const CustomerNoticeSimulateActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCustomerNoticeSimulateAction(maybeCustomerNoticeSimulateAction: unknown): CustomerNoticeSimulateAction | OaValidationError;
