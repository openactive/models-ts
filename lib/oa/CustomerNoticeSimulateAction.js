...
exports.validateCustomerNoticeSimulateAction = exports.CustomerNoticeSimulateActionOrSubClassJoiSchema = exports.CustomerNoticeSimulateActionJoiSchema = void 0;
 ...
 */
exports.CustomerNoticeSimulateActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.CustomerNoticeSimulateActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CustomerNoticeSimulateActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateCustomerNoticeSimulateAction(maybeCustomerNoticeSimulateAction) {
    const { value, error } = exports.CustomerNoticeSimulateActionJoiSchema.validate(maybeCustomerNoticeSimulateAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('CustomerNoticeSimulateAction', maybeCustomerNoticeSimulateAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateCustomerNoticeSimulateAction = validateCustomerNoticeSimulateAction;
