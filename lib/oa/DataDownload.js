...
exports.validateDataDownload = exports.DataDownloadOrSubClassJoiSchema = exports.DataDownloadJoiSchema = void 0;
 ...
 */
exports.DataDownloadJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.DataDownloadOrSubClassJoiSchema = Joi.alternatives().try([
    exports.DataDownloadJoiSchema,
]);
/**
 ...
 * ```
 */
function validateDataDownload(maybeDataDownload) {
    const { value, error } = exports.DataDownloadJoiSchema.validate(maybeDataDownload);
    if (error) {
        return new oaValidationError_1.OaValidationError('DataDownload', maybeDataDownload, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateDataDownload = validateDataDownload;
