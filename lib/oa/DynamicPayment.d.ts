 ...
 */
export declare type DynamicPayment = {
    '@type': 'DynamicPayment';
 ...
 * etc.
 */
export declare type DynamicPaymentOrSubClass = DynamicPayment;
/**
 * DynamicPayment - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const DynamicPaymentJoiSchema: Joi.ObjectSchema;
/**
 * DynamicPayment - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 ...
 * `SessionSeries`, etc.
 */
export declare const DynamicPaymentOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDynamicPayment(maybeDynamicPayment: unknown): DynamicPayment | OaValidationError;
