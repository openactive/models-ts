...
exports.validateFacilitySettingType = exports.FacilitySettingTypeJoiSchema = void 0;
 ...
 */
exports.FacilitySettingTypeJoiSchema = Joi.string().valid('https://openactive.io/ns-beta#IndoorFacility', 'https://openactive.io/ns-beta#OutdoorFacility');
/**
 ...
 * ```
 */
function validateFacilitySettingType(maybeFacilitySettingType) {
    const { value, error } = exports.FacilitySettingTypeJoiSchema.validate(maybeFacilitySettingType);
    if (error) {
        return new oaValidationError_1.OaValidationError('FacilitySettingType', maybeFacilitySettingType, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateFacilitySettingType = validateFacilitySettingType;
