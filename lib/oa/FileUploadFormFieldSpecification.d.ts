 ...
 */
export declare type FileUploadFormFieldSpecification = {
 ...
 * etc.
 */
export declare type FileUploadFormFieldSpecificationOrSubClass = FileUploadFormFieldSpecification;
/**
 * FileUploadFormFieldSpecification - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/PropertyValueSpecification, which means that any of this type's properties within schema.org may also be used.
 */
export declare const FileUploadFormFieldSpecificationJoiSchema: Joi.ObjectSchema;
/**
 * FileUploadFormFieldSpecification - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/PropertyValueSpecification, which means that any of this type's properties within schema.org may also be used.
 ...
 * `SessionSeries`, etc.
 */
export declare const FileUploadFormFieldSpecificationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateFileUploadFormFieldSpecification(maybeFileUploadFormFieldSpecification: unknown): FileUploadFormFieldSpecification | OaValidationError;
