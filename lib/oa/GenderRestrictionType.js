...
exports.validateGenderRestrictionType = exports.GenderRestrictionTypeJoiSchema = void 0;
 ...
 */
exports.GenderRestrictionTypeJoiSchema = Joi.string().valid('https://openactive.io/NoRestriction', 'https://openactive.io/MaleOnly', 'https://openactive.io/FemaleOnly');
/**
 ...
 * ```
 */
function validateGenderRestrictionType(maybeGenderRestrictionType) {
    const { value, error } = exports.GenderRestrictionTypeJoiSchema.validate(maybeGenderRestrictionType);
    if (error) {
        return new oaValidationError_1.OaValidationError('GenderRestrictionType', maybeGenderRestrictionType, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateGenderRestrictionType = validateGenderRestrictionType;
