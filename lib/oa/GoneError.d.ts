 ...
 * etc.
 */
export declare type GoneErrorOrSubClass = GoneError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const GoneErrorJoiSchema: Joi.ObjectSchema;
/**
 * GoneError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const GoneErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateGoneError(maybeGoneError: unknown): GoneError | OaValidationError;
