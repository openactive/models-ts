...
exports.validateHeadlineEvent = exports.HeadlineEventOrSubClassJoiSchema = exports.HeadlineEventJoiSchema = void 0;
 ...
 */
exports.HeadlineEventJoiSchema = Joi.object({
    '@type': Joi.string().valid('HeadlineEvent').required(),
 ...
 * `SessionSeries`, etc.
 */
exports.HeadlineEventOrSubClassJoiSchema = Joi.alternatives().try([
    exports.HeadlineEventJoiSchema,
]);
/**
 ...
 * ```
 */
function validateHeadlineEvent(maybeHeadlineEvent) {
    const { value, error } = exports.HeadlineEventJoiSchema.validate(maybeHeadlineEvent);
    if (error) {
        return new oaValidationError_1.OaValidationError('HeadlineEvent', maybeHeadlineEvent, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateHeadlineEvent = validateHeadlineEvent;
