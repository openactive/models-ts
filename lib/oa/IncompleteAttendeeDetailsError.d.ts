 ...
 */
export declare type IncompleteAttendeeDetailsError = {
 ...
 * etc.
 */
export declare type IncompleteAttendeeDetailsErrorOrSubClass = IncompleteAttendeeDetailsError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const IncompleteAttendeeDetailsErrorJoiSchema: Joi.ObjectSchema;
/**
 * IncompleteAttendeeDetailsError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const IncompleteAttendeeDetailsErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateIncompleteAttendeeDetailsError(maybeIncompleteAttendeeDetailsError: unknown): IncompleteAttendeeDetailsError | OaValidationError;
