 ...
 */
export declare type IncompleteBrokerDetailsError = {
 ...
 * etc.
 */
export declare type IncompleteBrokerDetailsErrorOrSubClass = IncompleteBrokerDetailsError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const IncompleteBrokerDetailsErrorJoiSchema: Joi.ObjectSchema;
/**
 * IncompleteBrokerDetailsError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const IncompleteBrokerDetailsErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateIncompleteBrokerDetailsError(maybeIncompleteBrokerDetailsError: unknown): IncompleteBrokerDetailsError | OaValidationError;
