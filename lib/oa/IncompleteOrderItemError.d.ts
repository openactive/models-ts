 ...
 */
export declare type IncompleteOrderItemError = {
 ...
 * etc.
 */
export declare type IncompleteOrderItemErrorOrSubClass = IncompleteOrderItemError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const IncompleteOrderItemErrorJoiSchema: Joi.ObjectSchema;
/**
 * IncompleteOrderItemError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const IncompleteOrderItemErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateIncompleteOrderItemError(maybeIncompleteOrderItemError: unknown): IncompleteOrderItemError | OaValidationError;
