 ...
 */
export declare type InternalApplicationError = {
 ...
 * etc.
 */
export declare type InternalApplicationErrorOrSubClass = InternalApplicationError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const InternalApplicationErrorJoiSchema: Joi.ObjectSchema;
/**
 * InternalApplicationError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const InternalApplicationErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateInternalApplicationError(maybeInternalApplicationError: unknown): InternalApplicationError | OaValidationError;
