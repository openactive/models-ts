 ...
 */
export declare type InternalLibraryConfigurationError = {
 ...
 * etc.
 */
export declare type InternalLibraryConfigurationErrorOrSubClass = InternalLibraryConfigurationError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const InternalLibraryConfigurationErrorJoiSchema: Joi.ObjectSchema;
/**
 * InternalLibraryConfigurationError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const InternalLibraryConfigurationErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateInternalLibraryConfigurationError(maybeInternalLibraryConfigurationError: unknown): InternalLibraryConfigurationError | OaValidationError;
