 ...
 */
export declare type InternalLibraryError = {
 ...
 * etc.
 */
export declare type InternalLibraryErrorOrSubClass = InternalLibraryError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const InternalLibraryErrorJoiSchema: Joi.ObjectSchema;
/**
 * InternalLibraryError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const InternalLibraryErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateInternalLibraryError(maybeInternalLibraryError: unknown): InternalLibraryError | OaValidationError;
