 ...
 */
export declare type InternalOpenBookingError = {
 ...
 * etc.
 */
export declare type InternalOpenBookingErrorOrSubClass = InternalOpenBookingError | oa.InternalApplicationErrorOrSubClass | oa.InternalLibraryConfigurationErrorOrSubClass | oa.InternalLibraryErrorOrSubClass;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const InternalOpenBookingErrorJoiSchema: Joi.ObjectSchema;
/**
 * InternalOpenBookingError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const InternalOpenBookingErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateInternalOpenBookingError(maybeInternalOpenBookingError: unknown): InternalOpenBookingError | OaValidationError;
