 ...
 */
export declare type InvalidAPITokenError = {
 ...
 * etc.
 */
export declare type InvalidAPITokenErrorOrSubClass = InvalidAPITokenError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const InvalidAPITokenErrorJoiSchema: Joi.ObjectSchema;
/**
 * InvalidAPITokenError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const InvalidAPITokenErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateInvalidAPITokenError(maybeInvalidAPITokenError: unknown): InvalidAPITokenError | OaValidationError;
