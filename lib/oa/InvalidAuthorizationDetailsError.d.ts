 ...
 */
export declare type InvalidAuthorizationDetailsError = {
 ...
 * etc.
 */
export declare type InvalidAuthorizationDetailsErrorOrSubClass = InvalidAuthorizationDetailsError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const InvalidAuthorizationDetailsErrorJoiSchema: Joi.ObjectSchema;
/**
 * InvalidAuthorizationDetailsError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const InvalidAuthorizationDetailsErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateInvalidAuthorizationDetailsError(maybeInvalidAuthorizationDetailsError: unknown): InvalidAuthorizationDetailsError | OaValidationError;
