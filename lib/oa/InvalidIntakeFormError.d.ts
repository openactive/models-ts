 ...
 */
export declare type InvalidIntakeFormError = {
 ...
 * etc.
 */
export declare type InvalidIntakeFormErrorOrSubClass = InvalidIntakeFormError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const InvalidIntakeFormErrorJoiSchema: Joi.ObjectSchema;
/**
 * InvalidIntakeFormError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const InvalidIntakeFormErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateInvalidIntakeFormError(maybeInvalidIntakeFormError: unknown): InvalidIntakeFormError | OaValidationError;
