 ...
 */
export declare type InvalidOpportunityOrOfferIdError = {
 ...
 * etc.
 */
export declare type InvalidOpportunityOrOfferIdErrorOrSubClass = InvalidOpportunityOrOfferIdError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const InvalidOpportunityOrOfferIdErrorJoiSchema: Joi.ObjectSchema;
/**
 * InvalidOpportunityOrOfferIdError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const InvalidOpportunityOrOfferIdErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateInvalidOpportunityOrOfferIdError(maybeInvalidOpportunityOrOfferIdError: unknown): InvalidOpportunityOrOfferIdError | OaValidationError;
