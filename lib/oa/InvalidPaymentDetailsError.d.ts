 ...
 */
export declare type InvalidPaymentDetailsError = {
 ...
 * etc.
 */
export declare type InvalidPaymentDetailsErrorOrSubClass = InvalidPaymentDetailsError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const InvalidPaymentDetailsErrorJoiSchema: Joi.ObjectSchema;
/**
 * InvalidPaymentDetailsError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const InvalidPaymentDetailsErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateInvalidPaymentDetailsError(maybeInvalidPaymentDetailsError: unknown): InvalidPaymentDetailsError | OaValidationError;
