 ...
 */
export declare type NoAPITokenError = {
 ...
 * etc.
 */
export declare type NoAPITokenErrorOrSubClass = NoAPITokenError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const NoAPITokenErrorJoiSchema: Joi.ObjectSchema;
/**
 * NoAPITokenError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const NoAPITokenErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateNoAPITokenError(maybeNoAPITokenError: unknown): NoAPITokenError | OaValidationError;
