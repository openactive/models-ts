 ...
 * etc.
 */
export declare type NotFoundErrorOrSubClass = NotFoundError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const NotFoundErrorJoiSchema: Joi.ObjectSchema;
/**
 * NotFoundError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const NotFoundErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateNotFoundError(maybeNotFoundError: unknown): NotFoundError | OaValidationError;
