 ...
 */
export declare type OfferOverride = {
    '@type': 'OfferOverride';
 ...
 * etc.
 */
export declare type OfferOverrideOrSubClass = OfferOverride;
/**
 * OfferOverride - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/Offer, which means that any of this type's properties within schema.org may also be used.
 */
export declare const OfferOverrideJoiSchema: Joi.ObjectSchema;
/**
 * OfferOverride - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/Offer, which means that any of this type's properties within schema.org may also be used.
 ...
 * `SessionSeries`, etc.
 */
export declare const OfferOverrideOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateOfferOverride(maybeOfferOverride: unknown): OfferOverride | OaValidationError;
