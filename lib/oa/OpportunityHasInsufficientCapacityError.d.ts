 ...
 */
export declare type OpportunityHasInsufficientCapacityError = {
 ...
 * etc.
 */
export declare type OpportunityHasInsufficientCapacityErrorOrSubClass = OpportunityHasInsufficientCapacityError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const OpportunityHasInsufficientCapacityErrorJoiSchema: Joi.ObjectSchema;
/**
 * OpportunityHasInsufficientCapacityError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const OpportunityHasInsufficientCapacityErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateOpportunityHasInsufficientCapacityError(maybeOpportunityHasInsufficientCapacityError: unknown): OpportunityHasInsufficientCapacityError | OaValidationError;
