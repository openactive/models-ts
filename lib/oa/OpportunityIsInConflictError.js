...
exports.validateOpportunityIsInConflictError = exports.OpportunityIsInConflictErrorOrSubClassJoiSchema = exports.OpportunityIsInConflictErrorJoiSchema = void 0;
 ...
 */
exports.OpportunityIsInConflictErrorJoiSchema = Joi.object({
    '@type': Joi.string().valid('OpportunityIsInConflictError').required(),
 ...
 * `SessionSeries`, etc.
 */
exports.OpportunityIsInConflictErrorOrSubClassJoiSchema = Joi.alternatives().try([
    exports.OpportunityIsInConflictErrorJoiSchema,
]);
/**
 ...
 * ```
 */
function validateOpportunityIsInConflictError(maybeOpportunityIsInConflictError) {
    const { value, error } = exports.OpportunityIsInConflictErrorJoiSchema.validate(maybeOpportunityIsInConflictError);
    if (error) {
        return new oaValidationError_1.OaValidationError('OpportunityIsInConflictError', maybeOpportunityIsInConflictError, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateOpportunityIsInConflictError = validateOpportunityIsInConflictError;
