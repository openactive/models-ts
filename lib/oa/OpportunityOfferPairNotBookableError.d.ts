 ...
 */
export declare type OpportunityOfferPairNotBookableError = {
 ...
 * etc.
 */
export declare type OpportunityOfferPairNotBookableErrorOrSubClass = OpportunityOfferPairNotBookableError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const OpportunityOfferPairNotBookableErrorJoiSchema: Joi.ObjectSchema;
/**
 * OpportunityOfferPairNotBookableError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const OpportunityOfferPairNotBookableErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateOpportunityOfferPairNotBookableError(maybeOpportunityOfferPairNotBookableError: unknown): OpportunityOfferPairNotBookableError | OaValidationError;
