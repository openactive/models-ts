 ...
 */
export declare type OrderAlreadyExistsError = {
 ...
 * etc.
 */
export declare type OrderAlreadyExistsErrorOrSubClass = OrderAlreadyExistsError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const OrderAlreadyExistsErrorJoiSchema: Joi.ObjectSchema;
/**
 * OrderAlreadyExistsError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const OrderAlreadyExistsErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 *
 * ```ts
 * const maybeOrderAlreadyExistsError = OrderAlreadyExistsError.validate(req.body); // `req.body` will have type `any` or `unknown`
 ...
 * ```
 */
export declare function validateOrderAlreadyExistsError(maybeOrderAlreadyExistsError: unknown): OrderAlreadyExistsError | OaValidationError;
