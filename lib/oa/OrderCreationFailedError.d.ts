 ...
 */
export declare type OrderCreationFailedError = {
 ...
 * etc.
 */
export declare type OrderCreationFailedErrorOrSubClass = OrderCreationFailedError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const OrderCreationFailedErrorJoiSchema: Joi.ObjectSchema;
/**
 * OrderCreationFailedError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const OrderCreationFailedErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateOrderCreationFailedError(maybeOrderCreationFailedError: unknown): OrderCreationFailedError | OaValidationError;
