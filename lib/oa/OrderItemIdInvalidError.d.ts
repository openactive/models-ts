 ...
 */
export declare type OrderItemIdInvalidError = {
 ...
 * etc.
 */
export declare type OrderItemIdInvalidErrorOrSubClass = OrderItemIdInvalidError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const OrderItemIdInvalidErrorJoiSchema: Joi.ObjectSchema;
/**
 * OrderItemIdInvalidError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const OrderItemIdInvalidErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateOrderItemIdInvalidError(maybeOrderItemIdInvalidError: unknown): OrderItemIdInvalidError | OaValidationError;
