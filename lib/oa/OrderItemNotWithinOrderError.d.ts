 ...
 */
export declare type OrderItemNotWithinOrderError = {
 ...
 * etc.
 */
export declare type OrderItemNotWithinOrderErrorOrSubClass = OrderItemNotWithinOrderError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const OrderItemNotWithinOrderErrorJoiSchema: Joi.ObjectSchema;
/**
 * OrderItemNotWithinOrderError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const OrderItemNotWithinOrderErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateOrderItemNotWithinOrderError(maybeOrderItemNotWithinOrderError: unknown): OrderItemNotWithinOrderError | OaValidationError;
