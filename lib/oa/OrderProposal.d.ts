 ...
 */
export declare type OrderProposal = {
    '@type': 'OrderProposal';
 ...
 * etc.
 */
export declare type OrderProposalOrSubClass = OrderProposal;
/**
 * OrderProposal - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/Order, which means that any of this type's properties within schema.org may also be used.
 */
export declare const OrderProposalJoiSchema: Joi.ObjectSchema;
/**
 * OrderProposal - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/Order, which means that any of this type's properties within schema.org may also be used.
 ...
 * `SessionSeries`, etc.
 */
export declare const OrderProposalOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateOrderProposal(maybeOrderProposal: unknown): OrderProposal | OaValidationError;
