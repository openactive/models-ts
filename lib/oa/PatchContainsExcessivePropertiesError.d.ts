 ...
 */
export declare type PatchContainsExcessivePropertiesError = {
 ...
 * etc.
 */
export declare type PatchContainsExcessivePropertiesErrorOrSubClass = PatchContainsExcessivePropertiesError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const PatchContainsExcessivePropertiesErrorJoiSchema: Joi.ObjectSchema;
/**
 * PatchContainsExcessivePropertiesError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PatchContainsExcessivePropertiesErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePatchContainsExcessivePropertiesError(maybePatchContainsExcessivePropertiesError: unknown): PatchContainsExcessivePropertiesError | OaValidationError;
