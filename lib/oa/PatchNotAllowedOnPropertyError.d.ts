 ...
 */
export declare type PatchNotAllowedOnPropertyError = {
 ...
 * etc.
 */
export declare type PatchNotAllowedOnPropertyErrorOrSubClass = PatchNotAllowedOnPropertyError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const PatchNotAllowedOnPropertyErrorJoiSchema: Joi.ObjectSchema;
/**
 * PatchNotAllowedOnPropertyError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PatchNotAllowedOnPropertyErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePatchNotAllowedOnPropertyError(maybePatchNotAllowedOnPropertyError: unknown): PatchNotAllowedOnPropertyError | OaValidationError;
