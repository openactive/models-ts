 ...
 */
export declare type PrivacyPolicy = {
    '@type': 'PrivacyPolicy';
 ...
 * etc.
 */
export declare type PrivacyPolicyOrSubClass = PrivacyPolicy;
/**
 * PrivacyPolicy - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/DigitalDocument, which means that any of this type's properties within schema.org may also be used.
 */
export declare const PrivacyPolicyJoiSchema: Joi.ObjectSchema;
/**
 * PrivacyPolicy - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/DigitalDocument, which means that any of this type's properties within schema.org may also be used.
 ...
 * `SessionSeries`, etc.
 */
export declare const PrivacyPolicyOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePrivacyPolicy(maybePrivacyPolicy: unknown): PrivacyPolicy | OaValidationError;
