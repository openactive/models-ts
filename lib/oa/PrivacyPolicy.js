...
exports.validatePrivacyPolicy = exports.PrivacyPolicyOrSubClassJoiSchema = exports.PrivacyPolicyJoiSchema = void 0;
 ...
 */
exports.PrivacyPolicyJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.PrivacyPolicyOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PrivacyPolicyJoiSchema,
]);
/**
 ...
 * ```
 */
function validatePrivacyPolicy(maybePrivacyPolicy) {
    const { value, error } = exports.PrivacyPolicyJoiSchema.validate(maybePrivacyPolicy);
    if (error) {
        return new oaValidationError_1.OaValidationError('PrivacyPolicy', maybePrivacyPolicy, error);
    }
