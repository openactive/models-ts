 ...
 */
export declare type ReplacementSimulateAction = {
 ...
 * etc.
 */
export declare type ReplacementSimulateActionOrSubClass = ReplacementSimulateAction;
/**
 ...
 * This type is derived from https://schema.org/Action, which means that any of this type's properties within schema.org may also be used.
 */
export declare const ReplacementSimulateActionJoiSchema: Joi.ObjectSchema;
/**
 * test:ReplacementSimulateAction - Validation schema (w/ JOI)
 *
 * [NOTICE: This class is part of the Open Booking API Test Interface, and MUST NOT be used in production.]
 ...
 * `SessionSeries`, etc.
 */
export declare const ReplacementSimulateActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateReplacementSimulateAction(maybeReplacementSimulateAction: unknown): ReplacementSimulateAction | OaValidationError;
