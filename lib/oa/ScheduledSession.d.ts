 ...
 */
export declare type ScheduledSession = {
 ...
 * etc.
 */
export declare type ScheduledSessionOrSubClass = ScheduledSession;
/**
 * ScheduledSession - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/Event, which means that any of this type's properties within schema.org may also be used.
 */
export declare const ScheduledSessionJoiSchema: Joi.ObjectSchema;
/**
 * ScheduledSession - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/Event, which means that any of this type's properties within schema.org may also be used.
 ...
 * `SessionSeries`, etc.
 */
export declare const ScheduledSessionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateScheduledSession(maybeScheduledSession: unknown): ScheduledSession | OaValidationError;
