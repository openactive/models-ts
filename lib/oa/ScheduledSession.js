...
exports.validateScheduledSession = exports.ScheduledSessionOrSubClassJoiSchema = exports.ScheduledSessionJoiSchema = void 0;
 ...
 */
exports.ScheduledSessionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ScheduledSessionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ScheduledSessionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateScheduledSession(maybeScheduledSession) {
    const { value, error } = exports.ScheduledSessionJoiSchema.validate(maybeScheduledSession);
    if (error) {
        return new oaValidationError_1.OaValidationError('ScheduledSession', maybeScheduledSession, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateScheduledSession = validateScheduledSession;
