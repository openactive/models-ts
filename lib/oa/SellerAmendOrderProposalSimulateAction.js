...
exports.validateSellerAmendOrderProposalSimulateAction = exports.SellerAmendOrderProposalSimulateActionOrSubClassJoiSchema = exports.SellerAmendOrderProposalSimulateActionJoiSchema = void 0;
 ...
 */
exports.SellerAmendOrderProposalSimulateActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.SellerAmendOrderProposalSimulateActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.SellerAmendOrderProposalSimulateActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateSellerAmendOrderProposalSimulateAction(maybeSellerAmendOrderProposalSimulateAction) {
    const { value, error } = exports.SellerAmendOrderProposalSimulateActionJoiSchema.validate(maybeSellerAmendOrderProposalSimulateAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('SellerAmendOrderProposalSimulateAction', maybeSellerAmendOrderProposalSimulateAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateSellerAmendOrderProposalSimulateAction = validateSellerAmendOrderProposalSimulateAction;
