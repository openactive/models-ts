...
exports.validateSellerRejectOrderProposalSimulateAction = exports.SellerRejectOrderProposalSimulateActionOrSubClassJoiSchema = exports.SellerRejectOrderProposalSimulateActionJoiSchema = void 0;
 ...
 */
exports.SellerRejectOrderProposalSimulateActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.SellerRejectOrderProposalSimulateActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.SellerRejectOrderProposalSimulateActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateSellerRejectOrderProposalSimulateAction(maybeSellerRejectOrderProposalSimulateAction) {
    const { value, error } = exports.SellerRejectOrderProposalSimulateActionJoiSchema.validate(maybeSellerRejectOrderProposalSimulateAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('SellerRejectOrderProposalSimulateAction', maybeSellerRejectOrderProposalSimulateAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateSellerRejectOrderProposalSimulateAction = validateSellerRejectOrderProposalSimulateAction;
