 ...
 */
export declare type SellerRequestedCancellationSimulateAction = {
 ...
 * etc.
 */
export declare type SellerRequestedCancellationSimulateActionOrSubClass = SellerRequestedCancellationSimulateAction | oa.SellerRequestedCancellationWithMessageSimulateActionOrSubClass;
/**
 ...
 * This type is derived from https://schema.org/Action, which means that any of this type's properties within schema.org may also be used.
 */
export declare const SellerRequestedCancellationSimulateActionJoiSchema: Joi.ObjectSchema;
/**
 * test:SellerRequestedCancellationSimulateAction - Validation schema (w/ JOI)
 *
 * [NOTICE: This class is part of the Open Booking API Test Interface, and MUST NOT be used in production.]
 ...
 * `SessionSeries`, etc.
 */
export declare const SellerRequestedCancellationSimulateActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSellerRequestedCancellationSimulateAction(maybeSellerRequestedCancellationSimulateAction: unknown): SellerRequestedCancellationSimulateAction | OaValidationError;
