 ...
 */
export declare type SellerRequestedCancellationWithMessageSimulateAction = {
 ...
 * etc.
 */
export declare type SellerRequestedCancellationWithMessageSimulateActionOrSubClass = SellerRequestedCancellationWithMessageSimulateAction;
/**
 ...
 * This type is derived from https://schema.org/Action, which means that any of this type's properties within schema.org may also be used.
 */
export declare const SellerRequestedCancellationWithMessageSimulateActionJoiSchema: Joi.ObjectSchema;
/**
 * test:SellerRequestedCancellationWithMessageSimulateAction - Validation schema (w/ JOI)
 *
 * [NOTICE: This class is part of the Open Booking API Test Interface, and MUST NOT be used in production.]
 ...
 * `SessionSeries`, etc.
 */
export declare const SellerRequestedCancellationWithMessageSimulateActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSellerRequestedCancellationWithMessageSimulateAction(maybeSellerRequestedCancellationWithMessageSimulateAction: unknown): SellerRequestedCancellationWithMessageSimulateAction | OaValidationError;
