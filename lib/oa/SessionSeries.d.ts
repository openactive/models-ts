 ...
 */
export declare type SessionSeries = {
    '@type': 'SessionSeries';
 ...
 * etc.
 */
export declare type SessionSeriesOrSubClass = SessionSeries;
/**
 * SessionSeries - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/Event, which means that any of this type's properties within schema.org may also be used.
 */
export declare const SessionSeriesJoiSchema: Joi.ObjectSchema;
/**
 * SessionSeries - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/Event, which means that any of this type's properties within schema.org may also be used.
 ...
 * `SessionSeries`, etc.
 */
export declare const SessionSeriesOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSessionSeries(maybeSessionSeries: unknown): SessionSeries | OaValidationError;
