...
exports.validateSessionSeries = exports.SessionSeriesOrSubClassJoiSchema = exports.SessionSeriesJoiSchema = void 0;
 ...
 */
exports.SessionSeriesJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.SessionSeriesOrSubClassJoiSchema = Joi.alternatives().try([
    exports.SessionSeriesJoiSchema,
]);
/**
 ...
 * ```
 */
function validateSessionSeries(maybeSessionSeries) {
    const { value, error } = exports.SessionSeriesJoiSchema.validate(maybeSessionSeries);
    if (error) {
        return new oaValidationError_1.OaValidationError('SessionSeries', maybeSessionSeries, error);
    }
