 ...
 */
export declare type ShortAnswerFormFieldSpecification = {
 ...
 * etc.
 */
export declare type ShortAnswerFormFieldSpecificationOrSubClass = ShortAnswerFormFieldSpecification;
/**
 * ShortAnswerFormFieldSpecification - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/PropertyValueSpecification, which means that any of this type's properties within schema.org may also be used.
 */
export declare const ShortAnswerFormFieldSpecificationJoiSchema: Joi.ObjectSchema;
/**
 * ShortAnswerFormFieldSpecification - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/PropertyValueSpecification, which means that any of this type's properties within schema.org may also be used.
 ...
 * `SessionSeries`, etc.
 */
export declare const ShortAnswerFormFieldSpecificationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateShortAnswerFormFieldSpecification(maybeShortAnswerFormFieldSpecification: unknown): ShortAnswerFormFieldSpecification | OaValidationError;
