...
exports.validateShortAnswerFormFieldSpecification = exports.ShortAnswerFormFieldSpecificationOrSubClassJoiSchema = exports.ShortAnswerFormFieldSpecificationJoiSchema = void 0;
 ...
 */
exports.ShortAnswerFormFieldSpecificationJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ShortAnswerFormFieldSpecificationOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ShortAnswerFormFieldSpecificationJoiSchema,
]);
/**
 ...
 *
 * ```ts
 * const maybeShortAnswerFormFieldSpecification = ShortAnswerFormFieldSpecification.validate(req.body); // `req.body` will have type `any` or `unknown`
 ...
 * ```
 */
function validateShortAnswerFormFieldSpecification(maybeShortAnswerFormFieldSpecification) {
    const { value, error } = exports.ShortAnswerFormFieldSpecificationJoiSchema.validate(maybeShortAnswerFormFieldSpecification);
    if (error) {
        return new oaValidationError_1.OaValidationError('ShortAnswerFormFieldSpecification', maybeShortAnswerFormFieldSpecification, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateShortAnswerFormFieldSpecification = validateShortAnswerFormFieldSpecification;
