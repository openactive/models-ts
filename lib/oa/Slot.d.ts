 ...
 * etc.
 */
export declare type SlotOrSubClass = Slot;
/**
 * Slot - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/Event, which means that any of this type's properties within schema.org may also be used.
 */
export declare const SlotJoiSchema: Joi.ObjectSchema;
/**
 * Slot - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/Event, which means that any of this type's properties within schema.org may also be used.
 ...
 * `SessionSeries`, etc.
 */
export declare const SlotOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSlot(maybeSlot: unknown): Slot | OaValidationError;
