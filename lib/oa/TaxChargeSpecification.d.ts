 ...
 */
export declare type TaxChargeSpecification = {
 ...
 * etc.
 */
export declare type TaxChargeSpecificationOrSubClass = TaxChargeSpecification;
/**
 * TaxChargeSpecification - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/PriceSpecification, which means that any of this type's properties within schema.org may also be used.
 */
export declare const TaxChargeSpecificationJoiSchema: Joi.ObjectSchema;
/**
 * TaxChargeSpecification - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/PriceSpecification, which means that any of this type's properties within schema.org may also be used.
 ...
 * `SessionSeries`, etc.
 */
export declare const TaxChargeSpecificationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTaxChargeSpecification(maybeTaxChargeSpecification: unknown): TaxChargeSpecification | OaValidationError;
