...
exports.validateTaxChargeSpecification = exports.TaxChargeSpecificationOrSubClassJoiSchema = exports.TaxChargeSpecificationJoiSchema = void 0;
 ...
 */
exports.TaxChargeSpecificationJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.TaxChargeSpecificationOrSubClassJoiSchema = Joi.alternatives().try([
    exports.TaxChargeSpecificationJoiSchema,
]);
/**
 ...
 * ```
 */
function validateTaxChargeSpecification(maybeTaxChargeSpecification) {
    const { value, error } = exports.TaxChargeSpecificationJoiSchema.validate(maybeTaxChargeSpecification);
    if (error) {
        return new oaValidationError_1.OaValidationError('TaxChargeSpecification', maybeTaxChargeSpecification, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateTaxChargeSpecification = validateTaxChargeSpecification;
