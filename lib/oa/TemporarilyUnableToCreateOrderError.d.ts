 ...
 */
export declare type TemporarilyUnableToCreateOrderError = {
 ...
 * etc.
 */
export declare type TemporarilyUnableToCreateOrderErrorOrSubClass = TemporarilyUnableToCreateOrderError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const TemporarilyUnableToCreateOrderErrorJoiSchema: Joi.ObjectSchema;
/**
 * TemporarilyUnableToCreateOrderError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TemporarilyUnableToCreateOrderErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTemporarilyUnableToCreateOrderError(maybeTemporarilyUnableToCreateOrderError: unknown): TemporarilyUnableToCreateOrderError | OaValidationError;
