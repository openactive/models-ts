 ...
 */
export declare type TemporarilyUnableToDeleteOrderError = {
 ...
 * etc.
 */
export declare type TemporarilyUnableToDeleteOrderErrorOrSubClass = TemporarilyUnableToDeleteOrderError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const TemporarilyUnableToDeleteOrderErrorJoiSchema: Joi.ObjectSchema;
/**
 * TemporarilyUnableToDeleteOrderError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TemporarilyUnableToDeleteOrderErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTemporarilyUnableToDeleteOrderError(maybeTemporarilyUnableToDeleteOrderError: unknown): TemporarilyUnableToDeleteOrderError | OaValidationError;
