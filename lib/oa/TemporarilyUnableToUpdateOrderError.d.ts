 ...
 */
export declare type TemporarilyUnableToUpdateOrderError = {
 ...
 * etc.
 */
export declare type TemporarilyUnableToUpdateOrderErrorOrSubClass = TemporarilyUnableToUpdateOrderError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const TemporarilyUnableToUpdateOrderErrorJoiSchema: Joi.ObjectSchema;
/**
 * TemporarilyUnableToUpdateOrderError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TemporarilyUnableToUpdateOrderErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTemporarilyUnableToUpdateOrderError(maybeTemporarilyUnableToUpdateOrderError: unknown): TemporarilyUnableToUpdateOrderError | OaValidationError;
