 ...
 * etc.
 */
export declare type TermsOrSubClass = Terms | oa.PrivacyPolicyOrSubClass | oa.TermsOfUseOrSubClass;
/**
 * Terms - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/DigitalDocument, which means that any of this type's properties within schema.org may also be used.
 */
export declare const TermsJoiSchema: Joi.ObjectSchema;
/**
 * Terms - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/DigitalDocument, which means that any of this type's properties within schema.org may also be used.
 ...
 * `SessionSeries`, etc.
 */
export declare const TermsOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTerms(maybeTerms: unknown): Terms | OaValidationError;
