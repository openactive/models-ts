...
exports.validateTerms = exports.TermsOrSubClassJoiSchema = exports.TermsJoiSchema = void 0;
 ...
 */
exports.TermsJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.TermsOrSubClassJoiSchema = Joi.alternatives().try([
    exports.TermsJoiSchema,
 ...
 * ```
 */
function validateTerms(maybeTerms) {
    const { value, error } = exports.TermsJoiSchema.validate(maybeTerms);
    if (error) {
        return new oaValidationError_1.OaValidationError('Terms', maybeTerms, error);
    }
