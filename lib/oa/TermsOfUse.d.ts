 ...
 */
export declare type TermsOfUse = {
    '@type': 'TermsOfUse';
 ...
 * etc.
 */
export declare type TermsOfUseOrSubClass = TermsOfUse;
/**
 * TermsOfUse - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/DigitalDocument, which means that any of this type's properties within schema.org may also be used.
 */
export declare const TermsOfUseJoiSchema: Joi.ObjectSchema;
/**
 * TermsOfUse - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/DigitalDocument, which means that any of this type's properties within schema.org may also be used.
 ...
 * `SessionSeries`, etc.
 */
export declare const TermsOfUseOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTermsOfUse(maybeTermsOfUse: unknown): TermsOfUse | OaValidationError;
