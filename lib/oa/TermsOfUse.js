...
exports.validateTermsOfUse = exports.TermsOfUseOrSubClassJoiSchema = exports.TermsOfUseJoiSchema = void 0;
 ...
 */
exports.TermsOfUseJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.TermsOfUseOrSubClassJoiSchema = Joi.alternatives().try([
    exports.TermsOfUseJoiSchema,
]);
/**
 ...
 * ```
 */
function validateTermsOfUse(maybeTermsOfUse) {
    const { value, error } = exports.TermsOfUseJoiSchema.validate(maybeTermsOfUse);
    if (error) {
        return new oaValidationError_1.OaValidationError('TermsOfUse', maybeTermsOfUse, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateTermsOfUse = validateTermsOfUse;
