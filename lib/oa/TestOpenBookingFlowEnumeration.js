...
exports.validateTestOpenBookingFlowEnumeration = exports.TestOpenBookingFlowEnumerationJoiSchema = void 0;
 ...
 */
exports.TestOpenBookingFlowEnumerationJoiSchema = Joi.string().valid('https://openactive.io/test-interface#OpenBookingSimpleFlow', 'https://openactive.io/test-interface#OpenBookingApprovalFlow');
/**
 ...
 * ```
 */
function validateTestOpenBookingFlowEnumeration(maybeTestOpenBookingFlowEnumeration) {
    const { value, error } = exports.TestOpenBookingFlowEnumerationJoiSchema.validate(maybeTestOpenBookingFlowEnumeration);
    if (error) {
        return new oaValidationError_1.OaValidationError('TestOpenBookingFlowEnumeration', maybeTestOpenBookingFlowEnumeration, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateTestOpenBookingFlowEnumeration = validateTestOpenBookingFlowEnumeration;
