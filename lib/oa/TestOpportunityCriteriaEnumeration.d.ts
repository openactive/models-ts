 ...
 * An enumeration of test opportunity criteria to which an opportunity must conform.
 */
export declare const TestOpportunityCriteriaEnumerationJoiSchema: Joi.StringSchema;
/**
 ...
 * ```
 */
export declare function validateTestOpportunityCriteriaEnumeration(maybeTestOpportunityCriteriaEnumeration: unknown): TestOpportunityCriteriaEnumeration | OaValidationError;
