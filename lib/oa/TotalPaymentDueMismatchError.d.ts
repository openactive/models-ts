 ...
 */
export declare type TotalPaymentDueMismatchError = {
 ...
 * etc.
 */
export declare type TotalPaymentDueMismatchErrorOrSubClass = TotalPaymentDueMismatchError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const TotalPaymentDueMismatchErrorJoiSchema: Joi.ObjectSchema;
/**
 * TotalPaymentDueMismatchError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TotalPaymentDueMismatchErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTotalPaymentDueMismatchError(maybeTotalPaymentDueMismatchError: unknown): TotalPaymentDueMismatchError | OaValidationError;
