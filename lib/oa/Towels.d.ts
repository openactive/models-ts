 ...
 * etc.
 */
export declare type TowelsOrSubClass = Towels;
/**
 * Towels - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/LocationFeatureSpecification, which means that any of this type's properties within schema.org may also be used.
 */
export declare const TowelsJoiSchema: Joi.ObjectSchema;
/**
 * Towels - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/LocationFeatureSpecification, which means that any of this type's properties within schema.org may also be used.
 ...
 * `SessionSeries`, etc.
 */
export declare const TowelsOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTowels(maybeTowels: unknown): Towels | OaValidationError;
