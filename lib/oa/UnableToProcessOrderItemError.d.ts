 ...
 */
export declare type UnableToProcessOrderItemError = {
 ...
 * etc.
 */
export declare type UnableToProcessOrderItemErrorOrSubClass = UnableToProcessOrderItemError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const UnableToProcessOrderItemErrorJoiSchema: Joi.ObjectSchema;
/**
 * UnableToProcessOrderItemError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const UnableToProcessOrderItemErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateUnableToProcessOrderItemError(maybeUnableToProcessOrderItemError: unknown): UnableToProcessOrderItemError | OaValidationError;
