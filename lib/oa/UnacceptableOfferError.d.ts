 ...
 */
export declare type UnacceptableOfferError = {
 ...
 * etc.
 */
export declare type UnacceptableOfferErrorOrSubClass = UnacceptableOfferError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const UnacceptableOfferErrorJoiSchema: Joi.ObjectSchema;
/**
 * UnacceptableOfferError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const UnacceptableOfferErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateUnacceptableOfferError(maybeUnacceptableOfferError: unknown): UnacceptableOfferError | OaValidationError;
