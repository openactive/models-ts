 ...
 */
export declare type UnexpectedOrderTypeError = {
 ...
 * etc.
 */
export declare type UnexpectedOrderTypeErrorOrSubClass = UnexpectedOrderTypeError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const UnexpectedOrderTypeErrorJoiSchema: Joi.ObjectSchema;
/**
 * UnexpectedOrderTypeError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const UnexpectedOrderTypeErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateUnexpectedOrderTypeError(maybeUnexpectedOrderTypeError: unknown): UnexpectedOrderTypeError | OaValidationError;
