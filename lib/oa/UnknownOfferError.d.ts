 ...
 */
export declare type UnknownOfferError = {
 ...
 * etc.
 */
export declare type UnknownOfferErrorOrSubClass = UnknownOfferError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const UnknownOfferErrorJoiSchema: Joi.ObjectSchema;
/**
 * UnknownOfferError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const UnknownOfferErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateUnknownOfferError(maybeUnknownOfferError: unknown): UnknownOfferError | OaValidationError;
