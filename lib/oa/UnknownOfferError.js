...
exports.validateUnknownOfferError = exports.UnknownOfferErrorOrSubClassJoiSchema = exports.UnknownOfferErrorJoiSchema = void 0;
 ...
 */
exports.UnknownOfferErrorJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.UnknownOfferErrorOrSubClassJoiSchema = Joi.alternatives().try([
    exports.UnknownOfferErrorJoiSchema,
]);
/**
 ...
 * ```
 */
function validateUnknownOfferError(maybeUnknownOfferError) {
    const { value, error } = exports.UnknownOfferErrorJoiSchema.validate(maybeUnknownOfferError);
    if (error) {
        return new oaValidationError_1.OaValidationError('UnknownOfferError', maybeUnknownOfferError, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateUnknownOfferError = validateUnknownOfferError;
