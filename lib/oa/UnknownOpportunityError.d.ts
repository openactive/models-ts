 ...
 */
export declare type UnknownOpportunityError = {
 ...
 * etc.
 */
export declare type UnknownOpportunityErrorOrSubClass = UnknownOpportunityError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const UnknownOpportunityErrorJoiSchema: Joi.ObjectSchema;
/**
 * UnknownOpportunityError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const UnknownOpportunityErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateUnknownOpportunityError(maybeUnknownOpportunityError: unknown): UnknownOpportunityError | OaValidationError;
