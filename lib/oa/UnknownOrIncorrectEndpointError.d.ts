 ...
 */
export declare type UnknownOrIncorrectEndpointError = {
 ...
 * etc.
 */
export declare type UnknownOrIncorrectEndpointErrorOrSubClass = UnknownOrIncorrectEndpointError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const UnknownOrIncorrectEndpointErrorJoiSchema: Joi.ObjectSchema;
/**
 * UnknownOrIncorrectEndpointError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const UnknownOrIncorrectEndpointErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateUnknownOrIncorrectEndpointError(maybeUnknownOrIncorrectEndpointError: unknown): UnknownOrIncorrectEndpointError | OaValidationError;
