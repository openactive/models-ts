 ...
 */
export declare type UnknownOrderError = {
 ...
 * etc.
 */
export declare type UnknownOrderErrorOrSubClass = UnknownOrderError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const UnknownOrderErrorJoiSchema: Joi.ObjectSchema;
/**
 * UnknownOrderError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const UnknownOrderErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateUnknownOrderError(maybeUnknownOrderError: unknown): UnknownOrderError | OaValidationError;
