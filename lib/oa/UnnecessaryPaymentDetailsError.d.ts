 ...
 */
export declare type UnnecessaryPaymentDetailsError = {
 ...
 * etc.
 */
export declare type UnnecessaryPaymentDetailsErrorOrSubClass = UnnecessaryPaymentDetailsError;
/**
 ...
 * This type is derived from https://schema.org/Thing, which means that any of this type's properties within schema.org may also be used.
 */
export declare const UnnecessaryPaymentDetailsErrorJoiSchema: Joi.ObjectSchema;
/**
 * UnnecessaryPaymentDetailsError - Validation schema (w/ JOI)
 *
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const UnnecessaryPaymentDetailsErrorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateUnnecessaryPaymentDetailsError(maybeUnnecessaryPaymentDetailsError: unknown): UnnecessaryPaymentDetailsError | OaValidationError;
