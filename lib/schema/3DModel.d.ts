 ...
 * schema:3DModel
 */
export declare type ThreeDModel = {
    '@type': '3DModel';
 ...
 * etc.
 */
export declare type ThreeDModelOrSubClass = ThreeDModel;
/**
 * schema:3DModel - Validation schema (w/ JOI)
 */
export declare const ThreeDModelJoiSchema: Joi.ObjectSchema;
/**
 * schema:3DModel - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ThreeDModelOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateThreeDModel(maybeThreeDModel: unknown): ThreeDModel | OaValidationError;
