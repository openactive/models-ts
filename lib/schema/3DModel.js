...
exports.validateThreeDModel = exports.ThreeDModelOrSubClassJoiSchema = exports.ThreeDModelJoiSchema = void 0;
 ...
 */
exports.ThreeDModelJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ThreeDModelOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ThreeDModelJoiSchema,
]);
/**
 ...
 * ```
 */
function validateThreeDModel(maybeThreeDModel) {
    const { value, error } = exports.ThreeDModelJoiSchema.validate(maybeThreeDModel);
    if (error) {
        return new oaValidationError_1.OaValidationError('ThreeDModel', maybeThreeDModel, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateThreeDModel = validateThreeDModel;
