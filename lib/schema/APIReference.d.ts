 ...
 * etc.
 */
export declare type APIReferenceOrSubClass = APIReference;
/**
 * schema:APIReference - Validation schema (w/ JOI)
 */
export declare const APIReferenceJoiSchema: Joi.ObjectSchema;
/**
 * schema:APIReference - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const APIReferenceOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAPIReference(maybeAPIReference: unknown): APIReference | OaValidationError;
