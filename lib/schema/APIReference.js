...
exports.validateAPIReference = exports.APIReferenceOrSubClassJoiSchema = exports.APIReferenceJoiSchema = void 0;
 ...
 */
exports.APIReferenceJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.APIReferenceOrSubClassJoiSchema = Joi.alternatives().try([
    exports.APIReferenceJoiSchema,
]);
/**
 ...
 * ```
 */
function validateAPIReference(maybeAPIReference) {
    const { value, error } = exports.APIReferenceJoiSchema.validate(maybeAPIReference);
    if (error) {
        return new oaValidationError_1.OaValidationError('APIReference', maybeAPIReference, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAPIReference = validateAPIReference;
