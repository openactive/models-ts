 ...
 * etc.
 */
export declare type AboutPageOrSubClass = AboutPage;
/**
 * schema:AboutPage - Validation schema (w/ JOI)
 */
export declare const AboutPageJoiSchema: Joi.ObjectSchema;
/**
 * schema:AboutPage - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AboutPageOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAboutPage(maybeAboutPage: unknown): AboutPage | OaValidationError;
