...
exports.validateAboutPage = exports.AboutPageOrSubClassJoiSchema = exports.AboutPageJoiSchema = void 0;
 ...
 */
exports.AboutPageJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AboutPageOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AboutPageJoiSchema,
]);
/**
 ...
 * ```
 */
function validateAboutPage(maybeAboutPage) {
    const { value, error } = exports.AboutPageJoiSchema.validate(maybeAboutPage);
    if (error) {
        return new oaValidationError_1.OaValidationError('AboutPage', maybeAboutPage, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAboutPage = validateAboutPage;
