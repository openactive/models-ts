 ...
 * etc.
 */
export declare type AcceptActionOrSubClass = AcceptAction;
/**
 * schema:AcceptAction - Validation schema (w/ JOI)
 */
export declare const AcceptActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:AcceptAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AcceptActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAcceptAction(maybeAcceptAction: unknown): AcceptAction | OaValidationError;
