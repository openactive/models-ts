 ...
 * etc.
 */
export declare type AccommodationOrSubClass = Accommodation | schema.ApartmentOrSubClass | schema.SuiteOrSubClass | schema.RoomOrSubClass | schema.CampingPitchOrSubClass | schema.HouseOrSubClass;
/**
