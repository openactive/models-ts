 ...
 * etc.
 */
export declare type AccommodationOrSubClass = Accommodation | schema.RoomOrSubClass | schema.ApartmentOrSubClass | schema.SuiteOrSubClass | schema.HouseOrSubClass | schema.CampingPitchOrSubClass;
/**
 * schema:Accommodation - Validation schema (w/ JOI)
 */
export declare const AccommodationJoiSchema: Joi.ObjectSchema;
/**
 * schema:Accommodation - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AccommodationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAccommodation(maybeAccommodation: unknown): Accommodation | OaValidationError;
