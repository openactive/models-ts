...
exports.validateAccommodation = exports.AccommodationOrSubClassJoiSchema = exports.AccommodationJoiSchema = void 0;
 ...
 */
exports.AccommodationJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AccommodationOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AccommodationJoiSchema,
 ...
 * ```
 */
function validateAccommodation(maybeAccommodation) {
    const { value, error } = exports.AccommodationJoiSchema.validate(maybeAccommodation);
    if (error) {
        return new oaValidationError_1.OaValidationError('Accommodation', maybeAccommodation, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAccommodation = validateAccommodation;
