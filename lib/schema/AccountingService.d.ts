 ...
 * etc.
 */
export declare type AccountingServiceOrSubClass = AccountingService;
/**
 * schema:AccountingService - Validation schema (w/ JOI)
 */
export declare const AccountingServiceJoiSchema: Joi.ObjectSchema;
/**
 * schema:AccountingService - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AccountingServiceOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAccountingService(maybeAccountingService: unknown): AccountingService | OaValidationError;
