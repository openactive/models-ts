...
exports.validateAccountingService = exports.AccountingServiceOrSubClassJoiSchema = exports.AccountingServiceJoiSchema = void 0;
 ...
 */
exports.AccountingServiceJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AccountingServiceOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AccountingServiceJoiSchema,
]);
/**
 ...
 * ```
 */
function validateAccountingService(maybeAccountingService) {
    const { value, error } = exports.AccountingServiceJoiSchema.validate(maybeAccountingService);
    if (error) {
        return new oaValidationError_1.OaValidationError('AccountingService', maybeAccountingService, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAccountingService = validateAccountingService;
