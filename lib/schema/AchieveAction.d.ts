 ...
 * etc.
 */
export declare type AchieveActionOrSubClass = AchieveAction | schema.WinActionOrSubClass | schema.TieActionOrSubClass | schema.LoseActionOrSubClass;
/**
 * schema:AchieveAction - Validation schema (w/ JOI)
 */
export declare const AchieveActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:AchieveAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AchieveActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAchieveAction(maybeAchieveAction: unknown): AchieveAction | OaValidationError;
