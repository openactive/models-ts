 ...
 * etc.
 */
export declare type ActionOrSubClass = Action | schema.ConsumeActionOrSubClass | schema.MoveActionOrSubClass | schema.AchieveActionOrSubClass | schema.ControlActionOrSubClass | schema.FindActionOrSubClass | schema.PlayActionOrSubClass | schema.AssessActionOrSubClass | schema.OrganizeActionOrSubClass | schema.SearchActionOrSubClass | schema.SeekToActionOrSubClass | schema.TradeActionOrSubClass | schema.SolveMathActionOrSubClass | schema.CreateActionOrSubClass | schema.InteractActionOrSubClass | schema.UpdateActionOrSubClass | schema.TransferActionOrSubClass;
/**
 * schema:Action - Validation schema (w/ JOI)
 */
export declare const ActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:Action - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAction(maybeAction: unknown): Action | OaValidationError;
