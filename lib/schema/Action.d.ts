 ...
 * etc.
 */
export declare type ActionOrSubClass = Action | schema.TradeActionOrSubClass | schema.TransferActionOrSubClass | schema.ControlActionOrSubClass | schema.CreateActionOrSubClass | schema.FindActionOrSubClass | schema.PlayActionOrSubClass | schema.MoveActionOrSubClass | schema.UpdateActionOrSubClass | schema.SearchActionOrSubClass | schema.SolveMathActionOrSubClass | schema.AssessActionOrSubClass | schema.ConsumeActionOrSubClass | schema.OrganizeActionOrSubClass | schema.SeekToActionOrSubClass | schema.InteractActionOrSubClass | schema.AchieveActionOrSubClass;
/**
