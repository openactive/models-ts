...
exports.validateActionAccessSpecification = exports.ActionAccessSpecificationOrSubClassJoiSchema = exports.ActionAccessSpecificationJoiSchema = void 0;
 ...
 */
exports.ActionAccessSpecificationJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ActionAccessSpecificationOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ActionAccessSpecificationJoiSchema,
]);
/**
 ...
 *
 * ```ts
 * const maybeActionAccessSpecification = ActionAccessSpecification.validate(req.body); // `req.body` will have type `any` or `unknown`
 ...
 * ```
 */
function validateActionAccessSpecification(maybeActionAccessSpecification) {
    const { value, error } = exports.ActionAccessSpecificationJoiSchema.validate(maybeActionAccessSpecification);
    if (error) {
        return new oaValidationError_1.OaValidationError('ActionAccessSpecification', maybeActionAccessSpecification, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateActionAccessSpecification = validateActionAccessSpecification;
