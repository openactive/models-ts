...
exports.validateActionStatusType = exports.ActionStatusTypeOrSubClassJoiSchema = exports.ActionStatusTypeJoiSchema = void 0;
 ...
 */
exports.ActionStatusTypeJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ActionStatusTypeOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ActionStatusTypeJoiSchema,
]);
/**
 ...
 * ```
 */
function validateActionStatusType(maybeActionStatusType) {
    const { value, error } = exports.ActionStatusTypeJoiSchema.validate(maybeActionStatusType);
    if (error) {
        return new oaValidationError_1.OaValidationError('ActionStatusType', maybeActionStatusType, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateActionStatusType = validateActionStatusType;
