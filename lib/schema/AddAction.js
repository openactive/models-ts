...
exports.validateAddAction = exports.AddActionOrSubClassJoiSchema = exports.AddActionJoiSchema = void 0;
 ...
 */
exports.AddActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AddActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AddActionJoiSchema,
 ...
 * ```
 */
function validateAddAction(maybeAddAction) {
    const { value, error } = exports.AddActionJoiSchema.validate(maybeAddAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('AddAction', maybeAddAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAddAction = validateAddAction;
