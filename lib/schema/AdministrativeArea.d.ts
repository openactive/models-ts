 ...
 * etc.
 */
export declare type AdministrativeAreaOrSubClass = AdministrativeArea | schema.StateOrSubClass | schema.CountryOrSubClass | schema.CityOrSubClass | schema.SchoolDistrictOrSubClass;
/**
 * schema:AdministrativeArea - Validation schema (w/ JOI)
 */
export declare const AdministrativeAreaJoiSchema: Joi.ObjectSchema;
/**
 * schema:AdministrativeArea - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AdministrativeAreaOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAdministrativeArea(maybeAdministrativeArea: unknown): AdministrativeArea | OaValidationError;
