 ...
 * etc.
 */
export declare type AdministrativeAreaOrSubClass = AdministrativeArea | schema.SchoolDistrictOrSubClass | schema.CountryOrSubClass | schema.CityOrSubClass | schema.StateOrSubClass;
/**
