...
exports.validateAdministrativeArea = exports.AdministrativeAreaOrSubClassJoiSchema = exports.AdministrativeAreaJoiSchema = void 0;
 ...
 */
exports.AdministrativeAreaJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AdministrativeAreaOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AdministrativeAreaJoiSchema,
 ...
 * ```
 */
function validateAdministrativeArea(maybeAdministrativeArea) {
    const { value, error } = exports.AdministrativeAreaJoiSchema.validate(maybeAdministrativeArea);
    if (error) {
        return new oaValidationError_1.OaValidationError('AdministrativeArea', maybeAdministrativeArea, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAdministrativeArea = validateAdministrativeArea;
