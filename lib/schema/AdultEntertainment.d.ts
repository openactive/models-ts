 ...
 * etc.
 */
export declare type AdultEntertainmentOrSubClass = AdultEntertainment;
/**
 * schema:AdultEntertainment - Validation schema (w/ JOI)
 */
export declare const AdultEntertainmentJoiSchema: Joi.ObjectSchema;
/**
 * schema:AdultEntertainment - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AdultEntertainmentOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAdultEntertainment(maybeAdultEntertainment: unknown): AdultEntertainment | OaValidationError;
