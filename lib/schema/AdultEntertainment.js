...
exports.validateAdultEntertainment = exports.AdultEntertainmentOrSubClassJoiSchema = exports.AdultEntertainmentJoiSchema = void 0;
 ...
 */
exports.AdultEntertainmentJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AdultEntertainmentOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AdultEntertainmentJoiSchema,
]);
/**
 ...
 * ```
 */
function validateAdultEntertainment(maybeAdultEntertainment) {
    const { value, error } = exports.AdultEntertainmentJoiSchema.validate(maybeAdultEntertainment);
    if (error) {
        return new oaValidationError_1.OaValidationError('AdultEntertainment', maybeAdultEntertainment, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAdultEntertainment = validateAdultEntertainment;
