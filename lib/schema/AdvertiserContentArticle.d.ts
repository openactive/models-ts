 ...
 * etc.
 */
export declare type AdvertiserContentArticleOrSubClass = AdvertiserContentArticle;
/**
 * schema:AdvertiserContentArticle - Validation schema (w/ JOI)
 */
export declare const AdvertiserContentArticleJoiSchema: Joi.ObjectSchema;
/**
 * schema:AdvertiserContentArticle - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AdvertiserContentArticleOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAdvertiserContentArticle(maybeAdvertiserContentArticle: unknown): AdvertiserContentArticle | OaValidationError;
