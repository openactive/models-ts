...
exports.validateAdvertiserContentArticle = exports.AdvertiserContentArticleOrSubClassJoiSchema = exports.AdvertiserContentArticleJoiSchema = void 0;
 ...
 */
exports.AdvertiserContentArticleJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AdvertiserContentArticleOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AdvertiserContentArticleJoiSchema,
]);
/**
 ...
 * ```
 */
function validateAdvertiserContentArticle(maybeAdvertiserContentArticle) {
    const { value, error } = exports.AdvertiserContentArticleJoiSchema.validate(maybeAdvertiserContentArticle);
    if (error) {
        return new oaValidationError_1.OaValidationError('AdvertiserContentArticle', maybeAdvertiserContentArticle, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAdvertiserContentArticle = validateAdvertiserContentArticle;
