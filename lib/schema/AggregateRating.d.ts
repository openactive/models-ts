 ...
 * etc.
 */
export declare type AggregateRatingOrSubClass = AggregateRating | schema.EmployerAggregateRatingOrSubClass;
/**
 * schema:AggregateRating - Validation schema (w/ JOI)
 */
export declare const AggregateRatingJoiSchema: Joi.ObjectSchema;
/**
 * schema:AggregateRating - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AggregateRatingOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 *
 * ```ts
 * const maybeAggregateRating = AggregateRating.validate(req.body); // `req.body` will have type `any` or `unknown`
 ...
 * ```
 */
export declare function validateAggregateRating(maybeAggregateRating: unknown): AggregateRating | OaValidationError;
