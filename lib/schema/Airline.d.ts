 ...
 * etc.
 */
export declare type AirlineOrSubClass = Airline;
/**
 * schema:Airline - Validation schema (w/ JOI)
 */
export declare const AirlineJoiSchema: Joi.ObjectSchema;
/**
 * schema:Airline - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AirlineOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAirline(maybeAirline: unknown): Airline | OaValidationError;
