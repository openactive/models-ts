...
exports.validateAirline = exports.AirlineOrSubClassJoiSchema = exports.AirlineJoiSchema = void 0;
 ...
 */
exports.AirlineJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AirlineOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AirlineJoiSchema,
]);
/**
 ...
 * ```
 */
function validateAirline(maybeAirline) {
    const { value, error } = exports.AirlineJoiSchema.validate(maybeAirline);
    if (error) {
        return new oaValidationError_1.OaValidationError('Airline', maybeAirline, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAirline = validateAirline;
