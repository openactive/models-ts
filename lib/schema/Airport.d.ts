 ...
 * etc.
 */
export declare type AirportOrSubClass = Airport;
/**
 * schema:Airport - Validation schema (w/ JOI)
 */
export declare const AirportJoiSchema: Joi.ObjectSchema;
/**
 * schema:Airport - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AirportOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAirport(maybeAirport: unknown): Airport | OaValidationError;
