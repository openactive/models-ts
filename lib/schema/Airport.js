...
exports.validateAirport = exports.AirportOrSubClassJoiSchema = exports.AirportJoiSchema = void 0;
 ...
 */
exports.AirportJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AirportOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AirportJoiSchema,
]);
/**
 ...
 * ```
 */
function validateAirport(maybeAirport) {
    const { value, error } = exports.AirportJoiSchema.validate(maybeAirport);
    if (error) {
        return new oaValidationError_1.OaValidationError('Airport', maybeAirport, error);
    }
