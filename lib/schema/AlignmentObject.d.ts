 ...
 * etc.
 */
export declare type AlignmentObjectOrSubClass = AlignmentObject;
/**
 * schema:AlignmentObject - Validation schema (w/ JOI)
 */
export declare const AlignmentObjectJoiSchema: Joi.ObjectSchema;
/**
 * schema:AlignmentObject - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AlignmentObjectOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAlignmentObject(maybeAlignmentObject: unknown): AlignmentObject | OaValidationError;
