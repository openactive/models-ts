 ...
 * etc.
 */
export declare type AmpStoryOrSubClass = AmpStory;
/**
 * schema:AmpStory - Validation schema (w/ JOI)
 */
export declare const AmpStoryJoiSchema: Joi.ObjectSchema;
/**
 * schema:AmpStory - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AmpStoryOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAmpStory(maybeAmpStory: unknown): AmpStory | OaValidationError;
