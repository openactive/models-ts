...
exports.validateAmpStory = exports.AmpStoryOrSubClassJoiSchema = exports.AmpStoryJoiSchema = void 0;
 ...
 */
exports.AmpStoryJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AmpStoryOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AmpStoryJoiSchema,
]);
/**
 ...
 * ```
 */
function validateAmpStory(maybeAmpStory) {
    const { value, error } = exports.AmpStoryJoiSchema.validate(maybeAmpStory);
    if (error) {
        return new oaValidationError_1.OaValidationError('AmpStory', maybeAmpStory, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAmpStory = validateAmpStory;
