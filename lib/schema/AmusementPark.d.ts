 ...
 * etc.
 */
export declare type AmusementParkOrSubClass = AmusementPark;
/**
 * schema:AmusementPark - Validation schema (w/ JOI)
 */
export declare const AmusementParkJoiSchema: Joi.ObjectSchema;
/**
 * schema:AmusementPark - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AmusementParkOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAmusementPark(maybeAmusementPark: unknown): AmusementPark | OaValidationError;
