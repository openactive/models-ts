...
exports.validateAmusementPark = exports.AmusementParkOrSubClassJoiSchema = exports.AmusementParkJoiSchema = void 0;
 ...
 */
exports.AmusementParkJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AmusementParkOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AmusementParkJoiSchema,
]);
/**
 ...
 * ```
 */
function validateAmusementPark(maybeAmusementPark) {
    const { value, error } = exports.AmusementParkJoiSchema.validate(maybeAmusementPark);
    if (error) {
        return new oaValidationError_1.OaValidationError('AmusementPark', maybeAmusementPark, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAmusementPark = validateAmusementPark;
