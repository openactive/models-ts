 ...
 * etc.
 */
export declare type AnalysisNewsArticleOrSubClass = AnalysisNewsArticle;
/**
 * schema:AnalysisNewsArticle - Validation schema (w/ JOI)
 */
export declare const AnalysisNewsArticleJoiSchema: Joi.ObjectSchema;
/**
 * schema:AnalysisNewsArticle - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AnalysisNewsArticleOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAnalysisNewsArticle(maybeAnalysisNewsArticle: unknown): AnalysisNewsArticle | OaValidationError;
