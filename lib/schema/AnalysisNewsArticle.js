...
exports.validateAnalysisNewsArticle = exports.AnalysisNewsArticleOrSubClassJoiSchema = exports.AnalysisNewsArticleJoiSchema = void 0;
 ...
 */
exports.AnalysisNewsArticleJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AnalysisNewsArticleOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AnalysisNewsArticleJoiSchema,
]);
/**
 ...
 * ```
 */
function validateAnalysisNewsArticle(maybeAnalysisNewsArticle) {
    const { value, error } = exports.AnalysisNewsArticleJoiSchema.validate(maybeAnalysisNewsArticle);
    if (error) {
        return new oaValidationError_1.OaValidationError('AnalysisNewsArticle', maybeAnalysisNewsArticle, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAnalysisNewsArticle = validateAnalysisNewsArticle;
