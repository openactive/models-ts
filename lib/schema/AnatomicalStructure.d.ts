 ...
 * etc.
 */
export declare type AnatomicalStructureOrSubClass = AnatomicalStructure | schema.NerveOrSubClass | schema.BrainStructureOrSubClass | schema.JointOrSubClass | schema.MuscleOrSubClass | schema.LigamentOrSubClass | schema.BoneOrSubClass | schema.VesselOrSubClass;
/**
 * schema:AnatomicalStructure - Validation schema (w/ JOI)
 */
export declare const AnatomicalStructureJoiSchema: Joi.ObjectSchema;
/**
 * schema:AnatomicalStructure - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AnatomicalStructureOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAnatomicalStructure(maybeAnatomicalStructure: unknown): AnatomicalStructure | OaValidationError;
