 ...
 * etc.
 */
export declare type AnatomicalStructureOrSubClass = AnatomicalStructure | schema.JointOrSubClass | schema.BoneOrSubClass | schema.VesselOrSubClass | schema.LigamentOrSubClass | schema.BrainStructureOrSubClass | schema.MuscleOrSubClass | schema.NerveOrSubClass;
/**
