 ...
 * etc.
 */
export declare type AnatomicalSystemOrSubClass = AnatomicalSystem;
/**
 * schema:AnatomicalSystem - Validation schema (w/ JOI)
 */
export declare const AnatomicalSystemJoiSchema: Joi.ObjectSchema;
/**
 * schema:AnatomicalSystem - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AnatomicalSystemOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 *
 * ```ts
 * const maybeAnatomicalSystem = AnatomicalSystem.validate(req.body); // `req.body` will have type `any` or `unknown`
 ...
 * ```
 */
export declare function validateAnatomicalSystem(maybeAnatomicalSystem: unknown): AnatomicalSystem | OaValidationError;
