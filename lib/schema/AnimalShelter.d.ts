 ...
 * etc.
 */
export declare type AnimalShelterOrSubClass = AnimalShelter;
/**
 * schema:AnimalShelter - Validation schema (w/ JOI)
 */
export declare const AnimalShelterJoiSchema: Joi.ObjectSchema;
/**
 * schema:AnimalShelter - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AnimalShelterOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAnimalShelter(maybeAnimalShelter: unknown): AnimalShelter | OaValidationError;
