...
exports.validateAnimalShelter = exports.AnimalShelterOrSubClassJoiSchema = exports.AnimalShelterJoiSchema = void 0;
 ...
 */
exports.AnimalShelterJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AnimalShelterOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AnimalShelterJoiSchema,
]);
/**
 ...
 * ```
 */
function validateAnimalShelter(maybeAnimalShelter) {
    const { value, error } = exports.AnimalShelterJoiSchema.validate(maybeAnimalShelter);
    if (error) {
        return new oaValidationError_1.OaValidationError('AnimalShelter', maybeAnimalShelter, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAnimalShelter = validateAnimalShelter;
