 ...
 * etc.
 */
export declare type AnswerOrSubClass = Answer;
/**
 * schema:Answer - Validation schema (w/ JOI)
 */
export declare const AnswerJoiSchema: Joi.ObjectSchema;
/**
 * schema:Answer - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AnswerOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAnswer(maybeAnswer: unknown): Answer | OaValidationError;
