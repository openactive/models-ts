...
exports.validateAnswer = exports.AnswerOrSubClassJoiSchema = exports.AnswerJoiSchema = void 0;
 ...
 */
exports.AnswerJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AnswerOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AnswerJoiSchema,
]);
/**
 ...
 * ```
 */
function validateAnswer(maybeAnswer) {
    const { value, error } = exports.AnswerJoiSchema.validate(maybeAnswer);
    if (error) {
        return new oaValidationError_1.OaValidationError('Answer', maybeAnswer, error);
    }
