 ...
 * etc.
 */
export declare type ApartmentOrSubClass = Apartment;
/**
 * schema:Apartment - Validation schema (w/ JOI)
 */
export declare const ApartmentJoiSchema: Joi.ObjectSchema;
/**
 * schema:Apartment - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ApartmentOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateApartment(maybeApartment: unknown): Apartment | OaValidationError;
