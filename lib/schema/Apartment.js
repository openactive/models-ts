...
exports.validateApartment = exports.ApartmentOrSubClassJoiSchema = exports.ApartmentJoiSchema = void 0;
 ...
 */
exports.ApartmentJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ApartmentOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ApartmentJoiSchema,
]);
/**
 ...
 * ```
 */
function validateApartment(maybeApartment) {
    const { value, error } = exports.ApartmentJoiSchema.validate(maybeApartment);
    if (error) {
        return new oaValidationError_1.OaValidationError('Apartment', maybeApartment, error);
    }
