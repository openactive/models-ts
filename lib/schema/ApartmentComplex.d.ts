 ...
 * etc.
 */
export declare type ApartmentComplexOrSubClass = ApartmentComplex;
/**
 * schema:ApartmentComplex - Validation schema (w/ JOI)
 */
export declare const ApartmentComplexJoiSchema: Joi.ObjectSchema;
/**
 * schema:ApartmentComplex - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ApartmentComplexOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateApartmentComplex(maybeApartmentComplex: unknown): ApartmentComplex | OaValidationError;
