...
exports.validateAppendAction = exports.AppendActionOrSubClassJoiSchema = exports.AppendActionJoiSchema = void 0;
 ...
 */
exports.AppendActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AppendActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AppendActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateAppendAction(maybeAppendAction) {
    const { value, error } = exports.AppendActionJoiSchema.validate(maybeAppendAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('AppendAction', maybeAppendAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAppendAction = validateAppendAction;
