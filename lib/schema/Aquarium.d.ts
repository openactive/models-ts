 ...
 * etc.
 */
export declare type AquariumOrSubClass = Aquarium;
/**
 * schema:Aquarium - Validation schema (w/ JOI)
 */
export declare const AquariumJoiSchema: Joi.ObjectSchema;
/**
 * schema:Aquarium - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AquariumOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAquarium(maybeAquarium: unknown): Aquarium | OaValidationError;
