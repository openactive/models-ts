...
exports.validateAquarium = exports.AquariumOrSubClassJoiSchema = exports.AquariumJoiSchema = void 0;
 ...
 */
exports.AquariumJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AquariumOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AquariumJoiSchema,
]);
/**
 ...
 * ```
 */
function validateAquarium(maybeAquarium) {
    const { value, error } = exports.AquariumJoiSchema.validate(maybeAquarium);
    if (error) {
        return new oaValidationError_1.OaValidationError('Aquarium', maybeAquarium, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAquarium = validateAquarium;
