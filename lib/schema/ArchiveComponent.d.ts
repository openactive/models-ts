 ...
 * etc.
 */
export declare type ArchiveComponentOrSubClass = ArchiveComponent;
/**
 * schema:ArchiveComponent - Validation schema (w/ JOI)
 */
export declare const ArchiveComponentJoiSchema: Joi.ObjectSchema;
/**
 * schema:ArchiveComponent - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ArchiveComponentOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateArchiveComponent(maybeArchiveComponent: unknown): ArchiveComponent | OaValidationError;
