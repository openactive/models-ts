...
exports.validateArchiveComponent = exports.ArchiveComponentOrSubClassJoiSchema = exports.ArchiveComponentJoiSchema = void 0;
 ...
 */
exports.ArchiveComponentJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ArchiveComponentOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ArchiveComponentJoiSchema,
]);
/**
 ...
 * ```
 */
function validateArchiveComponent(maybeArchiveComponent) {
    const { value, error } = exports.ArchiveComponentJoiSchema.validate(maybeArchiveComponent);
    if (error) {
        return new oaValidationError_1.OaValidationError('ArchiveComponent', maybeArchiveComponent, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateArchiveComponent = validateArchiveComponent;
