 ...
 * etc.
 */
export declare type ArchiveOrganizationOrSubClass = ArchiveOrganization;
/**
 * schema:ArchiveOrganization - Validation schema (w/ JOI)
 */
export declare const ArchiveOrganizationJoiSchema: Joi.ObjectSchema;
/**
 * schema:ArchiveOrganization - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ArchiveOrganizationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateArchiveOrganization(maybeArchiveOrganization: unknown): ArchiveOrganization | OaValidationError;
