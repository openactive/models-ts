...
exports.validateArchiveOrganization = exports.ArchiveOrganizationOrSubClassJoiSchema = exports.ArchiveOrganizationJoiSchema = void 0;
 ...
 */
exports.ArchiveOrganizationJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ArchiveOrganizationOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ArchiveOrganizationJoiSchema,
]);
/**
 ...
 * ```
 */
function validateArchiveOrganization(maybeArchiveOrganization) {
    const { value, error } = exports.ArchiveOrganizationJoiSchema.validate(maybeArchiveOrganization);
    if (error) {
        return new oaValidationError_1.OaValidationError('ArchiveOrganization', maybeArchiveOrganization, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateArchiveOrganization = validateArchiveOrganization;
