...
exports.validateArriveAction = exports.ArriveActionOrSubClassJoiSchema = exports.ArriveActionJoiSchema = void 0;
 ...
 */
exports.ArriveActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ArriveActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ArriveActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateArriveAction(maybeArriveAction) {
    const { value, error } = exports.ArriveActionJoiSchema.validate(maybeArriveAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('ArriveAction', maybeArriveAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateArriveAction = validateArriveAction;
