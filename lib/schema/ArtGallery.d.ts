 ...
 * etc.
 */
export declare type ArtGalleryOrSubClass = ArtGallery;
/**
 * schema:ArtGallery - Validation schema (w/ JOI)
 */
export declare const ArtGalleryJoiSchema: Joi.ObjectSchema;
/**
 * schema:ArtGallery - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ArtGalleryOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateArtGallery(maybeArtGallery: unknown): ArtGallery | OaValidationError;
