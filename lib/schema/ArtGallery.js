...
exports.validateArtGallery = exports.ArtGalleryOrSubClassJoiSchema = exports.ArtGalleryJoiSchema = void 0;
 ...
 */
exports.ArtGalleryJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ArtGalleryOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ArtGalleryJoiSchema,
]);
/**
 ...
 * ```
 */
function validateArtGallery(maybeArtGallery) {
    const { value, error } = exports.ArtGalleryJoiSchema.validate(maybeArtGallery);
    if (error) {
        return new oaValidationError_1.OaValidationError('ArtGallery', maybeArtGallery, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateArtGallery = validateArtGallery;
