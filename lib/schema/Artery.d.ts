 ...
 * etc.
 */
export declare type ArteryOrSubClass = Artery;
/**
 * schema:Artery - Validation schema (w/ JOI)
 */
export declare const ArteryJoiSchema: Joi.ObjectSchema;
/**
 * schema:Artery - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ArteryOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateArtery(maybeArtery: unknown): Artery | OaValidationError;
