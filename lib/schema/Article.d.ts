 ...
 * etc.
 */
export declare type ArticleOrSubClass = Article | schema.ReportOrSubClass | schema.ScholarlyArticleOrSubClass | schema.AdvertiserContentArticleOrSubClass | schema.NewsArticleOrSubClass | schema.SatiricalArticleOrSubClass | schema.SocialMediaPostingOrSubClass | schema.TechArticleOrSubClass;
/**
 * schema:Article - Validation schema (w/ JOI)
 */
export declare const ArticleJoiSchema: Joi.ObjectSchema;
/**
 * schema:Article - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ArticleOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateArticle(maybeArticle: unknown): Article | OaValidationError;
