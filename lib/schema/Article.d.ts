 ...
 * etc.
 */
export declare type ArticleOrSubClass = Article | schema.ReportOrSubClass | schema.NewsArticleOrSubClass | schema.SatiricalArticleOrSubClass | schema.ScholarlyArticleOrSubClass | schema.SocialMediaPostingOrSubClass | schema.AdvertiserContentArticleOrSubClass | schema.TechArticleOrSubClass;
/**
