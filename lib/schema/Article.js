...
exports.validateArticle = exports.ArticleOrSubClassJoiSchema = exports.ArticleJoiSchema = void 0;
 ...
 */
exports.ArticleJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ArticleOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ArticleJoiSchema,
 ...
 * ```
 */
function validateArticle(maybeArticle) {
    const { value, error } = exports.ArticleJoiSchema.validate(maybeArticle);
    if (error) {
        return new oaValidationError_1.OaValidationError('Article', maybeArticle, error);
    }
