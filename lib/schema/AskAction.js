...
exports.validateAskAction = exports.AskActionOrSubClassJoiSchema = exports.AskActionJoiSchema = void 0;
 ...
 */
exports.AskActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AskActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AskActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateAskAction(maybeAskAction) {
    const { value, error } = exports.AskActionJoiSchema.validate(maybeAskAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('AskAction', maybeAskAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAskAction = validateAskAction;
