 ...
 * etc.
 */
export declare type AskPublicNewsArticleOrSubClass = AskPublicNewsArticle;
/**
 * schema:AskPublicNewsArticle - Validation schema (w/ JOI)
 */
export declare const AskPublicNewsArticleJoiSchema: Joi.ObjectSchema;
/**
 * schema:AskPublicNewsArticle - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AskPublicNewsArticleOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAskPublicNewsArticle(maybeAskPublicNewsArticle: unknown): AskPublicNewsArticle | OaValidationError;
