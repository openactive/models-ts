...
exports.validateAskPublicNewsArticle = exports.AskPublicNewsArticleOrSubClassJoiSchema = exports.AskPublicNewsArticleJoiSchema = void 0;
 ...
 */
exports.AskPublicNewsArticleJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AskPublicNewsArticleOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AskPublicNewsArticleJoiSchema,
]);
/**
 ...
 * ```
 */
function validateAskPublicNewsArticle(maybeAskPublicNewsArticle) {
    const { value, error } = exports.AskPublicNewsArticleJoiSchema.validate(maybeAskPublicNewsArticle);
    if (error) {
        return new oaValidationError_1.OaValidationError('AskPublicNewsArticle', maybeAskPublicNewsArticle, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAskPublicNewsArticle = validateAskPublicNewsArticle;
