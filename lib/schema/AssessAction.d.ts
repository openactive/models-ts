 ...
 * etc.
 */
export declare type AssessActionOrSubClass = AssessAction | schema.ReactActionOrSubClass | schema.ReviewActionOrSubClass | schema.ChooseActionOrSubClass | schema.IgnoreActionOrSubClass;
/**
 * schema:AssessAction - Validation schema (w/ JOI)
 */
export declare const AssessActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:AssessAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AssessActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAssessAction(maybeAssessAction: unknown): AssessAction | OaValidationError;
