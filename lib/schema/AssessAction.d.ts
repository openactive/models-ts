 ...
 * etc.
 */
export declare type AssessActionOrSubClass = AssessAction | schema.ChooseActionOrSubClass | schema.ReviewActionOrSubClass | schema.ReactActionOrSubClass | schema.IgnoreActionOrSubClass;
/**
