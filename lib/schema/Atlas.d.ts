 ...
 * etc.
 */
export declare type AtlasOrSubClass = Atlas;
/**
 * schema:Atlas - Validation schema (w/ JOI)
 */
export declare const AtlasJoiSchema: Joi.ObjectSchema;
/**
 * schema:Atlas - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AtlasOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAtlas(maybeAtlas: unknown): Atlas | OaValidationError;
