 ...
 * etc.
 */
export declare type AttorneyOrSubClass = Attorney;
/**
 * schema:Attorney - Validation schema (w/ JOI)
 */
export declare const AttorneyJoiSchema: Joi.ObjectSchema;
/**
 * schema:Attorney - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AttorneyOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAttorney(maybeAttorney: unknown): Attorney | OaValidationError;
