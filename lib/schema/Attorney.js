...
exports.validateAttorney = exports.AttorneyOrSubClassJoiSchema = exports.AttorneyJoiSchema = void 0;
 ...
 */
exports.AttorneyJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AttorneyOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AttorneyJoiSchema,
]);
/**
 ...
 * ```
 */
function validateAttorney(maybeAttorney) {
    const { value, error } = exports.AttorneyJoiSchema.validate(maybeAttorney);
    if (error) {
        return new oaValidationError_1.OaValidationError('Attorney', maybeAttorney, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAttorney = validateAttorney;
