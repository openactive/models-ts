 ...
 * etc.
 */
export declare type AudienceOrSubClass = Audience | schema.EducationalAudienceOrSubClass | schema.MedicalAudienceOrSubClass | schema.ResearcherOrSubClass | schema.BusinessAudienceOrSubClass | schema.PeopleAudienceOrSubClass;
/**
 * schema:Audience - Validation schema (w/ JOI)
 */
export declare const AudienceJoiSchema: Joi.ObjectSchema;
/**
 * schema:Audience - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AudienceOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 *
 * ```ts
 * const maybeAudience = Audience.validate(req.body); // `req.body` will have type `any` or `unknown`
 ...
 * ```
 */
export declare function validateAudience(maybeAudience: unknown): Audience | OaValidationError;
