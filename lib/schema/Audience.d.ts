 ...
 * etc.
 */
export declare type AudienceOrSubClass = Audience | schema.BusinessAudienceOrSubClass | schema.ResearcherOrSubClass | schema.EducationalAudienceOrSubClass | schema.PeopleAudienceOrSubClass | schema.MedicalAudienceOrSubClass;
/**
