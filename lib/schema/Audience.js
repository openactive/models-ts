...
exports.validateAudience = exports.AudienceOrSubClassJoiSchema = exports.AudienceJoiSchema = void 0;
 ...
 */
exports.AudienceJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AudienceOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AudienceJoiSchema,
 ...
 * ```
 */
function validateAudience(maybeAudience) {
    const { value, error } = exports.AudienceJoiSchema.validate(maybeAudience);
    if (error) {
        return new oaValidationError_1.OaValidationError('Audience', maybeAudience, error);
    }
