 ...
 * etc.
 */
export declare type AudioObjectOrSubClass = AudioObject | schema.AudiobookOrSubClass | schema.AudioObjectSnapshotOrSubClass;
/**
 * schema:AudioObject - Validation schema (w/ JOI)
 */
export declare const AudioObjectJoiSchema: Joi.ObjectSchema;
/**
 * schema:AudioObject - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AudioObjectOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAudioObject(maybeAudioObject: unknown): AudioObject | OaValidationError;
