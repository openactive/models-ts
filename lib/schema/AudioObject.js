...
exports.validateAudioObject = exports.AudioObjectOrSubClassJoiSchema = exports.AudioObjectJoiSchema = void 0;
 ...
 */
exports.AudioObjectJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AudioObjectOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AudioObjectJoiSchema,
 ...
 * ```
 */
function validateAudioObject(maybeAudioObject) {
    const { value, error } = exports.AudioObjectJoiSchema.validate(maybeAudioObject);
    if (error) {
        return new oaValidationError_1.OaValidationError('AudioObject', maybeAudioObject, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAudioObject = validateAudioObject;
