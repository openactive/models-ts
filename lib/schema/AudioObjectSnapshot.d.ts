 ...
 */
export declare type AudioObjectSnapshot = {
 ...
 * etc.
 */
export declare type AudioObjectSnapshotOrSubClass = AudioObjectSnapshot;
/**
 * schema:AudioObjectSnapshot - Validation schema (w/ JOI)
 */
export declare const AudioObjectSnapshotJoiSchema: Joi.ObjectSchema;
/**
 * schema:AudioObjectSnapshot - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AudioObjectSnapshotOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAudioObjectSnapshot(maybeAudioObjectSnapshot: unknown): AudioObjectSnapshot | OaValidationError;
