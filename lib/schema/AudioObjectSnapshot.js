...
exports.validateAudioObjectSnapshot = exports.AudioObjectSnapshotOrSubClassJoiSchema = exports.AudioObjectSnapshotJoiSchema = void 0;
 ...
 */
exports.AudioObjectSnapshotJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AudioObjectSnapshotOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AudioObjectSnapshotJoiSchema,
]);
/**
 ...
 * ```
 */
function validateAudioObjectSnapshot(maybeAudioObjectSnapshot) {
    const { value, error } = exports.AudioObjectSnapshotJoiSchema.validate(maybeAudioObjectSnapshot);
    if (error) {
        return new oaValidationError_1.OaValidationError('AudioObjectSnapshot', maybeAudioObjectSnapshot, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAudioObjectSnapshot = validateAudioObjectSnapshot;
