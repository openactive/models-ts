 ...
 * etc.
 */
export declare type AudiobookOrSubClass = Audiobook;
/**
 * schema:Audiobook - Validation schema (w/ JOI)
 */
export declare const AudiobookJoiSchema: Joi.ObjectSchema;
/**
 * schema:Audiobook - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AudiobookOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAudiobook(maybeAudiobook: unknown): Audiobook | OaValidationError;
