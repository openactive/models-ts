...
exports.validateAudiobook = exports.AudiobookOrSubClassJoiSchema = exports.AudiobookJoiSchema = void 0;
 ...
 */
exports.AudiobookJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AudiobookOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AudiobookJoiSchema,
]);
/**
 ...
 * ```
 */
function validateAudiobook(maybeAudiobook) {
    const { value, error } = exports.AudiobookJoiSchema.validate(maybeAudiobook);
    if (error) {
        return new oaValidationError_1.OaValidationError('Audiobook', maybeAudiobook, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAudiobook = validateAudiobook;
