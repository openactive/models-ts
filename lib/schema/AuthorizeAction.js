...
exports.validateAuthorizeAction = exports.AuthorizeActionOrSubClassJoiSchema = exports.AuthorizeActionJoiSchema = void 0;
 ...
 */
exports.AuthorizeActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AuthorizeActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AuthorizeActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateAuthorizeAction(maybeAuthorizeAction) {
    const { value, error } = exports.AuthorizeActionJoiSchema.validate(maybeAuthorizeAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('AuthorizeAction', maybeAuthorizeAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAuthorizeAction = validateAuthorizeAction;
