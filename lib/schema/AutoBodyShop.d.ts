 ...
 * etc.
 */
export declare type AutoBodyShopOrSubClass = AutoBodyShop;
/**
 * schema:AutoBodyShop - Validation schema (w/ JOI)
 */
export declare const AutoBodyShopJoiSchema: Joi.ObjectSchema;
/**
 * schema:AutoBodyShop - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AutoBodyShopOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAutoBodyShop(maybeAutoBodyShop: unknown): AutoBodyShop | OaValidationError;
