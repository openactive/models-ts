...
exports.validateAutoBodyShop = exports.AutoBodyShopOrSubClassJoiSchema = exports.AutoBodyShopJoiSchema = void 0;
 ...
 */
exports.AutoBodyShopJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AutoBodyShopOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AutoBodyShopJoiSchema,
]);
/**
 ...
 * ```
 */
function validateAutoBodyShop(maybeAutoBodyShop) {
    const { value, error } = exports.AutoBodyShopJoiSchema.validate(maybeAutoBodyShop);
    if (error) {
        return new oaValidationError_1.OaValidationError('AutoBodyShop', maybeAutoBodyShop, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAutoBodyShop = validateAutoBodyShop;
