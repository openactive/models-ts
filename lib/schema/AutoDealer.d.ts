 ...
 * etc.
 */
export declare type AutoDealerOrSubClass = AutoDealer;
/**
 * schema:AutoDealer - Validation schema (w/ JOI)
 */
export declare const AutoDealerJoiSchema: Joi.ObjectSchema;
/**
 * schema:AutoDealer - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AutoDealerOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAutoDealer(maybeAutoDealer: unknown): AutoDealer | OaValidationError;
