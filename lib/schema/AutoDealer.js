...
exports.validateAutoDealer = exports.AutoDealerOrSubClassJoiSchema = exports.AutoDealerJoiSchema = void 0;
 ...
 */
exports.AutoDealerJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AutoDealerOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AutoDealerJoiSchema,
]);
/**
 ...
 * ```
 */
function validateAutoDealer(maybeAutoDealer) {
    const { value, error } = exports.AutoDealerJoiSchema.validate(maybeAutoDealer);
    if (error) {
        return new oaValidationError_1.OaValidationError('AutoDealer', maybeAutoDealer, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAutoDealer = validateAutoDealer;
