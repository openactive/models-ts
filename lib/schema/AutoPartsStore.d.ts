 ...
 * etc.
 */
export declare type AutoPartsStoreOrSubClass = AutoPartsStore;
/**
 * schema:AutoPartsStore - Validation schema (w/ JOI)
 */
export declare const AutoPartsStoreJoiSchema: Joi.ObjectSchema;
/**
 * schema:AutoPartsStore - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AutoPartsStoreOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAutoPartsStore(maybeAutoPartsStore: unknown): AutoPartsStore | OaValidationError;
