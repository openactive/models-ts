...
exports.validateAutoPartsStore = exports.AutoPartsStoreOrSubClassJoiSchema = exports.AutoPartsStoreJoiSchema = void 0;
 ...
 */
exports.AutoPartsStoreJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AutoPartsStoreOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AutoPartsStoreJoiSchema,
]);
/**
 ...
 * ```
 */
function validateAutoPartsStore(maybeAutoPartsStore) {
    const { value, error } = exports.AutoPartsStoreJoiSchema.validate(maybeAutoPartsStore);
    if (error) {
        return new oaValidationError_1.OaValidationError('AutoPartsStore', maybeAutoPartsStore, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAutoPartsStore = validateAutoPartsStore;
