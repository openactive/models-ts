 ...
 * etc.
 */
export declare type AutoRentalOrSubClass = AutoRental;
/**
 * schema:AutoRental - Validation schema (w/ JOI)
 */
export declare const AutoRentalJoiSchema: Joi.ObjectSchema;
/**
 * schema:AutoRental - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AutoRentalOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAutoRental(maybeAutoRental: unknown): AutoRental | OaValidationError;
