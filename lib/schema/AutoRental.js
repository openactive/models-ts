...
exports.validateAutoRental = exports.AutoRentalOrSubClassJoiSchema = exports.AutoRentalJoiSchema = void 0;
 ...
 */
exports.AutoRentalJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AutoRentalOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AutoRentalJoiSchema,
]);
/**
 ...
 * ```
 */
function validateAutoRental(maybeAutoRental) {
    const { value, error } = exports.AutoRentalJoiSchema.validate(maybeAutoRental);
    if (error) {
        return new oaValidationError_1.OaValidationError('AutoRental', maybeAutoRental, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAutoRental = validateAutoRental;
