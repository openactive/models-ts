 ...
 * etc.
 */
export declare type AutoRepairOrSubClass = AutoRepair;
/**
 * schema:AutoRepair - Validation schema (w/ JOI)
 */
export declare const AutoRepairJoiSchema: Joi.ObjectSchema;
/**
 * schema:AutoRepair - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AutoRepairOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAutoRepair(maybeAutoRepair: unknown): AutoRepair | OaValidationError;
