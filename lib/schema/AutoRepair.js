...
exports.validateAutoRepair = exports.AutoRepairOrSubClassJoiSchema = exports.AutoRepairJoiSchema = void 0;
 ...
 */
exports.AutoRepairJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AutoRepairOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AutoRepairJoiSchema,
]);
/**
 ...
 * ```
 */
function validateAutoRepair(maybeAutoRepair) {
    const { value, error } = exports.AutoRepairJoiSchema.validate(maybeAutoRepair);
    if (error) {
        return new oaValidationError_1.OaValidationError('AutoRepair', maybeAutoRepair, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAutoRepair = validateAutoRepair;
