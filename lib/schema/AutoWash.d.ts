 ...
 * etc.
 */
export declare type AutoWashOrSubClass = AutoWash;
/**
 * schema:AutoWash - Validation schema (w/ JOI)
 */
export declare const AutoWashJoiSchema: Joi.ObjectSchema;
/**
 * schema:AutoWash - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AutoWashOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAutoWash(maybeAutoWash: unknown): AutoWash | OaValidationError;
