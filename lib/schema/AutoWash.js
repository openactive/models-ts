...
exports.validateAutoWash = exports.AutoWashOrSubClassJoiSchema = exports.AutoWashJoiSchema = void 0;
 ...
 */
exports.AutoWashJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AutoWashOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AutoWashJoiSchema,
]);
/**
 ...
 * ```
 */
function validateAutoWash(maybeAutoWash) {
    const { value, error } = exports.AutoWashJoiSchema.validate(maybeAutoWash);
    if (error) {
        return new oaValidationError_1.OaValidationError('AutoWash', maybeAutoWash, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAutoWash = validateAutoWash;
