 ...
 * etc.
 */
export declare type AutomatedTellerOrSubClass = AutomatedTeller;
/**
 * schema:AutomatedTeller - Validation schema (w/ JOI)
 */
export declare const AutomatedTellerJoiSchema: Joi.ObjectSchema;
/**
 * schema:AutomatedTeller - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AutomatedTellerOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAutomatedTeller(maybeAutomatedTeller: unknown): AutomatedTeller | OaValidationError;
