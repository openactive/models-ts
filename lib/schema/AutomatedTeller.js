...
exports.validateAutomatedTeller = exports.AutomatedTellerOrSubClassJoiSchema = exports.AutomatedTellerJoiSchema = void 0;
 ...
 */
exports.AutomatedTellerJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AutomatedTellerOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AutomatedTellerJoiSchema,
]);
/**
 ...
 * ```
 */
function validateAutomatedTeller(maybeAutomatedTeller) {
    const { value, error } = exports.AutomatedTellerJoiSchema.validate(maybeAutomatedTeller);
    if (error) {
        return new oaValidationError_1.OaValidationError('AutomatedTeller', maybeAutomatedTeller, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAutomatedTeller = validateAutomatedTeller;
