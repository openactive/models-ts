 ...
 * etc.
 */
export declare type AutomotiveBusinessOrSubClass = AutomotiveBusiness | schema.AutoPartsStoreOrSubClass | schema.AutoRentalOrSubClass | schema.AutoDealerOrSubClass | schema.GasStationOrSubClass | schema.AutoWashOrSubClass | schema.MotorcycleRepairOrSubClass | schema.AutoRepairOrSubClass | schema.MotorcycleDealerOrSubClass | schema.AutoBodyShopOrSubClass;
/**
 * schema:AutomotiveBusiness - Validation schema (w/ JOI)
 */
export declare const AutomotiveBusinessJoiSchema: Joi.ObjectSchema;
/**
 * schema:AutomotiveBusiness - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const AutomotiveBusinessOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateAutomotiveBusiness(maybeAutomotiveBusiness: unknown): AutomotiveBusiness | OaValidationError;
