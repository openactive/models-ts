...
exports.validateAutomotiveBusiness = exports.AutomotiveBusinessOrSubClassJoiSchema = exports.AutomotiveBusinessJoiSchema = void 0;
 ...
 */
exports.AutomotiveBusinessJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.AutomotiveBusinessOrSubClassJoiSchema = Joi.alternatives().try([
    exports.AutomotiveBusinessJoiSchema,
 ...
 * ```
 */
function validateAutomotiveBusiness(maybeAutomotiveBusiness) {
    const { value, error } = exports.AutomotiveBusinessJoiSchema.validate(maybeAutomotiveBusiness);
    if (error) {
        return new oaValidationError_1.OaValidationError('AutomotiveBusiness', maybeAutomotiveBusiness, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateAutomotiveBusiness = validateAutomotiveBusiness;
