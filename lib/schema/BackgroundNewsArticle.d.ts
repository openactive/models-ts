 ...
 * etc.
 */
export declare type BackgroundNewsArticleOrSubClass = BackgroundNewsArticle;
/**
 * schema:BackgroundNewsArticle - Validation schema (w/ JOI)
 */
export declare const BackgroundNewsArticleJoiSchema: Joi.ObjectSchema;
/**
 * schema:BackgroundNewsArticle - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BackgroundNewsArticleOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBackgroundNewsArticle(maybeBackgroundNewsArticle: unknown): BackgroundNewsArticle | OaValidationError;
