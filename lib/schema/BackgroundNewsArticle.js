...
exports.validateBackgroundNewsArticle = exports.BackgroundNewsArticleOrSubClassJoiSchema = exports.BackgroundNewsArticleJoiSchema = void 0;
 ...
 */
exports.BackgroundNewsArticleJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.BackgroundNewsArticleOrSubClassJoiSchema = Joi.alternatives().try([
    exports.BackgroundNewsArticleJoiSchema,
]);
/**
 ...
 * ```
 */
function validateBackgroundNewsArticle(maybeBackgroundNewsArticle) {
    const { value, error } = exports.BackgroundNewsArticleJoiSchema.validate(maybeBackgroundNewsArticle);
    if (error) {
        return new oaValidationError_1.OaValidationError('BackgroundNewsArticle', maybeBackgroundNewsArticle, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateBackgroundNewsArticle = validateBackgroundNewsArticle;
