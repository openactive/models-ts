 ...
 * etc.
 */
export declare type BakeryOrSubClass = Bakery;
/**
 * schema:Bakery - Validation schema (w/ JOI)
 */
export declare const BakeryJoiSchema: Joi.ObjectSchema;
/**
 * schema:Bakery - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BakeryOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBakery(maybeBakery: unknown): Bakery | OaValidationError;
