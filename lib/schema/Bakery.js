...
exports.validateBakery = exports.BakeryOrSubClassJoiSchema = exports.BakeryJoiSchema = void 0;
 ...
 */
exports.BakeryJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.BakeryOrSubClassJoiSchema = Joi.alternatives().try([
    exports.BakeryJoiSchema,
]);
/**
 ...
 * ```
 */
function validateBakery(maybeBakery) {
    const { value, error } = exports.BakeryJoiSchema.validate(maybeBakery);
    if (error) {
        return new oaValidationError_1.OaValidationError('Bakery', maybeBakery, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateBakery = validateBakery;
