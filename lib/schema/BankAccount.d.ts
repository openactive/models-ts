 ...
 * etc.
 */
export declare type BankAccountOrSubClass = BankAccount | schema.DepositAccountOrSubClass;
/**
 * schema:BankAccount - Validation schema (w/ JOI)
 */
export declare const BankAccountJoiSchema: Joi.ObjectSchema;
/**
 * schema:BankAccount - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BankAccountOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBankAccount(maybeBankAccount: unknown): BankAccount | OaValidationError;
