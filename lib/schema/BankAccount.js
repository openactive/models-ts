...
exports.BankAccountJoiSchema = Joi.object({
    ...
    bankAccountType: Joi.alternatives().try(Joi.string(), Joi.string().uri()),
 ...
 *
 * ```ts
 * const maybeBankAccount = validateBankAccount(req.body); // `req.body` will have type `any` or `unknown`
