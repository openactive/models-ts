 ...
 * etc.
 */
export declare type BankOrCreditUnionOrSubClass = BankOrCreditUnion;
/**
 * schema:BankOrCreditUnion - Validation schema (w/ JOI)
 */
export declare const BankOrCreditUnionJoiSchema: Joi.ObjectSchema;
/**
 * schema:BankOrCreditUnion - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BankOrCreditUnionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBankOrCreditUnion(maybeBankOrCreditUnion: unknown): BankOrCreditUnion | OaValidationError;
