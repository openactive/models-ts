...
exports.validateBankOrCreditUnion = exports.BankOrCreditUnionOrSubClassJoiSchema = exports.BankOrCreditUnionJoiSchema = void 0;
 ...
 */
exports.BankOrCreditUnionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.BankOrCreditUnionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.BankOrCreditUnionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateBankOrCreditUnion(maybeBankOrCreditUnion) {
    const { value, error } = exports.BankOrCreditUnionJoiSchema.validate(maybeBankOrCreditUnion);
    if (error) {
        return new oaValidationError_1.OaValidationError('BankOrCreditUnion', maybeBankOrCreditUnion, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateBankOrCreditUnion = validateBankOrCreditUnion;
