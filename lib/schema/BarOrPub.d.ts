 ...
 * etc.
 */
export declare type BarOrPubOrSubClass = BarOrPub;
/**
 * schema:BarOrPub - Validation schema (w/ JOI)
 */
export declare const BarOrPubJoiSchema: Joi.ObjectSchema;
/**
 * schema:BarOrPub - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BarOrPubOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBarOrPub(maybeBarOrPub: unknown): BarOrPub | OaValidationError;
