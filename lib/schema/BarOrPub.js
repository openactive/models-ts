...
exports.validateBarOrPub = exports.BarOrPubOrSubClassJoiSchema = exports.BarOrPubJoiSchema = void 0;
 ...
 */
exports.BarOrPubJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.BarOrPubOrSubClassJoiSchema = Joi.alternatives().try([
    exports.BarOrPubJoiSchema,
]);
/**
 ...
 * ```
 */
function validateBarOrPub(maybeBarOrPub) {
    const { value, error } = exports.BarOrPubJoiSchema.validate(maybeBarOrPub);
    if (error) {
        return new oaValidationError_1.OaValidationError('BarOrPub', maybeBarOrPub, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateBarOrPub = validateBarOrPub;
