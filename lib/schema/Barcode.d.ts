 ...
 * etc.
 */
export declare type BarcodeOrSubClass = Barcode;
/**
 * schema:Barcode - Validation schema (w/ JOI)
 */
export declare const BarcodeJoiSchema: Joi.ObjectSchema;
/**
 * schema:Barcode - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BarcodeOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBarcode(maybeBarcode: unknown): Barcode | OaValidationError;
