...
exports.validateBarcode = exports.BarcodeOrSubClassJoiSchema = exports.BarcodeJoiSchema = void 0;
 ...
 */
exports.BarcodeJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.BarcodeOrSubClassJoiSchema = Joi.alternatives().try([
    exports.BarcodeJoiSchema,
]);
/**
 ...
 * ```
 */
function validateBarcode(maybeBarcode) {
    const { value, error } = exports.BarcodeJoiSchema.validate(maybeBarcode);
    if (error) {
        return new oaValidationError_1.OaValidationError('Barcode', maybeBarcode, error);
    }
