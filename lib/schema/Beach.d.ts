 ...
 * etc.
 */
export declare type BeachOrSubClass = Beach;
/**
 * schema:Beach - Validation schema (w/ JOI)
 */
export declare const BeachJoiSchema: Joi.ObjectSchema;
/**
 * schema:Beach - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BeachOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBeach(maybeBeach: unknown): Beach | OaValidationError;
