...
exports.validateBeach = exports.BeachOrSubClassJoiSchema = exports.BeachJoiSchema = void 0;
 ...
 */
exports.BeachJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.BeachOrSubClassJoiSchema = Joi.alternatives().try([
    exports.BeachJoiSchema,
]);
/**
 ...
 * ```
 */
function validateBeach(maybeBeach) {
    const { value, error } = exports.BeachJoiSchema.validate(maybeBeach);
    if (error) {
        return new oaValidationError_1.OaValidationError('Beach', maybeBeach, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateBeach = validateBeach;
