 ...
 * etc.
 */
export declare type BeautySalonOrSubClass = BeautySalon;
/**
 * schema:BeautySalon - Validation schema (w/ JOI)
 */
export declare const BeautySalonJoiSchema: Joi.ObjectSchema;
/**
 * schema:BeautySalon - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BeautySalonOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBeautySalon(maybeBeautySalon: unknown): BeautySalon | OaValidationError;
