...
exports.validateBeautySalon = exports.BeautySalonOrSubClassJoiSchema = exports.BeautySalonJoiSchema = void 0;
 ...
 */
exports.BeautySalonJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.BeautySalonOrSubClassJoiSchema = Joi.alternatives().try([
    exports.BeautySalonJoiSchema,
]);
/**
 ...
 * ```
 */
function validateBeautySalon(maybeBeautySalon) {
    const { value, error } = exports.BeautySalonJoiSchema.validate(maybeBeautySalon);
    if (error) {
        return new oaValidationError_1.OaValidationError('BeautySalon', maybeBeautySalon, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateBeautySalon = validateBeautySalon;
