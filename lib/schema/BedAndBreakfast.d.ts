 ...
 * etc.
 */
export declare type BedAndBreakfastOrSubClass = BedAndBreakfast;
/**
 * schema:BedAndBreakfast - Validation schema (w/ JOI)
 */
export declare const BedAndBreakfastJoiSchema: Joi.ObjectSchema;
/**
 * schema:BedAndBreakfast - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BedAndBreakfastOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBedAndBreakfast(maybeBedAndBreakfast: unknown): BedAndBreakfast | OaValidationError;
