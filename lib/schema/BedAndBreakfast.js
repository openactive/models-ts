...
exports.validateBedAndBreakfast = exports.BedAndBreakfastOrSubClassJoiSchema = exports.BedAndBreakfastJoiSchema = void 0;
 ...
 */
exports.BedAndBreakfastJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.BedAndBreakfastOrSubClassJoiSchema = Joi.alternatives().try([
    exports.BedAndBreakfastJoiSchema,
]);
/**
 ...
 * ```
 */
function validateBedAndBreakfast(maybeBedAndBreakfast) {
    const { value, error } = exports.BedAndBreakfastJoiSchema.validate(maybeBedAndBreakfast);
    if (error) {
        return new oaValidationError_1.OaValidationError('BedAndBreakfast', maybeBedAndBreakfast, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateBedAndBreakfast = validateBedAndBreakfast;
