 ...
 * etc.
 */
export declare type BefriendActionOrSubClass = BefriendAction;
/**
 * schema:BefriendAction - Validation schema (w/ JOI)
 */
export declare const BefriendActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:BefriendAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BefriendActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBefriendAction(maybeBefriendAction: unknown): BefriendAction | OaValidationError;
