 ...
 * etc.
 */
export declare type BikeStoreOrSubClass = BikeStore;
/**
 * schema:BikeStore - Validation schema (w/ JOI)
 */
export declare const BikeStoreJoiSchema: Joi.ObjectSchema;
/**
 * schema:BikeStore - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BikeStoreOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBikeStore(maybeBikeStore: unknown): BikeStore | OaValidationError;
