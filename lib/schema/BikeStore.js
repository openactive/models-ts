...
exports.validateBikeStore = exports.BikeStoreOrSubClassJoiSchema = exports.BikeStoreJoiSchema = void 0;
 ...
 */
exports.BikeStoreJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.BikeStoreOrSubClassJoiSchema = Joi.alternatives().try([
    exports.BikeStoreJoiSchema,
]);
/**
 ...
 * ```
 */
function validateBikeStore(maybeBikeStore) {
    const { value, error } = exports.BikeStoreJoiSchema.validate(maybeBikeStore);
    if (error) {
        return new oaValidationError_1.OaValidationError('BikeStore', maybeBikeStore, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateBikeStore = validateBikeStore;
