 ...
 */
export declare type BioChemEntity = {
    '@type': 'BioChemEntity';
 ...
 * etc.
 */
export declare type BioChemEntityOrSubClass = BioChemEntity | schema.MolecularEntityOrSubClass | schema.ProteinOrSubClass | schema.ChemicalSubstanceOrSubClass | schema.GeneOrSubClass;
/**
 * schema:BioChemEntity - Validation schema (w/ JOI)
 */
export declare const BioChemEntityJoiSchema: Joi.ObjectSchema;
/**
 * schema:BioChemEntity - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BioChemEntityOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBioChemEntity(maybeBioChemEntity: unknown): BioChemEntity | OaValidationError;
