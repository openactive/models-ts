 ...
 * etc.
 */
export declare type BlogOrSubClass = Blog;
/**
 * schema:Blog - Validation schema (w/ JOI)
 */
export declare const BlogJoiSchema: Joi.ObjectSchema;
/**
 * schema:Blog - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BlogOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBlog(maybeBlog: unknown): Blog | OaValidationError;
