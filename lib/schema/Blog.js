...
exports.validateBlog = exports.BlogOrSubClassJoiSchema = exports.BlogJoiSchema = void 0;
 ...
 */
exports.BlogJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.BlogOrSubClassJoiSchema = Joi.alternatives().try([
    exports.BlogJoiSchema,
]);
/**
 ...
 * ```
 */
function validateBlog(maybeBlog) {
    const { value, error } = exports.BlogJoiSchema.validate(maybeBlog);
    if (error) {
        return new oaValidationError_1.OaValidationError('Blog', maybeBlog, error);
    }
