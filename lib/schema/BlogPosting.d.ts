 ...
 * etc.
 */
export declare type BlogPostingOrSubClass = BlogPosting | schema.LiveBlogPostingOrSubClass;
/**
 * schema:BlogPosting - Validation schema (w/ JOI)
 */
export declare const BlogPostingJoiSchema: Joi.ObjectSchema;
/**
 * schema:BlogPosting - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BlogPostingOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBlogPosting(maybeBlogPosting: unknown): BlogPosting | OaValidationError;
