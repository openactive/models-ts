...
exports.validateBlogPosting = exports.BlogPostingOrSubClassJoiSchema = exports.BlogPostingJoiSchema = void 0;
 ...
 */
exports.BlogPostingJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.BlogPostingOrSubClassJoiSchema = Joi.alternatives().try([
    exports.BlogPostingJoiSchema,
 ...
 * ```
 */
function validateBlogPosting(maybeBlogPosting) {
    const { value, error } = exports.BlogPostingJoiSchema.validate(maybeBlogPosting);
    if (error) {
        return new oaValidationError_1.OaValidationError('BlogPosting', maybeBlogPosting, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateBlogPosting = validateBlogPosting;
