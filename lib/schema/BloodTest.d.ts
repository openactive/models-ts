 ...
 * etc.
 */
export declare type BloodTestOrSubClass = BloodTest;
/**
 * schema:BloodTest - Validation schema (w/ JOI)
 */
export declare const BloodTestJoiSchema: Joi.ObjectSchema;
/**
 * schema:BloodTest - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BloodTestOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBloodTest(maybeBloodTest: unknown): BloodTest | OaValidationError;
