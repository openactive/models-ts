...
exports.validateBoardingPolicyType = exports.BoardingPolicyTypeJoiSchema = void 0;
 ...
 */
exports.BoardingPolicyTypeJoiSchema = Joi.string().valid('https://schema.org/GroupBoardingPolicy', 'https://schema.org/ZoneBoardingPolicy');
/**
 ...
 * ```
 */
function validateBoardingPolicyType(maybeBoardingPolicyType) {
    const { value, error } = exports.BoardingPolicyTypeJoiSchema.validate(maybeBoardingPolicyType);
    if (error) {
        return new oaValidationError_1.OaValidationError('BoardingPolicyType', maybeBoardingPolicyType, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateBoardingPolicyType = validateBoardingPolicyType;
