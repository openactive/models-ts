 ...
 */
export declare type BoatReservation = {
 ...
 * etc.
 */
export declare type BoatReservationOrSubClass = BoatReservation;
/**
 * schema:BoatReservation - Validation schema (w/ JOI)
 */
export declare const BoatReservationJoiSchema: Joi.ObjectSchema;
/**
 * schema:BoatReservation - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BoatReservationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBoatReservation(maybeBoatReservation: unknown): BoatReservation | OaValidationError;
