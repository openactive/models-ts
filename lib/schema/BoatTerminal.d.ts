 ...
 * schema:BoatTerminal
 */
export declare type BoatTerminal = {
    '@type': 'BoatTerminal';
 ...
 * etc.
 */
export declare type BoatTerminalOrSubClass = BoatTerminal;
/**
 * schema:BoatTerminal - Validation schema (w/ JOI)
 */
export declare const BoatTerminalJoiSchema: Joi.ObjectSchema;
/**
 * schema:BoatTerminal - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BoatTerminalOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBoatTerminal(maybeBoatTerminal: unknown): BoatTerminal | OaValidationError;
