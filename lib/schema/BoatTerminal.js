...
exports.validateBoatTerminal = exports.BoatTerminalOrSubClassJoiSchema = exports.BoatTerminalJoiSchema = void 0;
 ...
 */
exports.BoatTerminalJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.BoatTerminalOrSubClassJoiSchema = Joi.alternatives().try([
    exports.BoatTerminalJoiSchema,
]);
/**
 ...
 * ```
 */
function validateBoatTerminal(maybeBoatTerminal) {
    const { value, error } = exports.BoatTerminalJoiSchema.validate(maybeBoatTerminal);
    if (error) {
        return new oaValidationError_1.OaValidationError('BoatTerminal', maybeBoatTerminal, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateBoatTerminal = validateBoatTerminal;
