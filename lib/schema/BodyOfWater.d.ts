 ...
 * etc.
 */
export declare type BodyOfWaterOrSubClass = BodyOfWater | schema.OceanBodyOfWaterOrSubClass | schema.PondOrSubClass | schema.RiverBodyOfWaterOrSubClass | schema.ReservoirOrSubClass | schema.SeaBodyOfWaterOrSubClass | schema.CanalOrSubClass | schema.LakeBodyOfWaterOrSubClass | schema.WaterfallOrSubClass;
/**
 * schema:BodyOfWater - Validation schema (w/ JOI)
 */
export declare const BodyOfWaterJoiSchema: Joi.ObjectSchema;
/**
 * schema:BodyOfWater - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BodyOfWaterOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBodyOfWater(maybeBodyOfWater: unknown): BodyOfWater | OaValidationError;
