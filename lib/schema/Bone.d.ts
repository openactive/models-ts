 ...
 * etc.
 */
export declare type BoneOrSubClass = Bone;
/**
 * schema:Bone - Validation schema (w/ JOI)
 */
export declare const BoneJoiSchema: Joi.ObjectSchema;
/**
 * schema:Bone - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BoneOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBone(maybeBone: unknown): Bone | OaValidationError;
