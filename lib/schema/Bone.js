...
exports.validateBone = exports.BoneOrSubClassJoiSchema = exports.BoneJoiSchema = void 0;
 ...
 */
exports.BoneJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.BoneOrSubClassJoiSchema = Joi.alternatives().try([
    exports.BoneJoiSchema,
]);
/**
 ...
 * ```
 */
function validateBone(maybeBone) {
    const { value, error } = exports.BoneJoiSchema.validate(maybeBone);
    if (error) {
        return new oaValidationError_1.OaValidationError('Bone', maybeBone, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateBone = validateBone;
