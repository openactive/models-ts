 ...
 * etc.
 */
export declare type BookOrSubClass = Book | schema.AudiobookOrSubClass;
/**
 * schema:Book - Validation schema (w/ JOI)
 */
export declare const BookJoiSchema: Joi.ObjectSchema;
/**
 * schema:Book - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BookOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBook(maybeBook: unknown): Book | OaValidationError;
