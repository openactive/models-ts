...
exports.validateBook = exports.BookOrSubClassJoiSchema = exports.BookJoiSchema = void 0;
 ...
 * `SessionSeries`, etc.
 */
exports.BookOrSubClassJoiSchema = Joi.alternatives().try([
    exports.BookJoiSchema,
 ...
 * ```
 */
function validateBook(maybeBook) {
    const { value, error } = exports.BookJoiSchema.validate(maybeBook);
    if (error) {
        return new oaValidationError_1.OaValidationError('Book', maybeBook, error);
    }
