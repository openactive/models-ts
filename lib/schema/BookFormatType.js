 ...
 */
exports.BookFormatTypeJoiSchema = Joi.string().valid('https://schema.org/GraphicNovel', 'https://schema.org/AudiobookFormat', 'https://schema.org/Hardcover', 'https://schema.org/EBook', 'https://schema.org/Paperback');
/**
