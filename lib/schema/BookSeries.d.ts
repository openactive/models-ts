 ...
 * etc.
 */
export declare type BookSeriesOrSubClass = BookSeries;
/**
 * schema:BookSeries - Validation schema (w/ JOI)
 */
export declare const BookSeriesJoiSchema: Joi.ObjectSchema;
/**
 * schema:BookSeries - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BookSeriesOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBookSeries(maybeBookSeries: unknown): BookSeries | OaValidationError;
