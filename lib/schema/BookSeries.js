...
exports.validateBookSeries = exports.BookSeriesOrSubClassJoiSchema = exports.BookSeriesJoiSchema = void 0;
 ...
 */
exports.BookSeriesJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.BookSeriesOrSubClassJoiSchema = Joi.alternatives().try([
    exports.BookSeriesJoiSchema,
]);
/**
 ...
 * ```
 */
function validateBookSeries(maybeBookSeries) {
    const { value, error } = exports.BookSeriesJoiSchema.validate(maybeBookSeries);
    if (error) {
        return new oaValidationError_1.OaValidationError('BookSeries', maybeBookSeries, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateBookSeries = validateBookSeries;
