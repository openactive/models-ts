 ...
 * etc.
 */
export declare type BookStoreOrSubClass = BookStore;
/**
 * schema:BookStore - Validation schema (w/ JOI)
 */
export declare const BookStoreJoiSchema: Joi.ObjectSchema;
/**
 * schema:BookStore - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BookStoreOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBookStore(maybeBookStore: unknown): BookStore | OaValidationError;
