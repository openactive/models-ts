...
exports.validateBookStore = exports.BookStoreOrSubClassJoiSchema = exports.BookStoreJoiSchema = void 0;
 ...
 */
exports.BookStoreJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.BookStoreOrSubClassJoiSchema = Joi.alternatives().try([
    exports.BookStoreJoiSchema,
]);
/**
 ...
 * ```
 */
function validateBookStore(maybeBookStore) {
    const { value, error } = exports.BookStoreJoiSchema.validate(maybeBookStore);
    if (error) {
        return new oaValidationError_1.OaValidationError('BookStore', maybeBookStore, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateBookStore = validateBookStore;
