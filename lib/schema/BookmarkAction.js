...
exports.validateBookmarkAction = exports.BookmarkActionOrSubClassJoiSchema = exports.BookmarkActionJoiSchema = void 0;
 ...
 */
exports.BookmarkActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.BookmarkActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.BookmarkActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateBookmarkAction(maybeBookmarkAction) {
    const { value, error } = exports.BookmarkActionJoiSchema.validate(maybeBookmarkAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('BookmarkAction', maybeBookmarkAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateBookmarkAction = validateBookmarkAction;
