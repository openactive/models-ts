 ...
 * etc.
 */
export declare type BorrowActionOrSubClass = BorrowAction;
/**
 * schema:BorrowAction - Validation schema (w/ JOI)
 */
export declare const BorrowActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:BorrowAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BorrowActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBorrowAction(maybeBorrowAction: unknown): BorrowAction | OaValidationError;
