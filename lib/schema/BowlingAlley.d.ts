 ...
 * etc.
 */
export declare type BowlingAlleyOrSubClass = BowlingAlley;
/**
 * schema:BowlingAlley - Validation schema (w/ JOI)
 */
export declare const BowlingAlleyJoiSchema: Joi.ObjectSchema;
/**
 * schema:BowlingAlley - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BowlingAlleyOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBowlingAlley(maybeBowlingAlley: unknown): BowlingAlley | OaValidationError;
