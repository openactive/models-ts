...
exports.validateBowlingAlley = exports.BowlingAlleyOrSubClassJoiSchema = exports.BowlingAlleyJoiSchema = void 0;
 ...
 */
exports.BowlingAlleyJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.BowlingAlleyOrSubClassJoiSchema = Joi.alternatives().try([
    exports.BowlingAlleyJoiSchema,
]);
/**
 ...
 * ```
 */
function validateBowlingAlley(maybeBowlingAlley) {
    const { value, error } = exports.BowlingAlleyJoiSchema.validate(maybeBowlingAlley);
    if (error) {
        return new oaValidationError_1.OaValidationError('BowlingAlley', maybeBowlingAlley, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateBowlingAlley = validateBowlingAlley;
