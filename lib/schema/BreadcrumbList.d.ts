 ...
 * etc.
 */
export declare type BreadcrumbListOrSubClass = BreadcrumbList;
/**
 * schema:BreadcrumbList - Validation schema (w/ JOI)
 */
export declare const BreadcrumbListJoiSchema: Joi.ObjectSchema;
/**
 * schema:BreadcrumbList - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BreadcrumbListOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 *
 * ```ts
 * const maybeBreadcrumbList = BreadcrumbList.validate(req.body); // `req.body` will have type `any` or `unknown`
 ...
 * ```
 */
export declare function validateBreadcrumbList(maybeBreadcrumbList: unknown): BreadcrumbList | OaValidationError;
