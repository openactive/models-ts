 ...
 * etc.
 */
export declare type BreweryOrSubClass = Brewery;
/**
 * schema:Brewery - Validation schema (w/ JOI)
 */
export declare const BreweryJoiSchema: Joi.ObjectSchema;
/**
 * schema:Brewery - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BreweryOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBrewery(maybeBrewery: unknown): Brewery | OaValidationError;
