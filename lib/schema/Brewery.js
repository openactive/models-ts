...
exports.validateBrewery = exports.BreweryOrSubClassJoiSchema = exports.BreweryJoiSchema = void 0;
 ...
 */
exports.BreweryJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.BreweryOrSubClassJoiSchema = Joi.alternatives().try([
    exports.BreweryJoiSchema,
]);
/**
 ...
 * ```
 */
function validateBrewery(maybeBrewery) {
    const { value, error } = exports.BreweryJoiSchema.validate(maybeBrewery);
    if (error) {
        return new oaValidationError_1.OaValidationError('Brewery', maybeBrewery, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateBrewery = validateBrewery;
