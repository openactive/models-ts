 ...
 * etc.
 */
export declare type BridgeOrSubClass = Bridge;
/**
 * schema:Bridge - Validation schema (w/ JOI)
 */
export declare const BridgeJoiSchema: Joi.ObjectSchema;
/**
 * schema:Bridge - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BridgeOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBridge(maybeBridge: unknown): Bridge | OaValidationError;
