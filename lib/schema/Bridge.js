...
exports.validateBridge = exports.BridgeOrSubClassJoiSchema = exports.BridgeJoiSchema = void 0;
 ...
 */
exports.BridgeJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.BridgeOrSubClassJoiSchema = Joi.alternatives().try([
    exports.BridgeJoiSchema,
]);
/**
 ...
 * ```
 */
function validateBridge(maybeBridge) {
    const { value, error } = exports.BridgeJoiSchema.validate(maybeBridge);
    if (error) {
        return new oaValidationError_1.OaValidationError('Bridge', maybeBridge, error);
    }
