 ...
 * schema:BroadcastChannel
 *
 * This differs from BroadcastChannel because it also allows for objects that have the type of a model that
 * sub-classes this model. e.g. `Event_OrSubClass` allows `Event`s as well as `ScheduledSession`s, `SessionSeries`,
 * etc.
 */
export declare type BroadcastChannelOrSubClass = BroadcastChannel | schema.TelevisionChannelOrSubClass | schema.RadioChannelOrSubClass;
/**
 * schema:BroadcastChannel - Validation schema (w/ JOI)
 */
export declare const BroadcastChannelJoiSchema: Joi.ObjectSchema;
/**
 * schema:BroadcastChannel - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BroadcastChannelOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 *
 * ```ts
 * const maybeBroadcastChannel = BroadcastChannel.validate(req.body); // `req.body` will have type `any` or `unknown`
 ...
 * ```
 */
export declare function validateBroadcastChannel(maybeBroadcastChannel: unknown): BroadcastChannel | OaValidationError;
