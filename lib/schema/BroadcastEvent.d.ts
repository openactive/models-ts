 ...
 * etc.
 */
export declare type BroadcastEventOrSubClass = BroadcastEvent;
/**
 * schema:BroadcastEvent - Validation schema (w/ JOI)
 */
export declare const BroadcastEventJoiSchema: Joi.ObjectSchema;
/**
 * schema:BroadcastEvent - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BroadcastEventOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBroadcastEvent(maybeBroadcastEvent: unknown): BroadcastEvent | OaValidationError;
