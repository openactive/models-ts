 ...
 * etc.
 */
export declare type BroadcastServiceOrSubClass = BroadcastService | schema.RadioBroadcastServiceOrSubClass;
/**
 * schema:BroadcastService - Validation schema (w/ JOI)
 */
export declare const BroadcastServiceJoiSchema: Joi.ObjectSchema;
/**
 * schema:BroadcastService - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BroadcastServiceOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBroadcastService(maybeBroadcastService: unknown): BroadcastService | OaValidationError;
