 ...
 * etc.
 */
export declare type BrokerageAccountOrSubClass = BrokerageAccount;
/**
 * schema:BrokerageAccount - Validation schema (w/ JOI)
 */
export declare const BrokerageAccountJoiSchema: Joi.ObjectSchema;
/**
 * schema:BrokerageAccount - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BrokerageAccountOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBrokerageAccount(maybeBrokerageAccount: unknown): BrokerageAccount | OaValidationError;
