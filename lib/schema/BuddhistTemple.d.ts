 ...
 * etc.
 */
export declare type BuddhistTempleOrSubClass = BuddhistTemple;
/**
 * schema:BuddhistTemple - Validation schema (w/ JOI)
 */
export declare const BuddhistTempleJoiSchema: Joi.ObjectSchema;
/**
 * schema:BuddhistTemple - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BuddhistTempleOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBuddhistTemple(maybeBuddhistTemple: unknown): BuddhistTemple | OaValidationError;
