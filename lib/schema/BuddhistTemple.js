...
exports.validateBuddhistTemple = exports.BuddhistTempleOrSubClassJoiSchema = exports.BuddhistTempleJoiSchema = void 0;
 ...
 */
exports.BuddhistTempleJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.BuddhistTempleOrSubClassJoiSchema = Joi.alternatives().try([
    exports.BuddhistTempleJoiSchema,
]);
/**
 ...
 * ```
 */
function validateBuddhistTemple(maybeBuddhistTemple) {
    const { value, error } = exports.BuddhistTempleJoiSchema.validate(maybeBuddhistTemple);
    if (error) {
        return new oaValidationError_1.OaValidationError('BuddhistTemple', maybeBuddhistTemple, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateBuddhistTemple = validateBuddhistTemple;
