 ...
 * etc.
 */
export declare type BusOrCoachOrSubClass = BusOrCoach;
/**
 * schema:BusOrCoach - Validation schema (w/ JOI)
 */
export declare const BusOrCoachJoiSchema: Joi.ObjectSchema;
/**
 * schema:BusOrCoach - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BusOrCoachOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBusOrCoach(maybeBusOrCoach: unknown): BusOrCoach | OaValidationError;
