...
exports.validateBusOrCoach = exports.BusOrCoachOrSubClassJoiSchema = exports.BusOrCoachJoiSchema = void 0;
 ...
 */
exports.BusOrCoachJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.BusOrCoachOrSubClassJoiSchema = Joi.alternatives().try([
    exports.BusOrCoachJoiSchema,
]);
/**
 ...
 * ```
 */
function validateBusOrCoach(maybeBusOrCoach) {
    const { value, error } = exports.BusOrCoachJoiSchema.validate(maybeBusOrCoach);
    if (error) {
        return new oaValidationError_1.OaValidationError('BusOrCoach', maybeBusOrCoach, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateBusOrCoach = validateBusOrCoach;
