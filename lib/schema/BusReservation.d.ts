 ...
 * etc.
 */
export declare type BusReservationOrSubClass = BusReservation;
/**
 * schema:BusReservation - Validation schema (w/ JOI)
 */
export declare const BusReservationJoiSchema: Joi.ObjectSchema;
/**
 * schema:BusReservation - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BusReservationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBusReservation(maybeBusReservation: unknown): BusReservation | OaValidationError;
