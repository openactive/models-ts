 ...
 * etc.
 */
export declare type BusStationOrSubClass = BusStation;
/**
 * schema:BusStation - Validation schema (w/ JOI)
 */
export declare const BusStationJoiSchema: Joi.ObjectSchema;
/**
 * schema:BusStation - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BusStationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBusStation(maybeBusStation: unknown): BusStation | OaValidationError;
