 ...
 * etc.
 */
export declare type BusStopOrSubClass = BusStop;
/**
 * schema:BusStop - Validation schema (w/ JOI)
 */
export declare const BusStopJoiSchema: Joi.ObjectSchema;
/**
 * schema:BusStop - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BusStopOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBusStop(maybeBusStop: unknown): BusStop | OaValidationError;
