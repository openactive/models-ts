...
exports.validateBusStop = exports.BusStopOrSubClassJoiSchema = exports.BusStopJoiSchema = void 0;
 ...
 */
exports.BusStopJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.BusStopOrSubClassJoiSchema = Joi.alternatives().try([
    exports.BusStopJoiSchema,
]);
/**
 ...
 * ```
 */
function validateBusStop(maybeBusStop) {
    const { value, error } = exports.BusStopJoiSchema.validate(maybeBusStop);
    if (error) {
        return new oaValidationError_1.OaValidationError('BusStop', maybeBusStop, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateBusStop = validateBusStop;
