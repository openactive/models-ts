...
export declare type BusTrip = {
     ...
     */
    departureBusStop?: schema.BusStationOrSubClass | schema.BusStopOrSubClass | string;
    /**
 ...
 * etc.
 */
export declare type BusTripOrSubClass = BusTrip;
/**
 * schema:BusTrip - Validation schema (w/ JOI)
 */
export declare const BusTripJoiSchema: Joi.ObjectSchema;
/**
 * schema:BusTrip - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BusTripOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBusTrip(maybeBusTrip: unknown): BusTrip | OaValidationError;
