 ...
 * etc.
 */
export declare type BusinessEventOrSubClass = BusinessEvent;
/**
 * schema:BusinessEvent - Validation schema (w/ JOI)
 */
export declare const BusinessEventJoiSchema: Joi.ObjectSchema;
/**
 * schema:BusinessEvent - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const BusinessEventOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateBusinessEvent(maybeBusinessEvent: unknown): BusinessEvent | OaValidationError;
