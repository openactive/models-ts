...
exports.validateBusinessFunction = exports.BusinessFunctionJoiSchema = void 0;
 ...
 *
 */
exports.BusinessFunctionJoiSchema = Joi.string().valid();
/**
 ...
 * ```
 */
function validateBusinessFunction(maybeBusinessFunction) {
    const { value, error } = exports.BusinessFunctionJoiSchema.validate(maybeBusinessFunction);
    if (error) {
        return new oaValidationError_1.OaValidationError('BusinessFunction', maybeBusinessFunction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateBusinessFunction = validateBusinessFunction;
