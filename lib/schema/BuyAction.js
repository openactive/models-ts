...
exports.validateBuyAction = exports.BuyActionOrSubClassJoiSchema = exports.BuyActionJoiSchema = void 0;
 ...
 */
exports.BuyActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.BuyActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.BuyActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateBuyAction(maybeBuyAction) {
    const { value, error } = exports.BuyActionJoiSchema.validate(maybeBuyAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('BuyAction', maybeBuyAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateBuyAction = validateBuyAction;
