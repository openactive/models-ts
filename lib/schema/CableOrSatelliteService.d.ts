 ...
 * etc.
 */
export declare type CableOrSatelliteServiceOrSubClass = CableOrSatelliteService;
/**
 * schema:CableOrSatelliteService - Validation schema (w/ JOI)
 */
export declare const CableOrSatelliteServiceJoiSchema: Joi.ObjectSchema;
/**
 * schema:CableOrSatelliteService - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CableOrSatelliteServiceOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCableOrSatelliteService(maybeCableOrSatelliteService: unknown): CableOrSatelliteService | OaValidationError;
