 ...
 * etc.
 */
export declare type CafeOrCoffeeShopOrSubClass = CafeOrCoffeeShop;
/**
 * schema:CafeOrCoffeeShop - Validation schema (w/ JOI)
 */
export declare const CafeOrCoffeeShopJoiSchema: Joi.ObjectSchema;
/**
 * schema:CafeOrCoffeeShop - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CafeOrCoffeeShopOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCafeOrCoffeeShop(maybeCafeOrCoffeeShop: unknown): CafeOrCoffeeShop | OaValidationError;
