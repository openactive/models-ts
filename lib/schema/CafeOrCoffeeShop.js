...
exports.validateCafeOrCoffeeShop = exports.CafeOrCoffeeShopOrSubClassJoiSchema = exports.CafeOrCoffeeShopJoiSchema = void 0;
 ...
 */
exports.CafeOrCoffeeShopJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.CafeOrCoffeeShopOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CafeOrCoffeeShopJoiSchema,
]);
/**
 ...
 * ```
 */
function validateCafeOrCoffeeShop(maybeCafeOrCoffeeShop) {
    const { value, error } = exports.CafeOrCoffeeShopJoiSchema.validate(maybeCafeOrCoffeeShop);
    if (error) {
        return new oaValidationError_1.OaValidationError('CafeOrCoffeeShop', maybeCafeOrCoffeeShop, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateCafeOrCoffeeShop = validateCafeOrCoffeeShop;
