 ...
 * etc.
 */
export declare type CampgroundOrSubClass = Campground;
/**
 * schema:Campground - Validation schema (w/ JOI)
 */
export declare const CampgroundJoiSchema: Joi.ObjectSchema;
/**
 * schema:Campground - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CampgroundOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCampground(maybeCampground: unknown): Campground | OaValidationError;
