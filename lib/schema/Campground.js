...
exports.validateCampground = exports.CampgroundOrSubClassJoiSchema = exports.CampgroundJoiSchema = void 0;
 ...
 */
exports.CampgroundJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.CampgroundOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CampgroundJoiSchema,
]);
/**
 ...
 * ```
 */
function validateCampground(maybeCampground) {
    const { value, error } = exports.CampgroundJoiSchema.validate(maybeCampground);
    if (error) {
        return new oaValidationError_1.OaValidationError('Campground', maybeCampground, error);
    }
