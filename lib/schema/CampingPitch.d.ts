 ...
 * etc.
 */
export declare type CampingPitchOrSubClass = CampingPitch;
/**
 * schema:CampingPitch - Validation schema (w/ JOI)
 */
export declare const CampingPitchJoiSchema: Joi.ObjectSchema;
/**
 * schema:CampingPitch - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CampingPitchOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCampingPitch(maybeCampingPitch: unknown): CampingPitch | OaValidationError;
