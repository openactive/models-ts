...
exports.validateCampingPitch = exports.CampingPitchOrSubClassJoiSchema = exports.CampingPitchJoiSchema = void 0;
 ...
 */
exports.CampingPitchJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.CampingPitchOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CampingPitchJoiSchema,
]);
/**
 ...
 * ```
 */
function validateCampingPitch(maybeCampingPitch) {
    const { value, error } = exports.CampingPitchJoiSchema.validate(maybeCampingPitch);
    if (error) {
        return new oaValidationError_1.OaValidationError('CampingPitch', maybeCampingPitch, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateCampingPitch = validateCampingPitch;
