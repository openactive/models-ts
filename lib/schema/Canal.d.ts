 ...
 * etc.
 */
export declare type CanalOrSubClass = Canal;
/**
 * schema:Canal - Validation schema (w/ JOI)
 */
export declare const CanalJoiSchema: Joi.ObjectSchema;
/**
 * schema:Canal - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CanalOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCanal(maybeCanal: unknown): Canal | OaValidationError;
