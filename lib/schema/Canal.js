...
exports.validateCanal = exports.CanalOrSubClassJoiSchema = exports.CanalJoiSchema = void 0;
 ...
 */
exports.CanalJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.CanalOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CanalJoiSchema,
]);
/**
 ...
 * ```
 */
function validateCanal(maybeCanal) {
    const { value, error } = exports.CanalJoiSchema.validate(maybeCanal);
    if (error) {
        return new oaValidationError_1.OaValidationError('Canal', maybeCanal, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateCanal = validateCanal;
