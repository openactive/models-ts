 ...
 * etc.
 */
export declare type CarOrSubClass = Car;
/**
 * schema:Car - Validation schema (w/ JOI)
 */
export declare const CarJoiSchema: Joi.ObjectSchema;
/**
 * schema:Car - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CarOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCar(maybeCar: unknown): Car | OaValidationError;
