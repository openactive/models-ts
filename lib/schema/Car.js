...
exports.validateCar = exports.CarOrSubClassJoiSchema = exports.CarJoiSchema = void 0;
 ...
 */
exports.CarJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.CarOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CarJoiSchema,
]);
/**
 ...
 * ```
 */
function validateCar(maybeCar) {
    const { value, error } = exports.CarJoiSchema.validate(maybeCar);
    if (error) {
        return new oaValidationError_1.OaValidationError('Car', maybeCar, error);
    }
