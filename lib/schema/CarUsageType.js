 ...
 */
exports.CarUsageTypeJoiSchema = Joi.string().valid('https://schema.org/DrivingSchoolVehicleUsage', 'https://schema.org/TaxiVehicleUsage', 'https://schema.org/RentalVehicleUsage');
/**
