 ...
 * etc.
 */
export declare type CasinoOrSubClass = Casino;
/**
 * schema:Casino - Validation schema (w/ JOI)
 */
export declare const CasinoJoiSchema: Joi.ObjectSchema;
/**
 * schema:Casino - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CasinoOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCasino(maybeCasino: unknown): Casino | OaValidationError;
