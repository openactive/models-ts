...
exports.validateCasino = exports.CasinoOrSubClassJoiSchema = exports.CasinoJoiSchema = void 0;
 ...
 */
exports.CasinoJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.CasinoOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CasinoJoiSchema,
]);
/**
 ...
 * ```
 */
function validateCasino(maybeCasino) {
    const { value, error } = exports.CasinoJoiSchema.validate(maybeCasino);
    if (error) {
        return new oaValidationError_1.OaValidationError('Casino', maybeCasino, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateCasino = validateCasino;
