 ...
 * etc.
 */
export declare type CategoryCodeOrSubClass = CategoryCode | schema.MedicalCodeOrSubClass;
/**
 * schema:CategoryCode - Validation schema (w/ JOI)
 */
export declare const CategoryCodeJoiSchema: Joi.ObjectSchema;
/**
 * schema:CategoryCode - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CategoryCodeOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCategoryCode(maybeCategoryCode: unknown): CategoryCode | OaValidationError;
