 ...
 * etc.
 */
export declare type CategoryCodeSetOrSubClass = CategoryCodeSet;
/**
 * schema:CategoryCodeSet - Validation schema (w/ JOI)
 */
export declare const CategoryCodeSetJoiSchema: Joi.ObjectSchema;
/**
 * schema:CategoryCodeSet - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CategoryCodeSetOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCategoryCodeSet(maybeCategoryCodeSet: unknown): CategoryCodeSet | OaValidationError;
