...
exports.validateCategoryCodeSet = exports.CategoryCodeSetOrSubClassJoiSchema = exports.CategoryCodeSetJoiSchema = void 0;
 ...
 */
exports.CategoryCodeSetJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.CategoryCodeSetOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CategoryCodeSetJoiSchema,
]);
/**
 ...
 * ```
 */
function validateCategoryCodeSet(maybeCategoryCodeSet) {
    const { value, error } = exports.CategoryCodeSetJoiSchema.validate(maybeCategoryCodeSet);
    if (error) {
        return new oaValidationError_1.OaValidationError('CategoryCodeSet', maybeCategoryCodeSet, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateCategoryCodeSet = validateCategoryCodeSet;
