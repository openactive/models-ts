 ...
 * etc.
 */
export declare type CatholicChurchOrSubClass = CatholicChurch;
/**
 * schema:CatholicChurch - Validation schema (w/ JOI)
 */
export declare const CatholicChurchJoiSchema: Joi.ObjectSchema;
/**
 * schema:CatholicChurch - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CatholicChurchOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCatholicChurch(maybeCatholicChurch: unknown): CatholicChurch | OaValidationError;
