...
exports.validateCatholicChurch = exports.CatholicChurchOrSubClassJoiSchema = exports.CatholicChurchJoiSchema = void 0;
 ...
 */
exports.CatholicChurchJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.CatholicChurchOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CatholicChurchJoiSchema,
]);
/**
 ...
 * ```
 */
function validateCatholicChurch(maybeCatholicChurch) {
    const { value, error } = exports.CatholicChurchJoiSchema.validate(maybeCatholicChurch);
    if (error) {
        return new oaValidationError_1.OaValidationError('CatholicChurch', maybeCatholicChurch, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateCatholicChurch = validateCatholicChurch;
