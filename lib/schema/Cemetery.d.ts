 ...
 * etc.
 */
export declare type CemeteryOrSubClass = Cemetery;
/**
 * schema:Cemetery - Validation schema (w/ JOI)
 */
export declare const CemeteryJoiSchema: Joi.ObjectSchema;
/**
 * schema:Cemetery - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CemeteryOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCemetery(maybeCemetery: unknown): Cemetery | OaValidationError;
