...
exports.validateCemetery = exports.CemeteryOrSubClassJoiSchema = exports.CemeteryJoiSchema = void 0;
 ...
 */
exports.CemeteryJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.CemeteryOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CemeteryJoiSchema,
]);
/**
 ...
 * ```
 */
function validateCemetery(maybeCemetery) {
    const { value, error } = exports.CemeteryJoiSchema.validate(maybeCemetery);
    if (error) {
        return new oaValidationError_1.OaValidationError('Cemetery', maybeCemetery, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateCemetery = validateCemetery;
