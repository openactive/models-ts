 ...
 * etc.
 */
export declare type ChapterOrSubClass = Chapter;
/**
 * schema:Chapter - Validation schema (w/ JOI)
 */
export declare const ChapterJoiSchema: Joi.ObjectSchema;
/**
 * schema:Chapter - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ChapterOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateChapter(maybeChapter: unknown): Chapter | OaValidationError;
