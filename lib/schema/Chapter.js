...
exports.validateChapter = exports.ChapterOrSubClassJoiSchema = exports.ChapterJoiSchema = void 0;
 ...
 */
exports.ChapterJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ChapterOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ChapterJoiSchema,
]);
/**
 ...
 * ```
 */
function validateChapter(maybeChapter) {
    const { value, error } = exports.ChapterJoiSchema.validate(maybeChapter);
    if (error) {
        return new oaValidationError_1.OaValidationError('Chapter', maybeChapter, error);
    }
