 ...
 * etc.
 */
export declare type CheckOutActionOrSubClass = CheckOutAction;
/**
 * schema:CheckOutAction - Validation schema (w/ JOI)
 */
export declare const CheckOutActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:CheckOutAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CheckOutActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCheckOutAction(maybeCheckOutAction: unknown): CheckOutAction | OaValidationError;
