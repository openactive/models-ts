 ...
 * etc.
 */
export declare type CheckoutPageOrSubClass = CheckoutPage;
/**
 * schema:CheckoutPage - Validation schema (w/ JOI)
 */
export declare const CheckoutPageJoiSchema: Joi.ObjectSchema;
/**
 * schema:CheckoutPage - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CheckoutPageOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCheckoutPage(maybeCheckoutPage: unknown): CheckoutPage | OaValidationError;
