 ...
 */
export declare type ChemicalSubstance = {
 ...
 * etc.
 */
export declare type ChemicalSubstanceOrSubClass = ChemicalSubstance;
/**
 * schema:ChemicalSubstance - Validation schema (w/ JOI)
 */
export declare const ChemicalSubstanceJoiSchema: Joi.ObjectSchema;
/**
 * schema:ChemicalSubstance - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ChemicalSubstanceOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateChemicalSubstance(maybeChemicalSubstance: unknown): ChemicalSubstance | OaValidationError;
