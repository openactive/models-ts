 ...
 * etc.
 */
export declare type ChildCareOrSubClass = ChildCare;
/**
 * schema:ChildCare - Validation schema (w/ JOI)
 */
export declare const ChildCareJoiSchema: Joi.ObjectSchema;
/**
 * schema:ChildCare - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ChildCareOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateChildCare(maybeChildCare: unknown): ChildCare | OaValidationError;
