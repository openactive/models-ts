...
exports.validateChildCare = exports.ChildCareOrSubClassJoiSchema = exports.ChildCareJoiSchema = void 0;
 ...
 */
exports.ChildCareJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ChildCareOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ChildCareJoiSchema,
]);
/**
 ...
 * ```
 */
function validateChildCare(maybeChildCare) {
    const { value, error } = exports.ChildCareJoiSchema.validate(maybeChildCare);
    if (error) {
        return new oaValidationError_1.OaValidationError('ChildCare', maybeChildCare, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateChildCare = validateChildCare;
