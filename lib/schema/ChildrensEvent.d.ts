 ...
 * etc.
 */
export declare type ChildrensEventOrSubClass = ChildrensEvent;
/**
 * schema:ChildrensEvent - Validation schema (w/ JOI)
 */
export declare const ChildrensEventJoiSchema: Joi.ObjectSchema;
/**
 * schema:ChildrensEvent - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ChildrensEventOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateChildrensEvent(maybeChildrensEvent: unknown): ChildrensEvent | OaValidationError;
