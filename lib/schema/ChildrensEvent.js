...
exports.validateChildrensEvent = exports.ChildrensEventOrSubClassJoiSchema = exports.ChildrensEventJoiSchema = void 0;
 ...
 */
exports.ChildrensEventJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ChildrensEventOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ChildrensEventJoiSchema,
]);
/**
 ...
 * ```
 */
function validateChildrensEvent(maybeChildrensEvent) {
    const { value, error } = exports.ChildrensEventJoiSchema.validate(maybeChildrensEvent);
    if (error) {
        return new oaValidationError_1.OaValidationError('ChildrensEvent', maybeChildrensEvent, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateChildrensEvent = validateChildrensEvent;
