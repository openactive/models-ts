 ...
 * etc.
 */
export declare type ChooseActionOrSubClass = ChooseAction | schema.VoteActionOrSubClass;
/**
 * schema:ChooseAction - Validation schema (w/ JOI)
 */
export declare const ChooseActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:ChooseAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ChooseActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateChooseAction(maybeChooseAction: unknown): ChooseAction | OaValidationError;
