 ...
 * etc.
 */
export declare type ChurchOrSubClass = Church | schema.CatholicChurchOrSubClass;
/**
 * schema:Church - Validation schema (w/ JOI)
 */
export declare const ChurchJoiSchema: Joi.ObjectSchema;
/**
 * schema:Church - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ChurchOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateChurch(maybeChurch: unknown): Church | OaValidationError;
