...
exports.validateChurch = exports.ChurchOrSubClassJoiSchema = exports.ChurchJoiSchema = void 0;
 ...
 */
exports.ChurchJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ChurchOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ChurchJoiSchema,
 ...
 * ```
 */
function validateChurch(maybeChurch) {
    const { value, error } = exports.ChurchJoiSchema.validate(maybeChurch);
    if (error) {
        return new oaValidationError_1.OaValidationError('Church', maybeChurch, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateChurch = validateChurch;
