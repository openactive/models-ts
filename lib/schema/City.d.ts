 ...
 * etc.
 */
export declare type CityOrSubClass = City;
/**
 * schema:City - Validation schema (w/ JOI)
 */
export declare const CityJoiSchema: Joi.ObjectSchema;
/**
 * schema:City - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CityOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCity(maybeCity: unknown): City | OaValidationError;
