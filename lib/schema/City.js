...
exports.validateCity = exports.CityOrSubClassJoiSchema = exports.CityJoiSchema = void 0;
 ...
 */
exports.CityJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.CityOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CityJoiSchema,
]);
/**
 ...
 * ```
 */
function validateCity(maybeCity) {
    const { value, error } = exports.CityJoiSchema.validate(maybeCity);
    if (error) {
        return new oaValidationError_1.OaValidationError('City', maybeCity, error);
    }
