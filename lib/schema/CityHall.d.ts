 ...
 * etc.
 */
export declare type CityHallOrSubClass = CityHall;
/**
 * schema:CityHall - Validation schema (w/ JOI)
 */
export declare const CityHallJoiSchema: Joi.ObjectSchema;
/**
 * schema:CityHall - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CityHallOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCityHall(maybeCityHall: unknown): CityHall | OaValidationError;
