...
exports.validateCityHall = exports.CityHallOrSubClassJoiSchema = exports.CityHallJoiSchema = void 0;
 ...
 */
exports.CityHallJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.CityHallOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CityHallJoiSchema,
]);
/**
 ...
 * ```
 */
function validateCityHall(maybeCityHall) {
    const { value, error } = exports.CityHallJoiSchema.validate(maybeCityHall);
    if (error) {
        return new oaValidationError_1.OaValidationError('CityHall', maybeCityHall, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateCityHall = validateCityHall;
