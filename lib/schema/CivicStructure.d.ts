 ...
 * etc.
 */
export declare type CivicStructureOrSubClass = CivicStructure | schema.AirportOrSubClass | schema.ZooOrSubClass | schema.ParkOrSubClass | schema.PerformingArtsTheaterOrSubClass | schema.CampgroundOrSubClass | schema.GovernmentBuildingOrSubClass | schema.StadiumOrArenaOrSubClass | schema.BusStationOrSubClass | schema.MusicVenueOrSubClass | schema.FireStationOrSubClass | schema.CrematoriumOrSubClass | schema.EducationalOrganizationOrSubClass | schema.ParkingFacilityOrSubClass | schema.HospitalOrSubClass | schema.SubwayStationOrSubClass | schema.RVParkOrSubClass | schema.EventVenueOrSubClass | schema.BeachOrSubClass | schema.TrainStationOrSubClass | schema.PublicToiletOrSubClass | schema.BoatTerminalOrSubClass | schema.PoliceStationOrSubClass | schema.TaxiStandOrSubClass | schema.MuseumOrSubClass | schema.BusStopOrSubClass | schema.CemeteryOrSubClass | schema.AquariumOrSubClass | schema.MovieTheaterOrSubClass | schema.PlaceOfWorshipOrSubClass | schema.PlaygroundOrSubClass | schema.BridgeOrSubClass;
/**
