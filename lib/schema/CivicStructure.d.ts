 ...
 * etc.
 */
export declare type CivicStructureOrSubClass = CivicStructure | schema.AquariumOrSubClass | schema.EducationalOrganizationOrSubClass | schema.MovieTheaterOrSubClass | schema.HospitalOrSubClass | schema.TrainStationOrSubClass | schema.CampgroundOrSubClass | schema.PoliceStationOrSubClass | schema.BridgeOrSubClass | schema.ZooOrSubClass | schema.BeachOrSubClass | schema.EventVenueOrSubClass | schema.PlaygroundOrSubClass | schema.SubwayStationOrSubClass | schema.AirportOrSubClass | schema.BusStopOrSubClass | schema.CemeteryOrSubClass | schema.FireStationOrSubClass | schema.BusStationOrSubClass | schema.MuseumOrSubClass | schema.ParkOrSubClass | schema.TaxiStandOrSubClass | schema.PlaceOfWorshipOrSubClass | schema.MusicVenueOrSubClass | schema.ParkingFacilityOrSubClass | schema.StadiumOrArenaOrSubClass | schema.CrematoriumOrSubClass | schema.BoatTerminalOrSubClass | schema.PublicToiletOrSubClass | schema.GovernmentBuildingOrSubClass | schema.RVParkOrSubClass | schema.PerformingArtsTheaterOrSubClass;
/**
 * schema:CivicStructure - Validation schema (w/ JOI)
 */
export declare const CivicStructureJoiSchema: Joi.ObjectSchema;
/**
 * schema:CivicStructure - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CivicStructureOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCivicStructure(maybeCivicStructure: unknown): CivicStructure | OaValidationError;
