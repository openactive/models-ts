 ...
 * etc.
 */
export declare type ClaimOrSubClass = Claim;
/**
 * schema:Claim - Validation schema (w/ JOI)
 */
export declare const ClaimJoiSchema: Joi.ObjectSchema;
/**
 * schema:Claim - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ClaimOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateClaim(maybeClaim: unknown): Claim | OaValidationError;
