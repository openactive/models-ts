...
exports.validateClaim = exports.ClaimOrSubClassJoiSchema = exports.ClaimJoiSchema = void 0;
 ...
 */
exports.ClaimJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ClaimOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ClaimJoiSchema,
]);
/**
 ...
 * ```
 */
function validateClaim(maybeClaim) {
    const { value, error } = exports.ClaimJoiSchema.validate(maybeClaim);
    if (error) {
        return new oaValidationError_1.OaValidationError('Claim', maybeClaim, error);
    }
