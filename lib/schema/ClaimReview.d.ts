 ...
 * etc.
 */
export declare type ClaimReviewOrSubClass = ClaimReview;
/**
 * schema:ClaimReview - Validation schema (w/ JOI)
 */
export declare const ClaimReviewJoiSchema: Joi.ObjectSchema;
/**
 * schema:ClaimReview - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ClaimReviewOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateClaimReview(maybeClaimReview: unknown): ClaimReview | OaValidationError;
