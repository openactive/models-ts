...
exports.validateClaimReview = exports.ClaimReviewOrSubClassJoiSchema = exports.ClaimReviewJoiSchema = void 0;
 ...
 */
exports.ClaimReviewJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ClaimReviewOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ClaimReviewJoiSchema,
]);
/**
 ...
 * ```
 */
function validateClaimReview(maybeClaimReview) {
    const { value, error } = exports.ClaimReviewJoiSchema.validate(maybeClaimReview);
    if (error) {
        return new oaValidationError_1.OaValidationError('ClaimReview', maybeClaimReview, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateClaimReview = validateClaimReview;
