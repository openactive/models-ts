 ...
 * etc.
 */
export declare type ClassOrSubClass = Class;
/**
 * schema:Class - Validation schema (w/ JOI)
 */
export declare const ClassJoiSchema: Joi.ObjectSchema;
/**
 * schema:Class - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ClassOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateClass(maybeClass: unknown): Class | OaValidationError;
