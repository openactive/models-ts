 ...
 * etc.
 */
export declare type ClipOrSubClass = Clip | schema.TVClipOrSubClass | schema.MovieClipOrSubClass | schema.VideoGameClipOrSubClass | schema.RadioClipOrSubClass;
/**
 * schema:Clip - Validation schema (w/ JOI)
 */
export declare const ClipJoiSchema: Joi.ObjectSchema;
/**
 * schema:Clip - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ClipOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateClip(maybeClip: unknown): Clip | OaValidationError;
