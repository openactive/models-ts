...
exports.validateClip = exports.ClipOrSubClassJoiSchema = exports.ClipJoiSchema = void 0;
 ...
 */
exports.ClipJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ClipOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ClipJoiSchema,
 ...
 * ```
 */
function validateClip(maybeClip) {
    const { value, error } = exports.ClipJoiSchema.validate(maybeClip);
    if (error) {
        return new oaValidationError_1.OaValidationError('Clip', maybeClip, error);
    }
