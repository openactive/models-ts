 ...
 * etc.
 */
export declare type ClothingStoreOrSubClass = ClothingStore;
/**
 * schema:ClothingStore - Validation schema (w/ JOI)
 */
export declare const ClothingStoreJoiSchema: Joi.ObjectSchema;
/**
 * schema:ClothingStore - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ClothingStoreOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateClothingStore(maybeClothingStore: unknown): ClothingStore | OaValidationError;
