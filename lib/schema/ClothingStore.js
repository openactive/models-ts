...
exports.validateClothingStore = exports.ClothingStoreOrSubClassJoiSchema = exports.ClothingStoreJoiSchema = void 0;
 ...
 */
exports.ClothingStoreJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ClothingStoreOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ClothingStoreJoiSchema,
]);
/**
 ...
 * ```
 */
function validateClothingStore(maybeClothingStore) {
    const { value, error } = exports.ClothingStoreJoiSchema.validate(maybeClothingStore);
    if (error) {
        return new oaValidationError_1.OaValidationError('ClothingStore', maybeClothingStore, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateClothingStore = validateClothingStore;
