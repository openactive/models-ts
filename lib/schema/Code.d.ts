 ...
 * etc.
 */
export declare type CodeOrSubClass = Code;
/**
 * schema:Code - Validation schema (w/ JOI)
 */
export declare const CodeJoiSchema: Joi.ObjectSchema;
/**
 * schema:Code - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CodeOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCode(maybeCode: unknown): Code | OaValidationError;
