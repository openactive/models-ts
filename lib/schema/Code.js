...
exports.validateCode = exports.CodeOrSubClassJoiSchema = exports.CodeJoiSchema = void 0;
 ...
 */
exports.CodeJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.CodeOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CodeJoiSchema,
]);
/**
 ...
 * ```
 */
function validateCode(maybeCode) {
    const { value, error } = exports.CodeJoiSchema.validate(maybeCode);
    if (error) {
        return new oaValidationError_1.OaValidationError('Code', maybeCode, error);
    }
