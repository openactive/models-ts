 ...
 * etc.
 */
export declare type CollectionOrSubClass = Collection | schema.ProductCollectionOrSubClass;
/**
 * schema:Collection - Validation schema (w/ JOI)
 */
export declare const CollectionJoiSchema: Joi.ObjectSchema;
/**
 * schema:Collection - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CollectionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCollection(maybeCollection: unknown): Collection | OaValidationError;
