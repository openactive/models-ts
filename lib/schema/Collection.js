...
exports.validateCollection = exports.CollectionOrSubClassJoiSchema = exports.CollectionJoiSchema = void 0;
 ...
 */
exports.CollectionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.CollectionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CollectionJoiSchema,
 ...
 * ```
 */
function validateCollection(maybeCollection) {
    const { value, error } = exports.CollectionJoiSchema.validate(maybeCollection);
    if (error) {
        return new oaValidationError_1.OaValidationError('Collection', maybeCollection, error);
    }
