 ...
 * etc.
 */
export declare type CollectionPageOrSubClass = CollectionPage | schema.MediaGalleryOrSubClass;
/**
 * schema:CollectionPage - Validation schema (w/ JOI)
 */
export declare const CollectionPageJoiSchema: Joi.ObjectSchema;
/**
 * schema:CollectionPage - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CollectionPageOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCollectionPage(maybeCollectionPage: unknown): CollectionPage | OaValidationError;
