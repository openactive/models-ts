...
exports.validateCollectionPage = exports.CollectionPageOrSubClassJoiSchema = exports.CollectionPageJoiSchema = void 0;
 ...
 */
exports.CollectionPageJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.CollectionPageOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CollectionPageJoiSchema,
 ...
 * ```
 */
function validateCollectionPage(maybeCollectionPage) {
    const { value, error } = exports.CollectionPageJoiSchema.validate(maybeCollectionPage);
    if (error) {
        return new oaValidationError_1.OaValidationError('CollectionPage', maybeCollectionPage, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateCollectionPage = validateCollectionPage;
