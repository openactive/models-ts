 ...
 * etc.
 */
export declare type CollegeOrUniversityOrSubClass = CollegeOrUniversity;
/**
 * schema:CollegeOrUniversity - Validation schema (w/ JOI)
 */
export declare const CollegeOrUniversityJoiSchema: Joi.ObjectSchema;
/**
 * schema:CollegeOrUniversity - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CollegeOrUniversityOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCollegeOrUniversity(maybeCollegeOrUniversity: unknown): CollegeOrUniversity | OaValidationError;
