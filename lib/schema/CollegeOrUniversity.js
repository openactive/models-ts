...
exports.validateCollegeOrUniversity = exports.CollegeOrUniversityOrSubClassJoiSchema = exports.CollegeOrUniversityJoiSchema = void 0;
 ...
 */
exports.CollegeOrUniversityJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.CollegeOrUniversityOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CollegeOrUniversityJoiSchema,
]);
/**
 ...
 * ```
 */
function validateCollegeOrUniversity(maybeCollegeOrUniversity) {
    const { value, error } = exports.CollegeOrUniversityJoiSchema.validate(maybeCollegeOrUniversity);
    if (error) {
        return new oaValidationError_1.OaValidationError('CollegeOrUniversity', maybeCollegeOrUniversity, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateCollegeOrUniversity = validateCollegeOrUniversity;
