 ...
 * etc.
 */
export declare type ComedyClubOrSubClass = ComedyClub;
/**
 * schema:ComedyClub - Validation schema (w/ JOI)
 */
export declare const ComedyClubJoiSchema: Joi.ObjectSchema;
/**
 * schema:ComedyClub - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ComedyClubOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateComedyClub(maybeComedyClub: unknown): ComedyClub | OaValidationError;
