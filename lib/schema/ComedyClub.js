...
exports.validateComedyClub = exports.ComedyClubOrSubClassJoiSchema = exports.ComedyClubJoiSchema = void 0;
 ...
 */
exports.ComedyClubJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ComedyClubOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ComedyClubJoiSchema,
]);
/**
 ...
 * ```
 */
function validateComedyClub(maybeComedyClub) {
    const { value, error } = exports.ComedyClubJoiSchema.validate(maybeComedyClub);
    if (error) {
        return new oaValidationError_1.OaValidationError('ComedyClub', maybeComedyClub, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateComedyClub = validateComedyClub;
