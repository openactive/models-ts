 ...
 * etc.
 */
export declare type ComedyEventOrSubClass = ComedyEvent;
/**
 * schema:ComedyEvent - Validation schema (w/ JOI)
 */
export declare const ComedyEventJoiSchema: Joi.ObjectSchema;
/**
 * schema:ComedyEvent - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ComedyEventOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateComedyEvent(maybeComedyEvent: unknown): ComedyEvent | OaValidationError;
