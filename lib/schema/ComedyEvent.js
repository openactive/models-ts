...
exports.validateComedyEvent = exports.ComedyEventOrSubClassJoiSchema = exports.ComedyEventJoiSchema = void 0;
 ...
 */
exports.ComedyEventJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ComedyEventOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ComedyEventJoiSchema,
]);
/**
 ...
 * ```
 */
function validateComedyEvent(maybeComedyEvent) {
    const { value, error } = exports.ComedyEventJoiSchema.validate(maybeComedyEvent);
    if (error) {
        return new oaValidationError_1.OaValidationError('ComedyEvent', maybeComedyEvent, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateComedyEvent = validateComedyEvent;
