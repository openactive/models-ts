 ...
 * etc.
 */
export declare type ComicCoverArtOrSubClass = ComicCoverArt;
/**
 * schema:ComicCoverArt - Validation schema (w/ JOI)
 */
export declare const ComicCoverArtJoiSchema: Joi.ObjectSchema;
/**
 * schema:ComicCoverArt - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ComicCoverArtOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateComicCoverArt(maybeComicCoverArt: unknown): ComicCoverArt | OaValidationError;
