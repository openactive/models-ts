...
exports.validateComicCoverArt = exports.ComicCoverArtOrSubClassJoiSchema = exports.ComicCoverArtJoiSchema = void 0;
 ...
 */
exports.ComicCoverArtJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ComicCoverArtOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ComicCoverArtJoiSchema,
]);
/**
 ...
 * ```
 */
function validateComicCoverArt(maybeComicCoverArt) {
    const { value, error } = exports.ComicCoverArtJoiSchema.validate(maybeComicCoverArt);
    if (error) {
        return new oaValidationError_1.OaValidationError('ComicCoverArt', maybeComicCoverArt, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateComicCoverArt = validateComicCoverArt;
