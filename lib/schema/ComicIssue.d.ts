 ...
 * etc.
 */
export declare type ComicIssueOrSubClass = ComicIssue;
/**
 * schema:ComicIssue - Validation schema (w/ JOI)
 */
export declare const ComicIssueJoiSchema: Joi.ObjectSchema;
/**
 * schema:ComicIssue - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ComicIssueOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateComicIssue(maybeComicIssue: unknown): ComicIssue | OaValidationError;
