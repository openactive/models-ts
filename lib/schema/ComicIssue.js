...
exports.validateComicIssue = exports.ComicIssueOrSubClassJoiSchema = exports.ComicIssueJoiSchema = void 0;
 ...
 */
exports.ComicIssueJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ComicIssueOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ComicIssueJoiSchema,
]);
/**
 ...
 * ```
 */
function validateComicIssue(maybeComicIssue) {
    const { value, error } = exports.ComicIssueJoiSchema.validate(maybeComicIssue);
    if (error) {
        return new oaValidationError_1.OaValidationError('ComicIssue', maybeComicIssue, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateComicIssue = validateComicIssue;
