 ...
 * etc.
 */
export declare type ComicSeriesOrSubClass = ComicSeries;
/**
 * schema:ComicSeries - Validation schema (w/ JOI)
 */
export declare const ComicSeriesJoiSchema: Joi.ObjectSchema;
/**
 * schema:ComicSeries - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ComicSeriesOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateComicSeries(maybeComicSeries: unknown): ComicSeries | OaValidationError;
