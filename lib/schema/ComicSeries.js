...
exports.validateComicSeries = exports.ComicSeriesOrSubClassJoiSchema = exports.ComicSeriesJoiSchema = void 0;
 ...
 */
exports.ComicSeriesJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ComicSeriesOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ComicSeriesJoiSchema,
]);
/**
 ...
 * ```
 */
function validateComicSeries(maybeComicSeries) {
    const { value, error } = exports.ComicSeriesJoiSchema.validate(maybeComicSeries);
    if (error) {
        return new oaValidationError_1.OaValidationError('ComicSeries', maybeComicSeries, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateComicSeries = validateComicSeries;
