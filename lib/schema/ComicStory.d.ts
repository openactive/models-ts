 ...
 * etc.
 */
export declare type ComicStoryOrSubClass = ComicStory | schema.ComicCoverArtOrSubClass;
/**
 * schema:ComicStory - Validation schema (w/ JOI)
 */
export declare const ComicStoryJoiSchema: Joi.ObjectSchema;
/**
 * schema:ComicStory - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ComicStoryOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateComicStory(maybeComicStory: unknown): ComicStory | OaValidationError;
