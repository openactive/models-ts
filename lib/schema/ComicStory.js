...
exports.validateComicStory = exports.ComicStoryOrSubClassJoiSchema = exports.ComicStoryJoiSchema = void 0;
 ...
 */
exports.ComicStoryJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ComicStoryOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ComicStoryJoiSchema,
 ...
 * ```
 */
function validateComicStory(maybeComicStory) {
    const { value, error } = exports.ComicStoryJoiSchema.validate(maybeComicStory);
    if (error) {
        return new oaValidationError_1.OaValidationError('ComicStory', maybeComicStory, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateComicStory = validateComicStory;
