 ...
 * etc.
 */
export declare type CommentOrSubClass = Comment | schema.CorrectionCommentOrSubClass | schema.QuestionOrSubClass | schema.AnswerOrSubClass;
/**
 * schema:Comment - Validation schema (w/ JOI)
 */
export declare const CommentJoiSchema: Joi.ObjectSchema;
/**
 * schema:Comment - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CommentOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateComment(maybeComment: unknown): Comment | OaValidationError;
