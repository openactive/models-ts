...
exports.validateComment = exports.CommentOrSubClassJoiSchema = exports.CommentJoiSchema = void 0;
 ...
 */
exports.CommentJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.CommentOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CommentJoiSchema,
 ...
 * ```
 */
function validateComment(maybeComment) {
    const { value, error } = exports.CommentJoiSchema.validate(maybeComment);
    if (error) {
        return new oaValidationError_1.OaValidationError('Comment', maybeComment, error);
    }
