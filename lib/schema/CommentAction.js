...
exports.validateCommentAction = exports.CommentActionOrSubClassJoiSchema = exports.CommentActionJoiSchema = void 0;
 ...
 */
exports.CommentActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.CommentActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CommentActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateCommentAction(maybeCommentAction) {
    const { value, error } = exports.CommentActionJoiSchema.validate(maybeCommentAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('CommentAction', maybeCommentAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateCommentAction = validateCommentAction;
