 ...
 * etc.
 */
export declare type CommunicateActionOrSubClass = CommunicateAction | schema.AskActionOrSubClass | schema.CommentActionOrSubClass | schema.InformActionOrSubClass | schema.CheckInActionOrSubClass | schema.CheckOutActionOrSubClass | schema.InviteActionOrSubClass | schema.ReplyActionOrSubClass | schema.ShareActionOrSubClass;
/**
 * schema:CommunicateAction - Validation schema (w/ JOI)
 */
export declare const CommunicateActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:CommunicateAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CommunicateActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCommunicateAction(maybeCommunicateAction: unknown): CommunicateAction | OaValidationError;
