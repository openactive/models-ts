 ...
 * etc.
 */
export declare type CompleteDataFeedOrSubClass = CompleteDataFeed;
/**
 * schema:CompleteDataFeed - Validation schema (w/ JOI)
 */
export declare const CompleteDataFeedJoiSchema: Joi.ObjectSchema;
/**
 * schema:CompleteDataFeed - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CompleteDataFeedOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCompleteDataFeed(maybeCompleteDataFeed: unknown): CompleteDataFeed | OaValidationError;
