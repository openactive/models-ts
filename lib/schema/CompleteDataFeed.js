...
exports.validateCompleteDataFeed = exports.CompleteDataFeedOrSubClassJoiSchema = exports.CompleteDataFeedJoiSchema = void 0;
 ...
 */
exports.CompleteDataFeedJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.CompleteDataFeedOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CompleteDataFeedJoiSchema,
]);
/**
 ...
 * ```
 */
function validateCompleteDataFeed(maybeCompleteDataFeed) {
    const { value, error } = exports.CompleteDataFeedJoiSchema.validate(maybeCompleteDataFeed);
    if (error) {
        return new oaValidationError_1.OaValidationError('CompleteDataFeed', maybeCompleteDataFeed, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateCompleteDataFeed = validateCompleteDataFeed;
