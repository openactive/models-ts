 ...
 * etc.
 */
export declare type ComputerLanguageOrSubClass = ComputerLanguage;
/**
 * schema:ComputerLanguage - Validation schema (w/ JOI)
 */
export declare const ComputerLanguageJoiSchema: Joi.ObjectSchema;
/**
 * schema:ComputerLanguage - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ComputerLanguageOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateComputerLanguage(maybeComputerLanguage: unknown): ComputerLanguage | OaValidationError;
