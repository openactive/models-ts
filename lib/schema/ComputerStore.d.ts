 ...
 * etc.
 */
export declare type ComputerStoreOrSubClass = ComputerStore;
/**
 * schema:ComputerStore - Validation schema (w/ JOI)
 */
export declare const ComputerStoreJoiSchema: Joi.ObjectSchema;
/**
 * schema:ComputerStore - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ComputerStoreOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateComputerStore(maybeComputerStore: unknown): ComputerStore | OaValidationError;
