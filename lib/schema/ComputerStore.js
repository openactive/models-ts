...
exports.validateComputerStore = exports.ComputerStoreOrSubClassJoiSchema = exports.ComputerStoreJoiSchema = void 0;
 ...
 */
exports.ComputerStoreJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ComputerStoreOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ComputerStoreJoiSchema,
]);
/**
 ...
 * ```
 */
function validateComputerStore(maybeComputerStore) {
    const { value, error } = exports.ComputerStoreJoiSchema.validate(maybeComputerStore);
    if (error) {
        return new oaValidationError_1.OaValidationError('ComputerStore', maybeComputerStore, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateComputerStore = validateComputerStore;
