...
exports.validateConfirmAction = exports.ConfirmActionOrSubClassJoiSchema = exports.ConfirmActionJoiSchema = void 0;
 ...
 */
exports.ConfirmActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ConfirmActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ConfirmActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateConfirmAction(maybeConfirmAction) {
    const { value, error } = exports.ConfirmActionJoiSchema.validate(maybeConfirmAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('ConfirmAction', maybeConfirmAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateConfirmAction = validateConfirmAction;
