 ...
 * etc.
 */
export declare type ConsortiumOrSubClass = Consortium;
/**
 * schema:Consortium - Validation schema (w/ JOI)
 */
export declare const ConsortiumJoiSchema: Joi.ObjectSchema;
/**
 * schema:Consortium - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ConsortiumOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateConsortium(maybeConsortium: unknown): Consortium | OaValidationError;
