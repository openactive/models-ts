...
exports.validateConsortium = exports.ConsortiumOrSubClassJoiSchema = exports.ConsortiumJoiSchema = void 0;
 ...
 */
exports.ConsortiumJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ConsortiumOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ConsortiumJoiSchema,
]);
/**
 ...
 * ```
 */
function validateConsortium(maybeConsortium) {
    const { value, error } = exports.ConsortiumJoiSchema.validate(maybeConsortium);
    if (error) {
        return new oaValidationError_1.OaValidationError('Consortium', maybeConsortium, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateConsortium = validateConsortium;
