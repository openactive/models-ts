 ...
 * etc.
 */
export declare type ConsumeActionOrSubClass = ConsumeAction | schema.ListenActionOrSubClass | schema.DrinkActionOrSubClass | schema.WatchActionOrSubClass | schema.ViewActionOrSubClass | schema.EatActionOrSubClass | schema.ReadActionOrSubClass | schema.InstallActionOrSubClass | schema.UseActionOrSubClass;
/**
 * schema:ConsumeAction - Validation schema (w/ JOI)
 */
export declare const ConsumeActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:ConsumeAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ConsumeActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateConsumeAction(maybeConsumeAction: unknown): ConsumeAction | OaValidationError;
