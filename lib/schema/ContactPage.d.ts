 ...
 * etc.
 */
export declare type ContactPageOrSubClass = ContactPage;
/**
 * schema:ContactPage - Validation schema (w/ JOI)
 */
export declare const ContactPageJoiSchema: Joi.ObjectSchema;
/**
 * schema:ContactPage - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ContactPageOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateContactPage(maybeContactPage: unknown): ContactPage | OaValidationError;
