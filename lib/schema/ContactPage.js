...
exports.validateContactPage = exports.ContactPageOrSubClassJoiSchema = exports.ContactPageJoiSchema = void 0;
 ...
 */
exports.ContactPageJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ContactPageOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ContactPageJoiSchema,
]);
/**
 ...
 * ```
 */
function validateContactPage(maybeContactPage) {
    const { value, error } = exports.ContactPageJoiSchema.validate(maybeContactPage);
    if (error) {
        return new oaValidationError_1.OaValidationError('ContactPage', maybeContactPage, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateContactPage = validateContactPage;
