 ...
 * etc.
 */
export declare type ContinentOrSubClass = Continent;
/**
 * schema:Continent - Validation schema (w/ JOI)
 */
export declare const ContinentJoiSchema: Joi.ObjectSchema;
/**
 * schema:Continent - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ContinentOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateContinent(maybeContinent: unknown): Continent | OaValidationError;
