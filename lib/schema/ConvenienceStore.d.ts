 ...
 * etc.
 */
export declare type ConvenienceStoreOrSubClass = ConvenienceStore;
/**
 * schema:ConvenienceStore - Validation schema (w/ JOI)
 */
export declare const ConvenienceStoreJoiSchema: Joi.ObjectSchema;
/**
 * schema:ConvenienceStore - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ConvenienceStoreOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateConvenienceStore(maybeConvenienceStore: unknown): ConvenienceStore | OaValidationError;
