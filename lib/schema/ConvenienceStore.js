...
exports.validateConvenienceStore = exports.ConvenienceStoreOrSubClassJoiSchema = exports.ConvenienceStoreJoiSchema = void 0;
 ...
 */
exports.ConvenienceStoreJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ConvenienceStoreOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ConvenienceStoreJoiSchema,
]);
/**
 ...
 * ```
 */
function validateConvenienceStore(maybeConvenienceStore) {
    const { value, error } = exports.ConvenienceStoreJoiSchema.validate(maybeConvenienceStore);
    if (error) {
        return new oaValidationError_1.OaValidationError('ConvenienceStore', maybeConvenienceStore, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateConvenienceStore = validateConvenienceStore;
