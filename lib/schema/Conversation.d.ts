 ...
 * etc.
 */
export declare type ConversationOrSubClass = Conversation;
/**
 * schema:Conversation - Validation schema (w/ JOI)
 */
export declare const ConversationJoiSchema: Joi.ObjectSchema;
/**
 * schema:Conversation - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ConversationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateConversation(maybeConversation: unknown): Conversation | OaValidationError;
