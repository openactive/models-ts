...
exports.validateConversation = exports.ConversationOrSubClassJoiSchema = exports.ConversationJoiSchema = void 0;
 ...
 */
exports.ConversationJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ConversationOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ConversationJoiSchema,
]);
/**
 ...
 * ```
 */
function validateConversation(maybeConversation) {
    const { value, error } = exports.ConversationJoiSchema.validate(maybeConversation);
    if (error) {
        return new oaValidationError_1.OaValidationError('Conversation', maybeConversation, error);
    }
