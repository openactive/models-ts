 ...
 * etc.
 */
export declare type CookActionOrSubClass = CookAction;
/**
 * schema:CookAction - Validation schema (w/ JOI)
 */
export declare const CookActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:CookAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CookActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCookAction(maybeCookAction: unknown): CookAction | OaValidationError;
