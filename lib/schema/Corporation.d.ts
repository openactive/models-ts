 ...
 * etc.
 */
export declare type CorporationOrSubClass = Corporation;
/**
 * schema:Corporation - Validation schema (w/ JOI)
 */
export declare const CorporationJoiSchema: Joi.ObjectSchema;
/**
 * schema:Corporation - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CorporationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCorporation(maybeCorporation: unknown): Corporation | OaValidationError;
