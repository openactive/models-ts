...
exports.validateCorporation = exports.CorporationOrSubClassJoiSchema = exports.CorporationJoiSchema = void 0;
 ...
 */
exports.CorporationJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.CorporationOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CorporationJoiSchema,
]);
/**
 ...
 * ```
 */
function validateCorporation(maybeCorporation) {
    const { value, error } = exports.CorporationJoiSchema.validate(maybeCorporation);
    if (error) {
        return new oaValidationError_1.OaValidationError('Corporation', maybeCorporation, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateCorporation = validateCorporation;
