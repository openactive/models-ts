 ...
 * etc.
 */
export declare type CorrectionCommentOrSubClass = CorrectionComment;
/**
 * schema:CorrectionComment - Validation schema (w/ JOI)
 */
export declare const CorrectionCommentJoiSchema: Joi.ObjectSchema;
/**
 * schema:CorrectionComment - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CorrectionCommentOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCorrectionComment(maybeCorrectionComment: unknown): CorrectionComment | OaValidationError;
