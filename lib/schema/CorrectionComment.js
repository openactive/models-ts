...
exports.validateCorrectionComment = exports.CorrectionCommentOrSubClassJoiSchema = exports.CorrectionCommentJoiSchema = void 0;
 ...
 */
exports.CorrectionCommentJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.CorrectionCommentOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CorrectionCommentJoiSchema,
]);
/**
 ...
 * ```
 */
function validateCorrectionComment(maybeCorrectionComment) {
    const { value, error } = exports.CorrectionCommentJoiSchema.validate(maybeCorrectionComment);
    if (error) {
        return new oaValidationError_1.OaValidationError('CorrectionComment', maybeCorrectionComment, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateCorrectionComment = validateCorrectionComment;
