 ...
 * etc.
 */
export declare type CountryOrSubClass = Country;
/**
 * schema:Country - Validation schema (w/ JOI)
 */
export declare const CountryJoiSchema: Joi.ObjectSchema;
/**
 * schema:Country - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CountryOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCountry(maybeCountry: unknown): Country | OaValidationError;
