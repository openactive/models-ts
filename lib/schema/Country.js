...
exports.validateCountry = exports.CountryOrSubClassJoiSchema = exports.CountryJoiSchema = void 0;
 ...
 */
exports.CountryJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.CountryOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CountryJoiSchema,
]);
/**
 ...
 * ```
 */
function validateCountry(maybeCountry) {
    const { value, error } = exports.CountryJoiSchema.validate(maybeCountry);
    if (error) {
        return new oaValidationError_1.OaValidationError('Country', maybeCountry, error);
    }
