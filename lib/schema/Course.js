...
exports.validateCourse = exports.CourseOrSubClassJoiSchema = exports.CourseJoiSchema = void 0;
// This file was generated
const Joi = require("joi");
const oaValidationError_1 = require("../oaValidationError");
const schema = require("../schema");
/**
 * schema:Course - Validation schema (w/ JOI)
 */
exports.CourseJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.CourseOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CourseJoiSchema,
]);
/**
 * Runtime validator for schema:Course.
 *
 * If some data has a structure which matches a schema:Course, it will be returned with the correct type.
 * Otherwise, this function returns an OAValidationError with details about why the data does not match.
 *
 * Use this to e.g. check a JSON object received in an HTTP request. Example usage (for an express request handler):
 *
 * ```ts
 * const maybeCourse = Course.validate(req.body); // `req.body` will have type `any` or `unknown`
 ...
 * ```
 */
function validateCourse(maybeCourse) {
    const { value, error } = exports.CourseJoiSchema.validate(maybeCourse);
    if (error) {
        return new oaValidationError_1.OaValidationError('Course', maybeCourse, error);
    }
