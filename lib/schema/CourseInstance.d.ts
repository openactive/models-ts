 ...
 * etc.
 */
export declare type CourseInstanceOrSubClass = CourseInstance;
/**
 * schema:CourseInstance - Validation schema (w/ JOI)
 */
export declare const CourseInstanceJoiSchema: Joi.ObjectSchema;
/**
 * schema:CourseInstance - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CourseInstanceOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCourseInstance(maybeCourseInstance: unknown): CourseInstance | OaValidationError;
