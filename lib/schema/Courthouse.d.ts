 ...
 * etc.
 */
export declare type CourthouseOrSubClass = Courthouse;
/**
 * schema:Courthouse - Validation schema (w/ JOI)
 */
export declare const CourthouseJoiSchema: Joi.ObjectSchema;
/**
 * schema:Courthouse - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CourthouseOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCourthouse(maybeCourthouse: unknown): Courthouse | OaValidationError;
