 ...
 * etc.
 */
export declare type CoverArtOrSubClass = CoverArt | schema.ComicCoverArtOrSubClass;
/**
 * schema:CoverArt - Validation schema (w/ JOI)
 */
export declare const CoverArtJoiSchema: Joi.ObjectSchema;
/**
 * schema:CoverArt - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CoverArtOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCoverArt(maybeCoverArt: unknown): CoverArt | OaValidationError;
