...
exports.validateCoverArt = exports.CoverArtOrSubClassJoiSchema = exports.CoverArtJoiSchema = void 0;
 ...
 */
exports.CoverArtJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.CoverArtOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CoverArtJoiSchema,
 ...
 * ```
 */
function validateCoverArt(maybeCoverArt) {
    const { value, error } = exports.CoverArtJoiSchema.validate(maybeCoverArt);
    if (error) {
        return new oaValidationError_1.OaValidationError('CoverArt', maybeCoverArt, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateCoverArt = validateCoverArt;
