 ...
 */
export declare type CovidTestingFacility = {
 ...
 * etc.
 */
export declare type CovidTestingFacilityOrSubClass = CovidTestingFacility;
/**
 * schema:CovidTestingFacility - Validation schema (w/ JOI)
 */
export declare const CovidTestingFacilityJoiSchema: Joi.ObjectSchema;
/**
 * schema:CovidTestingFacility - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CovidTestingFacilityOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCovidTestingFacility(maybeCovidTestingFacility: unknown): CovidTestingFacility | OaValidationError;
