...
exports.validateCovidTestingFacility = exports.CovidTestingFacilityOrSubClassJoiSchema = exports.CovidTestingFacilityJoiSchema = void 0;
 ...
 */
exports.CovidTestingFacilityJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.CovidTestingFacilityOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CovidTestingFacilityJoiSchema,
]);
/**
 ...
 * ```
 */
function validateCovidTestingFacility(maybeCovidTestingFacility) {
    const { value, error } = exports.CovidTestingFacilityJoiSchema.validate(maybeCovidTestingFacility);
    if (error) {
        return new oaValidationError_1.OaValidationError('CovidTestingFacility', maybeCovidTestingFacility, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateCovidTestingFacility = validateCovidTestingFacility;
