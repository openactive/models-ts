 ...
 * schema:CreativeWork
 *
 * This differs from CreativeWork because it also allows for objects that have the type of a model that
 * sub-classes this model. e.g. `Event_OrSubClass` allows `Event`s as well as `ScheduledSession`s, `SessionSeries`,
 * etc.
 */
export declare type CreativeWorkOrSubClass = CreativeWork | oa.ConceptCollectionOrSubClass | schema.SpecialAnnouncementOrSubClass | schema.AmpStoryOrSubClass | schema.DefinedTermSetOrSubClass | schema.PhotographOrSubClass | schema.CourseOrSubClass | schema.ClipOrSubClass | schema.CommentOrSubClass | schema.HyperTocEntryOrSubClass | schema.MusicCompositionOrSubClass | schema.WebPageOrSubClass | schema.DrawingOrSubClass | schema.CodeOrSubClass | schema.HowToStepOrSubClass | schema.MathSolverOrSubClass | schema.LegislationOrSubClass | schema.CreativeWorkSeriesOrSubClass | schema.HowToOrSubClass | schema.ThesisOrSubClass | schema.EducationalOccupationalCredentialOrSubClass | schema.WebPageElementOrSubClass | schema.VisualArtworkOrSubClass | schema.SheetMusicOrSubClass | schema.ChapterOrSubClass | schema.MusicPlaylistOrSubClass | schema.BookOrSubClass | schema.SculptureOrSubClass | schema.HowToSectionOrSubClass | schema.ComicStoryOrSubClass | schema.ArchiveComponentOrSubClass | schema.MapOrSubClass | schema.GameOrSubClass | schema.CollectionOrSubClass | schema.SeasonOrSubClass | schema.MenuSectionOrSubClass | schema.WebContentOrSubClass | schema.MovieOrSubClass | schema.ArticleOrSubClass | schema.PlayOrSubClass | schema.ReviewOrSubClass | schema.DatasetOrSubClass | schema.LearningResourceOrSubClass | schema.DietOrSubClass | schema.DataCatalogOrSubClass | schema.PublicationIssueOrSubClass | schema.AtlasOrSubClass | schema.PublicationVolumeOrSubClass | schema.MenuOrSubClass | schema.QuotationOrSubClass | schema.ConversationOrSubClass | schema.MusicRecordingOrSubClass | schema.ExercisePlanOrSubClass | schema.ClaimOrSubClass | schema.PaintingOrSubClass | schema.BlogOrSubClass | schema.HowToDirectionOrSubClass | schema.SoftwareApplicationOrSubClass | schema.SoftwareSourceCodeOrSubClass | schema.MessageOrSubClass | schema.GuideOrSubClass | schema.PosterOrSubClass | schema.TVSeriesOrSubClass | schema.HowToTipOrSubClass | schema.WebSiteOrSubClass | schema.EpisodeOrSubClass | schema.HyperTocOrSubClass | schema.ManuscriptOrSubClass | schema.ShortStoryOrSubClass | schema.TVSeasonOrSubClass | schema.DigitalDocumentOrSubClass | schema.CreativeWorkSeasonOrSubClass | schema.MediaObjectOrSubClass;
/**
 * schema:CreativeWork - Validation schema (w/ JOI)
 */
export declare const CreativeWorkJoiSchema: Joi.ObjectSchema;
/**
 * schema:CreativeWork - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CreativeWorkOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 *
 * ```ts
 * const maybeCreativeWork = CreativeWork.validate(req.body); // `req.body` will have type `any` or `unknown`
 ...
 * ```
 */
export declare function validateCreativeWork(maybeCreativeWork: unknown): CreativeWork | OaValidationError;
