 ...
 * etc.
 */
export declare type CreativeWorkOrSubClass = CreativeWork | oa.ConceptCollectionOrSubClass | schema.MediaReviewItemOrSubClass | schema.WebPageOrSubClass | schema.StatementOrSubClass | schema.ClipOrSubClass | schema.ManuscriptOrSubClass | schema.SheetMusicOrSubClass | schema.SeasonOrSubClass | schema.MessageOrSubClass | schema.AmpStoryOrSubClass | schema.ExercisePlanOrSubClass | schema.ThesisOrSubClass | schema.ShortStoryOrSubClass | schema.MathSolverOrSubClass | schema.SoftwareApplicationOrSubClass | schema.BlogOrSubClass | schema.MenuSectionOrSubClass | schema.MusicRecordingOrSubClass | schema.ComicStoryOrSubClass | schema.SoftwareSourceCodeOrSubClass | schema.WebPageElementOrSubClass | schema.PaintingOrSubClass | schema.MediaObjectOrSubClass | schema.DefinedTermSetOrSubClass | schema.HyperTocEntryOrSubClass | schema.TVSeriesOrSubClass | schema.DataCatalogOrSubClass | schema.HowToSectionOrSubClass | schema.ArchiveComponentOrSubClass | schema.EducationalOccupationalCredentialOrSubClass | schema.CollectionOrSubClass | schema.BookOrSubClass | schema.HyperTocOrSubClass | schema.MusicPlaylistOrSubClass | schema.CourseOrSubClass | schema.HowToOrSubClass | schema.HowToDirectionOrSubClass | schema.QuotationOrSubClass | schema.MovieOrSubClass | schema.LearningResourceOrSubClass | schema.MusicCompositionOrSubClass | schema.GameOrSubClass | schema.SculptureOrSubClass | schema.HowToTipOrSubClass | schema.TVSeasonOrSubClass | schema.WebContentOrSubClass | schema.PhotographOrSubClass | schema.LegislationOrSubClass | schema.EpisodeOrSubClass | schema.PublicationVolumeOrSubClass | schema.SpecialAnnouncementOrSubClass | schema.AtlasOrSubClass | schema.DrawingOrSubClass | schema.ClaimOrSubClass | schema.ChapterOrSubClass | schema.ArticleOrSubClass | schema.VisualArtworkOrSubClass | schema.GuideOrSubClass | schema.DigitalDocumentOrSubClass | schema.PosterOrSubClass | schema.ReviewOrSubClass | schema.WebSiteOrSubClass | schema.PublicationIssueOrSubClass | schema.CommentOrSubClass | schema.DietOrSubClass | schema.MenuOrSubClass | schema.DatasetOrSubClass | schema.ConversationOrSubClass | schema.CodeOrSubClass | schema.MapOrSubClass | schema.PlayOrSubClass | schema.HowToStepOrSubClass | schema.CreativeWorkSeriesOrSubClass | schema.CreativeWorkSeasonOrSubClass;
/**
