 ...
 * etc.
 */
export declare type CreativeWorkSeasonOrSubClass = CreativeWorkSeason | schema.RadioSeasonOrSubClass | schema.TVSeasonOrSubClass | schema.PodcastSeasonOrSubClass;
/**
