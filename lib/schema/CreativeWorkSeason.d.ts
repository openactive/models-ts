 ...
 * etc.
 */
export declare type CreativeWorkSeasonOrSubClass = CreativeWorkSeason | schema.TVSeasonOrSubClass | schema.PodcastSeasonOrSubClass | schema.RadioSeasonOrSubClass;
/**
 * schema:CreativeWorkSeason - Validation schema (w/ JOI)
 */
export declare const CreativeWorkSeasonJoiSchema: Joi.ObjectSchema;
/**
 * schema:CreativeWorkSeason - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CreativeWorkSeasonOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCreativeWorkSeason(maybeCreativeWorkSeason: unknown): CreativeWorkSeason | OaValidationError;
