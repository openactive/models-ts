...
exports.validateCreativeWorkSeason = exports.CreativeWorkSeasonOrSubClassJoiSchema = exports.CreativeWorkSeasonJoiSchema = void 0;
 ...
 */
exports.CreativeWorkSeasonJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.CreativeWorkSeasonOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CreativeWorkSeasonJoiSchema,
 ...
 * ```
 */
function validateCreativeWorkSeason(maybeCreativeWorkSeason) {
    const { value, error } = exports.CreativeWorkSeasonJoiSchema.validate(maybeCreativeWorkSeason);
    if (error) {
        return new oaValidationError_1.OaValidationError('CreativeWorkSeason', maybeCreativeWorkSeason, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateCreativeWorkSeason = validateCreativeWorkSeason;
