 ...
 * etc.
 */
export declare type CreativeWorkSeriesOrSubClass = CreativeWorkSeries | schema.PeriodicalOrSubClass | schema.RadioSeriesOrSubClass | schema.BookSeriesOrSubClass | schema.MovieSeriesOrSubClass | schema.PodcastSeriesOrSubClass | schema.VideoGameSeriesOrSubClass | schema.TVSeriesOrSubClass;
/**
 * schema:CreativeWorkSeries - Validation schema (w/ JOI)
 */
export declare const CreativeWorkSeriesJoiSchema: Joi.ObjectSchema;
/**
 * schema:CreativeWorkSeries - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CreativeWorkSeriesOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCreativeWorkSeries(maybeCreativeWorkSeries: unknown): CreativeWorkSeries | OaValidationError;
