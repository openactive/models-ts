...
exports.validateCreativeWorkSeries = exports.CreativeWorkSeriesOrSubClassJoiSchema = exports.CreativeWorkSeriesJoiSchema = void 0;
 ...
 */
exports.CreativeWorkSeriesJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.CreativeWorkSeriesOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CreativeWorkSeriesJoiSchema,
 ...
 * ```
 */
function validateCreativeWorkSeries(maybeCreativeWorkSeries) {
    const { value, error } = exports.CreativeWorkSeriesJoiSchema.validate(maybeCreativeWorkSeries);
    if (error) {
        return new oaValidationError_1.OaValidationError('CreativeWorkSeries', maybeCreativeWorkSeries, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateCreativeWorkSeries = validateCreativeWorkSeries;
