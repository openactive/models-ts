...
export declare type CreditCard = {
     ...
     */
    floorLimit?: schema.MonetaryAmountOrSubClass | string;
    /**
     * The minimum payment is the lowest amount of money that one is required to pay on a credit card statement each month.
     */
    monthlyMinimumRepaymentAmount?: schema.MonetaryAmountOrSubClass | number | string;
};
/**
 * schema:CreditCard
 *
 * This differs from CreditCard because it also allows for objects that have the type of a model that
 * sub-classes this model. e.g. `Event_OrSubClass` allows `Event`s as well as `ScheduledSession`s, `SessionSeries`,
 * etc.
 */
export declare type CreditCardOrSubClass = CreditCard;
/**
 * schema:CreditCard - Validation schema (w/ JOI)
 */
export declare const CreditCardJoiSchema: Joi.ObjectSchema;
/**
 * schema:CreditCard - Validation schema (w/ JOI)
 *
 * This differs from CreditCardJoiSchema because it also allows for objects that have the type of a model that
 * sub-classes this model. e.g. `Event.OrSubClassJoiSchema` allows `Event`s as well as `ScheduledSession`s,
 * `SessionSeries`, etc.
 */
export declare const CreditCardOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 * Runtime validator for schema:CreditCard.
 *
 * If some data has a structure which matches a schema:CreditCard, it will be returned with the correct type.
 ...
 * }
 * // From this point on, `maybeCreditCard` will have type `CreditCard`
 * const creditCard = maybeCreditCard;
 * ```
 */
export declare function validateCreditCard(maybeCreditCard: unknown): CreditCard | OaValidationError;
