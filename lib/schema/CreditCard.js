...
exports.validateCreditCard = exports.CreditCardOrSubClassJoiSchema = exports.CreditCardJoiSchema = void 0;
 ...
 */
exports.CreditCardJoiSchema = Joi.object({
    ...
    cashBack: Joi.alternatives().try(Joi.boolean(), Joi.number()),
 ...
 * `SessionSeries`, etc.
 */
exports.CreditCardOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CreditCardJoiSchema,
]);
/**
 ...
 * ```
 */
function validateCreditCard(maybeCreditCard) {
    const { value, error } = exports.CreditCardJoiSchema.validate(maybeCreditCard);
    if (error) {
        return new oaValidationError_1.OaValidationError('CreditCard', maybeCreditCard, error);
    }
