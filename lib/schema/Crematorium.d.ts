 ...
 * etc.
 */
export declare type CrematoriumOrSubClass = Crematorium;
/**
 * schema:Crematorium - Validation schema (w/ JOI)
 */
export declare const CrematoriumJoiSchema: Joi.ObjectSchema;
/**
 * schema:Crematorium - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CrematoriumOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCrematorium(maybeCrematorium: unknown): Crematorium | OaValidationError;
