...
exports.validateCrematorium = exports.CrematoriumOrSubClassJoiSchema = exports.CrematoriumJoiSchema = void 0;
 ...
 */
exports.CrematoriumJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.CrematoriumOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CrematoriumJoiSchema,
]);
/**
 ...
 * ```
 */
function validateCrematorium(maybeCrematorium) {
    const { value, error } = exports.CrematoriumJoiSchema.validate(maybeCrematorium);
    if (error) {
        return new oaValidationError_1.OaValidationError('Crematorium', maybeCrematorium, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateCrematorium = validateCrematorium;
