 ...
 * etc.
 */
export declare type CriticReviewOrSubClass = CriticReview | schema.ReviewNewsArticleOrSubClass;
/**
 * schema:CriticReview - Validation schema (w/ JOI)
 */
export declare const CriticReviewJoiSchema: Joi.ObjectSchema;
/**
 * schema:CriticReview - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CriticReviewOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCriticReview(maybeCriticReview: unknown): CriticReview | OaValidationError;
