...
exports.validateCriticReview = exports.CriticReviewOrSubClassJoiSchema = exports.CriticReviewJoiSchema = void 0;
 ...
 */
exports.CriticReviewJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.CriticReviewOrSubClassJoiSchema = Joi.alternatives().try([
    exports.CriticReviewJoiSchema,
 ...
 * ```
 */
function validateCriticReview(maybeCriticReview) {
    const { value, error } = exports.CriticReviewJoiSchema.validate(maybeCriticReview);
    if (error) {
        return new oaValidationError_1.OaValidationError('CriticReview', maybeCriticReview, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateCriticReview = validateCriticReview;
