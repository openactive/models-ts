 ...
 * etc.
 */
export declare type CurrencyConversionServiceOrSubClass = CurrencyConversionService;
/**
 * schema:CurrencyConversionService - Validation schema (w/ JOI)
 */
export declare const CurrencyConversionServiceJoiSchema: Joi.ObjectSchema;
/**
 * schema:CurrencyConversionService - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const CurrencyConversionServiceOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateCurrencyConversionService(maybeCurrencyConversionService: unknown): CurrencyConversionService | OaValidationError;
