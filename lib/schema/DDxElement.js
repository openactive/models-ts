...
exports.validateDDxElement = exports.DDxElementOrSubClassJoiSchema = exports.DDxElementJoiSchema = void 0;
 ...
 */
exports.DDxElementJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.DDxElementOrSubClassJoiSchema = Joi.alternatives().try([
    exports.DDxElementJoiSchema,
]);
/**
 ...
 * ```
 */
function validateDDxElement(maybeDDxElement) {
    const { value, error } = exports.DDxElementJoiSchema.validate(maybeDDxElement);
    if (error) {
        return new oaValidationError_1.OaValidationError('DDxElement', maybeDDxElement, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateDDxElement = validateDDxElement;
