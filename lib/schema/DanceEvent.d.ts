 ...
 * etc.
 */
export declare type DanceEventOrSubClass = DanceEvent;
/**
 * schema:DanceEvent - Validation schema (w/ JOI)
 */
export declare const DanceEventJoiSchema: Joi.ObjectSchema;
/**
 * schema:DanceEvent - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DanceEventOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDanceEvent(maybeDanceEvent: unknown): DanceEvent | OaValidationError;
