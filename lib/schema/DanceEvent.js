...
exports.validateDanceEvent = exports.DanceEventOrSubClassJoiSchema = exports.DanceEventJoiSchema = void 0;
 ...
 */
exports.DanceEventJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.DanceEventOrSubClassJoiSchema = Joi.alternatives().try([
    exports.DanceEventJoiSchema,
]);
/**
 ...
 * ```
 */
function validateDanceEvent(maybeDanceEvent) {
    const { value, error } = exports.DanceEventJoiSchema.validate(maybeDanceEvent);
    if (error) {
        return new oaValidationError_1.OaValidationError('DanceEvent', maybeDanceEvent, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateDanceEvent = validateDanceEvent;
