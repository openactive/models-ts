 ...
 * etc.
 */
export declare type DanceGroupOrSubClass = DanceGroup;
/**
 * schema:DanceGroup - Validation schema (w/ JOI)
 */
export declare const DanceGroupJoiSchema: Joi.ObjectSchema;
/**
 * schema:DanceGroup - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DanceGroupOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDanceGroup(maybeDanceGroup: unknown): DanceGroup | OaValidationError;
