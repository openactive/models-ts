...
exports.validateDanceGroup = exports.DanceGroupOrSubClassJoiSchema = exports.DanceGroupJoiSchema = void 0;
 ...
 */
exports.DanceGroupJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.DanceGroupOrSubClassJoiSchema = Joi.alternatives().try([
    exports.DanceGroupJoiSchema,
]);
/**
 ...
 * ```
 */
function validateDanceGroup(maybeDanceGroup) {
    const { value, error } = exports.DanceGroupJoiSchema.validate(maybeDanceGroup);
    if (error) {
        return new oaValidationError_1.OaValidationError('DanceGroup', maybeDanceGroup, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateDanceGroup = validateDanceGroup;
