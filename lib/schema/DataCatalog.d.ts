 ...
 * etc.
 */
export declare type DataCatalogOrSubClass = DataCatalog;
/**
 * schema:DataCatalog - Validation schema (w/ JOI)
 */
export declare const DataCatalogJoiSchema: Joi.ObjectSchema;
/**
 * schema:DataCatalog - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DataCatalogOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDataCatalog(maybeDataCatalog: unknown): DataCatalog | OaValidationError;
