...
exports.validateDataCatalog = exports.DataCatalogOrSubClassJoiSchema = exports.DataCatalogJoiSchema = void 0;
 ...
 */
exports.DataCatalogJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.DataCatalogOrSubClassJoiSchema = Joi.alternatives().try([
    exports.DataCatalogJoiSchema,
]);
/**
 ...
 * ```
 */
function validateDataCatalog(maybeDataCatalog) {
    const { value, error } = exports.DataCatalogJoiSchema.validate(maybeDataCatalog);
    if (error) {
        return new oaValidationError_1.OaValidationError('DataCatalog', maybeDataCatalog, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateDataCatalog = validateDataCatalog;
