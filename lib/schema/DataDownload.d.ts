 ...
 * etc.
 */
export declare type DataDownloadOrSubClass = DataDownload;
/**
 * schema:DataDownload - Validation schema (w/ JOI)
 */
export declare const DataDownloadJoiSchema: Joi.ObjectSchema;
/**
 * schema:DataDownload - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DataDownloadOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDataDownload(maybeDataDownload: unknown): DataDownload | OaValidationError;
