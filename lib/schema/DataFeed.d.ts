 ...
 * etc.
 */
export declare type DataFeedOrSubClass = DataFeed | schema.CompleteDataFeedOrSubClass;
/**
 * schema:DataFeed - Validation schema (w/ JOI)
 */
export declare const DataFeedJoiSchema: Joi.ObjectSchema;
/**
 * schema:DataFeed - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DataFeedOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDataFeed(maybeDataFeed: unknown): DataFeed | OaValidationError;
