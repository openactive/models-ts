...
exports.validateDataFeed = exports.DataFeedOrSubClassJoiSchema = exports.DataFeedJoiSchema = void 0;
 ...
 */
exports.DataFeedJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.DataFeedOrSubClassJoiSchema = Joi.alternatives().try([
    exports.DataFeedJoiSchema,
 ...
 * ```
 */
function validateDataFeed(maybeDataFeed) {
    const { value, error } = exports.DataFeedJoiSchema.validate(maybeDataFeed);
    if (error) {
        return new oaValidationError_1.OaValidationError('DataFeed', maybeDataFeed, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateDataFeed = validateDataFeed;
