...
exports.validateDataType = exports.DataTypeOrSubClassJoiSchema = exports.DataTypeJoiSchema = void 0;
 ...
 */
exports.DataTypeJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.DataTypeOrSubClassJoiSchema = Joi.alternatives().try([
    exports.DataTypeJoiSchema,
]);
/**
 ...
 * ```
 */
function validateDataType(maybeDataType) {
    const { value, error } = exports.DataTypeJoiSchema.validate(maybeDataType);
    if (error) {
        return new oaValidationError_1.OaValidationError('DataType', maybeDataType, error);
    }
