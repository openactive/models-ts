 ...
 * etc.
 */
export declare type DatasetOrSubClass = Dataset | schema.DataFeedOrSubClass;
/**
 * schema:Dataset - Validation schema (w/ JOI)
 */
export declare const DatasetJoiSchema: Joi.ObjectSchema;
/**
 * schema:Dataset - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DatasetOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDataset(maybeDataset: unknown): Dataset | OaValidationError;
