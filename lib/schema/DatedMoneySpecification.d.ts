 ...
 * etc.
 */
export declare type DatedMoneySpecificationOrSubClass = DatedMoneySpecification;
/**
 * schema:DatedMoneySpecification - Validation schema (w/ JOI)
 */
export declare const DatedMoneySpecificationJoiSchema: Joi.ObjectSchema;
/**
 * schema:DatedMoneySpecification - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DatedMoneySpecificationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDatedMoneySpecification(maybeDatedMoneySpecification: unknown): DatedMoneySpecification | OaValidationError;
