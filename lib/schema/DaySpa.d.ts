 ...
 * etc.
 */
export declare type DaySpaOrSubClass = DaySpa;
/**
 * schema:DaySpa - Validation schema (w/ JOI)
 */
export declare const DaySpaJoiSchema: Joi.ObjectSchema;
/**
 * schema:DaySpa - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DaySpaOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDaySpa(maybeDaySpa: unknown): DaySpa | OaValidationError;
