...
exports.validateDaySpa = exports.DaySpaOrSubClassJoiSchema = exports.DaySpaJoiSchema = void 0;
 ...
 */
exports.DaySpaJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.DaySpaOrSubClassJoiSchema = Joi.alternatives().try([
    exports.DaySpaJoiSchema,
]);
/**
 ...
 * ```
 */
function validateDaySpa(maybeDaySpa) {
    const { value, error } = exports.DaySpaJoiSchema.validate(maybeDaySpa);
    if (error) {
        return new oaValidationError_1.OaValidationError('DaySpa', maybeDaySpa, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateDaySpa = validateDaySpa;
