 ...
 * etc.
 */
export declare type DefenceEstablishmentOrSubClass = DefenceEstablishment;
/**
 * schema:DefenceEstablishment - Validation schema (w/ JOI)
 */
export declare const DefenceEstablishmentJoiSchema: Joi.ObjectSchema;
/**
 * schema:DefenceEstablishment - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DefenceEstablishmentOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDefenceEstablishment(maybeDefenceEstablishment: unknown): DefenceEstablishment | OaValidationError;
