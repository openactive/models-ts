...
exports.validateDefenceEstablishment = exports.DefenceEstablishmentOrSubClassJoiSchema = exports.DefenceEstablishmentJoiSchema = void 0;
 ...
 */
exports.DefenceEstablishmentJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.DefenceEstablishmentOrSubClassJoiSchema = Joi.alternatives().try([
    exports.DefenceEstablishmentJoiSchema,
]);
/**
 ...
 * ```
 */
function validateDefenceEstablishment(maybeDefenceEstablishment) {
    const { value, error } = exports.DefenceEstablishmentJoiSchema.validate(maybeDefenceEstablishment);
    if (error) {
        return new oaValidationError_1.OaValidationError('DefenceEstablishment', maybeDefenceEstablishment, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateDefenceEstablishment = validateDefenceEstablishment;
