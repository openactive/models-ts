 ...
 */
export declare type DefinedRegion = {
    '@type': 'DefinedRegion';
 ...
 * etc.
 */
export declare type DefinedRegionOrSubClass = DefinedRegion;
/**
 * schema:DefinedRegion - Validation schema (w/ JOI)
 */
export declare const DefinedRegionJoiSchema: Joi.ObjectSchema;
/**
 * schema:DefinedRegion - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DefinedRegionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDefinedRegion(maybeDefinedRegion: unknown): DefinedRegion | OaValidationError;
