 ...
 * etc.
 */
export declare type DefinedTermSetOrSubClass = DefinedTermSet | schema.CategoryCodeSetOrSubClass;
/**
 * schema:DefinedTermSet - Validation schema (w/ JOI)
 */
export declare const DefinedTermSetJoiSchema: Joi.ObjectSchema;
/**
 * schema:DefinedTermSet - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DefinedTermSetOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDefinedTermSet(maybeDefinedTermSet: unknown): DefinedTermSet | OaValidationError;
