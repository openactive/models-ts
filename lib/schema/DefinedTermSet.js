...
exports.validateDefinedTermSet = exports.DefinedTermSetOrSubClassJoiSchema = exports.DefinedTermSetJoiSchema = void 0;
 ...
 */
exports.DefinedTermSetJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.DefinedTermSetOrSubClassJoiSchema = Joi.alternatives().try([
    exports.DefinedTermSetJoiSchema,
 ...
 * ```
 */
function validateDefinedTermSet(maybeDefinedTermSet) {
    const { value, error } = exports.DefinedTermSetJoiSchema.validate(maybeDefinedTermSet);
    if (error) {
        return new oaValidationError_1.OaValidationError('DefinedTermSet', maybeDefinedTermSet, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateDefinedTermSet = validateDefinedTermSet;
