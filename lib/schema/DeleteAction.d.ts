 ...
 * etc.
 */
export declare type DeleteActionOrSubClass = DeleteAction;
/**
 * schema:DeleteAction - Validation schema (w/ JOI)
 */
export declare const DeleteActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:DeleteAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DeleteActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDeleteAction(maybeDeleteAction: unknown): DeleteAction | OaValidationError;
