 ...
 * etc.
 */
export declare type DeliveryEventOrSubClass = DeliveryEvent;
/**
 * schema:DeliveryEvent - Validation schema (w/ JOI)
 */
export declare const DeliveryEventJoiSchema: Joi.ObjectSchema;
/**
 * schema:DeliveryEvent - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DeliveryEventOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDeliveryEvent(maybeDeliveryEvent: unknown): DeliveryEvent | OaValidationError;
