 ...
 */
export declare type DeliveryTimeSettings = {
 ...
 * etc.
 */
export declare type DeliveryTimeSettingsOrSubClass = DeliveryTimeSettings;
/**
 * schema:DeliveryTimeSettings - Validation schema (w/ JOI)
 */
export declare const DeliveryTimeSettingsJoiSchema: Joi.ObjectSchema;
/**
 * schema:DeliveryTimeSettings - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DeliveryTimeSettingsOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDeliveryTimeSettings(maybeDeliveryTimeSettings: unknown): DeliveryTimeSettings | OaValidationError;
