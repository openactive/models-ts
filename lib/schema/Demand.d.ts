 ...
 * etc.
 */
export declare type DemandOrSubClass = Demand;
/**
 * schema:Demand - Validation schema (w/ JOI)
 */
export declare const DemandJoiSchema: Joi.ObjectSchema;
/**
 * schema:Demand - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DemandOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 *
 * ```ts
 * const maybeDemand = Demand.validate(req.body); // `req.body` will have type `any` or `unknown`
 ...
 * ```
 */
export declare function validateDemand(maybeDemand: unknown): Demand | OaValidationError;
