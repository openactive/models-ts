 ...
 * etc.
 */
export declare type DentistOrSubClass = Dentist;
/**
 * schema:Dentist - Validation schema (w/ JOI)
 */
export declare const DentistJoiSchema: Joi.ObjectSchema;
/**
 * schema:Dentist - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DentistOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDentist(maybeDentist: unknown): Dentist | OaValidationError;
