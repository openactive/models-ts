...
exports.validateDepartAction = exports.DepartActionOrSubClassJoiSchema = exports.DepartActionJoiSchema = void 0;
 ...
 */
exports.DepartActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.DepartActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.DepartActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateDepartAction(maybeDepartAction) {
    const { value, error } = exports.DepartActionJoiSchema.validate(maybeDepartAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('DepartAction', maybeDepartAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateDepartAction = validateDepartAction;
