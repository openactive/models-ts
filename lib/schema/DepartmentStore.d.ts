 ...
 * etc.
 */
export declare type DepartmentStoreOrSubClass = DepartmentStore;
/**
 * schema:DepartmentStore - Validation schema (w/ JOI)
 */
export declare const DepartmentStoreJoiSchema: Joi.ObjectSchema;
/**
 * schema:DepartmentStore - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DepartmentStoreOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDepartmentStore(maybeDepartmentStore: unknown): DepartmentStore | OaValidationError;
