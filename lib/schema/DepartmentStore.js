...
exports.validateDepartmentStore = exports.DepartmentStoreOrSubClassJoiSchema = exports.DepartmentStoreJoiSchema = void 0;
 ...
 */
exports.DepartmentStoreJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.DepartmentStoreOrSubClassJoiSchema = Joi.alternatives().try([
    exports.DepartmentStoreJoiSchema,
]);
/**
 ...
 * ```
 */
function validateDepartmentStore(maybeDepartmentStore) {
    const { value, error } = exports.DepartmentStoreJoiSchema.validate(maybeDepartmentStore);
    if (error) {
        return new oaValidationError_1.OaValidationError('DepartmentStore', maybeDepartmentStore, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateDepartmentStore = validateDepartmentStore;
