 ...
 * etc.
 */
export declare type DepositAccountOrSubClass = DepositAccount;
/**
 * schema:DepositAccount - Validation schema (w/ JOI)
 */
export declare const DepositAccountJoiSchema: Joi.ObjectSchema;
/**
 * schema:DepositAccount - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DepositAccountOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDepositAccount(maybeDepositAccount: unknown): DepositAccount | OaValidationError;
