...
exports.validateDepositAccount = exports.DepositAccountOrSubClassJoiSchema = exports.DepositAccountJoiSchema = void 0;
// This file was generated
const Joi = require("joi");
const oaValidationError_1 = require("../oaValidationError");
const schema = require("../schema");
/**
 * schema:DepositAccount - Validation schema (w/ JOI)
 */
exports.DepositAccountJoiSchema = Joi.object({
    '@type': Joi.string().valid('DepositAccount').required(),
 ...
 * schema:DepositAccount - Validation schema (w/ JOI)
 *
 * This differs from DepositAccountJoiSchema because it also allows for objects that have the type of a model that
 * sub-classes this model. e.g. `Event.OrSubClassJoiSchema` allows `Event`s as well as `ScheduledSession`s,
 * `SessionSeries`, etc.
 */
exports.DepositAccountOrSubClassJoiSchema = Joi.alternatives().try([
    exports.DepositAccountJoiSchema,
]);
/**
 * Runtime validator for schema:DepositAccount.
 *
 * If some data has a structure which matches a schema:DepositAccount, it will be returned with the correct type.
 ...
 * }
 * // From this point on, `maybeDepositAccount` will have type `DepositAccount`
 * const depositAccount = maybeDepositAccount;
 * ```
 */
function validateDepositAccount(maybeDepositAccount) {
    const { value, error } = exports.DepositAccountJoiSchema.validate(maybeDepositAccount);
    if (error) {
        return new oaValidationError_1.OaValidationError('DepositAccount', maybeDepositAccount, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateDepositAccount = validateDepositAccount;
