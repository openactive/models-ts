 ...
 * etc.
 */
export declare type DiagnosticProcedureOrSubClass = DiagnosticProcedure;
/**
 * schema:DiagnosticProcedure - Validation schema (w/ JOI)
 */
export declare const DiagnosticProcedureJoiSchema: Joi.ObjectSchema;
/**
 * schema:DiagnosticProcedure - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DiagnosticProcedureOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDiagnosticProcedure(maybeDiagnosticProcedure: unknown): DiagnosticProcedure | OaValidationError;
