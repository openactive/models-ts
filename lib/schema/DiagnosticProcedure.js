...
exports.validateDiagnosticProcedure = exports.DiagnosticProcedureOrSubClassJoiSchema = exports.DiagnosticProcedureJoiSchema = void 0;
 ...
 */
exports.DiagnosticProcedureJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.DiagnosticProcedureOrSubClassJoiSchema = Joi.alternatives().try([
    exports.DiagnosticProcedureJoiSchema,
]);
/**
 ...
 *
 * ```ts
 * const maybeDiagnosticProcedure = validateDiagnosticProcedure(req.body); // `req.body` will have type `any` or `unknown`
 ...
 * ```
 */
function validateDiagnosticProcedure(maybeDiagnosticProcedure) {
    const { value, error } = exports.DiagnosticProcedureJoiSchema.validate(maybeDiagnosticProcedure);
    if (error) {
        return new oaValidationError_1.OaValidationError('DiagnosticProcedure', maybeDiagnosticProcedure, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateDiagnosticProcedure = validateDiagnosticProcedure;
