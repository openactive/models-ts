 ...
 * etc.
 */
export declare type DietOrSubClass = Diet;
/**
 * schema:Diet - Validation schema (w/ JOI)
 */
export declare const DietJoiSchema: Joi.ObjectSchema;
/**
 * schema:Diet - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DietOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDiet(maybeDiet: unknown): Diet | OaValidationError;
