...
exports.validateDiet = exports.DietOrSubClassJoiSchema = exports.DietJoiSchema = void 0;
 ...
 */
exports.DietJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.DietOrSubClassJoiSchema = Joi.alternatives().try([
    exports.DietJoiSchema,
]);
/**
 ...
 * ```
 */
function validateDiet(maybeDiet) {
    const { value, error } = exports.DietJoiSchema.validate(maybeDiet);
    if (error) {
        return new oaValidationError_1.OaValidationError('Diet', maybeDiet, error);
    }
