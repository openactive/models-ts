 ...
 * etc.
 */
export declare type DietarySupplementOrSubClass = DietarySupplement;
/**
 * schema:DietarySupplement - Validation schema (w/ JOI)
 */
export declare const DietarySupplementJoiSchema: Joi.ObjectSchema;
/**
 * schema:DietarySupplement - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DietarySupplementOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDietarySupplement(maybeDietarySupplement: unknown): DietarySupplement | OaValidationError;
