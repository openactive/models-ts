 ...
 * etc.
 */
export declare type DigitalDocumentOrSubClass = DigitalDocument | oa.TermsOrSubClass | schema.SpreadsheetDigitalDocumentOrSubClass | schema.NoteDigitalDocumentOrSubClass | schema.TextDigitalDocumentOrSubClass | schema.PresentationDigitalDocumentOrSubClass;
/**
 * schema:DigitalDocument - Validation schema (w/ JOI)
 */
export declare const DigitalDocumentJoiSchema: Joi.ObjectSchema;
/**
 * schema:DigitalDocument - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DigitalDocumentOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDigitalDocument(maybeDigitalDocument: unknown): DigitalDocument | OaValidationError;
