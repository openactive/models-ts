...
exports.validateDigitalDocument = exports.DigitalDocumentOrSubClassJoiSchema = exports.DigitalDocumentJoiSchema = void 0;
 ...
 */
exports.DigitalDocumentJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.DigitalDocumentOrSubClassJoiSchema = Joi.alternatives().try([
    exports.DigitalDocumentJoiSchema,
 ...
 * ```
 */
function validateDigitalDocument(maybeDigitalDocument) {
    const { value, error } = exports.DigitalDocumentJoiSchema.validate(maybeDigitalDocument);
    if (error) {
        return new oaValidationError_1.OaValidationError('DigitalDocument', maybeDigitalDocument, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateDigitalDocument = validateDigitalDocument;
