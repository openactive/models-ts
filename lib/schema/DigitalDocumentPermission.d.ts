 ...
 * etc.
 */
export declare type DigitalDocumentPermissionOrSubClass = DigitalDocumentPermission;
/**
 * schema:DigitalDocumentPermission - Validation schema (w/ JOI)
 */
export declare const DigitalDocumentPermissionJoiSchema: Joi.ObjectSchema;
/**
 * schema:DigitalDocumentPermission - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DigitalDocumentPermissionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDigitalDocumentPermission(maybeDigitalDocumentPermission: unknown): DigitalDocumentPermission | OaValidationError;
