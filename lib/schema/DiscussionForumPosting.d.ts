 ...
 * etc.
 */
export declare type DiscussionForumPostingOrSubClass = DiscussionForumPosting;
/**
 * schema:DiscussionForumPosting - Validation schema (w/ JOI)
 */
export declare const DiscussionForumPostingJoiSchema: Joi.ObjectSchema;
/**
 * schema:DiscussionForumPosting - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DiscussionForumPostingOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDiscussionForumPosting(maybeDiscussionForumPosting: unknown): DiscussionForumPosting | OaValidationError;
