...
exports.validateDiscussionForumPosting = exports.DiscussionForumPostingOrSubClassJoiSchema = exports.DiscussionForumPostingJoiSchema = void 0;
 ...
 */
exports.DiscussionForumPostingJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.DiscussionForumPostingOrSubClassJoiSchema = Joi.alternatives().try([
    exports.DiscussionForumPostingJoiSchema,
]);
/**
 ...
 * ```
 */
function validateDiscussionForumPosting(maybeDiscussionForumPosting) {
    const { value, error } = exports.DiscussionForumPostingJoiSchema.validate(maybeDiscussionForumPosting);
    if (error) {
        return new oaValidationError_1.OaValidationError('DiscussionForumPosting', maybeDiscussionForumPosting, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateDiscussionForumPosting = validateDiscussionForumPosting;
