...
exports.validateDislikeAction = exports.DislikeActionOrSubClassJoiSchema = exports.DislikeActionJoiSchema = void 0;
 ...
 */
exports.DislikeActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.DislikeActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.DislikeActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateDislikeAction(maybeDislikeAction) {
    const { value, error } = exports.DislikeActionJoiSchema.validate(maybeDislikeAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('DislikeAction', maybeDislikeAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateDislikeAction = validateDislikeAction;
