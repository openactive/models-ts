 ...
 * etc.
 */
export declare type DistilleryOrSubClass = Distillery;
/**
 * schema:Distillery - Validation schema (w/ JOI)
 */
export declare const DistilleryJoiSchema: Joi.ObjectSchema;
/**
 * schema:Distillery - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DistilleryOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDistillery(maybeDistillery: unknown): Distillery | OaValidationError;
