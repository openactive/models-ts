...
exports.validateDonateAction = exports.DonateActionOrSubClassJoiSchema = exports.DonateActionJoiSchema = void 0;
 ...
 */
exports.DonateActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.DonateActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.DonateActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateDonateAction(maybeDonateAction) {
    const { value, error } = exports.DonateActionJoiSchema.validate(maybeDonateAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('DonateAction', maybeDonateAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateDonateAction = validateDonateAction;
