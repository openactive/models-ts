 ...
 * etc.
 */
export declare type DoseScheduleOrSubClass = DoseSchedule | schema.RecommendedDoseScheduleOrSubClass | schema.ReportedDoseScheduleOrSubClass | schema.MaximumDoseScheduleOrSubClass;
/**
