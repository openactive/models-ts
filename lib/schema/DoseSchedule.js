...
exports.validateDoseSchedule = exports.DoseScheduleOrSubClassJoiSchema = exports.DoseScheduleJoiSchema = void 0;
 ...
 */
exports.DoseScheduleJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.DoseScheduleOrSubClassJoiSchema = Joi.alternatives().try([
    exports.DoseScheduleJoiSchema,
 ...
 * ```
 */
function validateDoseSchedule(maybeDoseSchedule) {
    const { value, error } = exports.DoseScheduleJoiSchema.validate(maybeDoseSchedule);
    if (error) {
        return new oaValidationError_1.OaValidationError('DoseSchedule', maybeDoseSchedule, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateDoseSchedule = validateDoseSchedule;
