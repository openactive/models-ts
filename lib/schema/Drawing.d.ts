 ...
 * etc.
 */
export declare type DrawingOrSubClass = Drawing;
/**
 * schema:Drawing - Validation schema (w/ JOI)
 */
export declare const DrawingJoiSchema: Joi.ObjectSchema;
/**
 * schema:Drawing - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DrawingOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDrawing(maybeDrawing: unknown): Drawing | OaValidationError;
