...
exports.validateDrawing = exports.DrawingOrSubClassJoiSchema = exports.DrawingJoiSchema = void 0;
 ...
 */
exports.DrawingJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.DrawingOrSubClassJoiSchema = Joi.alternatives().try([
    exports.DrawingJoiSchema,
]);
/**
 ...
 * ```
 */
function validateDrawing(maybeDrawing) {
    const { value, error } = exports.DrawingJoiSchema.validate(maybeDrawing);
    if (error) {
        return new oaValidationError_1.OaValidationError('Drawing', maybeDrawing, error);
    }
