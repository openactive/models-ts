 ...
 * etc.
 */
export declare type DrinkActionOrSubClass = DrinkAction;
/**
 * schema:DrinkAction - Validation schema (w/ JOI)
 */
export declare const DrinkActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:DrinkAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DrinkActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDrinkAction(maybeDrinkAction: unknown): DrinkAction | OaValidationError;
