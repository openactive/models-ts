 ...
 * etc.
 */
export declare type DrugClassOrSubClass = DrugClass;
/**
 * schema:DrugClass - Validation schema (w/ JOI)
 */
export declare const DrugClassJoiSchema: Joi.ObjectSchema;
/**
 * schema:DrugClass - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DrugClassOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDrugClass(maybeDrugClass: unknown): DrugClass | OaValidationError;
