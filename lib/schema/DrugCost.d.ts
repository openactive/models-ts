 ...
 * etc.
 */
export declare type DrugCostOrSubClass = DrugCost;
/**
 * schema:DrugCost - Validation schema (w/ JOI)
 */
export declare const DrugCostJoiSchema: Joi.ObjectSchema;
/**
 * schema:DrugCost - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DrugCostOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDrugCost(maybeDrugCost: unknown): DrugCost | OaValidationError;
