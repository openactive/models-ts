...
exports.validateDrugCostCategory = exports.DrugCostCategoryOrSubClassJoiSchema = exports.DrugCostCategoryJoiSchema = void 0;
 ...
 */
exports.DrugCostCategoryJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.DrugCostCategoryOrSubClassJoiSchema = Joi.alternatives().try([
    exports.DrugCostCategoryJoiSchema,
]);
/**
 ...
 * ```
 */
function validateDrugCostCategory(maybeDrugCostCategory) {
    const { value, error } = exports.DrugCostCategoryJoiSchema.validate(maybeDrugCostCategory);
    if (error) {
        return new oaValidationError_1.OaValidationError('DrugCostCategory', maybeDrugCostCategory, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateDrugCostCategory = validateDrugCostCategory;
