 ...
 * etc.
 */
export declare type DrugLegalStatusOrSubClass = DrugLegalStatus;
/**
 * schema:DrugLegalStatus - Validation schema (w/ JOI)
 */
export declare const DrugLegalStatusJoiSchema: Joi.ObjectSchema;
/**
 * schema:DrugLegalStatus - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DrugLegalStatusOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDrugLegalStatus(maybeDrugLegalStatus: unknown): DrugLegalStatus | OaValidationError;
