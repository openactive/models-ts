 ...
 * etc.
 */
export declare type DryCleaningOrLaundryOrSubClass = DryCleaningOrLaundry;
/**
 * schema:DryCleaningOrLaundry - Validation schema (w/ JOI)
 */
export declare const DryCleaningOrLaundryJoiSchema: Joi.ObjectSchema;
/**
 * schema:DryCleaningOrLaundry - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const DryCleaningOrLaundryOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateDryCleaningOrLaundry(maybeDryCleaningOrLaundry: unknown): DryCleaningOrLaundry | OaValidationError;
