...
exports.validateDryCleaningOrLaundry = exports.DryCleaningOrLaundryOrSubClassJoiSchema = exports.DryCleaningOrLaundryJoiSchema = void 0;
 ...
 */
exports.DryCleaningOrLaundryJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.DryCleaningOrLaundryOrSubClassJoiSchema = Joi.alternatives().try([
    exports.DryCleaningOrLaundryJoiSchema,
]);
/**
 ...
 * ```
 */
function validateDryCleaningOrLaundry(maybeDryCleaningOrLaundry) {
    const { value, error } = exports.DryCleaningOrLaundryJoiSchema.validate(maybeDryCleaningOrLaundry);
    if (error) {
        return new oaValidationError_1.OaValidationError('DryCleaningOrLaundry', maybeDryCleaningOrLaundry, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateDryCleaningOrLaundry = validateDryCleaningOrLaundry;
