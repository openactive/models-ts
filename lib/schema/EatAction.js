...
exports.validateEatAction = exports.EatActionOrSubClassJoiSchema = exports.EatActionJoiSchema = void 0;
 ...
 */
exports.EatActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.EatActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.EatActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateEatAction(maybeEatAction) {
    const { value, error } = exports.EatActionJoiSchema.validate(maybeEatAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('EatAction', maybeEatAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateEatAction = validateEatAction;
