 ...
 * etc.
 */
export declare type EducationEventOrSubClass = EducationEvent;
/**
 * schema:EducationEvent - Validation schema (w/ JOI)
 */
export declare const EducationEventJoiSchema: Joi.ObjectSchema;
/**
 * schema:EducationEvent - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const EducationEventOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateEducationEvent(maybeEducationEvent: unknown): EducationEvent | OaValidationError;
