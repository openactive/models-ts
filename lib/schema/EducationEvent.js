...
exports.validateEducationEvent = exports.EducationEventOrSubClassJoiSchema = exports.EducationEventJoiSchema = void 0;
 ...
 */
exports.EducationEventJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.EducationEventOrSubClassJoiSchema = Joi.alternatives().try([
    exports.EducationEventJoiSchema,
]);
/**
 ...
 *
 * ```ts
 * const maybeEducationEvent = validateEducationEvent(req.body); // `req.body` will have type `any` or `unknown`
 ...
 * ```
 */
function validateEducationEvent(maybeEducationEvent) {
    const { value, error } = exports.EducationEventJoiSchema.validate(maybeEducationEvent);
    if (error) {
        return new oaValidationError_1.OaValidationError('EducationEvent', maybeEducationEvent, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateEducationEvent = validateEducationEvent;
