 ...
 * etc.
 */
export declare type EducationalAudienceOrSubClass = EducationalAudience;
/**
 * schema:EducationalAudience - Validation schema (w/ JOI)
 */
export declare const EducationalAudienceJoiSchema: Joi.ObjectSchema;
/**
 * schema:EducationalAudience - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const EducationalAudienceOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateEducationalAudience(maybeEducationalAudience: unknown): EducationalAudience | OaValidationError;
