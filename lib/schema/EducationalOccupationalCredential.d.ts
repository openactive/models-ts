 ...
 * etc.
 */
export declare type EducationalOccupationalCredentialOrSubClass = EducationalOccupationalCredential;
/**
 * schema:EducationalOccupationalCredential - Validation schema (w/ JOI)
 */
export declare const EducationalOccupationalCredentialJoiSchema: Joi.ObjectSchema;
/**
 * schema:EducationalOccupationalCredential - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const EducationalOccupationalCredentialOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateEducationalOccupationalCredential(maybeEducationalOccupationalCredential: unknown): EducationalOccupationalCredential | OaValidationError;
