...
exports.validateEducationalOccupationalCredential = exports.EducationalOccupationalCredentialOrSubClassJoiSchema = exports.EducationalOccupationalCredentialJoiSchema = void 0;
 ...
 */
exports.EducationalOccupationalCredentialJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.EducationalOccupationalCredentialOrSubClassJoiSchema = Joi.alternatives().try([
    exports.EducationalOccupationalCredentialJoiSchema,
]);
/**
 ...
 * ```
 */
function validateEducationalOccupationalCredential(maybeEducationalOccupationalCredential) {
    const { value, error } = exports.EducationalOccupationalCredentialJoiSchema.validate(maybeEducationalOccupationalCredential);
    if (error) {
        return new oaValidationError_1.OaValidationError('EducationalOccupationalCredential', maybeEducationalOccupationalCredential, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateEducationalOccupationalCredential = validateEducationalOccupationalCredential;
