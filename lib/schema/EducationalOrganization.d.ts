 ...
 * etc.
 */
export declare type EducationalOrganizationOrSubClass = EducationalOrganization | schema.CollegeOrUniversityOrSubClass | schema.SchoolOrSubClass | schema.HighSchoolOrSubClass | schema.ElementarySchoolOrSubClass | schema.PreschoolOrSubClass | schema.MiddleSchoolOrSubClass;
/**
 * schema:EducationalOrganization - Validation schema (w/ JOI)
 */
export declare const EducationalOrganizationJoiSchema: Joi.ObjectSchema;
/**
 * schema:EducationalOrganization - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const EducationalOrganizationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateEducationalOrganization(maybeEducationalOrganization: unknown): EducationalOrganization | OaValidationError;
