 ...
 * etc.
 */
export declare type EducationalOrganizationOrSubClass = EducationalOrganization | schema.SchoolOrSubClass | schema.MiddleSchoolOrSubClass | schema.PreschoolOrSubClass | schema.CollegeOrUniversityOrSubClass | schema.HighSchoolOrSubClass | schema.ElementarySchoolOrSubClass;
/**
