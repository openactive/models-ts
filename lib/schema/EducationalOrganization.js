...
exports.validateEducationalOrganization = exports.EducationalOrganizationOrSubClassJoiSchema = exports.EducationalOrganizationJoiSchema = void 0;
 ...
 */
exports.EducationalOrganizationJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.EducationalOrganizationOrSubClassJoiSchema = Joi.alternatives().try([
    exports.EducationalOrganizationJoiSchema,
 ...
 * ```
 */
function validateEducationalOrganization(maybeEducationalOrganization) {
    const { value, error } = exports.EducationalOrganizationJoiSchema.validate(maybeEducationalOrganization);
    if (error) {
        return new oaValidationError_1.OaValidationError('EducationalOrganization', maybeEducationalOrganization, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateEducationalOrganization = validateEducationalOrganization;
