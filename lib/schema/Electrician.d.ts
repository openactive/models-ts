 ...
 * etc.
 */
export declare type ElectricianOrSubClass = Electrician;
/**
 * schema:Electrician - Validation schema (w/ JOI)
 */
export declare const ElectricianJoiSchema: Joi.ObjectSchema;
/**
 * schema:Electrician - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ElectricianOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateElectrician(maybeElectrician: unknown): Electrician | OaValidationError;
