...
exports.validateElectrician = exports.ElectricianOrSubClassJoiSchema = exports.ElectricianJoiSchema = void 0;
 ...
 */
exports.ElectricianJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ElectricianOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ElectricianJoiSchema,
]);
/**
 ...
 * ```
 */
function validateElectrician(maybeElectrician) {
    const { value, error } = exports.ElectricianJoiSchema.validate(maybeElectrician);
    if (error) {
        return new oaValidationError_1.OaValidationError('Electrician', maybeElectrician, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateElectrician = validateElectrician;
