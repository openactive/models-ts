 ...
 * etc.
 */
export declare type ElectronicsStoreOrSubClass = ElectronicsStore;
/**
 * schema:ElectronicsStore - Validation schema (w/ JOI)
 */
export declare const ElectronicsStoreJoiSchema: Joi.ObjectSchema;
/**
 * schema:ElectronicsStore - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ElectronicsStoreOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateElectronicsStore(maybeElectronicsStore: unknown): ElectronicsStore | OaValidationError;
