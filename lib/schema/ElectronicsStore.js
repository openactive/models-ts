...
exports.validateElectronicsStore = exports.ElectronicsStoreOrSubClassJoiSchema = exports.ElectronicsStoreJoiSchema = void 0;
 ...
 */
exports.ElectronicsStoreJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ElectronicsStoreOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ElectronicsStoreJoiSchema,
]);
/**
 ...
 * ```
 */
function validateElectronicsStore(maybeElectronicsStore) {
    const { value, error } = exports.ElectronicsStoreJoiSchema.validate(maybeElectronicsStore);
    if (error) {
        return new oaValidationError_1.OaValidationError('ElectronicsStore', maybeElectronicsStore, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateElectronicsStore = validateElectronicsStore;
