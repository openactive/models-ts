 ...
 * etc.
 */
export declare type ElementarySchoolOrSubClass = ElementarySchool;
/**
 * schema:ElementarySchool - Validation schema (w/ JOI)
 */
export declare const ElementarySchoolJoiSchema: Joi.ObjectSchema;
/**
 * schema:ElementarySchool - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ElementarySchoolOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateElementarySchool(maybeElementarySchool: unknown): ElementarySchool | OaValidationError;
