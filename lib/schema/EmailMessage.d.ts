 ...
 * etc.
 */
export declare type EmailMessageOrSubClass = EmailMessage;
/**
 * schema:EmailMessage - Validation schema (w/ JOI)
 */
export declare const EmailMessageJoiSchema: Joi.ObjectSchema;
/**
 * schema:EmailMessage - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const EmailMessageOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateEmailMessage(maybeEmailMessage: unknown): EmailMessage | OaValidationError;
