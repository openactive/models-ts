...
exports.validateEmailMessage = exports.EmailMessageOrSubClassJoiSchema = exports.EmailMessageJoiSchema = void 0;
 ...
 */
exports.EmailMessageJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.EmailMessageOrSubClassJoiSchema = Joi.alternatives().try([
    exports.EmailMessageJoiSchema,
]);
/**
 ...
 * ```
 */
function validateEmailMessage(maybeEmailMessage) {
    const { value, error } = exports.EmailMessageJoiSchema.validate(maybeEmailMessage);
    if (error) {
        return new oaValidationError_1.OaValidationError('EmailMessage', maybeEmailMessage, error);
    }
