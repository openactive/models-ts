 ...
 * etc.
 */
export declare type EmbassyOrSubClass = Embassy;
/**
 * schema:Embassy - Validation schema (w/ JOI)
 */
export declare const EmbassyJoiSchema: Joi.ObjectSchema;
/**
 * schema:Embassy - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const EmbassyOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateEmbassy(maybeEmbassy: unknown): Embassy | OaValidationError;
