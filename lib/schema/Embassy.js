...
exports.validateEmbassy = exports.EmbassyOrSubClassJoiSchema = exports.EmbassyJoiSchema = void 0;
 ...
 */
exports.EmbassyJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.EmbassyOrSubClassJoiSchema = Joi.alternatives().try([
    exports.EmbassyJoiSchema,
]);
/**
 ...
 * ```
 */
function validateEmbassy(maybeEmbassy) {
    const { value, error } = exports.EmbassyJoiSchema.validate(maybeEmbassy);
    if (error) {
        return new oaValidationError_1.OaValidationError('Embassy', maybeEmbassy, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateEmbassy = validateEmbassy;
