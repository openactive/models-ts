 ...
 * etc.
 */
export declare type EmergencyServiceOrSubClass = EmergencyService | schema.HospitalOrSubClass | schema.PoliceStationOrSubClass | schema.FireStationOrSubClass;
/**
 * schema:EmergencyService - Validation schema (w/ JOI)
 */
export declare const EmergencyServiceJoiSchema: Joi.ObjectSchema;
/**
 * schema:EmergencyService - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const EmergencyServiceOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateEmergencyService(maybeEmergencyService: unknown): EmergencyService | OaValidationError;
