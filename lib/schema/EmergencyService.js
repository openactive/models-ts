...
exports.validateEmergencyService = exports.EmergencyServiceOrSubClassJoiSchema = exports.EmergencyServiceJoiSchema = void 0;
 ...
 */
exports.EmergencyServiceJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.EmergencyServiceOrSubClassJoiSchema = Joi.alternatives().try([
    exports.EmergencyServiceJoiSchema,
 ...
 * ```
 */
function validateEmergencyService(maybeEmergencyService) {
    const { value, error } = exports.EmergencyServiceJoiSchema.validate(maybeEmergencyService);
    if (error) {
        return new oaValidationError_1.OaValidationError('EmergencyService', maybeEmergencyService, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateEmergencyService = validateEmergencyService;
