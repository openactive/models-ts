 ...
 * etc.
 */
export declare type EmployerAggregateRatingOrSubClass = EmployerAggregateRating;
/**
 * schema:EmployerAggregateRating - Validation schema (w/ JOI)
 */
export declare const EmployerAggregateRatingJoiSchema: Joi.ObjectSchema;
/**
 * schema:EmployerAggregateRating - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const EmployerAggregateRatingOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateEmployerAggregateRating(maybeEmployerAggregateRating: unknown): EmployerAggregateRating | OaValidationError;
