 ...
 * etc.
 */
export declare type EmployerReviewOrSubClass = EmployerReview;
/**
 * schema:EmployerReview - Validation schema (w/ JOI)
 */
export declare const EmployerReviewJoiSchema: Joi.ObjectSchema;
/**
 * schema:EmployerReview - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const EmployerReviewOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateEmployerReview(maybeEmployerReview: unknown): EmployerReview | OaValidationError;
