...
exports.validateEmployerReview = exports.EmployerReviewOrSubClassJoiSchema = exports.EmployerReviewJoiSchema = void 0;
 ...
 */
exports.EmployerReviewJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.EmployerReviewOrSubClassJoiSchema = Joi.alternatives().try([
    exports.EmployerReviewJoiSchema,
]);
/**
 ...
 * ```
 */
function validateEmployerReview(maybeEmployerReview) {
    const { value, error } = exports.EmployerReviewJoiSchema.validate(maybeEmployerReview);
    if (error) {
        return new oaValidationError_1.OaValidationError('EmployerReview', maybeEmployerReview, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateEmployerReview = validateEmployerReview;
