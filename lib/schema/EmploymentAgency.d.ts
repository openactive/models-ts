 ...
 * etc.
 */
export declare type EmploymentAgencyOrSubClass = EmploymentAgency;
/**
 * schema:EmploymentAgency - Validation schema (w/ JOI)
 */
export declare const EmploymentAgencyJoiSchema: Joi.ObjectSchema;
/**
 * schema:EmploymentAgency - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const EmploymentAgencyOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateEmploymentAgency(maybeEmploymentAgency: unknown): EmploymentAgency | OaValidationError;
