...
exports.validateEmploymentAgency = exports.EmploymentAgencyOrSubClassJoiSchema = exports.EmploymentAgencyJoiSchema = void 0;
 ...
 */
exports.EmploymentAgencyJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.EmploymentAgencyOrSubClassJoiSchema = Joi.alternatives().try([
    exports.EmploymentAgencyJoiSchema,
]);
/**
 ...
 * ```
 */
function validateEmploymentAgency(maybeEmploymentAgency) {
    const { value, error } = exports.EmploymentAgencyJoiSchema.validate(maybeEmploymentAgency);
    if (error) {
        return new oaValidationError_1.OaValidationError('EmploymentAgency', maybeEmploymentAgency, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateEmploymentAgency = validateEmploymentAgency;
