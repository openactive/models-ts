 ...
 * etc.
 */
export declare type EnergyOrSubClass = Energy;
/**
 * schema:Energy - Validation schema (w/ JOI)
 */
export declare const EnergyJoiSchema: Joi.ObjectSchema;
/**
 * schema:Energy - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const EnergyOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateEnergy(maybeEnergy: unknown): Energy | OaValidationError;
