...
exports.validateEnergyConsumptionDetails = exports.EnergyConsumptionDetailsOrSubClassJoiSchema = exports.EnergyConsumptionDetailsJoiSchema = void 0;
 ...
 */
exports.EnergyConsumptionDetailsJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.EnergyConsumptionDetailsOrSubClassJoiSchema = Joi.alternatives().try([
    exports.EnergyConsumptionDetailsJoiSchema,
]);
/**
 ...
 * ```
 */
function validateEnergyConsumptionDetails(maybeEnergyConsumptionDetails) {
    const { value, error } = exports.EnergyConsumptionDetailsJoiSchema.validate(maybeEnergyConsumptionDetails);
    if (error) {
        return new oaValidationError_1.OaValidationError('EnergyConsumptionDetails', maybeEnergyConsumptionDetails, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateEnergyConsumptionDetails = validateEnergyConsumptionDetails;
