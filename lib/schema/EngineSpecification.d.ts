...
export declare type EngineSpecification = {
     ...
     */
    engineType?: schema.QualitativeValue | string;
    /**
 ...
 * etc.
 */
export declare type EngineSpecificationOrSubClass = EngineSpecification;
/**
 * schema:EngineSpecification - Validation schema (w/ JOI)
 */
export declare const EngineSpecificationJoiSchema: Joi.ObjectSchema;
/**
 * schema:EngineSpecification - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const EngineSpecificationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateEngineSpecification(maybeEngineSpecification: unknown): EngineSpecification | OaValidationError;
