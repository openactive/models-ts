 ...
 * etc.
 */
export declare type EntertainmentBusinessOrSubClass = EntertainmentBusiness | schema.ComedyClubOrSubClass | schema.NightClubOrSubClass | schema.AmusementParkOrSubClass | schema.AdultEntertainmentOrSubClass | schema.ArtGalleryOrSubClass | schema.MovieTheaterOrSubClass | schema.CasinoOrSubClass;
/**
