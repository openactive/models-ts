 ...
 * etc.
 */
export declare type EntertainmentBusinessOrSubClass = EntertainmentBusiness | schema.MovieTheaterOrSubClass | schema.ArtGalleryOrSubClass | schema.AmusementParkOrSubClass | schema.AdultEntertainmentOrSubClass | schema.ComedyClubOrSubClass | schema.CasinoOrSubClass | schema.NightClubOrSubClass;
/**
 * schema:EntertainmentBusiness - Validation schema (w/ JOI)
 */
export declare const EntertainmentBusinessJoiSchema: Joi.ObjectSchema;
/**
 * schema:EntertainmentBusiness - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const EntertainmentBusinessOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateEntertainmentBusiness(maybeEntertainmentBusiness: unknown): EntertainmentBusiness | OaValidationError;
