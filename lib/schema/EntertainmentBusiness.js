...
exports.validateEntertainmentBusiness = exports.EntertainmentBusinessOrSubClassJoiSchema = exports.EntertainmentBusinessJoiSchema = void 0;
 ...
 */
exports.EntertainmentBusinessJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.EntertainmentBusinessOrSubClassJoiSchema = Joi.alternatives().try([
    exports.EntertainmentBusinessJoiSchema,
 ...
 * ```
 */
function validateEntertainmentBusiness(maybeEntertainmentBusiness) {
    const { value, error } = exports.EntertainmentBusinessJoiSchema.validate(maybeEntertainmentBusiness);
    if (error) {
        return new oaValidationError_1.OaValidationError('EntertainmentBusiness', maybeEntertainmentBusiness, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateEntertainmentBusiness = validateEntertainmentBusiness;
