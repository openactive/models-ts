 ...
 * etc.
 */
export declare type EpisodeOrSubClass = Episode | schema.PodcastEpisodeOrSubClass | schema.RadioEpisodeOrSubClass | schema.TVEpisodeOrSubClass;
/**
 * schema:Episode - Validation schema (w/ JOI)
 */
export declare const EpisodeJoiSchema: Joi.ObjectSchema;
/**
 * schema:Episode - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const EpisodeOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateEpisode(maybeEpisode: unknown): Episode | OaValidationError;
