 ...
 * etc.
 */
export declare type Event_OrSubClass = Event_ | schema.SaleEventOrSubClass | schema.FestivalOrSubClass | schema.MusicEventOrSubClass | schema.ExhibitionEventOrSubClass | schema.HackathonOrSubClass | schema.ComedyEventOrSubClass | schema.EventSeriesOrSubClass | schema.ChildrensEventOrSubClass | schema.UserInteractionOrSubClass | schema.PublicationEventOrSubClass | schema.CourseInstanceOrSubClass | schema.ScreeningEventOrSubClass | schema.DeliveryEventOrSubClass | schema.LiteraryEventOrSubClass | schema.SportsEventOrSubClass | schema.BusinessEventOrSubClass | schema.VisualArtsEventOrSubClass | schema.SocialEventOrSubClass | schema.TheaterEventOrSubClass | schema.DanceEventOrSubClass | schema.EducationEventOrSubClass | schema.FoodEventOrSubClass;
/**
