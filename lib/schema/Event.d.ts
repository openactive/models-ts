 ...
 * etc.
 */
export declare type Event_OrSubClass = Event_ | schema.DanceEventOrSubClass | schema.ScreeningEventOrSubClass | schema.ExhibitionEventOrSubClass | schema.MusicEventOrSubClass | schema.PublicationEventOrSubClass | schema.TheaterEventOrSubClass | schema.ChildrensEventOrSubClass | schema.VisualArtsEventOrSubClass | schema.HackathonOrSubClass | schema.UserInteractionOrSubClass | schema.EventSeriesOrSubClass | schema.FoodEventOrSubClass | schema.SaleEventOrSubClass | schema.LiteraryEventOrSubClass | schema.FestivalOrSubClass | schema.CourseInstanceOrSubClass | schema.EducationEventOrSubClass | schema.SocialEventOrSubClass | schema.BusinessEventOrSubClass | schema.DeliveryEventOrSubClass | schema.SportsEventOrSubClass | schema.ComedyEventOrSubClass;
/**
 * schema:Event - Validation schema (w/ JOI)
 */
export declare const Event_JoiSchema: Joi.ObjectSchema;
/**
 * schema:Event - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const Event_OrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateEvent_(maybeEvent_: unknown): Event_ | OaValidationError;
