 ...
 * etc.
 */
export declare type EventSeriesOrSubClass = EventSeries;
/**
 * schema:EventSeries - Validation schema (w/ JOI)
 */
export declare const EventSeriesJoiSchema: Joi.ObjectSchema;
/**
 * schema:EventSeries - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const EventSeriesOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateEventSeries(maybeEventSeries: unknown): EventSeries | OaValidationError;
