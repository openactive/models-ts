...
exports.validateEventSeries = exports.EventSeriesOrSubClassJoiSchema = exports.EventSeriesJoiSchema = void 0;
 ...
 */
exports.EventSeriesJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.EventSeriesOrSubClassJoiSchema = Joi.alternatives().try([
    exports.EventSeriesJoiSchema,
]);
/**
 ...
 * ```
 */
function validateEventSeries(maybeEventSeries) {
    const { value, error } = exports.EventSeriesJoiSchema.validate(maybeEventSeries);
    if (error) {
        return new oaValidationError_1.OaValidationError('EventSeries', maybeEventSeries, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateEventSeries = validateEventSeries;
