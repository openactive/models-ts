 ...
 * etc.
 */
export declare type EventVenueOrSubClass = EventVenue;
/**
 * schema:EventVenue - Validation schema (w/ JOI)
 */
export declare const EventVenueJoiSchema: Joi.ObjectSchema;
/**
 * schema:EventVenue - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const EventVenueOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateEventVenue(maybeEventVenue: unknown): EventVenue | OaValidationError;
