...
exports.validateEventVenue = exports.EventVenueOrSubClassJoiSchema = exports.EventVenueJoiSchema = void 0;
 ...
 */
exports.EventVenueJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.EventVenueOrSubClassJoiSchema = Joi.alternatives().try([
    exports.EventVenueJoiSchema,
]);
/**
 ...
 * ```
 */
function validateEventVenue(maybeEventVenue) {
    const { value, error } = exports.EventVenueJoiSchema.validate(maybeEventVenue);
    if (error) {
        return new oaValidationError_1.OaValidationError('EventVenue', maybeEventVenue, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateEventVenue = validateEventVenue;
