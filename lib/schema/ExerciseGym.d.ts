 ...
 * etc.
 */
export declare type ExerciseGymOrSubClass = ExerciseGym;
/**
 * schema:ExerciseGym - Validation schema (w/ JOI)
 */
export declare const ExerciseGymJoiSchema: Joi.ObjectSchema;
/**
 * schema:ExerciseGym - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ExerciseGymOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateExerciseGym(maybeExerciseGym: unknown): ExerciseGym | OaValidationError;
