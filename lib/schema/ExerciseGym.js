...
exports.validateExerciseGym = exports.ExerciseGymOrSubClassJoiSchema = exports.ExerciseGymJoiSchema = void 0;
 ...
 */
exports.ExerciseGymJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ExerciseGymOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ExerciseGymJoiSchema,
]);
/**
 ...
 * ```
 */
function validateExerciseGym(maybeExerciseGym) {
    const { value, error } = exports.ExerciseGymJoiSchema.validate(maybeExerciseGym);
    if (error) {
        return new oaValidationError_1.OaValidationError('ExerciseGym', maybeExerciseGym, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateExerciseGym = validateExerciseGym;
