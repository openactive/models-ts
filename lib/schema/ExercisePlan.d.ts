 ...
 * etc.
 */
export declare type ExercisePlanOrSubClass = ExercisePlan;
/**
 * schema:ExercisePlan - Validation schema (w/ JOI)
 */
export declare const ExercisePlanJoiSchema: Joi.ObjectSchema;
/**
 * schema:ExercisePlan - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ExercisePlanOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateExercisePlan(maybeExercisePlan: unknown): ExercisePlan | OaValidationError;
