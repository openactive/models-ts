...
exports.validateExercisePlan = exports.ExercisePlanOrSubClassJoiSchema = exports.ExercisePlanJoiSchema = void 0;
 ...
 */
exports.ExercisePlanJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ExercisePlanOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ExercisePlanJoiSchema,
]);
/**
 ...
 * ```
 */
function validateExercisePlan(maybeExercisePlan) {
    const { value, error } = exports.ExercisePlanJoiSchema.validate(maybeExercisePlan);
    if (error) {
        return new oaValidationError_1.OaValidationError('ExercisePlan', maybeExercisePlan, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateExercisePlan = validateExercisePlan;
