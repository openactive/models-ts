 ...
 * etc.
 */
export declare type ExhibitionEventOrSubClass = ExhibitionEvent;
/**
 * schema:ExhibitionEvent - Validation schema (w/ JOI)
 */
export declare const ExhibitionEventJoiSchema: Joi.ObjectSchema;
/**
 * schema:ExhibitionEvent - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ExhibitionEventOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateExhibitionEvent(maybeExhibitionEvent: unknown): ExhibitionEvent | OaValidationError;
