...
exports.validateExhibitionEvent = exports.ExhibitionEventOrSubClassJoiSchema = exports.ExhibitionEventJoiSchema = void 0;
 ...
 */
exports.ExhibitionEventJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ExhibitionEventOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ExhibitionEventJoiSchema,
]);
/**
 ...
 * ```
 */
function validateExhibitionEvent(maybeExhibitionEvent) {
    const { value, error } = exports.ExhibitionEventJoiSchema.validate(maybeExhibitionEvent);
    if (error) {
        return new oaValidationError_1.OaValidationError('ExhibitionEvent', maybeExhibitionEvent, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateExhibitionEvent = validateExhibitionEvent;
