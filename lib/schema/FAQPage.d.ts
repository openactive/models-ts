 ...
 * etc.
 */
export declare type FAQPageOrSubClass = FAQPage;
/**
 * schema:FAQPage - Validation schema (w/ JOI)
 */
export declare const FAQPageJoiSchema: Joi.ObjectSchema;
/**
 * schema:FAQPage - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const FAQPageOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateFAQPage(maybeFAQPage: unknown): FAQPage | OaValidationError;
