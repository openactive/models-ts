...
exports.validateFAQPage = exports.FAQPageOrSubClassJoiSchema = exports.FAQPageJoiSchema = void 0;
 ...
 */
exports.FAQPageJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.FAQPageOrSubClassJoiSchema = Joi.alternatives().try([
    exports.FAQPageJoiSchema,
]);
/**
 ...
 * ```
 */
function validateFAQPage(maybeFAQPage) {
    const { value, error } = exports.FAQPageJoiSchema.validate(maybeFAQPage);
    if (error) {
        return new oaValidationError_1.OaValidationError('FAQPage', maybeFAQPage, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateFAQPage = validateFAQPage;
