 ...
 * etc.
 */
export declare type FMRadioChannelOrSubClass = FMRadioChannel;
/**
 * schema:FMRadioChannel - Validation schema (w/ JOI)
 */
export declare const FMRadioChannelJoiSchema: Joi.ObjectSchema;
/**
 * schema:FMRadioChannel - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const FMRadioChannelOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateFMRadioChannel(maybeFMRadioChannel: unknown): FMRadioChannel | OaValidationError;
