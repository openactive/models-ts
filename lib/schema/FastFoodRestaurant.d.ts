 ...
 * etc.
 */
export declare type FastFoodRestaurantOrSubClass = FastFoodRestaurant;
/**
 * schema:FastFoodRestaurant - Validation schema (w/ JOI)
 */
export declare const FastFoodRestaurantJoiSchema: Joi.ObjectSchema;
/**
 * schema:FastFoodRestaurant - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const FastFoodRestaurantOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateFastFoodRestaurant(maybeFastFoodRestaurant: unknown): FastFoodRestaurant | OaValidationError;
