...
exports.validateFastFoodRestaurant = exports.FastFoodRestaurantOrSubClassJoiSchema = exports.FastFoodRestaurantJoiSchema = void 0;
 ...
 */
exports.FastFoodRestaurantJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.FastFoodRestaurantOrSubClassJoiSchema = Joi.alternatives().try([
    exports.FastFoodRestaurantJoiSchema,
]);
/**
 ...
 * ```
 */
function validateFastFoodRestaurant(maybeFastFoodRestaurant) {
    const { value, error } = exports.FastFoodRestaurantJoiSchema.validate(maybeFastFoodRestaurant);
    if (error) {
        return new oaValidationError_1.OaValidationError('FastFoodRestaurant', maybeFastFoodRestaurant, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateFastFoodRestaurant = validateFastFoodRestaurant;
