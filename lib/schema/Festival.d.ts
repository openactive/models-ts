 ...
 * etc.
 */
export declare type FestivalOrSubClass = Festival;
/**
 * schema:Festival - Validation schema (w/ JOI)
 */
export declare const FestivalJoiSchema: Joi.ObjectSchema;
/**
 * schema:Festival - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const FestivalOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateFestival(maybeFestival: unknown): Festival | OaValidationError;
