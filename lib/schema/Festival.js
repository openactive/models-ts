...
exports.validateFestival = exports.FestivalOrSubClassJoiSchema = exports.FestivalJoiSchema = void 0;
 ...
 */
exports.FestivalJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.FestivalOrSubClassJoiSchema = Joi.alternatives().try([
    exports.FestivalJoiSchema,
]);
/**
 ...
 * ```
 */
function validateFestival(maybeFestival) {
    const { value, error } = exports.FestivalJoiSchema.validate(maybeFestival);
    if (error) {
        return new oaValidationError_1.OaValidationError('Festival', maybeFestival, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateFestival = validateFestival;
