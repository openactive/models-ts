 ...
 * etc.
 */
export declare type FinancialProductOrSubClass = FinancialProduct | schema.PaymentCardOrSubClass | schema.CurrencyConversionServiceOrSubClass | schema.PaymentServiceOrSubClass | schema.BankAccountOrSubClass | schema.LoanOrCreditOrSubClass | schema.InvestmentOrDepositOrSubClass;
/**
 * schema:FinancialProduct - Validation schema (w/ JOI)
 */
export declare const FinancialProductJoiSchema: Joi.ObjectSchema;
/**
 * schema:FinancialProduct - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const FinancialProductOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateFinancialProduct(maybeFinancialProduct: unknown): FinancialProduct | OaValidationError;
