 ...
 * etc.
 */
export declare type FinancialProductOrSubClass = FinancialProduct | schema.BankAccountOrSubClass | schema.CurrencyConversionServiceOrSubClass | schema.InvestmentOrDepositOrSubClass | schema.LoanOrCreditOrSubClass | schema.PaymentCardOrSubClass | schema.PaymentServiceOrSubClass;
/**
