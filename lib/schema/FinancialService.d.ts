 ...
 * etc.
 */
export declare type FinancialServiceOrSubClass = FinancialService | schema.BankOrCreditUnionOrSubClass | schema.AutomatedTellerOrSubClass | schema.AccountingServiceOrSubClass | schema.InsuranceAgencyOrSubClass;
/**
