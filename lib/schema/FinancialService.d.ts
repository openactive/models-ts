 ...
 * etc.
 */
export declare type FinancialServiceOrSubClass = FinancialService | schema.AutomatedTellerOrSubClass | schema.InsuranceAgencyOrSubClass | schema.BankOrCreditUnionOrSubClass | schema.AccountingServiceOrSubClass;
/**
 * schema:FinancialService - Validation schema (w/ JOI)
 */
export declare const FinancialServiceJoiSchema: Joi.ObjectSchema;
/**
 * schema:FinancialService - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const FinancialServiceOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateFinancialService(maybeFinancialService: unknown): FinancialService | OaValidationError;
