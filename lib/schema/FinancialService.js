...
exports.validateFinancialService = exports.FinancialServiceOrSubClassJoiSchema = exports.FinancialServiceJoiSchema = void 0;
 ...
 */
exports.FinancialServiceJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.FinancialServiceOrSubClassJoiSchema = Joi.alternatives().try([
    exports.FinancialServiceJoiSchema,
 ...
 * ```
 */
function validateFinancialService(maybeFinancialService) {
    const { value, error } = exports.FinancialServiceJoiSchema.validate(maybeFinancialService);
    if (error) {
        return new oaValidationError_1.OaValidationError('FinancialService', maybeFinancialService, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateFinancialService = validateFinancialService;
