 ...
 * etc.
 */
export declare type FindActionOrSubClass = FindAction | schema.TrackActionOrSubClass | schema.CheckActionOrSubClass | schema.DiscoverActionOrSubClass;
/**
 * schema:FindAction - Validation schema (w/ JOI)
 */
export declare const FindActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:FindAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const FindActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateFindAction(maybeFindAction: unknown): FindAction | OaValidationError;
