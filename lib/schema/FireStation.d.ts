 ...
 * etc.
 */
export declare type FireStationOrSubClass = FireStation;
/**
 * schema:FireStation - Validation schema (w/ JOI)
 */
export declare const FireStationJoiSchema: Joi.ObjectSchema;
/**
 * schema:FireStation - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const FireStationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateFireStation(maybeFireStation: unknown): FireStation | OaValidationError;
