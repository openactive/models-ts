...
exports.validateFireStation = exports.FireStationOrSubClassJoiSchema = exports.FireStationJoiSchema = void 0;
 ...
 */
exports.FireStationJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.FireStationOrSubClassJoiSchema = Joi.alternatives().try([
    exports.FireStationJoiSchema,
]);
/**
 ...
 * ```
 */
function validateFireStation(maybeFireStation) {
    const { value, error } = exports.FireStationJoiSchema.validate(maybeFireStation);
    if (error) {
        return new oaValidationError_1.OaValidationError('FireStation', maybeFireStation, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateFireStation = validateFireStation;
