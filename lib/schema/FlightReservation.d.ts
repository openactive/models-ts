 ...
 * etc.
 */
export declare type FlightReservationOrSubClass = FlightReservation;
/**
 * schema:FlightReservation - Validation schema (w/ JOI)
 */
export declare const FlightReservationJoiSchema: Joi.ObjectSchema;
/**
 * schema:FlightReservation - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const FlightReservationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateFlightReservation(maybeFlightReservation: unknown): FlightReservation | OaValidationError;
