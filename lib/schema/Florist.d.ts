 ...
 * etc.
 */
export declare type FloristOrSubClass = Florist;
/**
 * schema:Florist - Validation schema (w/ JOI)
 */
export declare const FloristJoiSchema: Joi.ObjectSchema;
/**
 * schema:Florist - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const FloristOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateFlorist(maybeFlorist: unknown): Florist | OaValidationError;
