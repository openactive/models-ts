...
exports.validateFlorist = exports.FloristOrSubClassJoiSchema = exports.FloristJoiSchema = void 0;
 ...
 */
exports.FloristJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.FloristOrSubClassJoiSchema = Joi.alternatives().try([
    exports.FloristJoiSchema,
]);
/**
 ...
 * ```
 */
function validateFlorist(maybeFlorist) {
    const { value, error } = exports.FloristJoiSchema.validate(maybeFlorist);
    if (error) {
        return new oaValidationError_1.OaValidationError('Florist', maybeFlorist, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateFlorist = validateFlorist;
