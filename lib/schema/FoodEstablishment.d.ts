 ...
 * etc.
 */
export declare type FoodEstablishmentOrSubClass = FoodEstablishment | schema.WineryOrSubClass | schema.BreweryOrSubClass | schema.DistilleryOrSubClass | schema.BarOrPubOrSubClass | schema.FastFoodRestaurantOrSubClass | schema.IceCreamShopOrSubClass | schema.CafeOrCoffeeShopOrSubClass | schema.BakeryOrSubClass | schema.RestaurantOrSubClass;
/**
 * schema:FoodEstablishment - Validation schema (w/ JOI)
 */
export declare const FoodEstablishmentJoiSchema: Joi.ObjectSchema;
/**
 * schema:FoodEstablishment - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const FoodEstablishmentOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateFoodEstablishment(maybeFoodEstablishment: unknown): FoodEstablishment | OaValidationError;
