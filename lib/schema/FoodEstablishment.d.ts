 ...
 * etc.
 */
export declare type FoodEstablishmentOrSubClass = FoodEstablishment | schema.FastFoodRestaurantOrSubClass | schema.DistilleryOrSubClass | schema.BreweryOrSubClass | schema.BarOrPubOrSubClass | schema.BakeryOrSubClass | schema.IceCreamShopOrSubClass | schema.WineryOrSubClass | schema.RestaurantOrSubClass | schema.CafeOrCoffeeShopOrSubClass;
/**
