...
exports.validateFoodEstablishment = exports.FoodEstablishmentOrSubClassJoiSchema = exports.FoodEstablishmentJoiSchema = void 0;
 ...
 */
exports.FoodEstablishmentJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.FoodEstablishmentOrSubClassJoiSchema = Joi.alternatives().try([
    exports.FoodEstablishmentJoiSchema,
 ...
 * ```
 */
function validateFoodEstablishment(maybeFoodEstablishment) {
    const { value, error } = exports.FoodEstablishmentJoiSchema.validate(maybeFoodEstablishment);
    if (error) {
        return new oaValidationError_1.OaValidationError('FoodEstablishment', maybeFoodEstablishment, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateFoodEstablishment = validateFoodEstablishment;
