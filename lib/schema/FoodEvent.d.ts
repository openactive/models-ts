 ...
 * etc.
 */
export declare type FoodEventOrSubClass = FoodEvent;
/**
 * schema:FoodEvent - Validation schema (w/ JOI)
 */
export declare const FoodEventJoiSchema: Joi.ObjectSchema;
/**
 * schema:FoodEvent - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const FoodEventOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateFoodEvent(maybeFoodEvent: unknown): FoodEvent | OaValidationError;
