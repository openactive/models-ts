...
exports.validateFoodEvent = exports.FoodEventOrSubClassJoiSchema = exports.FoodEventJoiSchema = void 0;
 ...
 */
exports.FoodEventJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.FoodEventOrSubClassJoiSchema = Joi.alternatives().try([
    exports.FoodEventJoiSchema,
]);
/**
 ...
 * ```
 */
function validateFoodEvent(maybeFoodEvent) {
    const { value, error } = exports.FoodEventJoiSchema.validate(maybeFoodEvent);
    if (error) {
        return new oaValidationError_1.OaValidationError('FoodEvent', maybeFoodEvent, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateFoodEvent = validateFoodEvent;
