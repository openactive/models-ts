 ...
 * etc.
 */
export declare type FoodServiceOrSubClass = FoodService;
/**
 * schema:FoodService - Validation schema (w/ JOI)
 */
export declare const FoodServiceJoiSchema: Joi.ObjectSchema;
/**
 * schema:FoodService - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const FoodServiceOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateFoodService(maybeFoodService: unknown): FoodService | OaValidationError;
