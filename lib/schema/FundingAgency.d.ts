 ...
 * etc.
 */
export declare type FundingAgencyOrSubClass = FundingAgency;
/**
 * schema:FundingAgency - Validation schema (w/ JOI)
 */
export declare const FundingAgencyJoiSchema: Joi.ObjectSchema;
/**
 * schema:FundingAgency - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const FundingAgencyOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateFundingAgency(maybeFundingAgency: unknown): FundingAgency | OaValidationError;
