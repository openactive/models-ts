...
exports.validateFundingAgency = exports.FundingAgencyOrSubClassJoiSchema = exports.FundingAgencyJoiSchema = void 0;
 ...
 */
exports.FundingAgencyJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.FundingAgencyOrSubClassJoiSchema = Joi.alternatives().try([
    exports.FundingAgencyJoiSchema,
]);
/**
 ...
 * ```
 */
function validateFundingAgency(maybeFundingAgency) {
    const { value, error } = exports.FundingAgencyJoiSchema.validate(maybeFundingAgency);
    if (error) {
        return new oaValidationError_1.OaValidationError('FundingAgency', maybeFundingAgency, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateFundingAgency = validateFundingAgency;
