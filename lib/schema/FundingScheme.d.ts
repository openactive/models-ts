 ...
 * etc.
 */
export declare type FundingSchemeOrSubClass = FundingScheme;
/**
 * schema:FundingScheme - Validation schema (w/ JOI)
 */
export declare const FundingSchemeJoiSchema: Joi.ObjectSchema;
/**
 * schema:FundingScheme - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const FundingSchemeOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateFundingScheme(maybeFundingScheme: unknown): FundingScheme | OaValidationError;
