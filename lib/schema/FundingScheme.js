...
exports.validateFundingScheme = exports.FundingSchemeOrSubClassJoiSchema = exports.FundingSchemeJoiSchema = void 0;
 ...
 */
exports.FundingSchemeJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.FundingSchemeOrSubClassJoiSchema = Joi.alternatives().try([
    exports.FundingSchemeJoiSchema,
]);
/**
 ...
 * ```
 */
function validateFundingScheme(maybeFundingScheme) {
    const { value, error } = exports.FundingSchemeJoiSchema.validate(maybeFundingScheme);
    if (error) {
        return new oaValidationError_1.OaValidationError('FundingScheme', maybeFundingScheme, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateFundingScheme = validateFundingScheme;
