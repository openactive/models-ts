 ...
 * etc.
 */
export declare type FurnitureStoreOrSubClass = FurnitureStore;
/**
 * schema:FurnitureStore - Validation schema (w/ JOI)
 */
export declare const FurnitureStoreJoiSchema: Joi.ObjectSchema;
/**
 * schema:FurnitureStore - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const FurnitureStoreOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateFurnitureStore(maybeFurnitureStore: unknown): FurnitureStore | OaValidationError;
