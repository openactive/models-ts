...
exports.validateFurnitureStore = exports.FurnitureStoreOrSubClassJoiSchema = exports.FurnitureStoreJoiSchema = void 0;
 ...
 */
exports.FurnitureStoreJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.FurnitureStoreOrSubClassJoiSchema = Joi.alternatives().try([
    exports.FurnitureStoreJoiSchema,
]);
/**
 ...
 * ```
 */
function validateFurnitureStore(maybeFurnitureStore) {
    const { value, error } = exports.FurnitureStoreJoiSchema.validate(maybeFurnitureStore);
    if (error) {
        return new oaValidationError_1.OaValidationError('FurnitureStore', maybeFurnitureStore, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateFurnitureStore = validateFurnitureStore;
