 ...
 * etc.
 */
export declare type GameOrSubClass = Game | schema.VideoGameOrSubClass;
/**
 * schema:Game - Validation schema (w/ JOI)
 */
export declare const GameJoiSchema: Joi.ObjectSchema;
/**
 * schema:Game - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const GameOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateGame(maybeGame: unknown): Game | OaValidationError;
