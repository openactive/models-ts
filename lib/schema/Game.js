...
exports.validateGame = exports.GameOrSubClassJoiSchema = exports.GameJoiSchema = void 0;
 ...
 */
exports.GameJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.GameOrSubClassJoiSchema = Joi.alternatives().try([
    exports.GameJoiSchema,
 ...
 * ```
 */
function validateGame(maybeGame) {
    const { value, error } = exports.GameJoiSchema.validate(maybeGame);
    if (error) {
        return new oaValidationError_1.OaValidationError('Game', maybeGame, error);
    }
