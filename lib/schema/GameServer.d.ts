 ...
 * etc.
 */
export declare type GameServerOrSubClass = GameServer;
/**
 * schema:GameServer - Validation schema (w/ JOI)
 */
export declare const GameServerJoiSchema: Joi.ObjectSchema;
/**
 * schema:GameServer - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const GameServerOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateGameServer(maybeGameServer: unknown): GameServer | OaValidationError;
