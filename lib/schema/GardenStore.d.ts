 ...
 * etc.
 */
export declare type GardenStoreOrSubClass = GardenStore;
/**
 * schema:GardenStore - Validation schema (w/ JOI)
 */
export declare const GardenStoreJoiSchema: Joi.ObjectSchema;
/**
 * schema:GardenStore - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const GardenStoreOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateGardenStore(maybeGardenStore: unknown): GardenStore | OaValidationError;
