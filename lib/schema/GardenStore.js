...
exports.validateGardenStore = exports.GardenStoreOrSubClassJoiSchema = exports.GardenStoreJoiSchema = void 0;
 ...
 */
exports.GardenStoreJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.GardenStoreOrSubClassJoiSchema = Joi.alternatives().try([
    exports.GardenStoreJoiSchema,
]);
/**
 ...
 * ```
 */
function validateGardenStore(maybeGardenStore) {
    const { value, error } = exports.GardenStoreJoiSchema.validate(maybeGardenStore);
    if (error) {
        return new oaValidationError_1.OaValidationError('GardenStore', maybeGardenStore, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateGardenStore = validateGardenStore;
