 ...
 * etc.
 */
export declare type GasStationOrSubClass = GasStation;
/**
 * schema:GasStation - Validation schema (w/ JOI)
 */
export declare const GasStationJoiSchema: Joi.ObjectSchema;
/**
 * schema:GasStation - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const GasStationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateGasStation(maybeGasStation: unknown): GasStation | OaValidationError;
