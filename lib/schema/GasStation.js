...
exports.validateGasStation = exports.GasStationOrSubClassJoiSchema = exports.GasStationJoiSchema = void 0;
 ...
 */
exports.GasStationJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.GasStationOrSubClassJoiSchema = Joi.alternatives().try([
    exports.GasStationJoiSchema,
]);
/**
 ...
 * ```
 */
function validateGasStation(maybeGasStation) {
    const { value, error } = exports.GasStationJoiSchema.validate(maybeGasStation);
    if (error) {
        return new oaValidationError_1.OaValidationError('GasStation', maybeGasStation, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateGasStation = validateGasStation;
