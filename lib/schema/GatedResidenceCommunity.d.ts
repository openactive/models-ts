 ...
 * etc.
 */
export declare type GatedResidenceCommunityOrSubClass = GatedResidenceCommunity;
/**
 * schema:GatedResidenceCommunity - Validation schema (w/ JOI)
 */
export declare const GatedResidenceCommunityJoiSchema: Joi.ObjectSchema;
/**
 * schema:GatedResidenceCommunity - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const GatedResidenceCommunityOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateGatedResidenceCommunity(maybeGatedResidenceCommunity: unknown): GatedResidenceCommunity | OaValidationError;
