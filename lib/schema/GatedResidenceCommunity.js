...
exports.validateGatedResidenceCommunity = exports.GatedResidenceCommunityOrSubClassJoiSchema = exports.GatedResidenceCommunityJoiSchema = void 0;
 ...
 */
exports.GatedResidenceCommunityJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.GatedResidenceCommunityOrSubClassJoiSchema = Joi.alternatives().try([
    exports.GatedResidenceCommunityJoiSchema,
]);
/**
 ...
 * ```
 */
function validateGatedResidenceCommunity(maybeGatedResidenceCommunity) {
    const { value, error } = exports.GatedResidenceCommunityJoiSchema.validate(maybeGatedResidenceCommunity);
    if (error) {
        return new oaValidationError_1.OaValidationError('GatedResidenceCommunity', maybeGatedResidenceCommunity, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateGatedResidenceCommunity = validateGatedResidenceCommunity;
