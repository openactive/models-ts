 ...
 * etc.
 */
export declare type GeneOrSubClass = Gene;
/**
 * schema:Gene - Validation schema (w/ JOI)
 */
export declare const GeneJoiSchema: Joi.ObjectSchema;
/**
 * schema:Gene - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const GeneOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateGene(maybeGene: unknown): Gene | OaValidationError;
