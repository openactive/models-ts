 ...
 * etc.
 */
export declare type GeneralContractorOrSubClass = GeneralContractor;
/**
 * schema:GeneralContractor - Validation schema (w/ JOI)
 */
export declare const GeneralContractorJoiSchema: Joi.ObjectSchema;
/**
 * schema:GeneralContractor - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const GeneralContractorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateGeneralContractor(maybeGeneralContractor: unknown): GeneralContractor | OaValidationError;
