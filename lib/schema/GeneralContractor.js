...
exports.validateGeneralContractor = exports.GeneralContractorOrSubClassJoiSchema = exports.GeneralContractorJoiSchema = void 0;
 ...
 */
exports.GeneralContractorJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.GeneralContractorOrSubClassJoiSchema = Joi.alternatives().try([
    exports.GeneralContractorJoiSchema,
]);
/**
 ...
 * ```
 */
function validateGeneralContractor(maybeGeneralContractor) {
    const { value, error } = exports.GeneralContractorJoiSchema.validate(maybeGeneralContractor);
    if (error) {
        return new oaValidationError_1.OaValidationError('GeneralContractor', maybeGeneralContractor, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateGeneralContractor = validateGeneralContractor;
