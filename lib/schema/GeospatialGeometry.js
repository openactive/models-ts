...
exports.validateGeospatialGeometry = exports.GeospatialGeometryOrSubClassJoiSchema = exports.GeospatialGeometryJoiSchema = void 0;
 ...
 */
exports.GeospatialGeometryJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.GeospatialGeometryOrSubClassJoiSchema = Joi.alternatives().try([
    exports.GeospatialGeometryJoiSchema,
]);
/**
 ...
 * ```
 */
function validateGeospatialGeometry(maybeGeospatialGeometry) {
    const { value, error } = exports.GeospatialGeometryJoiSchema.validate(maybeGeospatialGeometry);
    if (error) {
        return new oaValidationError_1.OaValidationError('GeospatialGeometry', maybeGeospatialGeometry, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateGeospatialGeometry = validateGeospatialGeometry;
