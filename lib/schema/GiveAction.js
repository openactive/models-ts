...
exports.validateGiveAction = exports.GiveActionOrSubClassJoiSchema = exports.GiveActionJoiSchema = void 0;
 ...
 */
exports.GiveActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.GiveActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.GiveActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateGiveAction(maybeGiveAction) {
    const { value, error } = exports.GiveActionJoiSchema.validate(maybeGiveAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('GiveAction', maybeGiveAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateGiveAction = validateGiveAction;
