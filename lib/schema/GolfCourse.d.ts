 ...
 * etc.
 */
export declare type GolfCourseOrSubClass = GolfCourse;
/**
 * schema:GolfCourse - Validation schema (w/ JOI)
 */
export declare const GolfCourseJoiSchema: Joi.ObjectSchema;
/**
 * schema:GolfCourse - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const GolfCourseOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateGolfCourse(maybeGolfCourse: unknown): GolfCourse | OaValidationError;
