...
exports.validateGolfCourse = exports.GolfCourseOrSubClassJoiSchema = exports.GolfCourseJoiSchema = void 0;
 ...
 */
exports.GolfCourseJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.GolfCourseOrSubClassJoiSchema = Joi.alternatives().try([
    exports.GolfCourseJoiSchema,
]);
/**
 ...
 * ```
 */
function validateGolfCourse(maybeGolfCourse) {
    const { value, error } = exports.GolfCourseJoiSchema.validate(maybeGolfCourse);
    if (error) {
        return new oaValidationError_1.OaValidationError('GolfCourse', maybeGolfCourse, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateGolfCourse = validateGolfCourse;
