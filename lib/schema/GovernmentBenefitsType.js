 ...
 */
exports.GovernmentBenefitsTypeJoiSchema = Joi.string().valid('https://schema.org/BusinessSupport', 'https://schema.org/PaidLeave', 'https://schema.org/ParentalSupport', 'https://schema.org/DisabilitySupport', 'https://schema.org/UnemploymentSupport', 'https://schema.org/HealthCare', 'https://schema.org/OneTimePayments', 'https://schema.org/BasicIncome');
/**
