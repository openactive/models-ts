 ...
 * etc.
 */
export declare type GovernmentBuildingOrSubClass = GovernmentBuilding | schema.EmbassyOrSubClass | schema.LegislativeBuildingOrSubClass | schema.DefenceEstablishmentOrSubClass | schema.CityHallOrSubClass | schema.CourthouseOrSubClass;
/**
