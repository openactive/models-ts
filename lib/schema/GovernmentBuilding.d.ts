 ...
 * etc.
 */
export declare type GovernmentBuildingOrSubClass = GovernmentBuilding | schema.DefenceEstablishmentOrSubClass | schema.EmbassyOrSubClass | schema.LegislativeBuildingOrSubClass | schema.CityHallOrSubClass | schema.CourthouseOrSubClass;
/**
 * schema:GovernmentBuilding - Validation schema (w/ JOI)
 */
export declare const GovernmentBuildingJoiSchema: Joi.ObjectSchema;
/**
 * schema:GovernmentBuilding - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const GovernmentBuildingOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateGovernmentBuilding(maybeGovernmentBuilding: unknown): GovernmentBuilding | OaValidationError;
