...
exports.validateGovernmentBuilding = exports.GovernmentBuildingOrSubClassJoiSchema = exports.GovernmentBuildingJoiSchema = void 0;
 ...
 */
exports.GovernmentBuildingJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.GovernmentBuildingOrSubClassJoiSchema = Joi.alternatives().try([
    exports.GovernmentBuildingJoiSchema,
 ...
 * ```
 */
function validateGovernmentBuilding(maybeGovernmentBuilding) {
    const { value, error } = exports.GovernmentBuildingJoiSchema.validate(maybeGovernmentBuilding);
    if (error) {
        return new oaValidationError_1.OaValidationError('GovernmentBuilding', maybeGovernmentBuilding, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateGovernmentBuilding = validateGovernmentBuilding;
