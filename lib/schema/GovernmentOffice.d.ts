 ...
 * etc.
 */
export declare type GovernmentOfficeOrSubClass = GovernmentOffice | schema.PostOfficeOrSubClass;
/**
 * schema:GovernmentOffice - Validation schema (w/ JOI)
 */
export declare const GovernmentOfficeJoiSchema: Joi.ObjectSchema;
/**
 * schema:GovernmentOffice - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const GovernmentOfficeOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateGovernmentOffice(maybeGovernmentOffice: unknown): GovernmentOffice | OaValidationError;
