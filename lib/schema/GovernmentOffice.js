...
exports.validateGovernmentOffice = exports.GovernmentOfficeOrSubClassJoiSchema = exports.GovernmentOfficeJoiSchema = void 0;
 ...
 */
exports.GovernmentOfficeJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.GovernmentOfficeOrSubClassJoiSchema = Joi.alternatives().try([
    exports.GovernmentOfficeJoiSchema,
 ...
 * ```
 */
function validateGovernmentOffice(maybeGovernmentOffice) {
    const { value, error } = exports.GovernmentOfficeJoiSchema.validate(maybeGovernmentOffice);
    if (error) {
        return new oaValidationError_1.OaValidationError('GovernmentOffice', maybeGovernmentOffice, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateGovernmentOffice = validateGovernmentOffice;
