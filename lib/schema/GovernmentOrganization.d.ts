 ...
 * etc.
 */
export declare type GovernmentOrganizationOrSubClass = GovernmentOrganization;
/**
 * schema:GovernmentOrganization - Validation schema (w/ JOI)
 */
export declare const GovernmentOrganizationJoiSchema: Joi.ObjectSchema;
/**
 * schema:GovernmentOrganization - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const GovernmentOrganizationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateGovernmentOrganization(maybeGovernmentOrganization: unknown): GovernmentOrganization | OaValidationError;
