...
exports.validateGovernmentOrganization = exports.GovernmentOrganizationOrSubClassJoiSchema = exports.GovernmentOrganizationJoiSchema = void 0;
 ...
 */
exports.GovernmentOrganizationJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.GovernmentOrganizationOrSubClassJoiSchema = Joi.alternatives().try([
    exports.GovernmentOrganizationJoiSchema,
]);
/**
 ...
 * ```
 */
function validateGovernmentOrganization(maybeGovernmentOrganization) {
    const { value, error } = exports.GovernmentOrganizationJoiSchema.validate(maybeGovernmentOrganization);
    if (error) {
        return new oaValidationError_1.OaValidationError('GovernmentOrganization', maybeGovernmentOrganization, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateGovernmentOrganization = validateGovernmentOrganization;
