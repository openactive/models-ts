 ...
 * etc.
 */
export declare type GroceryStoreOrSubClass = GroceryStore;
/**
 * schema:GroceryStore - Validation schema (w/ JOI)
 */
export declare const GroceryStoreJoiSchema: Joi.ObjectSchema;
/**
 * schema:GroceryStore - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const GroceryStoreOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateGroceryStore(maybeGroceryStore: unknown): GroceryStore | OaValidationError;
