...
exports.validateGroceryStore = exports.GroceryStoreOrSubClassJoiSchema = exports.GroceryStoreJoiSchema = void 0;
 ...
 */
exports.GroceryStoreJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.GroceryStoreOrSubClassJoiSchema = Joi.alternatives().try([
    exports.GroceryStoreJoiSchema,
]);
/**
 ...
 * ```
 */
function validateGroceryStore(maybeGroceryStore) {
    const { value, error } = exports.GroceryStoreJoiSchema.validate(maybeGroceryStore);
    if (error) {
        return new oaValidationError_1.OaValidationError('GroceryStore', maybeGroceryStore, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateGroceryStore = validateGroceryStore;
