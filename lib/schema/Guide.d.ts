 ...
 * etc.
 */
export declare type GuideOrSubClass = Guide;
/**
 * schema:Guide - Validation schema (w/ JOI)
 */
export declare const GuideJoiSchema: Joi.ObjectSchema;
/**
 * schema:Guide - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const GuideOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateGuide(maybeGuide: unknown): Guide | OaValidationError;
