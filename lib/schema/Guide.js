...
exports.validateGuide = exports.GuideOrSubClassJoiSchema = exports.GuideJoiSchema = void 0;
 ...
 */
exports.GuideJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.GuideOrSubClassJoiSchema = Joi.alternatives().try([
    exports.GuideJoiSchema,
]);
/**
 ...
 * ```
 */
function validateGuide(maybeGuide) {
    const { value, error } = exports.GuideJoiSchema.validate(maybeGuide);
    if (error) {
        return new oaValidationError_1.OaValidationError('Guide', maybeGuide, error);
    }
