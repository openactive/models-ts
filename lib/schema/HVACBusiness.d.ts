 ...
 * etc.
 */
export declare type HVACBusinessOrSubClass = HVACBusiness;
/**
 * schema:HVACBusiness - Validation schema (w/ JOI)
 */
export declare const HVACBusinessJoiSchema: Joi.ObjectSchema;
/**
 * schema:HVACBusiness - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const HVACBusinessOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateHVACBusiness(maybeHVACBusiness: unknown): HVACBusiness | OaValidationError;
