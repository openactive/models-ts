...
exports.validateHVACBusiness = exports.HVACBusinessOrSubClassJoiSchema = exports.HVACBusinessJoiSchema = void 0;
 ...
 */
exports.HVACBusinessJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.HVACBusinessOrSubClassJoiSchema = Joi.alternatives().try([
    exports.HVACBusinessJoiSchema,
]);
/**
 ...
 * ```
 */
function validateHVACBusiness(maybeHVACBusiness) {
    const { value, error } = exports.HVACBusinessJoiSchema.validate(maybeHVACBusiness);
    if (error) {
        return new oaValidationError_1.OaValidationError('HVACBusiness', maybeHVACBusiness, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateHVACBusiness = validateHVACBusiness;
