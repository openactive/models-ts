 ...
 * etc.
 */
export declare type HairSalonOrSubClass = HairSalon;
/**
 * schema:HairSalon - Validation schema (w/ JOI)
 */
export declare const HairSalonJoiSchema: Joi.ObjectSchema;
/**
 * schema:HairSalon - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const HairSalonOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateHairSalon(maybeHairSalon: unknown): HairSalon | OaValidationError;
