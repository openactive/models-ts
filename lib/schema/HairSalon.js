...
exports.validateHairSalon = exports.HairSalonOrSubClassJoiSchema = exports.HairSalonJoiSchema = void 0;
 ...
 */
exports.HairSalonJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.HairSalonOrSubClassJoiSchema = Joi.alternatives().try([
    exports.HairSalonJoiSchema,
]);
/**
 ...
 * ```
 */
function validateHairSalon(maybeHairSalon) {
    const { value, error } = exports.HairSalonJoiSchema.validate(maybeHairSalon);
    if (error) {
        return new oaValidationError_1.OaValidationError('HairSalon', maybeHairSalon, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateHairSalon = validateHairSalon;
