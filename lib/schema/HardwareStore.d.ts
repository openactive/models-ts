 ...
 * etc.
 */
export declare type HardwareStoreOrSubClass = HardwareStore;
/**
 * schema:HardwareStore - Validation schema (w/ JOI)
 */
export declare const HardwareStoreJoiSchema: Joi.ObjectSchema;
/**
 * schema:HardwareStore - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const HardwareStoreOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateHardwareStore(maybeHardwareStore: unknown): HardwareStore | OaValidationError;
