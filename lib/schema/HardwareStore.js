...
exports.validateHardwareStore = exports.HardwareStoreOrSubClassJoiSchema = exports.HardwareStoreJoiSchema = void 0;
 ...
 */
exports.HardwareStoreJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.HardwareStoreOrSubClassJoiSchema = Joi.alternatives().try([
    exports.HardwareStoreJoiSchema,
]);
/**
 ...
 * ```
 */
function validateHardwareStore(maybeHardwareStore) {
    const { value, error } = exports.HardwareStoreJoiSchema.validate(maybeHardwareStore);
    if (error) {
        return new oaValidationError_1.OaValidationError('HardwareStore', maybeHardwareStore, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateHardwareStore = validateHardwareStore;
