 ...
 * etc.
 */
export declare type HealthAndBeautyBusinessOrSubClass = HealthAndBeautyBusiness | schema.DaySpaOrSubClass | schema.HealthClubOrSubClass | schema.HairSalonOrSubClass | schema.BeautySalonOrSubClass | schema.TattooParlorOrSubClass | schema.NailSalonOrSubClass;
/**
