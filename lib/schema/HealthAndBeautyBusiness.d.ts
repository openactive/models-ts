 ...
 * etc.
 */
export declare type HealthAndBeautyBusinessOrSubClass = HealthAndBeautyBusiness | schema.BeautySalonOrSubClass | schema.DaySpaOrSubClass | schema.HealthClubOrSubClass | schema.HairSalonOrSubClass | schema.NailSalonOrSubClass | schema.TattooParlorOrSubClass;
/**
 * schema:HealthAndBeautyBusiness - Validation schema (w/ JOI)
 */
export declare const HealthAndBeautyBusinessJoiSchema: Joi.ObjectSchema;
/**
 * schema:HealthAndBeautyBusiness - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const HealthAndBeautyBusinessOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateHealthAndBeautyBusiness(maybeHealthAndBeautyBusiness: unknown): HealthAndBeautyBusiness | OaValidationError;
