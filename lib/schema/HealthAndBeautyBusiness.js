...
exports.validateHealthAndBeautyBusiness = exports.HealthAndBeautyBusinessOrSubClassJoiSchema = exports.HealthAndBeautyBusinessJoiSchema = void 0;
 ...
 */
exports.HealthAndBeautyBusinessJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.HealthAndBeautyBusinessOrSubClassJoiSchema = Joi.alternatives().try([
    exports.HealthAndBeautyBusinessJoiSchema,
 ...
 * ```
 */
function validateHealthAndBeautyBusiness(maybeHealthAndBeautyBusiness) {
    const { value, error } = exports.HealthAndBeautyBusinessJoiSchema.validate(maybeHealthAndBeautyBusiness);
    if (error) {
        return new oaValidationError_1.OaValidationError('HealthAndBeautyBusiness', maybeHealthAndBeautyBusiness, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateHealthAndBeautyBusiness = validateHealthAndBeautyBusiness;
