 ...
 */
exports.HealthAspectEnumerationJoiSchema = Joi.string().valid('https://schema.org/BenefitsHealthAspect', 'https://schema.org/StagesHealthAspect', 'https://schema.org/SelfCareHealthAspect', 'https://schema.org/SideEffectsHealthAspect', 'https://schema.org/EffectivenessHealthAspect', 'https://schema.org/MayTreatHealthAspect', 'https://schema.org/ScreeningHealthAspect', 'https://schema.org/SafetyHealthAspect', 'https://schema.org/ContagiousnessHealthAspect', 'https://schema.org/CausesHealthAspect', 'https://schema.org/OverviewHealthAspect', 'https://schema.org/SymptomsHealthAspect', 'https://schema.org/SeeDoctorHealthAspect', 'https://schema.org/GettingAccessHealthAspect', 'https://schema.org/PrognosisHealthAspect', 'https://schema.org/LivingWithHealthAspect', 'https://schema.org/RisksOrComplicationsHealthAspect', 'https://schema.org/PatientExperienceHealthAspect', 'https://schema.org/PreventionHealthAspect', 'https://schema.org/TreatmentsHealthAspect', 'https://schema.org/IngredientsHealthAspect', 'https://schema.org/HowItWorksHealthAspect', 'https://schema.org/AllergiesHealthAspect', 'https://schema.org/UsageOrScheduleHealthAspect', 'https://schema.org/MisconceptionsHealthAspect', 'https://schema.org/PregnancyHealthAspect', 'https://schema.org/HowOrWhereHealthAspect', 'https://schema.org/RelatedTopicsHealthAspect', 'https://schema.org/TypesHealthAspect');
/**
