 ...
 * etc.
 */
export declare type HealthClubOrSubClass = HealthClub;
/**
 * schema:HealthClub - Validation schema (w/ JOI)
 */
export declare const HealthClubJoiSchema: Joi.ObjectSchema;
/**
 * schema:HealthClub - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const HealthClubOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateHealthClub(maybeHealthClub: unknown): HealthClub | OaValidationError;
