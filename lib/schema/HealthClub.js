...
exports.validateHealthClub = exports.HealthClubOrSubClassJoiSchema = exports.HealthClubJoiSchema = void 0;
 ...
 */
exports.HealthClubJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.HealthClubOrSubClassJoiSchema = Joi.alternatives().try([
    exports.HealthClubJoiSchema,
]);
/**
 ...
 * ```
 */
function validateHealthClub(maybeHealthClub) {
    const { value, error } = exports.HealthClubJoiSchema.validate(maybeHealthClub);
    if (error) {
        return new oaValidationError_1.OaValidationError('HealthClub', maybeHealthClub, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateHealthClub = validateHealthClub;
