 ...
 * etc.
 */
export declare type HealthInsurancePlanOrSubClass = HealthInsurancePlan;
/**
 * schema:HealthInsurancePlan - Validation schema (w/ JOI)
 */
export declare const HealthInsurancePlanJoiSchema: Joi.ObjectSchema;
/**
 * schema:HealthInsurancePlan - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const HealthInsurancePlanOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateHealthInsurancePlan(maybeHealthInsurancePlan: unknown): HealthInsurancePlan | OaValidationError;
