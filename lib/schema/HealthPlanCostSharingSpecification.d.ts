 ...
 * etc.
 */
export declare type HealthPlanCostSharingSpecificationOrSubClass = HealthPlanCostSharingSpecification;
/**
 * schema:HealthPlanCostSharingSpecification - Validation schema (w/ JOI)
 */
export declare const HealthPlanCostSharingSpecificationJoiSchema: Joi.ObjectSchema;
/**
 * schema:HealthPlanCostSharingSpecification - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const HealthPlanCostSharingSpecificationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateHealthPlanCostSharingSpecification(maybeHealthPlanCostSharingSpecification: unknown): HealthPlanCostSharingSpecification | OaValidationError;
