 ...
 * etc.
 */
export declare type HealthTopicContentOrSubClass = HealthTopicContent;
/**
 * schema:HealthTopicContent - Validation schema (w/ JOI)
 */
export declare const HealthTopicContentJoiSchema: Joi.ObjectSchema;
/**
 * schema:HealthTopicContent - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const HealthTopicContentOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateHealthTopicContent(maybeHealthTopicContent: unknown): HealthTopicContent | OaValidationError;
