...
exports.validateHealthTopicContent = exports.HealthTopicContentOrSubClassJoiSchema = exports.HealthTopicContentJoiSchema = void 0;
 ...
 */
exports.HealthTopicContentJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.HealthTopicContentOrSubClassJoiSchema = Joi.alternatives().try([
    exports.HealthTopicContentJoiSchema,
]);
/**
 ...
 * ```
 */
function validateHealthTopicContent(maybeHealthTopicContent) {
    const { value, error } = exports.HealthTopicContentJoiSchema.validate(maybeHealthTopicContent);
    if (error) {
        return new oaValidationError_1.OaValidationError('HealthTopicContent', maybeHealthTopicContent, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateHealthTopicContent = validateHealthTopicContent;
