 ...
 * etc.
 */
export declare type HighSchoolOrSubClass = HighSchool;
/**
 * schema:HighSchool - Validation schema (w/ JOI)
 */
export declare const HighSchoolJoiSchema: Joi.ObjectSchema;
/**
 * schema:HighSchool - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const HighSchoolOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateHighSchool(maybeHighSchool: unknown): HighSchool | OaValidationError;
