...
exports.validateHighSchool = exports.HighSchoolOrSubClassJoiSchema = exports.HighSchoolJoiSchema = void 0;
 ...
 */
exports.HighSchoolJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.HighSchoolOrSubClassJoiSchema = Joi.alternatives().try([
    exports.HighSchoolJoiSchema,
]);
/**
 ...
 * ```
 */
function validateHighSchool(maybeHighSchool) {
    const { value, error } = exports.HighSchoolJoiSchema.validate(maybeHighSchool);
    if (error) {
        return new oaValidationError_1.OaValidationError('HighSchool', maybeHighSchool, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateHighSchool = validateHighSchool;
