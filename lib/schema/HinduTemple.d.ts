 ...
 * etc.
 */
export declare type HinduTempleOrSubClass = HinduTemple;
/**
 * schema:HinduTemple - Validation schema (w/ JOI)
 */
export declare const HinduTempleJoiSchema: Joi.ObjectSchema;
/**
 * schema:HinduTemple - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const HinduTempleOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateHinduTemple(maybeHinduTemple: unknown): HinduTemple | OaValidationError;
