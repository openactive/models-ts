...
exports.validateHinduTemple = exports.HinduTempleOrSubClassJoiSchema = exports.HinduTempleJoiSchema = void 0;
 ...
 */
exports.HinduTempleJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.HinduTempleOrSubClassJoiSchema = Joi.alternatives().try([
    exports.HinduTempleJoiSchema,
]);
/**
 ...
 * ```
 */
function validateHinduTemple(maybeHinduTemple) {
    const { value, error } = exports.HinduTempleJoiSchema.validate(maybeHinduTemple);
    if (error) {
        return new oaValidationError_1.OaValidationError('HinduTemple', maybeHinduTemple, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateHinduTemple = validateHinduTemple;
