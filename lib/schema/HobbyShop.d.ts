 ...
 * etc.
 */
export declare type HobbyShopOrSubClass = HobbyShop;
/**
 * schema:HobbyShop - Validation schema (w/ JOI)
 */
export declare const HobbyShopJoiSchema: Joi.ObjectSchema;
/**
 * schema:HobbyShop - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const HobbyShopOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateHobbyShop(maybeHobbyShop: unknown): HobbyShop | OaValidationError;
