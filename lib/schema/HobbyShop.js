...
exports.validateHobbyShop = exports.HobbyShopOrSubClassJoiSchema = exports.HobbyShopJoiSchema = void 0;
 ...
 */
exports.HobbyShopJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.HobbyShopOrSubClassJoiSchema = Joi.alternatives().try([
    exports.HobbyShopJoiSchema,
]);
/**
 ...
 * ```
 */
function validateHobbyShop(maybeHobbyShop) {
    const { value, error } = exports.HobbyShopJoiSchema.validate(maybeHobbyShop);
    if (error) {
        return new oaValidationError_1.OaValidationError('HobbyShop', maybeHobbyShop, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateHobbyShop = validateHobbyShop;
