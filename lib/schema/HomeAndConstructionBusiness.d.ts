 ...
 * etc.
 */
export declare type HomeAndConstructionBusinessOrSubClass = HomeAndConstructionBusiness | schema.HVACBusinessOrSubClass | schema.MovingCompanyOrSubClass | schema.GeneralContractorOrSubClass | schema.RoofingContractorOrSubClass | schema.ElectricianOrSubClass | schema.PlumberOrSubClass | schema.LocksmithOrSubClass | schema.HousePainterOrSubClass;
/**
 * schema:HomeAndConstructionBusiness - Validation schema (w/ JOI)
 */
export declare const HomeAndConstructionBusinessJoiSchema: Joi.ObjectSchema;
/**
 * schema:HomeAndConstructionBusiness - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const HomeAndConstructionBusinessOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateHomeAndConstructionBusiness(maybeHomeAndConstructionBusiness: unknown): HomeAndConstructionBusiness | OaValidationError;
