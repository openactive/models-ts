 ...
 * etc.
 */
export declare type HomeAndConstructionBusinessOrSubClass = HomeAndConstructionBusiness | schema.ElectricianOrSubClass | schema.RoofingContractorOrSubClass | schema.HVACBusinessOrSubClass | schema.PlumberOrSubClass | schema.HousePainterOrSubClass | schema.GeneralContractorOrSubClass | schema.LocksmithOrSubClass | schema.MovingCompanyOrSubClass;
/**
