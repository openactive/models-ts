...
exports.validateHomeAndConstructionBusiness = exports.HomeAndConstructionBusinessOrSubClassJoiSchema = exports.HomeAndConstructionBusinessJoiSchema = void 0;
 ...
 */
exports.HomeAndConstructionBusinessJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.HomeAndConstructionBusinessOrSubClassJoiSchema = Joi.alternatives().try([
    exports.HomeAndConstructionBusinessJoiSchema,
 ...
 * ```
 */
function validateHomeAndConstructionBusiness(maybeHomeAndConstructionBusiness) {
    const { value, error } = exports.HomeAndConstructionBusinessJoiSchema.validate(maybeHomeAndConstructionBusiness);
    if (error) {
        return new oaValidationError_1.OaValidationError('HomeAndConstructionBusiness', maybeHomeAndConstructionBusiness, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateHomeAndConstructionBusiness = validateHomeAndConstructionBusiness;
