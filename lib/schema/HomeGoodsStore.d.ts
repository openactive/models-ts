 ...
 * etc.
 */
export declare type HomeGoodsStoreOrSubClass = HomeGoodsStore;
/**
 * schema:HomeGoodsStore - Validation schema (w/ JOI)
 */
export declare const HomeGoodsStoreJoiSchema: Joi.ObjectSchema;
/**
 * schema:HomeGoodsStore - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const HomeGoodsStoreOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateHomeGoodsStore(maybeHomeGoodsStore: unknown): HomeGoodsStore | OaValidationError;
