...
exports.validateHomeGoodsStore = exports.HomeGoodsStoreOrSubClassJoiSchema = exports.HomeGoodsStoreJoiSchema = void 0;
 ...
 */
exports.HomeGoodsStoreJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.HomeGoodsStoreOrSubClassJoiSchema = Joi.alternatives().try([
    exports.HomeGoodsStoreJoiSchema,
]);
/**
 ...
 * ```
 */
function validateHomeGoodsStore(maybeHomeGoodsStore) {
    const { value, error } = exports.HomeGoodsStoreJoiSchema.validate(maybeHomeGoodsStore);
    if (error) {
        return new oaValidationError_1.OaValidationError('HomeGoodsStore', maybeHomeGoodsStore, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateHomeGoodsStore = validateHomeGoodsStore;
