 ...
 * etc.
 */
export declare type HospitalOrSubClass = Hospital;
/**
 * schema:Hospital - Validation schema (w/ JOI)
 */
export declare const HospitalJoiSchema: Joi.ObjectSchema;
/**
 * schema:Hospital - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const HospitalOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateHospital(maybeHospital: unknown): Hospital | OaValidationError;
