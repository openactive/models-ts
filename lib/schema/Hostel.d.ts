 ...
 * etc.
 */
export declare type HostelOrSubClass = Hostel;
/**
 * schema:Hostel - Validation schema (w/ JOI)
 */
export declare const HostelJoiSchema: Joi.ObjectSchema;
/**
 * schema:Hostel - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const HostelOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateHostel(maybeHostel: unknown): Hostel | OaValidationError;
