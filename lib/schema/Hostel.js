...
exports.validateHostel = exports.HostelOrSubClassJoiSchema = exports.HostelJoiSchema = void 0;
 ...
 */
exports.HostelJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.HostelOrSubClassJoiSchema = Joi.alternatives().try([
    exports.HostelJoiSchema,
]);
/**
 ...
 * ```
 */
function validateHostel(maybeHostel) {
    const { value, error } = exports.HostelJoiSchema.validate(maybeHostel);
    if (error) {
        return new oaValidationError_1.OaValidationError('Hostel', maybeHostel, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateHostel = validateHostel;
