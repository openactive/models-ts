 ...
 * etc.
 */
export declare type HotelOrSubClass = Hotel;
/**
 * schema:Hotel - Validation schema (w/ JOI)
 */
export declare const HotelJoiSchema: Joi.ObjectSchema;
/**
 * schema:Hotel - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const HotelOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateHotel(maybeHotel: unknown): Hotel | OaValidationError;
