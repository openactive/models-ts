...
exports.validateHotel = exports.HotelOrSubClassJoiSchema = exports.HotelJoiSchema = void 0;
 ...
 * `SessionSeries`, etc.
 */
exports.HotelOrSubClassJoiSchema = Joi.alternatives().try([
    exports.HotelJoiSchema,
]);
/**
 ...
 * ```
 */
function validateHotel(maybeHotel) {
    const { value, error } = exports.HotelJoiSchema.validate(maybeHotel);
    if (error) {
        return new oaValidationError_1.OaValidationError('Hotel', maybeHotel, error);
    }
