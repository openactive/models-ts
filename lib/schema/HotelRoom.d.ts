 ...
 * etc.
 */
export declare type HotelRoomOrSubClass = HotelRoom;
/**
 * schema:HotelRoom - Validation schema (w/ JOI)
 */
export declare const HotelRoomJoiSchema: Joi.ObjectSchema;
/**
 * schema:HotelRoom - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const HotelRoomOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateHotelRoom(maybeHotelRoom: unknown): HotelRoom | OaValidationError;
