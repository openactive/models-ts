...
exports.validateHotelRoom = exports.HotelRoomOrSubClassJoiSchema = exports.HotelRoomJoiSchema = void 0;
 ...
 */
exports.HotelRoomJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.HotelRoomOrSubClassJoiSchema = Joi.alternatives().try([
    exports.HotelRoomJoiSchema,
]);
/**
 ...
 * ```
 */
function validateHotelRoom(maybeHotelRoom) {
    const { value, error } = exports.HotelRoomJoiSchema.validate(maybeHotelRoom);
    if (error) {
        return new oaValidationError_1.OaValidationError('HotelRoom', maybeHotelRoom, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateHotelRoom = validateHotelRoom;
