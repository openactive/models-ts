 ...
 * etc.
 */
export declare type HousePainterOrSubClass = HousePainter;
/**
 * schema:HousePainter - Validation schema (w/ JOI)
 */
export declare const HousePainterJoiSchema: Joi.ObjectSchema;
/**
 * schema:HousePainter - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const HousePainterOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateHousePainter(maybeHousePainter: unknown): HousePainter | OaValidationError;
