...
exports.validateHousePainter = exports.HousePainterOrSubClassJoiSchema = exports.HousePainterJoiSchema = void 0;
 ...
 */
exports.HousePainterJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.HousePainterOrSubClassJoiSchema = Joi.alternatives().try([
    exports.HousePainterJoiSchema,
]);
/**
 ...
 * ```
 */
function validateHousePainter(maybeHousePainter) {
    const { value, error } = exports.HousePainterJoiSchema.validate(maybeHousePainter);
    if (error) {
        return new oaValidationError_1.OaValidationError('HousePainter', maybeHousePainter, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateHousePainter = validateHousePainter;
