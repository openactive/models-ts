 ...
 * etc.
 */
export declare type HowToOrSubClass = HowTo | schema.RecipeOrSubClass;
/**
 * schema:HowTo - Validation schema (w/ JOI)
 */
export declare const HowToJoiSchema: Joi.ObjectSchema;
/**
 * schema:HowTo - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const HowToOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateHowTo(maybeHowTo: unknown): HowTo | OaValidationError;
