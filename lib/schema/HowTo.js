...
exports.validateHowTo = exports.HowToOrSubClassJoiSchema = exports.HowToJoiSchema = void 0;
 ...
 */
exports.HowToJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.HowToOrSubClassJoiSchema = Joi.alternatives().try([
    exports.HowToJoiSchema,
 ...
 * ```
 */
function validateHowTo(maybeHowTo) {
    const { value, error } = exports.HowToJoiSchema.validate(maybeHowTo);
    if (error) {
        return new oaValidationError_1.OaValidationError('HowTo', maybeHowTo, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateHowTo = validateHowTo;
