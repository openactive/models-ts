 ...
 * etc.
 */
export declare type HowToDirectionOrSubClass = HowToDirection;
/**
 * schema:HowToDirection - Validation schema (w/ JOI)
 */
export declare const HowToDirectionJoiSchema: Joi.ObjectSchema;
/**
 * schema:HowToDirection - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const HowToDirectionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateHowToDirection(maybeHowToDirection: unknown): HowToDirection | OaValidationError;
