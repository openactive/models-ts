...
exports.validateHowToDirection = exports.HowToDirectionOrSubClassJoiSchema = exports.HowToDirectionJoiSchema = void 0;
 ...
 */
exports.HowToDirectionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.HowToDirectionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.HowToDirectionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateHowToDirection(maybeHowToDirection) {
    const { value, error } = exports.HowToDirectionJoiSchema.validate(maybeHowToDirection);
    if (error) {
        return new oaValidationError_1.OaValidationError('HowToDirection', maybeHowToDirection, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateHowToDirection = validateHowToDirection;
