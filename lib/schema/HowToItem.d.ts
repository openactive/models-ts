 ...
 * etc.
 */
export declare type HowToItemOrSubClass = HowToItem | schema.HowToSupplyOrSubClass | schema.HowToToolOrSubClass;
/**
 * schema:HowToItem - Validation schema (w/ JOI)
 */
export declare const HowToItemJoiSchema: Joi.ObjectSchema;
/**
 * schema:HowToItem - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const HowToItemOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateHowToItem(maybeHowToItem: unknown): HowToItem | OaValidationError;
