 ...
 * etc.
 */
export declare type HowToSectionOrSubClass = HowToSection;
/**
 * schema:HowToSection - Validation schema (w/ JOI)
 */
export declare const HowToSectionJoiSchema: Joi.ObjectSchema;
/**
 * schema:HowToSection - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const HowToSectionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateHowToSection(maybeHowToSection: unknown): HowToSection | OaValidationError;
