...
exports.validateHowToSection = exports.HowToSectionOrSubClassJoiSchema = exports.HowToSectionJoiSchema = void 0;
 ...
 */
exports.HowToSectionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.HowToSectionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.HowToSectionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateHowToSection(maybeHowToSection) {
    const { value, error } = exports.HowToSectionJoiSchema.validate(maybeHowToSection);
    if (error) {
        return new oaValidationError_1.OaValidationError('HowToSection', maybeHowToSection, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateHowToSection = validateHowToSection;
