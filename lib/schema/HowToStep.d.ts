 ...
 * etc.
 */
export declare type HowToStepOrSubClass = HowToStep;
/**
 * schema:HowToStep - Validation schema (w/ JOI)
 */
export declare const HowToStepJoiSchema: Joi.ObjectSchema;
/**
 * schema:HowToStep - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const HowToStepOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateHowToStep(maybeHowToStep: unknown): HowToStep | OaValidationError;
