...
exports.validateHowToStep = exports.HowToStepOrSubClassJoiSchema = exports.HowToStepJoiSchema = void 0;
 ...
 */
exports.HowToStepJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.HowToStepOrSubClassJoiSchema = Joi.alternatives().try([
    exports.HowToStepJoiSchema,
]);
/**
 ...
 * ```
 */
function validateHowToStep(maybeHowToStep) {
    const { value, error } = exports.HowToStepJoiSchema.validate(maybeHowToStep);
    if (error) {
        return new oaValidationError_1.OaValidationError('HowToStep', maybeHowToStep, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateHowToStep = validateHowToStep;
