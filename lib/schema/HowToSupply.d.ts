 ...
 * etc.
 */
export declare type HowToSupplyOrSubClass = HowToSupply;
/**
 * schema:HowToSupply - Validation schema (w/ JOI)
 */
export declare const HowToSupplyJoiSchema: Joi.ObjectSchema;
/**
 * schema:HowToSupply - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const HowToSupplyOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 *
 * ```ts
 * const maybeHowToSupply = HowToSupply.validate(req.body); // `req.body` will have type `any` or `unknown`
 ...
 * ```
 */
export declare function validateHowToSupply(maybeHowToSupply: unknown): HowToSupply | OaValidationError;
