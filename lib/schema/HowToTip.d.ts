 ...
 * etc.
 */
export declare type HowToTipOrSubClass = HowToTip;
/**
 * schema:HowToTip - Validation schema (w/ JOI)
 */
export declare const HowToTipJoiSchema: Joi.ObjectSchema;
/**
 * schema:HowToTip - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const HowToTipOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateHowToTip(maybeHowToTip: unknown): HowToTip | OaValidationError;
