...
exports.validateHowToTip = exports.HowToTipOrSubClassJoiSchema = exports.HowToTipJoiSchema = void 0;
 ...
 */
exports.HowToTipJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.HowToTipOrSubClassJoiSchema = Joi.alternatives().try([
    exports.HowToTipJoiSchema,
]);
/**
 ...
 * ```
 */
function validateHowToTip(maybeHowToTip) {
    const { value, error } = exports.HowToTipJoiSchema.validate(maybeHowToTip);
    if (error) {
        return new oaValidationError_1.OaValidationError('HowToTip', maybeHowToTip, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateHowToTip = validateHowToTip;
