 ...
 * etc.
 */
export declare type HowToToolOrSubClass = HowToTool;
/**
 * schema:HowToTool - Validation schema (w/ JOI)
 */
export declare const HowToToolJoiSchema: Joi.ObjectSchema;
/**
 * schema:HowToTool - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const HowToToolOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateHowToTool(maybeHowToTool: unknown): HowToTool | OaValidationError;
