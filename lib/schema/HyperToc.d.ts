 ...
 * etc.
 */
export declare type HyperTocOrSubClass = HyperToc;
/**
 * schema:HyperToc - Validation schema (w/ JOI)
 */
export declare const HyperTocJoiSchema: Joi.ObjectSchema;
/**
 * schema:HyperToc - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const HyperTocOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateHyperToc(maybeHyperToc: unknown): HyperToc | OaValidationError;
