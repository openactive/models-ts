...
exports.validateHyperToc = exports.HyperTocOrSubClassJoiSchema = exports.HyperTocJoiSchema = void 0;
 ...
 */
exports.HyperTocJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.HyperTocOrSubClassJoiSchema = Joi.alternatives().try([
    exports.HyperTocJoiSchema,
]);
/**
 ...
 * ```
 */
function validateHyperToc(maybeHyperToc) {
    const { value, error } = exports.HyperTocJoiSchema.validate(maybeHyperToc);
    if (error) {
        return new oaValidationError_1.OaValidationError('HyperToc', maybeHyperToc, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateHyperToc = validateHyperToc;
