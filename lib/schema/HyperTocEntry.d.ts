 ...
 */
export declare type HyperTocEntry = {
    '@type': 'HyperTocEntry';
 ...
 * etc.
 */
export declare type HyperTocEntryOrSubClass = HyperTocEntry;
/**
 * schema:HyperTocEntry - Validation schema (w/ JOI)
 */
export declare const HyperTocEntryJoiSchema: Joi.ObjectSchema;
/**
 * schema:HyperTocEntry - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const HyperTocEntryOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateHyperTocEntry(maybeHyperTocEntry: unknown): HyperTocEntry | OaValidationError;
