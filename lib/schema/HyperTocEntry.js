...
exports.validateHyperTocEntry = exports.HyperTocEntryOrSubClassJoiSchema = exports.HyperTocEntryJoiSchema = void 0;
 ...
 */
exports.HyperTocEntryJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.HyperTocEntryOrSubClassJoiSchema = Joi.alternatives().try([
    exports.HyperTocEntryJoiSchema,
]);
/**
 ...
 * ```
 */
function validateHyperTocEntry(maybeHyperTocEntry) {
    const { value, error } = exports.HyperTocEntryJoiSchema.validate(maybeHyperTocEntry);
    if (error) {
        return new oaValidationError_1.OaValidationError('HyperTocEntry', maybeHyperTocEntry, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateHyperTocEntry = validateHyperTocEntry;
