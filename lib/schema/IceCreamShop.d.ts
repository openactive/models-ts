 ...
 * etc.
 */
export declare type IceCreamShopOrSubClass = IceCreamShop;
/**
 * schema:IceCreamShop - Validation schema (w/ JOI)
 */
export declare const IceCreamShopJoiSchema: Joi.ObjectSchema;
/**
 * schema:IceCreamShop - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const IceCreamShopOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateIceCreamShop(maybeIceCreamShop: unknown): IceCreamShop | OaValidationError;
