...
exports.validateIceCreamShop = exports.IceCreamShopOrSubClassJoiSchema = exports.IceCreamShopJoiSchema = void 0;
 ...
 */
exports.IceCreamShopJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.IceCreamShopOrSubClassJoiSchema = Joi.alternatives().try([
    exports.IceCreamShopJoiSchema,
]);
/**
 ...
 *
 * ```ts
 * const maybeIceCreamShop = IceCreamShop.validate(req.body); // `req.body` will have type `any` or `unknown`
 ...
 * ```
 */
function validateIceCreamShop(maybeIceCreamShop) {
    const { value, error } = exports.IceCreamShopJoiSchema.validate(maybeIceCreamShop);
    if (error) {
        return new oaValidationError_1.OaValidationError('IceCreamShop', maybeIceCreamShop, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateIceCreamShop = validateIceCreamShop;
