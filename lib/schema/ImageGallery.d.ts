 ...
 * etc.
 */
export declare type ImageGalleryOrSubClass = ImageGallery;
/**
 * schema:ImageGallery - Validation schema (w/ JOI)
 */
export declare const ImageGalleryJoiSchema: Joi.ObjectSchema;
/**
 * schema:ImageGallery - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ImageGalleryOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateImageGallery(maybeImageGallery: unknown): ImageGallery | OaValidationError;
