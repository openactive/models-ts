...
exports.validateImageGallery = exports.ImageGalleryOrSubClassJoiSchema = exports.ImageGalleryJoiSchema = void 0;
 ...
 */
exports.ImageGalleryJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ImageGalleryOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ImageGalleryJoiSchema,
]);
/**
 ...
 * ```
 */
function validateImageGallery(maybeImageGallery) {
    const { value, error } = exports.ImageGalleryJoiSchema.validate(maybeImageGallery);
    if (error) {
        return new oaValidationError_1.OaValidationError('ImageGallery', maybeImageGallery, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateImageGallery = validateImageGallery;
