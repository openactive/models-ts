 ...
 * etc.
 */
export declare type ImageObjectOrSubClass = ImageObject | schema.BarcodeOrSubClass;
/**
 * schema:ImageObject - Validation schema (w/ JOI)
 */
export declare const ImageObjectJoiSchema: Joi.ObjectSchema;
/**
 * schema:ImageObject - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ImageObjectOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateImageObject(maybeImageObject: unknown): ImageObject | OaValidationError;
