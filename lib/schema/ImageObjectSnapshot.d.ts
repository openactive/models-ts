 ...
 */
export declare type ImageObjectSnapshot = {
 ...
 * etc.
 */
export declare type ImageObjectSnapshotOrSubClass = ImageObjectSnapshot;
/**
 * schema:ImageObjectSnapshot - Validation schema (w/ JOI)
 */
export declare const ImageObjectSnapshotJoiSchema: Joi.ObjectSchema;
/**
 * schema:ImageObjectSnapshot - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ImageObjectSnapshotOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateImageObjectSnapshot(maybeImageObjectSnapshot: unknown): ImageObjectSnapshot | OaValidationError;
