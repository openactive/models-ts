...
exports.validateImageObjectSnapshot = exports.ImageObjectSnapshotOrSubClassJoiSchema = exports.ImageObjectSnapshotJoiSchema = void 0;
 ...
 */
exports.ImageObjectSnapshotJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ImageObjectSnapshotOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ImageObjectSnapshotJoiSchema,
]);
/**
 ...
 * ```
 */
function validateImageObjectSnapshot(maybeImageObjectSnapshot) {
    const { value, error } = exports.ImageObjectSnapshotJoiSchema.validate(maybeImageObjectSnapshot);
    if (error) {
        return new oaValidationError_1.OaValidationError('ImageObjectSnapshot', maybeImageObjectSnapshot, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateImageObjectSnapshot = validateImageObjectSnapshot;
