 ...
 * etc.
 */
export declare type ImagingTestOrSubClass = ImagingTest;
/**
 * schema:ImagingTest - Validation schema (w/ JOI)
 */
export declare const ImagingTestJoiSchema: Joi.ObjectSchema;
/**
 * schema:ImagingTest - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ImagingTestOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateImagingTest(maybeImagingTest: unknown): ImagingTest | OaValidationError;
