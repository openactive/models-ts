...
exports.validateImagingTest = exports.ImagingTestOrSubClassJoiSchema = exports.ImagingTestJoiSchema = void 0;
 ...
 */
exports.ImagingTestJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ImagingTestOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ImagingTestJoiSchema,
]);
/**
 ...
 *
 * ```ts
 * const maybeImagingTest = ImagingTest.validate(req.body); // `req.body` will have type `any` or `unknown`
 ...
 * ```
 */
function validateImagingTest(maybeImagingTest) {
    const { value, error } = exports.ImagingTestJoiSchema.validate(maybeImagingTest);
    if (error) {
        return new oaValidationError_1.OaValidationError('ImagingTest', maybeImagingTest, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateImagingTest = validateImagingTest;
