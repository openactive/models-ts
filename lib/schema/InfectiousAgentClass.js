...
exports.validateInfectiousAgentClass = exports.InfectiousAgentClassOrSubClassJoiSchema = exports.InfectiousAgentClassJoiSchema = void 0;
 ...
 */
exports.InfectiousAgentClassJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.InfectiousAgentClassOrSubClassJoiSchema = Joi.alternatives().try([
    exports.InfectiousAgentClassJoiSchema,
]);
/**
 ...
 * ```
 */
function validateInfectiousAgentClass(maybeInfectiousAgentClass) {
    const { value, error } = exports.InfectiousAgentClassJoiSchema.validate(maybeInfectiousAgentClass);
    if (error) {
        return new oaValidationError_1.OaValidationError('InfectiousAgentClass', maybeInfectiousAgentClass, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateInfectiousAgentClass = validateInfectiousAgentClass;
