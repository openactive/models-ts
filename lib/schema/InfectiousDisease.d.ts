 ...
 * etc.
 */
export declare type InfectiousDiseaseOrSubClass = InfectiousDisease;
/**
 * schema:InfectiousDisease - Validation schema (w/ JOI)
 */
export declare const InfectiousDiseaseJoiSchema: Joi.ObjectSchema;
/**
 * schema:InfectiousDisease - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const InfectiousDiseaseOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 *
 * ```ts
 * const maybeInfectiousDisease = InfectiousDisease.validate(req.body); // `req.body` will have type `any` or `unknown`
 ...
 * ```
 */
export declare function validateInfectiousDisease(maybeInfectiousDisease: unknown): InfectiousDisease | OaValidationError;
