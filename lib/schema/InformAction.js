...
exports.validateInformAction = exports.InformActionOrSubClassJoiSchema = exports.InformActionJoiSchema = void 0;
 ...
 */
exports.InformActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.InformActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.InformActionJoiSchema,
 ...
 * ```
 */
function validateInformAction(maybeInformAction) {
    const { value, error } = exports.InformActionJoiSchema.validate(maybeInformAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('InformAction', maybeInformAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateInformAction = validateInformAction;
