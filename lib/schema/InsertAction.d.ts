 ...
 * etc.
 */
export declare type InsertActionOrSubClass = InsertAction | schema.AppendActionOrSubClass | schema.PrependActionOrSubClass;
/**
 * schema:InsertAction - Validation schema (w/ JOI)
 */
export declare const InsertActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:InsertAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const InsertActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateInsertAction(maybeInsertAction: unknown): InsertAction | OaValidationError;
