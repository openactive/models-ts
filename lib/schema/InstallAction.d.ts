 ...
 * etc.
 */
export declare type InstallActionOrSubClass = InstallAction;
/**
 * schema:InstallAction - Validation schema (w/ JOI)
 */
export declare const InstallActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:InstallAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const InstallActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateInstallAction(maybeInstallAction: unknown): InstallAction | OaValidationError;
