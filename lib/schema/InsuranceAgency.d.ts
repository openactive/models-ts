 ...
 * etc.
 */
export declare type InsuranceAgencyOrSubClass = InsuranceAgency;
/**
 * schema:InsuranceAgency - Validation schema (w/ JOI)
 */
export declare const InsuranceAgencyJoiSchema: Joi.ObjectSchema;
/**
 * schema:InsuranceAgency - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const InsuranceAgencyOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateInsuranceAgency(maybeInsuranceAgency: unknown): InsuranceAgency | OaValidationError;
