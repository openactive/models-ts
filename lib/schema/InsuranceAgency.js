...
exports.validateInsuranceAgency = exports.InsuranceAgencyOrSubClassJoiSchema = exports.InsuranceAgencyJoiSchema = void 0;
 ...
 */
exports.InsuranceAgencyJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.InsuranceAgencyOrSubClassJoiSchema = Joi.alternatives().try([
    exports.InsuranceAgencyJoiSchema,
]);
/**
 ...
 * ```
 */
function validateInsuranceAgency(maybeInsuranceAgency) {
    const { value, error } = exports.InsuranceAgencyJoiSchema.validate(maybeInsuranceAgency);
    if (error) {
        return new oaValidationError_1.OaValidationError('InsuranceAgency', maybeInsuranceAgency, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateInsuranceAgency = validateInsuranceAgency;
