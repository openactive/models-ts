 ...
 */
export declare const IntangibleJoiSchema: Joi.ObjectSchema;
/**
 * schema:Intangible - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const IntangibleOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateIntangible(maybeIntangible: unknown): Intangible | OaValidationError;
