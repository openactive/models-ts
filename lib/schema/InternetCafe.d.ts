 ...
 * etc.
 */
export declare type InternetCafeOrSubClass = InternetCafe;
/**
 * schema:InternetCafe - Validation schema (w/ JOI)
 */
export declare const InternetCafeJoiSchema: Joi.ObjectSchema;
/**
 * schema:InternetCafe - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const InternetCafeOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateInternetCafe(maybeInternetCafe: unknown): InternetCafe | OaValidationError;
