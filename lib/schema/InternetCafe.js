...
exports.validateInternetCafe = exports.InternetCafeOrSubClassJoiSchema = exports.InternetCafeJoiSchema = void 0;
 ...
 */
exports.InternetCafeJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.InternetCafeOrSubClassJoiSchema = Joi.alternatives().try([
    exports.InternetCafeJoiSchema,
]);
/**
 ...
 * ```
 */
function validateInternetCafe(maybeInternetCafe) {
    const { value, error } = exports.InternetCafeJoiSchema.validate(maybeInternetCafe);
    if (error) {
        return new oaValidationError_1.OaValidationError('InternetCafe', maybeInternetCafe, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateInternetCafe = validateInternetCafe;
