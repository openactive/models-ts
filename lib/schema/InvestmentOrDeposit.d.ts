 ...
 * etc.
 */
export declare type InvestmentOrDepositOrSubClass = InvestmentOrDeposit | schema.DepositAccountOrSubClass | schema.InvestmentFundOrSubClass | schema.BrokerageAccountOrSubClass;
/**
 * schema:InvestmentOrDeposit - Validation schema (w/ JOI)
 */
export declare const InvestmentOrDepositJoiSchema: Joi.ObjectSchema;
/**
 * schema:InvestmentOrDeposit - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const InvestmentOrDepositOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateInvestmentOrDeposit(maybeInvestmentOrDeposit: unknown): InvestmentOrDeposit | OaValidationError;
