 ...
 * etc.
 */
export declare type InvestmentOrDepositOrSubClass = InvestmentOrDeposit | schema.DepositAccountOrSubClass | schema.BrokerageAccountOrSubClass | schema.InvestmentFundOrSubClass;
/**
