...
exports.validateInviteAction = exports.InviteActionOrSubClassJoiSchema = exports.InviteActionJoiSchema = void 0;
 ...
 */
exports.InviteActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.InviteActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.InviteActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateInviteAction(maybeInviteAction) {
    const { value, error } = exports.InviteActionJoiSchema.validate(maybeInviteAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('InviteAction', maybeInviteAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateInviteAction = validateInviteAction;
