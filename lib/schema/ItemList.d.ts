 ...
 * etc.
 */
export declare type ItemListOrSubClass = ItemList | schema.HowToStepOrSubClass | schema.BreadcrumbListOrSubClass | schema.HowToSectionOrSubClass | schema.OfferCatalogOrSubClass;
/**
