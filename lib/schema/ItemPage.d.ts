 ...
 * etc.
 */
export declare type ItemPageOrSubClass = ItemPage;
/**
 * schema:ItemPage - Validation schema (w/ JOI)
 */
export declare const ItemPageJoiSchema: Joi.ObjectSchema;
/**
 * schema:ItemPage - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ItemPageOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateItemPage(maybeItemPage: unknown): ItemPage | OaValidationError;
