...
exports.validateItemPage = exports.ItemPageOrSubClassJoiSchema = exports.ItemPageJoiSchema = void 0;
 ...
 */
exports.ItemPageJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ItemPageOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ItemPageJoiSchema,
]);
/**
 ...
 * ```
 */
function validateItemPage(maybeItemPage) {
    const { value, error } = exports.ItemPageJoiSchema.validate(maybeItemPage);
    if (error) {
        return new oaValidationError_1.OaValidationError('ItemPage', maybeItemPage, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateItemPage = validateItemPage;
