 ...
 * etc.
 */
export declare type JewelryStoreOrSubClass = JewelryStore;
/**
 * schema:JewelryStore - Validation schema (w/ JOI)
 */
export declare const JewelryStoreJoiSchema: Joi.ObjectSchema;
/**
 * schema:JewelryStore - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const JewelryStoreOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateJewelryStore(maybeJewelryStore: unknown): JewelryStore | OaValidationError;
