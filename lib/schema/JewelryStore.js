...
exports.validateJewelryStore = exports.JewelryStoreOrSubClassJoiSchema = exports.JewelryStoreJoiSchema = void 0;
 ...
 */
exports.JewelryStoreJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.JewelryStoreOrSubClassJoiSchema = Joi.alternatives().try([
    exports.JewelryStoreJoiSchema,
]);
/**
 ...
 * ```
 */
function validateJewelryStore(maybeJewelryStore) {
    const { value, error } = exports.JewelryStoreJoiSchema.validate(maybeJewelryStore);
    if (error) {
        return new oaValidationError_1.OaValidationError('JewelryStore', maybeJewelryStore, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateJewelryStore = validateJewelryStore;
