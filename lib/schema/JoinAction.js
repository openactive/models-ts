...
exports.validateJoinAction = exports.JoinActionOrSubClassJoiSchema = exports.JoinActionJoiSchema = void 0;
 ...
 */
exports.JoinActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.JoinActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.JoinActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateJoinAction(maybeJoinAction) {
    const { value, error } = exports.JoinActionJoiSchema.validate(maybeJoinAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('JoinAction', maybeJoinAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateJoinAction = validateJoinAction;
