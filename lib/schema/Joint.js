...
exports.validateJoint = exports.JointOrSubClassJoiSchema = exports.JointJoiSchema = void 0;
 ...
 */
exports.JointJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.JointOrSubClassJoiSchema = Joi.alternatives().try([
    exports.JointJoiSchema,
]);
/**
 ...
 * ```
 */
function validateJoint(maybeJoint) {
    const { value, error } = exports.JointJoiSchema.validate(maybeJoint);
    if (error) {
        return new oaValidationError_1.OaValidationError('Joint', maybeJoint, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateJoint = validateJoint;
