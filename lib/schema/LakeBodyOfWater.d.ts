 ...
 * etc.
 */
export declare type LakeBodyOfWaterOrSubClass = LakeBodyOfWater;
/**
 * schema:LakeBodyOfWater - Validation schema (w/ JOI)
 */
export declare const LakeBodyOfWaterJoiSchema: Joi.ObjectSchema;
/**
 * schema:LakeBodyOfWater - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const LakeBodyOfWaterOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateLakeBodyOfWater(maybeLakeBodyOfWater: unknown): LakeBodyOfWater | OaValidationError;
