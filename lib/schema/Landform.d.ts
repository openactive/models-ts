 ...
 * etc.
 */
export declare type LandformOrSubClass = Landform | schema.BodyOfWaterOrSubClass | schema.ContinentOrSubClass | schema.MountainOrSubClass | schema.VolcanoOrSubClass;
/**
 * schema:Landform - Validation schema (w/ JOI)
 */
export declare const LandformJoiSchema: Joi.ObjectSchema;
/**
 * schema:Landform - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const LandformOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateLandform(maybeLandform: unknown): Landform | OaValidationError;
