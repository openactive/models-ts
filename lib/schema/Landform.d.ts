 ...
 * etc.
 */
export declare type LandformOrSubClass = Landform | schema.ContinentOrSubClass | schema.BodyOfWaterOrSubClass | schema.MountainOrSubClass | schema.VolcanoOrSubClass;
/**
