...
exports.validateLandform = exports.LandformOrSubClassJoiSchema = exports.LandformJoiSchema = void 0;
 ...
 */
exports.LandformJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.LandformOrSubClassJoiSchema = Joi.alternatives().try([
    exports.LandformJoiSchema,
 ...
 * ```
 */
function validateLandform(maybeLandform) {
    const { value, error } = exports.LandformJoiSchema.validate(maybeLandform);
    if (error) {
        return new oaValidationError_1.OaValidationError('Landform', maybeLandform, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateLandform = validateLandform;
