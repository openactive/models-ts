 ...
 * etc.
 */
export declare type LandmarksOrHistoricalBuildingsOrSubClass = LandmarksOrHistoricalBuildings;
/**
 * schema:LandmarksOrHistoricalBuildings - Validation schema (w/ JOI)
 */
export declare const LandmarksOrHistoricalBuildingsJoiSchema: Joi.ObjectSchema;
/**
 * schema:LandmarksOrHistoricalBuildings - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const LandmarksOrHistoricalBuildingsOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateLandmarksOrHistoricalBuildings(maybeLandmarksOrHistoricalBuildings: unknown): LandmarksOrHistoricalBuildings | OaValidationError;
