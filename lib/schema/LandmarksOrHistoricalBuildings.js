...
exports.validateLandmarksOrHistoricalBuildings = exports.LandmarksOrHistoricalBuildingsOrSubClassJoiSchema = exports.LandmarksOrHistoricalBuildingsJoiSchema = void 0;
 ...
 */
exports.LandmarksOrHistoricalBuildingsJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.LandmarksOrHistoricalBuildingsOrSubClassJoiSchema = Joi.alternatives().try([
    exports.LandmarksOrHistoricalBuildingsJoiSchema,
]);
/**
 ...
 * ```
 */
function validateLandmarksOrHistoricalBuildings(maybeLandmarksOrHistoricalBuildings) {
    const { value, error } = exports.LandmarksOrHistoricalBuildingsJoiSchema.validate(maybeLandmarksOrHistoricalBuildings);
    if (error) {
        return new oaValidationError_1.OaValidationError('LandmarksOrHistoricalBuildings', maybeLandmarksOrHistoricalBuildings, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateLandmarksOrHistoricalBuildings = validateLandmarksOrHistoricalBuildings;
