 ...
 * etc.
 */
export declare type LanguageOrSubClass = Language;
/**
 * schema:Language - Validation schema (w/ JOI)
 */
export declare const LanguageJoiSchema: Joi.ObjectSchema;
/**
 * schema:Language - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const LanguageOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateLanguage(maybeLanguage: unknown): Language | OaValidationError;
