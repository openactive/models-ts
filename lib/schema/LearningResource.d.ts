 ...
 */
export declare type LearningResource = {
 ...
 * etc.
 */
export declare type LearningResourceOrSubClass = LearningResource | schema.CourseOrSubClass | schema.QuizOrSubClass;
/**
 * schema:LearningResource - Validation schema (w/ JOI)
 */
export declare const LearningResourceJoiSchema: Joi.ObjectSchema;
/**
 * schema:LearningResource - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const LearningResourceOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateLearningResource(maybeLearningResource: unknown): LearningResource | OaValidationError;
