...
exports.validateLearningResource = exports.LearningResourceOrSubClassJoiSchema = exports.LearningResourceJoiSchema = void 0;
 ...
 */
exports.LearningResourceJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.LearningResourceOrSubClassJoiSchema = Joi.alternatives().try([
    exports.LearningResourceJoiSchema,
 ...
 * ```
 */
function validateLearningResource(maybeLearningResource) {
    const { value, error } = exports.LearningResourceJoiSchema.validate(maybeLearningResource);
    if (error) {
        return new oaValidationError_1.OaValidationError('LearningResource', maybeLearningResource, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateLearningResource = validateLearningResource;
