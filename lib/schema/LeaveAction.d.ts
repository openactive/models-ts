 ...
 * etc.
 */
export declare type LeaveActionOrSubClass = LeaveAction;
/**
 * schema:LeaveAction - Validation schema (w/ JOI)
 */
export declare const LeaveActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:LeaveAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const LeaveActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateLeaveAction(maybeLeaveAction: unknown): LeaveAction | OaValidationError;
