...
exports.validateLegalForceStatus = exports.LegalForceStatusOrSubClassJoiSchema = exports.LegalForceStatusJoiSchema = void 0;
 ...
 */
exports.LegalForceStatusJoiSchema = Joi.object({
    '@type': Joi.string().valid('LegalForceStatus').required(),
 ...
 * `SessionSeries`, etc.
 */
exports.LegalForceStatusOrSubClassJoiSchema = Joi.alternatives().try([
    exports.LegalForceStatusJoiSchema,
]);
/**
 ...
 * ```
 */
function validateLegalForceStatus(maybeLegalForceStatus) {
    const { value, error } = exports.LegalForceStatusJoiSchema.validate(maybeLegalForceStatus);
    if (error) {
        return new oaValidationError_1.OaValidationError('LegalForceStatus', maybeLegalForceStatus, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateLegalForceStatus = validateLegalForceStatus;
