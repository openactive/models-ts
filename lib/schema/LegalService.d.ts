 ...
 * etc.
 */
export declare type LegalServiceOrSubClass = LegalService | schema.AttorneyOrSubClass | schema.NotaryOrSubClass;
/**
 * schema:LegalService - Validation schema (w/ JOI)
 */
export declare const LegalServiceJoiSchema: Joi.ObjectSchema;
/**
 * schema:LegalService - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const LegalServiceOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateLegalService(maybeLegalService: unknown): LegalService | OaValidationError;
