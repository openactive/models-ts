...
exports.validateLegalService = exports.LegalServiceOrSubClassJoiSchema = exports.LegalServiceJoiSchema = void 0;
 ...
 */
exports.LegalServiceJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.LegalServiceOrSubClassJoiSchema = Joi.alternatives().try([
    exports.LegalServiceJoiSchema,
 ...
 * ```
 */
function validateLegalService(maybeLegalService) {
    const { value, error } = exports.LegalServiceJoiSchema.validate(maybeLegalService);
    if (error) {
        return new oaValidationError_1.OaValidationError('LegalService', maybeLegalService, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateLegalService = validateLegalService;
