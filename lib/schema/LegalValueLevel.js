 ...
 */
exports.LegalValueLevelJoiSchema = Joi.string().valid('https://schema.org/UnofficialLegalValue', 'https://schema.org/AuthoritativeLegalValue', 'https://schema.org/OfficialLegalValue', 'https://schema.org/DefinitiveLegalValue');
/**
