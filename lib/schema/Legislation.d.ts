 ...
 * etc.
 */
export declare type LegislationOrSubClass = Legislation | schema.LegislationObjectOrSubClass;
/**
 * schema:Legislation - Validation schema (w/ JOI)
 */
export declare const LegislationJoiSchema: Joi.ObjectSchema;
/**
 * schema:Legislation - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const LegislationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateLegislation(maybeLegislation: unknown): Legislation | OaValidationError;
