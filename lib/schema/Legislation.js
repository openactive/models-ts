...
exports.validateLegislation = exports.LegislationOrSubClassJoiSchema = exports.LegislationJoiSchema = void 0;
 ...
 */
exports.LegislationJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.LegislationOrSubClassJoiSchema = Joi.alternatives().try([
    exports.LegislationJoiSchema,
 ...
 * ```
 */
function validateLegislation(maybeLegislation) {
    const { value, error } = exports.LegislationJoiSchema.validate(maybeLegislation);
    if (error) {
        return new oaValidationError_1.OaValidationError('Legislation', maybeLegislation, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateLegislation = validateLegislation;
