 ...
 * etc.
 */
export declare type LegislationObjectOrSubClass = LegislationObject;
/**
 * schema:LegislationObject - Validation schema (w/ JOI)
 */
export declare const LegislationObjectJoiSchema: Joi.ObjectSchema;
/**
 * schema:LegislationObject - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const LegislationObjectOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateLegislationObject(maybeLegislationObject: unknown): LegislationObject | OaValidationError;
