 ...
 * etc.
 */
export declare type LegislativeBuildingOrSubClass = LegislativeBuilding;
/**
 * schema:LegislativeBuilding - Validation schema (w/ JOI)
 */
export declare const LegislativeBuildingJoiSchema: Joi.ObjectSchema;
/**
 * schema:LegislativeBuilding - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const LegislativeBuildingOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateLegislativeBuilding(maybeLegislativeBuilding: unknown): LegislativeBuilding | OaValidationError;
