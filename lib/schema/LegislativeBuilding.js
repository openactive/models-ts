...
exports.validateLegislativeBuilding = exports.LegislativeBuildingOrSubClassJoiSchema = exports.LegislativeBuildingJoiSchema = void 0;
 ...
 */
exports.LegislativeBuildingJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.LegislativeBuildingOrSubClassJoiSchema = Joi.alternatives().try([
    exports.LegislativeBuildingJoiSchema,
]);
/**
 ...
 * ```
 */
function validateLegislativeBuilding(maybeLegislativeBuilding) {
    const { value, error } = exports.LegislativeBuildingJoiSchema.validate(maybeLegislativeBuilding);
    if (error) {
        return new oaValidationError_1.OaValidationError('LegislativeBuilding', maybeLegislativeBuilding, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateLegislativeBuilding = validateLegislativeBuilding;
