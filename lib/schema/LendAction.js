...
exports.validateLendAction = exports.LendActionOrSubClassJoiSchema = exports.LendActionJoiSchema = void 0;
 ...
 */
exports.LendActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.LendActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.LendActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateLendAction(maybeLendAction) {
    const { value, error } = exports.LendActionJoiSchema.validate(maybeLendAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('LendAction', maybeLendAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateLendAction = validateLendAction;
