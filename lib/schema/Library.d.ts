 ...
 * etc.
 */
export declare type LibraryOrSubClass = Library;
/**
 * schema:Library - Validation schema (w/ JOI)
 */
export declare const LibraryJoiSchema: Joi.ObjectSchema;
/**
 * schema:Library - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const LibraryOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateLibrary(maybeLibrary: unknown): Library | OaValidationError;
