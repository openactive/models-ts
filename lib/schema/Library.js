...
exports.validateLibrary = exports.LibraryOrSubClassJoiSchema = exports.LibraryJoiSchema = void 0;
 ...
 */
exports.LibraryJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.LibraryOrSubClassJoiSchema = Joi.alternatives().try([
    exports.LibraryJoiSchema,
]);
/**
 ...
 * ```
 */
function validateLibrary(maybeLibrary) {
    const { value, error } = exports.LibraryJoiSchema.validate(maybeLibrary);
    if (error) {
        return new oaValidationError_1.OaValidationError('Library', maybeLibrary, error);
    }
