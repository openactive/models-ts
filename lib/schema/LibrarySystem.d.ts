 ...
 * etc.
 */
export declare type LibrarySystemOrSubClass = LibrarySystem;
/**
 * schema:LibrarySystem - Validation schema (w/ JOI)
 */
export declare const LibrarySystemJoiSchema: Joi.ObjectSchema;
/**
 * schema:LibrarySystem - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const LibrarySystemOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateLibrarySystem(maybeLibrarySystem: unknown): LibrarySystem | OaValidationError;
