...
exports.validateLibrarySystem = exports.LibrarySystemOrSubClassJoiSchema = exports.LibrarySystemJoiSchema = void 0;
 ...
 */
exports.LibrarySystemJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.LibrarySystemOrSubClassJoiSchema = Joi.alternatives().try([
    exports.LibrarySystemJoiSchema,
]);
/**
 ...
 * ```
 */
function validateLibrarySystem(maybeLibrarySystem) {
    const { value, error } = exports.LibrarySystemJoiSchema.validate(maybeLibrarySystem);
    if (error) {
        return new oaValidationError_1.OaValidationError('LibrarySystem', maybeLibrarySystem, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateLibrarySystem = validateLibrarySystem;
