 ...
 * etc.
 */
export declare type LifestyleModificationOrSubClass = LifestyleModification | schema.PhysicalActivityOrSubClass | schema.DietOrSubClass;
/**
 * schema:LifestyleModification - Validation schema (w/ JOI)
 */
export declare const LifestyleModificationJoiSchema: Joi.ObjectSchema;
/**
 * schema:LifestyleModification - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const LifestyleModificationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateLifestyleModification(maybeLifestyleModification: unknown): LifestyleModification | OaValidationError;
