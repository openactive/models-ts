...
exports.validateLigament = exports.LigamentOrSubClassJoiSchema = exports.LigamentJoiSchema = void 0;
 ...
 */
exports.LigamentJoiSchema = Joi.object({
    '@type': Joi.string().valid('Ligament').required(),
 ...
 * `SessionSeries`, etc.
 */
exports.LigamentOrSubClassJoiSchema = Joi.alternatives().try([
    exports.LigamentJoiSchema,
]);
/**
 ...
 * ```
 */
function validateLigament(maybeLigament) {
    const { value, error } = exports.LigamentJoiSchema.validate(maybeLigament);
    if (error) {
        return new oaValidationError_1.OaValidationError('Ligament', maybeLigament, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateLigament = validateLigament;
