 ...
 * etc.
 */
export declare type LiquorStoreOrSubClass = LiquorStore;
/**
 * schema:LiquorStore - Validation schema (w/ JOI)
 */
export declare const LiquorStoreJoiSchema: Joi.ObjectSchema;
/**
 * schema:LiquorStore - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const LiquorStoreOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateLiquorStore(maybeLiquorStore: unknown): LiquorStore | OaValidationError;
