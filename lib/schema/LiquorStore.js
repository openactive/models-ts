...
exports.validateLiquorStore = exports.LiquorStoreOrSubClassJoiSchema = exports.LiquorStoreJoiSchema = void 0;
 ...
 */
exports.LiquorStoreJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.LiquorStoreOrSubClassJoiSchema = Joi.alternatives().try([
    exports.LiquorStoreJoiSchema,
]);
/**
 ...
 * ```
 */
function validateLiquorStore(maybeLiquorStore) {
    const { value, error } = exports.LiquorStoreJoiSchema.validate(maybeLiquorStore);
    if (error) {
        return new oaValidationError_1.OaValidationError('LiquorStore', maybeLiquorStore, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateLiquorStore = validateLiquorStore;
