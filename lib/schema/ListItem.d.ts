 ...
 * etc.
 */
export declare type ListItemOrSubClass = ListItem | schema.HowToSectionOrSubClass | schema.HowToDirectionOrSubClass | schema.HowToTipOrSubClass | schema.HowToItemOrSubClass | schema.HowToStepOrSubClass;
/**
