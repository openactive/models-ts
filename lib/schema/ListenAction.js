...
exports.validateListenAction = exports.ListenActionOrSubClassJoiSchema = exports.ListenActionJoiSchema = void 0;
 ...
 */
exports.ListenActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ListenActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ListenActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateListenAction(maybeListenAction) {
    const { value, error } = exports.ListenActionJoiSchema.validate(maybeListenAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('ListenAction', maybeListenAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateListenAction = validateListenAction;
