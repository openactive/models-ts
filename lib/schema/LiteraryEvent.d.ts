 ...
 * etc.
 */
export declare type LiteraryEventOrSubClass = LiteraryEvent;
/**
 * schema:LiteraryEvent - Validation schema (w/ JOI)
 */
export declare const LiteraryEventJoiSchema: Joi.ObjectSchema;
/**
 * schema:LiteraryEvent - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const LiteraryEventOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateLiteraryEvent(maybeLiteraryEvent: unknown): LiteraryEvent | OaValidationError;
