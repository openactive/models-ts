...
exports.validateLiteraryEvent = exports.LiteraryEventOrSubClassJoiSchema = exports.LiteraryEventJoiSchema = void 0;
 ...
 */
exports.LiteraryEventJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.LiteraryEventOrSubClassJoiSchema = Joi.alternatives().try([
    exports.LiteraryEventJoiSchema,
]);
/**
 ...
 * ```
 */
function validateLiteraryEvent(maybeLiteraryEvent) {
    const { value, error } = exports.LiteraryEventJoiSchema.validate(maybeLiteraryEvent);
    if (error) {
        return new oaValidationError_1.OaValidationError('LiteraryEvent', maybeLiteraryEvent, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateLiteraryEvent = validateLiteraryEvent;
