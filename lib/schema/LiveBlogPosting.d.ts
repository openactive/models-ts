 ...
 * etc.
 */
export declare type LiveBlogPostingOrSubClass = LiveBlogPosting;
/**
 * schema:LiveBlogPosting - Validation schema (w/ JOI)
 */
export declare const LiveBlogPostingJoiSchema: Joi.ObjectSchema;
/**
 * schema:LiveBlogPosting - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const LiveBlogPostingOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateLiveBlogPosting(maybeLiveBlogPosting: unknown): LiveBlogPosting | OaValidationError;
