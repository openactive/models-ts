...
exports.validateLiveBlogPosting = exports.LiveBlogPostingOrSubClassJoiSchema = exports.LiveBlogPostingJoiSchema = void 0;
 ...
 */
exports.LiveBlogPostingJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.LiveBlogPostingOrSubClassJoiSchema = Joi.alternatives().try([
    exports.LiveBlogPostingJoiSchema,
]);
/**
 ...
 * ```
 */
function validateLiveBlogPosting(maybeLiveBlogPosting) {
    const { value, error } = exports.LiveBlogPostingJoiSchema.validate(maybeLiveBlogPosting);
    if (error) {
        return new oaValidationError_1.OaValidationError('LiveBlogPosting', maybeLiveBlogPosting, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateLiveBlogPosting = validateLiveBlogPosting;
