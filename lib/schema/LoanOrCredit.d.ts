 ...
 * schema:LoanOrCredit
 *
 * This differs from LoanOrCredit because it also allows for objects that have the type of a model that
 * sub-classes this model. e.g. `Event_OrSubClass` allows `Event`s as well as `ScheduledSession`s, `SessionSeries`,
 * etc.
 */
export declare type LoanOrCreditOrSubClass = LoanOrCredit | schema.CreditCardOrSubClass | schema.MortgageLoanOrSubClass;
/**
 * schema:LoanOrCredit - Validation schema (w/ JOI)
 */
export declare const LoanOrCreditJoiSchema: Joi.ObjectSchema;
/**
 * schema:LoanOrCredit - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const LoanOrCreditOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateLoanOrCredit(maybeLoanOrCredit: unknown): LoanOrCredit | OaValidationError;
