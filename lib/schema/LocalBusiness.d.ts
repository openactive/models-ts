 ...
 * etc.
 */
export declare type LocalBusinessOrSubClass = LocalBusiness | schema.EmploymentAgencyOrSubClass | schema.DryCleaningOrLaundryOrSubClass | schema.ProfessionalServiceOrSubClass | schema.SelfStorageOrSubClass | schema.EmergencyServiceOrSubClass | schema.MedicalBusinessOrSubClass | schema.RadioStationOrSubClass | schema.TravelAgencyOrSubClass | schema.RecyclingCenterOrSubClass | schema.AnimalShelterOrSubClass | schema.HomeAndConstructionBusinessOrSubClass | schema.FoodEstablishmentOrSubClass | schema.LibraryOrSubClass | schema.ChildCareOrSubClass | schema.DentistOrSubClass | schema.InternetCafeOrSubClass | schema.FinancialServiceOrSubClass | schema.AutomotiveBusinessOrSubClass | schema.GovernmentOfficeOrSubClass | schema.ShoppingCenterOrSubClass | schema.StoreOrSubClass | schema.TouristInformationCenterOrSubClass | schema.EntertainmentBusinessOrSubClass | schema.LegalServiceOrSubClass | schema.HealthAndBeautyBusinessOrSubClass | schema.LodgingBusinessOrSubClass | schema.RealEstateAgentOrSubClass | schema.TelevisionStationOrSubClass | schema.SportsActivityLocationOrSubClass | schema.ArchiveOrganizationOrSubClass;
/**
 * schema:LocalBusiness - Validation schema (w/ JOI)
 */
export declare const LocalBusinessJoiSchema: Joi.ObjectSchema;
/**
 * schema:LocalBusiness - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const LocalBusinessOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateLocalBusiness(maybeLocalBusiness: unknown): LocalBusiness | OaValidationError;
