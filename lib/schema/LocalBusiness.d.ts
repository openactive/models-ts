 ...
 * etc.
 */
export declare type LocalBusinessOrSubClass = LocalBusiness | schema.DentistOrSubClass | schema.FoodEstablishmentOrSubClass | schema.SportsActivityLocationOrSubClass | schema.TelevisionStationOrSubClass | schema.ChildCareOrSubClass | schema.TravelAgencyOrSubClass | schema.RecyclingCenterOrSubClass | schema.FinancialServiceOrSubClass | schema.RealEstateAgentOrSubClass | schema.DryCleaningOrLaundryOrSubClass | schema.SelfStorageOrSubClass | schema.LegalServiceOrSubClass | schema.EmploymentAgencyOrSubClass | schema.RadioStationOrSubClass | schema.StoreOrSubClass | schema.GovernmentOfficeOrSubClass | schema.LodgingBusinessOrSubClass | schema.EntertainmentBusinessOrSubClass | schema.EmergencyServiceOrSubClass | schema.ProfessionalServiceOrSubClass | schema.MedicalBusinessOrSubClass | schema.InternetCafeOrSubClass | schema.AnimalShelterOrSubClass | schema.ArchiveOrganizationOrSubClass | schema.ShoppingCenterOrSubClass | schema.TouristInformationCenterOrSubClass | schema.HealthAndBeautyBusinessOrSubClass | schema.AutomotiveBusinessOrSubClass | schema.HomeAndConstructionBusinessOrSubClass | schema.LibraryOrSubClass;
/**
