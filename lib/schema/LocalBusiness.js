...
exports.validateLocalBusiness = exports.LocalBusinessOrSubClassJoiSchema = exports.LocalBusinessJoiSchema = void 0;
 ...
 */
exports.LocalBusinessJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.LocalBusinessOrSubClassJoiSchema = Joi.alternatives().try([
    exports.LocalBusinessJoiSchema,
 ...
 * ```
 */
function validateLocalBusiness(maybeLocalBusiness) {
    const { value, error } = exports.LocalBusinessJoiSchema.validate(maybeLocalBusiness);
    if (error) {
        return new oaValidationError_1.OaValidationError('LocalBusiness', maybeLocalBusiness, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateLocalBusiness = validateLocalBusiness;
