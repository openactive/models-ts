 ...
 * etc.
 */
export declare type LocksmithOrSubClass = Locksmith;
/**
 * schema:Locksmith - Validation schema (w/ JOI)
 */
export declare const LocksmithJoiSchema: Joi.ObjectSchema;
/**
 * schema:Locksmith - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const LocksmithOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateLocksmith(maybeLocksmith: unknown): Locksmith | OaValidationError;
