...
exports.validateLocksmith = exports.LocksmithOrSubClassJoiSchema = exports.LocksmithJoiSchema = void 0;
 ...
 */
exports.LocksmithJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.LocksmithOrSubClassJoiSchema = Joi.alternatives().try([
    exports.LocksmithJoiSchema,
]);
/**
 ...
 * ```
 */
function validateLocksmith(maybeLocksmith) {
    const { value, error } = exports.LocksmithJoiSchema.validate(maybeLocksmith);
    if (error) {
        return new oaValidationError_1.OaValidationError('Locksmith', maybeLocksmith, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateLocksmith = validateLocksmith;
