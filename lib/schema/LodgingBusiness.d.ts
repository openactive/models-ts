 ...
 * etc.
 */
export declare type LodgingBusinessOrSubClass = LodgingBusiness | schema.BedAndBreakfastOrSubClass | schema.CampgroundOrSubClass | schema.HostelOrSubClass | schema.ResortOrSubClass | schema.MotelOrSubClass | schema.HotelOrSubClass;
/**
 * schema:LodgingBusiness - Validation schema (w/ JOI)
 */
export declare const LodgingBusinessJoiSchema: Joi.ObjectSchema;
/**
 * schema:LodgingBusiness - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const LodgingBusinessOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateLodgingBusiness(maybeLodgingBusiness: unknown): LodgingBusiness | OaValidationError;
