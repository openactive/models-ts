 ...
 * etc.
 */
export declare type LodgingBusinessOrSubClass = LodgingBusiness | schema.HotelOrSubClass | schema.CampgroundOrSubClass | schema.ResortOrSubClass | schema.BedAndBreakfastOrSubClass | schema.HostelOrSubClass | schema.MotelOrSubClass;
/**
