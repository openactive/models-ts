...
exports.validateLodgingBusiness = exports.LodgingBusinessOrSubClassJoiSchema = exports.LodgingBusinessJoiSchema = void 0;
 ...
 */
exports.LodgingBusinessJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.LodgingBusinessOrSubClassJoiSchema = Joi.alternatives().try([
    exports.LodgingBusinessJoiSchema,
 ...
 * ```
 */
function validateLodgingBusiness(maybeLodgingBusiness) {
    const { value, error } = exports.LodgingBusinessJoiSchema.validate(maybeLodgingBusiness);
    if (error) {
        return new oaValidationError_1.OaValidationError('LodgingBusiness', maybeLodgingBusiness, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateLodgingBusiness = validateLodgingBusiness;
