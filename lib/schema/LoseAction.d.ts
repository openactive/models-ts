 ...
 * etc.
 */
export declare type LoseActionOrSubClass = LoseAction;
/**
 * schema:LoseAction - Validation schema (w/ JOI)
 */
export declare const LoseActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:LoseAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const LoseActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateLoseAction(maybeLoseAction: unknown): LoseAction | OaValidationError;
