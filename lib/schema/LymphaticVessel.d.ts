 ...
 * etc.
 */
export declare type LymphaticVesselOrSubClass = LymphaticVessel;
/**
 * schema:LymphaticVessel - Validation schema (w/ JOI)
 */
export declare const LymphaticVesselJoiSchema: Joi.ObjectSchema;
/**
 * schema:LymphaticVessel - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const LymphaticVesselOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateLymphaticVessel(maybeLymphaticVessel: unknown): LymphaticVessel | OaValidationError;
