...
exports.validateLymphaticVessel = exports.LymphaticVesselOrSubClassJoiSchema = exports.LymphaticVesselJoiSchema = void 0;
 ...
 */
exports.LymphaticVesselJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.LymphaticVesselOrSubClassJoiSchema = Joi.alternatives().try([
    exports.LymphaticVesselJoiSchema,
]);
/**
 ...
 * ```
 */
function validateLymphaticVessel(maybeLymphaticVessel) {
    const { value, error } = exports.LymphaticVesselJoiSchema.validate(maybeLymphaticVessel);
    if (error) {
        return new oaValidationError_1.OaValidationError('LymphaticVessel', maybeLymphaticVessel, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateLymphaticVessel = validateLymphaticVessel;
