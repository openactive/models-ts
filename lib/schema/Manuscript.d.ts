 ...
 * etc.
 */
export declare type ManuscriptOrSubClass = Manuscript;
/**
 * schema:Manuscript - Validation schema (w/ JOI)
 */
export declare const ManuscriptJoiSchema: Joi.ObjectSchema;
/**
 * schema:Manuscript - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ManuscriptOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateManuscript(maybeManuscript: unknown): Manuscript | OaValidationError;
