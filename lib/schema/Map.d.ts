 ...
 * etc.
 */
export declare type MapOrSubClass = Map;
/**
 * schema:Map - Validation schema (w/ JOI)
 */
export declare const MapJoiSchema: Joi.ObjectSchema;
/**
 * schema:Map - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MapOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMap(maybeMap: unknown): Map | OaValidationError;
