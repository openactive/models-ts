 ...
 */
exports.MapCategoryTypeJoiSchema = Joi.string().valid('https://schema.org/SeatingMap', 'https://schema.org/VenueMap', 'https://schema.org/TransitMap', 'https://schema.org/ParkingMap');
/**
