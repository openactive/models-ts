...
exports.validateMarryAction = exports.MarryActionOrSubClassJoiSchema = exports.MarryActionJoiSchema = void 0;
 ...
 */
exports.MarryActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MarryActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MarryActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMarryAction(maybeMarryAction) {
    const { value, error } = exports.MarryActionJoiSchema.validate(maybeMarryAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('MarryAction', maybeMarryAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMarryAction = validateMarryAction;
