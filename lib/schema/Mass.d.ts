 ...
 * etc.
 */
export declare type MassOrSubClass = Mass;
/**
 * schema:Mass - Validation schema (w/ JOI)
 */
export declare const MassJoiSchema: Joi.ObjectSchema;
/**
 * schema:Mass - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MassOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMass(maybeMass: unknown): Mass | OaValidationError;
