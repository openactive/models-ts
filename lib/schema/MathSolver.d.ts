 ...
 * schema:MathSolver
 */
export declare type MathSolver = {
    '@type': 'MathSolver';
 ...
 * etc.
 */
export declare type MathSolverOrSubClass = MathSolver;
/**
 * schema:MathSolver - Validation schema (w/ JOI)
 */
export declare const MathSolverJoiSchema: Joi.ObjectSchema;
/**
 * schema:MathSolver - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MathSolverOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMathSolver(maybeMathSolver: unknown): MathSolver | OaValidationError;
