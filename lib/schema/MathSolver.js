...
exports.validateMathSolver = exports.MathSolverOrSubClassJoiSchema = exports.MathSolverJoiSchema = void 0;
 ...
 */
exports.MathSolverJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MathSolverOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MathSolverJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMathSolver(maybeMathSolver) {
    const { value, error } = exports.MathSolverJoiSchema.validate(maybeMathSolver);
    if (error) {
        return new oaValidationError_1.OaValidationError('MathSolver', maybeMathSolver, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMathSolver = validateMathSolver;
