 ...
 * etc.
 */
export declare type MaximumDoseScheduleOrSubClass = MaximumDoseSchedule;
/**
 * schema:MaximumDoseSchedule - Validation schema (w/ JOI)
 */
export declare const MaximumDoseScheduleJoiSchema: Joi.ObjectSchema;
/**
 * schema:MaximumDoseSchedule - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MaximumDoseScheduleOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMaximumDoseSchedule(maybeMaximumDoseSchedule: unknown): MaximumDoseSchedule | OaValidationError;
