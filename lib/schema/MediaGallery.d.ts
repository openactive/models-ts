 ...
 * etc.
 */
export declare type MediaGalleryOrSubClass = MediaGallery | schema.ImageGalleryOrSubClass | schema.VideoGalleryOrSubClass;
/**
 * schema:MediaGallery - Validation schema (w/ JOI)
 */
export declare const MediaGalleryJoiSchema: Joi.ObjectSchema;
/**
 * schema:MediaGallery - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MediaGalleryOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMediaGallery(maybeMediaGallery: unknown): MediaGallery | OaValidationError;
