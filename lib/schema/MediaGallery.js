...
exports.validateMediaGallery = exports.MediaGalleryOrSubClassJoiSchema = exports.MediaGalleryJoiSchema = void 0;
 ...
 */
exports.MediaGalleryJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MediaGalleryOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MediaGalleryJoiSchema,
 ...
 * ```
 */
function validateMediaGallery(maybeMediaGallery) {
    const { value, error } = exports.MediaGalleryJoiSchema.validate(maybeMediaGallery);
    if (error) {
        return new oaValidationError_1.OaValidationError('MediaGallery', maybeMediaGallery, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMediaGallery = validateMediaGallery;
