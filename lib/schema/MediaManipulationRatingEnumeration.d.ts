 ...
 */
export declare type MediaManipulationRatingEnumeration = 'https://schema.org/SatireOrParodyContent' | 'https://schema.org/EditedOrCroppedContent' | 'https://schema.org/OriginalMediaContent' | 'https://schema.org/DecontextualizedContent' | 'https://schema.org/TransformedContent' | 'https://schema.org/StagedContent';
/**
