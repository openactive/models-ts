 ...
 * etc.
 */
export declare type MediaObjectOrSubClass = MediaObject | schema.DataDownloadOrSubClass | schema.ImageObjectOrSubClass | schema.VideoObjectOrSubClass | schema.AudioObjectOrSubClass | schema.LegislationObjectOrSubClass | schema.MusicVideoObjectOrSubClass | schema.ThreeDModelOrSubClass;
/**
 * schema:MediaObject - Validation schema (w/ JOI)
 */
export declare const MediaObjectJoiSchema: Joi.ObjectSchema;
/**
 * schema:MediaObject - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MediaObjectOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMediaObject(maybeMediaObject: unknown): MediaObject | OaValidationError;
