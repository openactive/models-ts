...
exports.validateMediaObject = exports.MediaObjectOrSubClassJoiSchema = exports.MediaObjectJoiSchema = void 0;
 ...
 */
exports.MediaObjectJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MediaObjectOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MediaObjectJoiSchema,
 ...
 * ```
 */
function validateMediaObject(maybeMediaObject) {
    const { value, error } = exports.MediaObjectJoiSchema.validate(maybeMediaObject);
    if (error) {
        return new oaValidationError_1.OaValidationError('MediaObject', maybeMediaObject, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMediaObject = validateMediaObject;
