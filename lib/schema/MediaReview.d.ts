 ...
 * schema:MediaReview
 */
export declare type MediaReview = {
    '@type': 'MediaReview';
 ...
 * etc.
 */
export declare type MediaReviewOrSubClass = MediaReview;
/**
 * schema:MediaReview - Validation schema (w/ JOI)
 */
export declare const MediaReviewJoiSchema: Joi.ObjectSchema;
/**
 * schema:MediaReview - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MediaReviewOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMediaReview(maybeMediaReview: unknown): MediaReview | OaValidationError;
