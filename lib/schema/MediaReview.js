...
exports.validateMediaReview = exports.MediaReviewOrSubClassJoiSchema = exports.MediaReviewJoiSchema = void 0;
 ...
 */
exports.MediaReviewJoiSchema = Joi.object({
    ...
    '@id': Joi.string().uri(),
    originalMediaLink: Joi.alternatives().try(Joi.string().uri(), Joi.lazy(() => schema.WebPageOrSubClassJoiSchema), Joi.lazy(() => schema.MediaObjectOrSubClassJoiSchema)),
    mediaAuthenticityCategory: Joi.lazy(() => schema.MediaManipulationRatingEnumerationJoiSchema),
    originalMediaContextDescription: Joi.string(),
 ...
 * `SessionSeries`, etc.
 */
exports.MediaReviewOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MediaReviewJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMediaReview(maybeMediaReview) {
    const { value, error } = exports.MediaReviewJoiSchema.validate(maybeMediaReview);
    if (error) {
        return new oaValidationError_1.OaValidationError('MediaReview', maybeMediaReview, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMediaReview = validateMediaReview;
