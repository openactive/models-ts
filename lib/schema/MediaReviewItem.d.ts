 ...
 */
export declare type MediaReviewItem = {
 ...
 * etc.
 */
export declare type MediaReviewItemOrSubClass = MediaReviewItem;
/**
 * schema:MediaReviewItem - Validation schema (w/ JOI)
 */
export declare const MediaReviewItemJoiSchema: Joi.ObjectSchema;
/**
 * schema:MediaReviewItem - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MediaReviewItemOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMediaReviewItem(maybeMediaReviewItem: unknown): MediaReviewItem | OaValidationError;
