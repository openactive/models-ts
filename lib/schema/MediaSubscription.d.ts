 ...
 * etc.
 */
export declare type MediaSubscriptionOrSubClass = MediaSubscription;
/**
 * schema:MediaSubscription - Validation schema (w/ JOI)
 */
export declare const MediaSubscriptionJoiSchema: Joi.ObjectSchema;
/**
 * schema:MediaSubscription - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MediaSubscriptionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMediaSubscription(maybeMediaSubscription: unknown): MediaSubscription | OaValidationError;
