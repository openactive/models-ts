 ...
 * etc.
 */
export declare type MedicalBusinessOrSubClass = MedicalBusiness | schema.PharmacyOrSubClass | schema.OpticianOrSubClass | schema.DentistOrSubClass | schema.MedicalClinicOrSubClass | schema.PhysicianOrSubClass;
/**
 * schema:MedicalBusiness - Validation schema (w/ JOI)
 */
export declare const MedicalBusinessJoiSchema: Joi.ObjectSchema;
/**
 * schema:MedicalBusiness - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MedicalBusinessOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMedicalBusiness(maybeMedicalBusiness: unknown): MedicalBusiness | OaValidationError;
