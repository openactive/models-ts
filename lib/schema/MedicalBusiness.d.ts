 ...
 * etc.
 */
export declare type MedicalBusinessOrSubClass = MedicalBusiness | schema.DentistOrSubClass | schema.PharmacyOrSubClass | schema.PhysicianOrSubClass | schema.OpticianOrSubClass | schema.MedicalClinicOrSubClass;
/**
