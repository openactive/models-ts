...
exports.validateMedicalBusiness = exports.MedicalBusinessOrSubClassJoiSchema = exports.MedicalBusinessJoiSchema = void 0;
 ...
 */
exports.MedicalBusinessJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MedicalBusinessOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MedicalBusinessJoiSchema,
 ...
 * ```
 */
function validateMedicalBusiness(maybeMedicalBusiness) {
    const { value, error } = exports.MedicalBusinessJoiSchema.validate(maybeMedicalBusiness);
    if (error) {
        return new oaValidationError_1.OaValidationError('MedicalBusiness', maybeMedicalBusiness, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMedicalBusiness = validateMedicalBusiness;
