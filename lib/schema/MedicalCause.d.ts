 ...
 * etc.
 */
export declare type MedicalCauseOrSubClass = MedicalCause;
/**
 * schema:MedicalCause - Validation schema (w/ JOI)
 */
export declare const MedicalCauseJoiSchema: Joi.ObjectSchema;
/**
 * schema:MedicalCause - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MedicalCauseOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMedicalCause(maybeMedicalCause: unknown): MedicalCause | OaValidationError;
