 ...
 * etc.
 */
export declare type MedicalClinicOrSubClass = MedicalClinic | schema.CovidTestingFacilityOrSubClass;
/**
 * schema:MedicalClinic - Validation schema (w/ JOI)
 */
export declare const MedicalClinicJoiSchema: Joi.ObjectSchema;
/**
 * schema:MedicalClinic - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MedicalClinicOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMedicalClinic(maybeMedicalClinic: unknown): MedicalClinic | OaValidationError;
