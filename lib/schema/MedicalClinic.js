...
exports.validateMedicalClinic = exports.MedicalClinicOrSubClassJoiSchema = exports.MedicalClinicJoiSchema = void 0;
 ...
 */
exports.MedicalClinicJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MedicalClinicOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MedicalClinicJoiSchema,
 ...
 * ```
 */
function validateMedicalClinic(maybeMedicalClinic) {
    const { value, error } = exports.MedicalClinicJoiSchema.validate(maybeMedicalClinic);
    if (error) {
        return new oaValidationError_1.OaValidationError('MedicalClinic', maybeMedicalClinic, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMedicalClinic = validateMedicalClinic;
