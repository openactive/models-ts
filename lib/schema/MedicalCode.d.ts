 ...
 * etc.
 */
export declare type MedicalCodeOrSubClass = MedicalCode;
/**
 * schema:MedicalCode - Validation schema (w/ JOI)
 */
export declare const MedicalCodeJoiSchema: Joi.ObjectSchema;
/**
 * schema:MedicalCode - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MedicalCodeOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMedicalCode(maybeMedicalCode: unknown): MedicalCode | OaValidationError;
