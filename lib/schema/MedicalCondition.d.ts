 ...
 * etc.
 */
export declare type MedicalConditionOrSubClass = MedicalCondition | schema.InfectiousDiseaseOrSubClass | schema.MedicalSignOrSymptomOrSubClass;
/**
 * schema:MedicalCondition - Validation schema (w/ JOI)
 */
export declare const MedicalConditionJoiSchema: Joi.ObjectSchema;
/**
 * schema:MedicalCondition - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MedicalConditionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMedicalCondition(maybeMedicalCondition: unknown): MedicalCondition | OaValidationError;
