 ...
 * etc.
 */
export declare type MedicalConditionStageOrSubClass = MedicalConditionStage;
/**
 * schema:MedicalConditionStage - Validation schema (w/ JOI)
 */
export declare const MedicalConditionStageJoiSchema: Joi.ObjectSchema;
/**
 * schema:MedicalConditionStage - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MedicalConditionStageOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMedicalConditionStage(maybeMedicalConditionStage: unknown): MedicalConditionStage | OaValidationError;
