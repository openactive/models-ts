 ...
 * etc.
 */
export declare type MedicalEntityOrSubClass = MedicalEntity | schema.MedicalTestOrSubClass | schema.DrugCostOrSubClass | schema.SubstanceOrSubClass | schema.MedicalContraindicationOrSubClass | schema.MedicalCauseOrSubClass | schema.MedicalRiskEstimatorOrSubClass | schema.MedicalIntangibleOrSubClass | schema.MedicalIndicationOrSubClass | schema.AnatomicalStructureOrSubClass | schema.MedicalRiskFactorOrSubClass | schema.SuperficialAnatomyOrSubClass | schema.DrugClassOrSubClass | schema.MedicalStudyOrSubClass | schema.LifestyleModificationOrSubClass | schema.MedicalProcedureOrSubClass | schema.MedicalGuidelineOrSubClass | schema.MedicalDeviceOrSubClass | schema.AnatomicalSystemOrSubClass | schema.MedicalConditionOrSubClass;
/**
