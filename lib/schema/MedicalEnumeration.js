...
exports.validateMedicalEnumeration = exports.MedicalEnumerationJoiSchema = void 0;
 ...
 */
exports.MedicalEnumerationJoiSchema = Joi.string().valid();
/**
 ...
 * ```
 */
function validateMedicalEnumeration(maybeMedicalEnumeration) {
    const { value, error } = exports.MedicalEnumerationJoiSchema.validate(maybeMedicalEnumeration);
    if (error) {
        return new oaValidationError_1.OaValidationError('MedicalEnumeration', maybeMedicalEnumeration, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMedicalEnumeration = validateMedicalEnumeration;
