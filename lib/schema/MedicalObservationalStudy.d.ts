 ...
 * etc.
 */
export declare type MedicalObservationalStudyOrSubClass = MedicalObservationalStudy;
/**
 * schema:MedicalObservationalStudy - Validation schema (w/ JOI)
 */
export declare const MedicalObservationalStudyJoiSchema: Joi.ObjectSchema;
/**
 * schema:MedicalObservationalStudy - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MedicalObservationalStudyOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMedicalObservationalStudy(maybeMedicalObservationalStudy: unknown): MedicalObservationalStudy | OaValidationError;
