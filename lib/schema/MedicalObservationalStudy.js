...
exports.validateMedicalObservationalStudy = exports.MedicalObservationalStudyOrSubClassJoiSchema = exports.MedicalObservationalStudyJoiSchema = void 0;
 ...
 */
exports.MedicalObservationalStudyJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MedicalObservationalStudyOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MedicalObservationalStudyJoiSchema,
]);
/**
 ...
 *
 * ```ts
 * const maybeMedicalObservationalStudy = MedicalObservationalStudy.validate(req.body); // `req.body` will have type `any` or `unknown`
 ...
 * ```
 */
function validateMedicalObservationalStudy(maybeMedicalObservationalStudy) {
    const { value, error } = exports.MedicalObservationalStudyJoiSchema.validate(maybeMedicalObservationalStudy);
    if (error) {
        return new oaValidationError_1.OaValidationError('MedicalObservationalStudy', maybeMedicalObservationalStudy, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMedicalObservationalStudy = validateMedicalObservationalStudy;
