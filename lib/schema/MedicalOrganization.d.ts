 ...
 * etc.
 */
export declare type MedicalOrganizationOrSubClass = MedicalOrganization | schema.DentistOrSubClass | schema.PharmacyOrSubClass | schema.PhysicianOrSubClass | schema.VeterinaryCareOrSubClass | schema.DiagnosticLabOrSubClass | schema.HospitalOrSubClass | schema.MedicalClinicOrSubClass;
/**
