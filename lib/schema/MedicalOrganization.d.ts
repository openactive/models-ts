 ...
 * etc.
 */
export declare type MedicalOrganizationOrSubClass = MedicalOrganization | schema.PharmacyOrSubClass | schema.HospitalOrSubClass | schema.DiagnosticLabOrSubClass | schema.DentistOrSubClass | schema.MedicalClinicOrSubClass | schema.VeterinaryCareOrSubClass | schema.PhysicianOrSubClass;
/**
 * schema:MedicalOrganization - Validation schema (w/ JOI)
 */
export declare const MedicalOrganizationJoiSchema: Joi.ObjectSchema;
/**
 * schema:MedicalOrganization - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MedicalOrganizationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMedicalOrganization(maybeMedicalOrganization: unknown): MedicalOrganization | OaValidationError;
