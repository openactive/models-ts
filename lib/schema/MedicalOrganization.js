...
exports.validateMedicalOrganization = exports.MedicalOrganizationOrSubClassJoiSchema = exports.MedicalOrganizationJoiSchema = void 0;
 ...
 */
exports.MedicalOrganizationJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MedicalOrganizationOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MedicalOrganizationJoiSchema,
 ...
 * ```
 */
function validateMedicalOrganization(maybeMedicalOrganization) {
    const { value, error } = exports.MedicalOrganizationJoiSchema.validate(maybeMedicalOrganization);
    if (error) {
        return new oaValidationError_1.OaValidationError('MedicalOrganization', maybeMedicalOrganization, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMedicalOrganization = validateMedicalOrganization;
