 ...
 * etc.
 */
export declare type MedicalProcedureOrSubClass = MedicalProcedure | schema.PhysicalExamOrSubClass | schema.TherapeuticProcedureOrSubClass | schema.SurgicalProcedureOrSubClass | schema.DiagnosticProcedureOrSubClass | schema.PalliativeProcedureOrSubClass;
/**
 * schema:MedicalProcedure - Validation schema (w/ JOI)
 */
export declare const MedicalProcedureJoiSchema: Joi.ObjectSchema;
/**
 * schema:MedicalProcedure - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MedicalProcedureOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMedicalProcedure(maybeMedicalProcedure: unknown): MedicalProcedure | OaValidationError;
