 ...
 * etc.
 */
export declare type MedicalRiskEstimatorOrSubClass = MedicalRiskEstimator | schema.MedicalRiskCalculatorOrSubClass | schema.MedicalRiskScoreOrSubClass;
/**
 * schema:MedicalRiskEstimator - Validation schema (w/ JOI)
 */
export declare const MedicalRiskEstimatorJoiSchema: Joi.ObjectSchema;
/**
 * schema:MedicalRiskEstimator - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MedicalRiskEstimatorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMedicalRiskEstimator(maybeMedicalRiskEstimator: unknown): MedicalRiskEstimator | OaValidationError;
