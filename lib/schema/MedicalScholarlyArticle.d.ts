 ...
 * etc.
 */
export declare type MedicalScholarlyArticleOrSubClass = MedicalScholarlyArticle;
/**
 * schema:MedicalScholarlyArticle - Validation schema (w/ JOI)
 */
export declare const MedicalScholarlyArticleJoiSchema: Joi.ObjectSchema;
/**
 * schema:MedicalScholarlyArticle - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MedicalScholarlyArticleOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMedicalScholarlyArticle(maybeMedicalScholarlyArticle: unknown): MedicalScholarlyArticle | OaValidationError;
