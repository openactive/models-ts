...
exports.validateMedicalScholarlyArticle = exports.MedicalScholarlyArticleOrSubClassJoiSchema = exports.MedicalScholarlyArticleJoiSchema = void 0;
 ...
 */
exports.MedicalScholarlyArticleJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MedicalScholarlyArticleOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MedicalScholarlyArticleJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMedicalScholarlyArticle(maybeMedicalScholarlyArticle) {
    const { value, error } = exports.MedicalScholarlyArticleJoiSchema.validate(maybeMedicalScholarlyArticle);
    if (error) {
        return new oaValidationError_1.OaValidationError('MedicalScholarlyArticle', maybeMedicalScholarlyArticle, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMedicalScholarlyArticle = validateMedicalScholarlyArticle;
