 ...
 * etc.
 */
export declare type MedicalSignOrSubClass = MedicalSign | schema.VitalSignOrSubClass;
/**
 * schema:MedicalSign - Validation schema (w/ JOI)
 */
export declare const MedicalSignJoiSchema: Joi.ObjectSchema;
/**
 * schema:MedicalSign - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MedicalSignOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMedicalSign(maybeMedicalSign: unknown): MedicalSign | OaValidationError;
