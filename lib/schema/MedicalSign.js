...
exports.validateMedicalSign = exports.MedicalSignOrSubClassJoiSchema = exports.MedicalSignJoiSchema = void 0;
 ...
 */
exports.MedicalSignJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MedicalSignOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MedicalSignJoiSchema,
 ...
 * ```
 */
function validateMedicalSign(maybeMedicalSign) {
    const { value, error } = exports.MedicalSignJoiSchema.validate(maybeMedicalSign);
    if (error) {
        return new oaValidationError_1.OaValidationError('MedicalSign', maybeMedicalSign, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMedicalSign = validateMedicalSign;
