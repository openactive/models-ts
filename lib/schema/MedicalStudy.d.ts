 ...
 * etc.
 */
export declare type MedicalStudyOrSubClass = MedicalStudy | schema.MedicalObservationalStudyOrSubClass | schema.MedicalTrialOrSubClass;
/**
 * schema:MedicalStudy - Validation schema (w/ JOI)
 */
export declare const MedicalStudyJoiSchema: Joi.ObjectSchema;
/**
 * schema:MedicalStudy - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MedicalStudyOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMedicalStudy(maybeMedicalStudy: unknown): MedicalStudy | OaValidationError;
