 ...
 * etc.
 */
export declare type MedicalSymptomOrSubClass = MedicalSymptom;
/**
 * schema:MedicalSymptom - Validation schema (w/ JOI)
 */
export declare const MedicalSymptomJoiSchema: Joi.ObjectSchema;
/**
 * schema:MedicalSymptom - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MedicalSymptomOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMedicalSymptom(maybeMedicalSymptom: unknown): MedicalSymptom | OaValidationError;
