...
exports.validateMedicalSymptom = exports.MedicalSymptomOrSubClassJoiSchema = exports.MedicalSymptomJoiSchema = void 0;
 ...
 */
exports.MedicalSymptomJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MedicalSymptomOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MedicalSymptomJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMedicalSymptom(maybeMedicalSymptom) {
    const { value, error } = exports.MedicalSymptomJoiSchema.validate(maybeMedicalSymptom);
    if (error) {
        return new oaValidationError_1.OaValidationError('MedicalSymptom', maybeMedicalSymptom, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMedicalSymptom = validateMedicalSymptom;
