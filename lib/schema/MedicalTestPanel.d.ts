 ...
 * etc.
 */
export declare type MedicalTestPanelOrSubClass = MedicalTestPanel;
/**
 * schema:MedicalTestPanel - Validation schema (w/ JOI)
 */
export declare const MedicalTestPanelJoiSchema: Joi.ObjectSchema;
/**
 * schema:MedicalTestPanel - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MedicalTestPanelOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMedicalTestPanel(maybeMedicalTestPanel: unknown): MedicalTestPanel | OaValidationError;
