 ...
 * etc.
 */
export declare type MedicalTherapyOrSubClass = MedicalTherapy | schema.RadiationTherapyOrSubClass | schema.PalliativeProcedureOrSubClass | schema.PhysicalTherapyOrSubClass | schema.OccupationalTherapyOrSubClass;
/**
