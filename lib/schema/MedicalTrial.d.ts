 ...
 * etc.
 */
export declare type MedicalTrialOrSubClass = MedicalTrial;
/**
 * schema:MedicalTrial - Validation schema (w/ JOI)
 */
export declare const MedicalTrialJoiSchema: Joi.ObjectSchema;
/**
 * schema:MedicalTrial - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MedicalTrialOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMedicalTrial(maybeMedicalTrial: unknown): MedicalTrial | OaValidationError;
