...
exports.validateMedicalTrialDesign = exports.MedicalTrialDesignOrSubClassJoiSchema = exports.MedicalTrialDesignJoiSchema = void 0;
 ...
 */
exports.MedicalTrialDesignJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MedicalTrialDesignOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MedicalTrialDesignJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMedicalTrialDesign(maybeMedicalTrialDesign) {
    const { value, error } = exports.MedicalTrialDesignJoiSchema.validate(maybeMedicalTrialDesign);
    if (error) {
        return new oaValidationError_1.OaValidationError('MedicalTrialDesign', maybeMedicalTrialDesign, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMedicalTrialDesign = validateMedicalTrialDesign;
