 ...
 * etc.
 */
export declare type MedicalWebPageOrSubClass = MedicalWebPage;
/**
 * schema:MedicalWebPage - Validation schema (w/ JOI)
 */
export declare const MedicalWebPageJoiSchema: Joi.ObjectSchema;
/**
 * schema:MedicalWebPage - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MedicalWebPageOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMedicalWebPage(maybeMedicalWebPage: unknown): MedicalWebPage | OaValidationError;
