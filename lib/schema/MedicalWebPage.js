...
exports.validateMedicalWebPage = exports.MedicalWebPageOrSubClassJoiSchema = exports.MedicalWebPageJoiSchema = void 0;
 ...
 */
exports.MedicalWebPageJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MedicalWebPageOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MedicalWebPageJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMedicalWebPage(maybeMedicalWebPage) {
    const { value, error } = exports.MedicalWebPageJoiSchema.validate(maybeMedicalWebPage);
    if (error) {
        return new oaValidationError_1.OaValidationError('MedicalWebPage', maybeMedicalWebPage, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMedicalWebPage = validateMedicalWebPage;
