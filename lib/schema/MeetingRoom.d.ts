 ...
 * etc.
 */
export declare type MeetingRoomOrSubClass = MeetingRoom;
/**
 * schema:MeetingRoom - Validation schema (w/ JOI)
 */
export declare const MeetingRoomJoiSchema: Joi.ObjectSchema;
/**
 * schema:MeetingRoom - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MeetingRoomOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMeetingRoom(maybeMeetingRoom: unknown): MeetingRoom | OaValidationError;
