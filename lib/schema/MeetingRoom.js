...
exports.validateMeetingRoom = exports.MeetingRoomOrSubClassJoiSchema = exports.MeetingRoomJoiSchema = void 0;
 ...
 */
exports.MeetingRoomJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MeetingRoomOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MeetingRoomJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMeetingRoom(maybeMeetingRoom) {
    const { value, error } = exports.MeetingRoomJoiSchema.validate(maybeMeetingRoom);
    if (error) {
        return new oaValidationError_1.OaValidationError('MeetingRoom', maybeMeetingRoom, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMeetingRoom = validateMeetingRoom;
