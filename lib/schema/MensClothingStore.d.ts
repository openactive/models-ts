 ...
 * etc.
 */
export declare type MensClothingStoreOrSubClass = MensClothingStore;
/**
 * schema:MensClothingStore - Validation schema (w/ JOI)
 */
export declare const MensClothingStoreJoiSchema: Joi.ObjectSchema;
/**
 * schema:MensClothingStore - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MensClothingStoreOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMensClothingStore(maybeMensClothingStore: unknown): MensClothingStore | OaValidationError;
