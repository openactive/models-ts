...
exports.validateMensClothingStore = exports.MensClothingStoreOrSubClassJoiSchema = exports.MensClothingStoreJoiSchema = void 0;
 ...
 */
exports.MensClothingStoreJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MensClothingStoreOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MensClothingStoreJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMensClothingStore(maybeMensClothingStore) {
    const { value, error } = exports.MensClothingStoreJoiSchema.validate(maybeMensClothingStore);
    if (error) {
        return new oaValidationError_1.OaValidationError('MensClothingStore', maybeMensClothingStore, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMensClothingStore = validateMensClothingStore;
