 ...
 * etc.
 */
export declare type MenuOrSubClass = Menu;
/**
 * schema:Menu - Validation schema (w/ JOI)
 */
export declare const MenuJoiSchema: Joi.ObjectSchema;
/**
 * schema:Menu - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MenuOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMenu(maybeMenu: unknown): Menu | OaValidationError;
