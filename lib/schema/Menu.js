...
exports.validateMenu = exports.MenuOrSubClassJoiSchema = exports.MenuJoiSchema = void 0;
 ...
 */
exports.MenuJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MenuOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MenuJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMenu(maybeMenu) {
    const { value, error } = exports.MenuJoiSchema.validate(maybeMenu);
    if (error) {
        return new oaValidationError_1.OaValidationError('Menu', maybeMenu, error);
    }
