 ...
 * etc.
 */
export declare type MenuSectionOrSubClass = MenuSection;
/**
 * schema:MenuSection - Validation schema (w/ JOI)
 */
export declare const MenuSectionJoiSchema: Joi.ObjectSchema;
/**
 * schema:MenuSection - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MenuSectionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMenuSection(maybeMenuSection: unknown): MenuSection | OaValidationError;
