...
exports.validateMenuSection = exports.MenuSectionOrSubClassJoiSchema = exports.MenuSectionJoiSchema = void 0;
 ...
 */
exports.MenuSectionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MenuSectionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MenuSectionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMenuSection(maybeMenuSection) {
    const { value, error } = exports.MenuSectionJoiSchema.validate(maybeMenuSection);
    if (error) {
        return new oaValidationError_1.OaValidationError('MenuSection', maybeMenuSection, error);
    }
