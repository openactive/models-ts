 ...
 * etc.
 */
export declare type MessageOrSubClass = Message | schema.EmailMessageOrSubClass;
/**
 * schema:Message - Validation schema (w/ JOI)
 */
export declare const MessageJoiSchema: Joi.ObjectSchema;
/**
 * schema:Message - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MessageOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMessage(maybeMessage: unknown): Message | OaValidationError;
