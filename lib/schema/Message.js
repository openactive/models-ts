...
exports.validateMessage = exports.MessageOrSubClassJoiSchema = exports.MessageJoiSchema = void 0;
 ...
 */
exports.MessageJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MessageOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MessageJoiSchema,
...
function validateMessage(maybeMessage) {
    const { value, error } = exports.MessageJoiSchema.validate(maybeMessage);
    if (error) {
        return new oaValidationError_1.OaValidationError('Message', maybeMessage, error);
    }
