 ...
 * etc.
 */
export declare type MiddleSchoolOrSubClass = MiddleSchool;
/**
 * schema:MiddleSchool - Validation schema (w/ JOI)
 */
export declare const MiddleSchoolJoiSchema: Joi.ObjectSchema;
/**
 * schema:MiddleSchool - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MiddleSchoolOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMiddleSchool(maybeMiddleSchool: unknown): MiddleSchool | OaValidationError;
