 ...
 * etc.
 */
export declare type MobileApplicationOrSubClass = MobileApplication;
/**
 * schema:MobileApplication - Validation schema (w/ JOI)
 */
export declare const MobileApplicationJoiSchema: Joi.ObjectSchema;
/**
 * schema:MobileApplication - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MobileApplicationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMobileApplication(maybeMobileApplication: unknown): MobileApplication | OaValidationError;
