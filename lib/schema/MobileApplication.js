...
exports.validateMobileApplication = exports.MobileApplicationOrSubClassJoiSchema = exports.MobileApplicationJoiSchema = void 0;
 ...
 */
exports.MobileApplicationJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MobileApplicationOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MobileApplicationJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMobileApplication(maybeMobileApplication) {
    const { value, error } = exports.MobileApplicationJoiSchema.validate(maybeMobileApplication);
    if (error) {
        return new oaValidationError_1.OaValidationError('MobileApplication', maybeMobileApplication, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMobileApplication = validateMobileApplication;
