 ...
 * etc.
 */
export declare type MobilePhoneStoreOrSubClass = MobilePhoneStore;
/**
 * schema:MobilePhoneStore - Validation schema (w/ JOI)
 */
export declare const MobilePhoneStoreJoiSchema: Joi.ObjectSchema;
/**
 * schema:MobilePhoneStore - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MobilePhoneStoreOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMobilePhoneStore(maybeMobilePhoneStore: unknown): MobilePhoneStore | OaValidationError;
