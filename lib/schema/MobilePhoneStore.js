...
exports.validateMobilePhoneStore = exports.MobilePhoneStoreOrSubClassJoiSchema = exports.MobilePhoneStoreJoiSchema = void 0;
 ...
 */
exports.MobilePhoneStoreJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MobilePhoneStoreOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MobilePhoneStoreJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMobilePhoneStore(maybeMobilePhoneStore) {
    const { value, error } = exports.MobilePhoneStoreJoiSchema.validate(maybeMobilePhoneStore);
    if (error) {
        return new oaValidationError_1.OaValidationError('MobilePhoneStore', maybeMobilePhoneStore, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMobilePhoneStore = validateMobilePhoneStore;
