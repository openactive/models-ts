 ...
 * etc.
 */
export declare type MonetaryAmountOrSubClass = MonetaryAmount;
/**
 * schema:MonetaryAmount - Validation schema (w/ JOI)
 */
export declare const MonetaryAmountJoiSchema: Joi.ObjectSchema;
/**
 * schema:MonetaryAmount - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MonetaryAmountOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMonetaryAmount(maybeMonetaryAmount: unknown): MonetaryAmount | OaValidationError;
