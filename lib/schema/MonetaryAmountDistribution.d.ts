 ...
 * etc.
 */
export declare type MonetaryAmountDistributionOrSubClass = MonetaryAmountDistribution;
/**
 * schema:MonetaryAmountDistribution - Validation schema (w/ JOI)
 */
export declare const MonetaryAmountDistributionJoiSchema: Joi.ObjectSchema;
/**
 * schema:MonetaryAmountDistribution - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MonetaryAmountDistributionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMonetaryAmountDistribution(maybeMonetaryAmountDistribution: unknown): MonetaryAmountDistribution | OaValidationError;
