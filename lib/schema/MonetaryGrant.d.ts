 ...
 * etc.
 */
export declare type MonetaryGrantOrSubClass = MonetaryGrant;
/**
 * schema:MonetaryGrant - Validation schema (w/ JOI)
 */
export declare const MonetaryGrantJoiSchema: Joi.ObjectSchema;
/**
 * schema:MonetaryGrant - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MonetaryGrantOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMonetaryGrant(maybeMonetaryGrant: unknown): MonetaryGrant | OaValidationError;
