...
exports.validateMoneyTransfer = exports.MoneyTransferOrSubClassJoiSchema = exports.MoneyTransferJoiSchema = void 0;
 ...
 */
exports.MoneyTransferJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MoneyTransferOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MoneyTransferJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMoneyTransfer(maybeMoneyTransfer) {
    const { value, error } = exports.MoneyTransferJoiSchema.validate(maybeMoneyTransfer);
    if (error) {
        return new oaValidationError_1.OaValidationError('MoneyTransfer', maybeMoneyTransfer, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMoneyTransfer = validateMoneyTransfer;
