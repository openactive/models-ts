 ...
 * etc.
 */
export declare type MosqueOrSubClass = Mosque;
/**
 * schema:Mosque - Validation schema (w/ JOI)
 */
export declare const MosqueJoiSchema: Joi.ObjectSchema;
/**
 * schema:Mosque - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MosqueOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMosque(maybeMosque: unknown): Mosque | OaValidationError;
