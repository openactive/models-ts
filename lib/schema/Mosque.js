...
exports.validateMosque = exports.MosqueOrSubClassJoiSchema = exports.MosqueJoiSchema = void 0;
 ...
 */
exports.MosqueJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MosqueOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MosqueJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMosque(maybeMosque) {
    const { value, error } = exports.MosqueJoiSchema.validate(maybeMosque);
    if (error) {
        return new oaValidationError_1.OaValidationError('Mosque', maybeMosque, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMosque = validateMosque;
