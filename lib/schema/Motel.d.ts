 ...
 * etc.
 */
export declare type MotelOrSubClass = Motel;
/**
 * schema:Motel - Validation schema (w/ JOI)
 */
export declare const MotelJoiSchema: Joi.ObjectSchema;
/**
 * schema:Motel - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MotelOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMotel(maybeMotel: unknown): Motel | OaValidationError;
