...
exports.validateMotel = exports.MotelOrSubClassJoiSchema = exports.MotelJoiSchema = void 0;
 ...
 */
exports.MotelJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MotelOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MotelJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMotel(maybeMotel) {
    const { value, error } = exports.MotelJoiSchema.validate(maybeMotel);
    if (error) {
        return new oaValidationError_1.OaValidationError('Motel', maybeMotel, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMotel = validateMotel;
