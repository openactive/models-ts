 ...
 * etc.
 */
export declare type MotorcycleOrSubClass = Motorcycle;
/**
 * schema:Motorcycle - Validation schema (w/ JOI)
 */
export declare const MotorcycleJoiSchema: Joi.ObjectSchema;
/**
 * schema:Motorcycle - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MotorcycleOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMotorcycle(maybeMotorcycle: unknown): Motorcycle | OaValidationError;
