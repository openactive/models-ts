 ...
 * etc.
 */
export declare type MotorcycleDealerOrSubClass = MotorcycleDealer;
/**
 * schema:MotorcycleDealer - Validation schema (w/ JOI)
 */
export declare const MotorcycleDealerJoiSchema: Joi.ObjectSchema;
/**
 * schema:MotorcycleDealer - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MotorcycleDealerOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMotorcycleDealer(maybeMotorcycleDealer: unknown): MotorcycleDealer | OaValidationError;
