...
exports.validateMotorcycleDealer = exports.MotorcycleDealerOrSubClassJoiSchema = exports.MotorcycleDealerJoiSchema = void 0;
 ...
 */
exports.MotorcycleDealerJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MotorcycleDealerOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MotorcycleDealerJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMotorcycleDealer(maybeMotorcycleDealer) {
    const { value, error } = exports.MotorcycleDealerJoiSchema.validate(maybeMotorcycleDealer);
    if (error) {
        return new oaValidationError_1.OaValidationError('MotorcycleDealer', maybeMotorcycleDealer, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMotorcycleDealer = validateMotorcycleDealer;
