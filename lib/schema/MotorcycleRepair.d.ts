 ...
 * etc.
 */
export declare type MotorcycleRepairOrSubClass = MotorcycleRepair;
/**
 * schema:MotorcycleRepair - Validation schema (w/ JOI)
 */
export declare const MotorcycleRepairJoiSchema: Joi.ObjectSchema;
/**
 * schema:MotorcycleRepair - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MotorcycleRepairOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMotorcycleRepair(maybeMotorcycleRepair: unknown): MotorcycleRepair | OaValidationError;
