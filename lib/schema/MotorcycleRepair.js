...
exports.validateMotorcycleRepair = exports.MotorcycleRepairOrSubClassJoiSchema = exports.MotorcycleRepairJoiSchema = void 0;
 ...
 */
exports.MotorcycleRepairJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MotorcycleRepairOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MotorcycleRepairJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMotorcycleRepair(maybeMotorcycleRepair) {
    const { value, error } = exports.MotorcycleRepairJoiSchema.validate(maybeMotorcycleRepair);
    if (error) {
        return new oaValidationError_1.OaValidationError('MotorcycleRepair', maybeMotorcycleRepair, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMotorcycleRepair = validateMotorcycleRepair;
