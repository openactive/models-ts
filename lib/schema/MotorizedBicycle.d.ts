 ...
 * etc.
 */
export declare type MotorizedBicycleOrSubClass = MotorizedBicycle;
/**
 * schema:MotorizedBicycle - Validation schema (w/ JOI)
 */
export declare const MotorizedBicycleJoiSchema: Joi.ObjectSchema;
/**
 * schema:MotorizedBicycle - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MotorizedBicycleOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMotorizedBicycle(maybeMotorizedBicycle: unknown): MotorizedBicycle | OaValidationError;
