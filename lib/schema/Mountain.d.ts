 ...
 * etc.
 */
export declare type MountainOrSubClass = Mountain;
/**
 * schema:Mountain - Validation schema (w/ JOI)
 */
export declare const MountainJoiSchema: Joi.ObjectSchema;
/**
 * schema:Mountain - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MountainOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMountain(maybeMountain: unknown): Mountain | OaValidationError;
