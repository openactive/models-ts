...
exports.validateMountain = exports.MountainOrSubClassJoiSchema = exports.MountainJoiSchema = void 0;
 ...
 */
exports.MountainJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MountainOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MountainJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMountain(maybeMountain) {
    const { value, error } = exports.MountainJoiSchema.validate(maybeMountain);
    if (error) {
        return new oaValidationError_1.OaValidationError('Mountain', maybeMountain, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMountain = validateMountain;
