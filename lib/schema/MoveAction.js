...
exports.validateMoveAction = exports.MoveActionOrSubClassJoiSchema = exports.MoveActionJoiSchema = void 0;
 ...
 */
exports.MoveActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MoveActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MoveActionJoiSchema,
 ...
 * ```
 */
function validateMoveAction(maybeMoveAction) {
    const { value, error } = exports.MoveActionJoiSchema.validate(maybeMoveAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('MoveAction', maybeMoveAction, error);
    }
