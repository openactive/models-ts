 ...
 * etc.
 */
export declare type MovieOrSubClass = Movie;
/**
 * schema:Movie - Validation schema (w/ JOI)
 */
export declare const MovieJoiSchema: Joi.ObjectSchema;
/**
 * schema:Movie - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MovieOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMovie(maybeMovie: unknown): Movie | OaValidationError;
