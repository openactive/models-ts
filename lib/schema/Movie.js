...
exports.validateMovie = exports.MovieOrSubClassJoiSchema = exports.MovieJoiSchema = void 0;
 ...
 */
exports.MovieJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MovieOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MovieJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMovie(maybeMovie) {
    const { value, error } = exports.MovieJoiSchema.validate(maybeMovie);
    if (error) {
        return new oaValidationError_1.OaValidationError('Movie', maybeMovie, error);
    }
