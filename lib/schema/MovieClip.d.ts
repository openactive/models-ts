 ...
 * etc.
 */
export declare type MovieClipOrSubClass = MovieClip;
/**
 * schema:MovieClip - Validation schema (w/ JOI)
 */
export declare const MovieClipJoiSchema: Joi.ObjectSchema;
/**
 * schema:MovieClip - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MovieClipOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMovieClip(maybeMovieClip: unknown): MovieClip | OaValidationError;
