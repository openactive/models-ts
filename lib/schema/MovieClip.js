...
exports.validateMovieClip = exports.MovieClipOrSubClassJoiSchema = exports.MovieClipJoiSchema = void 0;
 ...
 */
exports.MovieClipJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MovieClipOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MovieClipJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMovieClip(maybeMovieClip) {
    const { value, error } = exports.MovieClipJoiSchema.validate(maybeMovieClip);
    if (error) {
        return new oaValidationError_1.OaValidationError('MovieClip', maybeMovieClip, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMovieClip = validateMovieClip;
