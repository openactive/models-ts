 ...
 * etc.
 */
export declare type MovieRentalStoreOrSubClass = MovieRentalStore;
/**
 * schema:MovieRentalStore - Validation schema (w/ JOI)
 */
export declare const MovieRentalStoreJoiSchema: Joi.ObjectSchema;
/**
 * schema:MovieRentalStore - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MovieRentalStoreOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMovieRentalStore(maybeMovieRentalStore: unknown): MovieRentalStore | OaValidationError;
