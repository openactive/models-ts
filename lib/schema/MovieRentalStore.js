...
exports.validateMovieRentalStore = exports.MovieRentalStoreOrSubClassJoiSchema = exports.MovieRentalStoreJoiSchema = void 0;
 ...
 */
exports.MovieRentalStoreJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MovieRentalStoreOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MovieRentalStoreJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMovieRentalStore(maybeMovieRentalStore) {
    const { value, error } = exports.MovieRentalStoreJoiSchema.validate(maybeMovieRentalStore);
    if (error) {
        return new oaValidationError_1.OaValidationError('MovieRentalStore', maybeMovieRentalStore, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMovieRentalStore = validateMovieRentalStore;
