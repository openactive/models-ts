 ...
 * etc.
 */
export declare type MovieSeriesOrSubClass = MovieSeries;
/**
 * schema:MovieSeries - Validation schema (w/ JOI)
 */
export declare const MovieSeriesJoiSchema: Joi.ObjectSchema;
/**
 * schema:MovieSeries - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MovieSeriesOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMovieSeries(maybeMovieSeries: unknown): MovieSeries | OaValidationError;
