...
exports.validateMovieSeries = exports.MovieSeriesOrSubClassJoiSchema = exports.MovieSeriesJoiSchema = void 0;
 ...
 */
exports.MovieSeriesJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MovieSeriesOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MovieSeriesJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMovieSeries(maybeMovieSeries) {
    const { value, error } = exports.MovieSeriesJoiSchema.validate(maybeMovieSeries);
    if (error) {
        return new oaValidationError_1.OaValidationError('MovieSeries', maybeMovieSeries, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMovieSeries = validateMovieSeries;
