 ...
 * etc.
 */
export declare type MovieTheaterOrSubClass = MovieTheater;
/**
 * schema:MovieTheater - Validation schema (w/ JOI)
 */
export declare const MovieTheaterJoiSchema: Joi.ObjectSchema;
/**
 * schema:MovieTheater - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MovieTheaterOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMovieTheater(maybeMovieTheater: unknown): MovieTheater | OaValidationError;
