...
exports.validateMovieTheater = exports.MovieTheaterOrSubClassJoiSchema = exports.MovieTheaterJoiSchema = void 0;
 ...
 */
exports.MovieTheaterJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MovieTheaterOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MovieTheaterJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMovieTheater(maybeMovieTheater) {
    const { value, error } = exports.MovieTheaterJoiSchema.validate(maybeMovieTheater);
    if (error) {
        return new oaValidationError_1.OaValidationError('MovieTheater', maybeMovieTheater, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMovieTheater = validateMovieTheater;
