 ...
 * etc.
 */
export declare type MovingCompanyOrSubClass = MovingCompany;
/**
 * schema:MovingCompany - Validation schema (w/ JOI)
 */
export declare const MovingCompanyJoiSchema: Joi.ObjectSchema;
/**
 * schema:MovingCompany - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MovingCompanyOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMovingCompany(maybeMovingCompany: unknown): MovingCompany | OaValidationError;
