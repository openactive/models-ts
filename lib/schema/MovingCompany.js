...
exports.validateMovingCompany = exports.MovingCompanyOrSubClassJoiSchema = exports.MovingCompanyJoiSchema = void 0;
 ...
 */
exports.MovingCompanyJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MovingCompanyOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MovingCompanyJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMovingCompany(maybeMovingCompany) {
    const { value, error } = exports.MovingCompanyJoiSchema.validate(maybeMovingCompany);
    if (error) {
        return new oaValidationError_1.OaValidationError('MovingCompany', maybeMovingCompany, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMovingCompany = validateMovingCompany;
