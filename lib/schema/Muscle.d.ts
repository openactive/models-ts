 ...
 * etc.
 */
export declare type MuscleOrSubClass = Muscle;
/**
 * schema:Muscle - Validation schema (w/ JOI)
 */
export declare const MuscleJoiSchema: Joi.ObjectSchema;
/**
 * schema:Muscle - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MuscleOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMuscle(maybeMuscle: unknown): Muscle | OaValidationError;
