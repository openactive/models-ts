 ...
 * etc.
 */
export declare type MuseumOrSubClass = Museum;
/**
 * schema:Museum - Validation schema (w/ JOI)
 */
export declare const MuseumJoiSchema: Joi.ObjectSchema;
/**
 * schema:Museum - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MuseumOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMuseum(maybeMuseum: unknown): Museum | OaValidationError;
