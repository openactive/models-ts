...
exports.validateMuseum = exports.MuseumOrSubClassJoiSchema = exports.MuseumJoiSchema = void 0;
 ...
 */
exports.MuseumJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MuseumOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MuseumJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMuseum(maybeMuseum) {
    const { value, error } = exports.MuseumJoiSchema.validate(maybeMuseum);
    if (error) {
        return new oaValidationError_1.OaValidationError('Museum', maybeMuseum, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMuseum = validateMuseum;
