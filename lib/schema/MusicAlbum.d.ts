 ...
 * etc.
 */
export declare type MusicAlbumOrSubClass = MusicAlbum;
/**
 * schema:MusicAlbum - Validation schema (w/ JOI)
 */
export declare const MusicAlbumJoiSchema: Joi.ObjectSchema;
/**
 * schema:MusicAlbum - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MusicAlbumOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMusicAlbum(maybeMusicAlbum: unknown): MusicAlbum | OaValidationError;
