...
exports.validateMusicAlbum = exports.MusicAlbumOrSubClassJoiSchema = exports.MusicAlbumJoiSchema = void 0;
 ...
 */
exports.MusicAlbumJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MusicAlbumOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MusicAlbumJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMusicAlbum(maybeMusicAlbum) {
    const { value, error } = exports.MusicAlbumJoiSchema.validate(maybeMusicAlbum);
    if (error) {
        return new oaValidationError_1.OaValidationError('MusicAlbum', maybeMusicAlbum, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMusicAlbum = validateMusicAlbum;
