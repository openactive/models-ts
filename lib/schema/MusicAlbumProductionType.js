 ...
 */
exports.MusicAlbumProductionTypeJoiSchema = Joi.string().valid('https://schema.org/StudioAlbum', 'https://schema.org/MixtapeAlbum', 'https://schema.org/DemoAlbum', 'https://schema.org/SpokenWordAlbum', 'https://schema.org/DJMixAlbum', 'https://schema.org/SoundtrackAlbum', 'https://schema.org/CompilationAlbum', 'https://schema.org/LiveAlbum', 'https://schema.org/RemixAlbum');
/**
