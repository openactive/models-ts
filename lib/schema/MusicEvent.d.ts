 ...
 * etc.
 */
export declare type MusicEventOrSubClass = MusicEvent;
/**
 * schema:MusicEvent - Validation schema (w/ JOI)
 */
export declare const MusicEventJoiSchema: Joi.ObjectSchema;
/**
 * schema:MusicEvent - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MusicEventOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMusicEvent(maybeMusicEvent: unknown): MusicEvent | OaValidationError;
