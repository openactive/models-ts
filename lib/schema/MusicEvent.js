...
exports.validateMusicEvent = exports.MusicEventOrSubClassJoiSchema = exports.MusicEventJoiSchema = void 0;
 ...
 */
exports.MusicEventJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MusicEventOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MusicEventJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMusicEvent(maybeMusicEvent) {
    const { value, error } = exports.MusicEventJoiSchema.validate(maybeMusicEvent);
    if (error) {
        return new oaValidationError_1.OaValidationError('MusicEvent', maybeMusicEvent, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMusicEvent = validateMusicEvent;
