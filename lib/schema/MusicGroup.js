...
exports.validateMusicGroup = exports.MusicGroupOrSubClassJoiSchema = exports.MusicGroupJoiSchema = void 0;
 ...
 */
exports.MusicGroupJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MusicGroupOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MusicGroupJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMusicGroup(maybeMusicGroup) {
    const { value, error } = exports.MusicGroupJoiSchema.validate(maybeMusicGroup);
    if (error) {
        return new oaValidationError_1.OaValidationError('MusicGroup', maybeMusicGroup, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMusicGroup = validateMusicGroup;
