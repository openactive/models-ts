 ...
 * etc.
 */
export declare type MusicPlaylistOrSubClass = MusicPlaylist | schema.MusicAlbumOrSubClass | schema.MusicReleaseOrSubClass;
/**
 * schema:MusicPlaylist - Validation schema (w/ JOI)
 */
export declare const MusicPlaylistJoiSchema: Joi.ObjectSchema;
/**
 * schema:MusicPlaylist - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MusicPlaylistOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMusicPlaylist(maybeMusicPlaylist: unknown): MusicPlaylist | OaValidationError;
