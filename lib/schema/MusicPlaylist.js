...
exports.validateMusicPlaylist = exports.MusicPlaylistOrSubClassJoiSchema = exports.MusicPlaylistJoiSchema = void 0;
 ...
 */
exports.MusicPlaylistJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MusicPlaylistOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MusicPlaylistJoiSchema,
 ...
 * ```
 */
function validateMusicPlaylist(maybeMusicPlaylist) {
    const { value, error } = exports.MusicPlaylistJoiSchema.validate(maybeMusicPlaylist);
    if (error) {
        return new oaValidationError_1.OaValidationError('MusicPlaylist', maybeMusicPlaylist, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMusicPlaylist = validateMusicPlaylist;
