 ...
 * etc.
 */
export declare type MusicRecordingOrSubClass = MusicRecording;
/**
 * schema:MusicRecording - Validation schema (w/ JOI)
 */
export declare const MusicRecordingJoiSchema: Joi.ObjectSchema;
/**
 * schema:MusicRecording - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MusicRecordingOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMusicRecording(maybeMusicRecording: unknown): MusicRecording | OaValidationError;
