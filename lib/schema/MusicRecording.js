...
exports.validateMusicRecording = exports.MusicRecordingOrSubClassJoiSchema = exports.MusicRecordingJoiSchema = void 0;
 ...
 */
exports.MusicRecordingJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MusicRecordingOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MusicRecordingJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMusicRecording(maybeMusicRecording) {
    const { value, error } = exports.MusicRecordingJoiSchema.validate(maybeMusicRecording);
    if (error) {
        return new oaValidationError_1.OaValidationError('MusicRecording', maybeMusicRecording, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMusicRecording = validateMusicRecording;
