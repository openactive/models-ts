 ...
 * etc.
 */
export declare type MusicReleaseOrSubClass = MusicRelease;
/**
 * schema:MusicRelease - Validation schema (w/ JOI)
 */
export declare const MusicReleaseJoiSchema: Joi.ObjectSchema;
/**
 * schema:MusicRelease - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MusicReleaseOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMusicRelease(maybeMusicRelease: unknown): MusicRelease | OaValidationError;
