...
exports.validateMusicRelease = exports.MusicReleaseOrSubClassJoiSchema = exports.MusicReleaseJoiSchema = void 0;
 ...
 */
exports.MusicReleaseJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MusicReleaseOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MusicReleaseJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMusicRelease(maybeMusicRelease) {
    const { value, error } = exports.MusicReleaseJoiSchema.validate(maybeMusicRelease);
    if (error) {
        return new oaValidationError_1.OaValidationError('MusicRelease', maybeMusicRelease, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMusicRelease = validateMusicRelease;
