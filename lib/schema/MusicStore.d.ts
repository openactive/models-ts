 ...
 * etc.
 */
export declare type MusicStoreOrSubClass = MusicStore;
/**
 * schema:MusicStore - Validation schema (w/ JOI)
 */
export declare const MusicStoreJoiSchema: Joi.ObjectSchema;
/**
 * schema:MusicStore - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MusicStoreOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMusicStore(maybeMusicStore: unknown): MusicStore | OaValidationError;
