...
exports.validateMusicStore = exports.MusicStoreOrSubClassJoiSchema = exports.MusicStoreJoiSchema = void 0;
 ...
 */
exports.MusicStoreJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MusicStoreOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MusicStoreJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMusicStore(maybeMusicStore) {
    const { value, error } = exports.MusicStoreJoiSchema.validate(maybeMusicStore);
    if (error) {
        return new oaValidationError_1.OaValidationError('MusicStore', maybeMusicStore, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMusicStore = validateMusicStore;
