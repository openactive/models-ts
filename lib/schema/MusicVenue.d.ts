 ...
 * etc.
 */
export declare type MusicVenueOrSubClass = MusicVenue;
/**
 * schema:MusicVenue - Validation schema (w/ JOI)
 */
export declare const MusicVenueJoiSchema: Joi.ObjectSchema;
/**
 * schema:MusicVenue - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MusicVenueOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMusicVenue(maybeMusicVenue: unknown): MusicVenue | OaValidationError;
