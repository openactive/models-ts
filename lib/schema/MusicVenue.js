...
exports.validateMusicVenue = exports.MusicVenueOrSubClassJoiSchema = exports.MusicVenueJoiSchema = void 0;
 ...
 */
exports.MusicVenueJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MusicVenueOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MusicVenueJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMusicVenue(maybeMusicVenue) {
    const { value, error } = exports.MusicVenueJoiSchema.validate(maybeMusicVenue);
    if (error) {
        return new oaValidationError_1.OaValidationError('MusicVenue', maybeMusicVenue, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMusicVenue = validateMusicVenue;
