 ...
 * etc.
 */
export declare type MusicVideoObjectOrSubClass = MusicVideoObject;
/**
 * schema:MusicVideoObject - Validation schema (w/ JOI)
 */
export declare const MusicVideoObjectJoiSchema: Joi.ObjectSchema;
/**
 * schema:MusicVideoObject - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const MusicVideoObjectOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateMusicVideoObject(maybeMusicVideoObject: unknown): MusicVideoObject | OaValidationError;
