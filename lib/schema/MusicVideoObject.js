...
exports.validateMusicVideoObject = exports.MusicVideoObjectOrSubClassJoiSchema = exports.MusicVideoObjectJoiSchema = void 0;
 ...
 */
exports.MusicVideoObjectJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.MusicVideoObjectOrSubClassJoiSchema = Joi.alternatives().try([
    exports.MusicVideoObjectJoiSchema,
]);
/**
 ...
 * ```
 */
function validateMusicVideoObject(maybeMusicVideoObject) {
    const { value, error } = exports.MusicVideoObjectJoiSchema.validate(maybeMusicVideoObject);
    if (error) {
        return new oaValidationError_1.OaValidationError('MusicVideoObject', maybeMusicVideoObject, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateMusicVideoObject = validateMusicVideoObject;
