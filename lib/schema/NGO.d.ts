 ...
 * etc.
 */
export declare type NGOOrSubClass = NGO;
/**
 * schema:NGO - Validation schema (w/ JOI)
 */
export declare const NGOJoiSchema: Joi.ObjectSchema;
/**
 * schema:NGO - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const NGOOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateNGO(maybeNGO: unknown): NGO | OaValidationError;
