 ...
 * etc.
 */
export declare type NailSalonOrSubClass = NailSalon;
/**
 * schema:NailSalon - Validation schema (w/ JOI)
 */
export declare const NailSalonJoiSchema: Joi.ObjectSchema;
/**
 * schema:NailSalon - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const NailSalonOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateNailSalon(maybeNailSalon: unknown): NailSalon | OaValidationError;
