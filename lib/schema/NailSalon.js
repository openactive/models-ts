...
exports.validateNailSalon = exports.NailSalonOrSubClassJoiSchema = exports.NailSalonJoiSchema = void 0;
 ...
 */
exports.NailSalonJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.NailSalonOrSubClassJoiSchema = Joi.alternatives().try([
    exports.NailSalonJoiSchema,
]);
/**
 ...
 * ```
 */
function validateNailSalon(maybeNailSalon) {
    const { value, error } = exports.NailSalonJoiSchema.validate(maybeNailSalon);
    if (error) {
        return new oaValidationError_1.OaValidationError('NailSalon', maybeNailSalon, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateNailSalon = validateNailSalon;
