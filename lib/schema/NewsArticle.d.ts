 ...
 * etc.
 */
export declare type NewsArticleOrSubClass = NewsArticle | schema.ReportageNewsArticleOrSubClass | schema.OpinionNewsArticleOrSubClass | schema.BackgroundNewsArticleOrSubClass | schema.AnalysisNewsArticleOrSubClass | schema.AskPublicNewsArticleOrSubClass | schema.ReviewNewsArticleOrSubClass;
/**
 * schema:NewsArticle - Validation schema (w/ JOI)
 */
export declare const NewsArticleJoiSchema: Joi.ObjectSchema;
/**
 * schema:NewsArticle - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const NewsArticleOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateNewsArticle(maybeNewsArticle: unknown): NewsArticle | OaValidationError;
