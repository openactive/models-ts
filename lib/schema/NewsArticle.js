...
exports.validateNewsArticle = exports.NewsArticleOrSubClassJoiSchema = exports.NewsArticleJoiSchema = void 0;
 ...
 */
exports.NewsArticleJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.NewsArticleOrSubClassJoiSchema = Joi.alternatives().try([
    exports.NewsArticleJoiSchema,
 ...
 * ```
 */
function validateNewsArticle(maybeNewsArticle) {
    const { value, error } = exports.NewsArticleJoiSchema.validate(maybeNewsArticle);
    if (error) {
        return new oaValidationError_1.OaValidationError('NewsArticle', maybeNewsArticle, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateNewsArticle = validateNewsArticle;
