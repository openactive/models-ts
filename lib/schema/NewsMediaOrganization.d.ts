 ...
 * etc.
 */
export declare type NewsMediaOrganizationOrSubClass = NewsMediaOrganization;
/**
 * schema:NewsMediaOrganization - Validation schema (w/ JOI)
 */
export declare const NewsMediaOrganizationJoiSchema: Joi.ObjectSchema;
/**
 * schema:NewsMediaOrganization - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const NewsMediaOrganizationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateNewsMediaOrganization(maybeNewsMediaOrganization: unknown): NewsMediaOrganization | OaValidationError;
