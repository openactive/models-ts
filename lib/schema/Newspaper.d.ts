 ...
 * etc.
 */
export declare type NewspaperOrSubClass = Newspaper;
/**
 * schema:Newspaper - Validation schema (w/ JOI)
 */
export declare const NewspaperJoiSchema: Joi.ObjectSchema;
/**
 * schema:Newspaper - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const NewspaperOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateNewspaper(maybeNewspaper: unknown): Newspaper | OaValidationError;
