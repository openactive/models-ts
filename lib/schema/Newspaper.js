...
exports.validateNewspaper = exports.NewspaperOrSubClassJoiSchema = exports.NewspaperJoiSchema = void 0;
 ...
 */
exports.NewspaperJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.NewspaperOrSubClassJoiSchema = Joi.alternatives().try([
    exports.NewspaperJoiSchema,
]);
/**
 ...
 * ```
 */
function validateNewspaper(maybeNewspaper) {
    const { value, error } = exports.NewspaperJoiSchema.validate(maybeNewspaper);
    if (error) {
        return new oaValidationError_1.OaValidationError('Newspaper', maybeNewspaper, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateNewspaper = validateNewspaper;
