 ...
 * etc.
 */
export declare type NightClubOrSubClass = NightClub;
/**
 * schema:NightClub - Validation schema (w/ JOI)
 */
export declare const NightClubJoiSchema: Joi.ObjectSchema;
/**
 * schema:NightClub - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const NightClubOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateNightClub(maybeNightClub: unknown): NightClub | OaValidationError;
