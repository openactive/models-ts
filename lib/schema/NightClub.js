...
exports.validateNightClub = exports.NightClubOrSubClassJoiSchema = exports.NightClubJoiSchema = void 0;
 ...
 */
exports.NightClubJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.NightClubOrSubClassJoiSchema = Joi.alternatives().try([
    exports.NightClubJoiSchema,
]);
/**
 ...
 * ```
 */
function validateNightClub(maybeNightClub) {
    const { value, error } = exports.NightClubJoiSchema.validate(maybeNightClub);
    if (error) {
        return new oaValidationError_1.OaValidationError('NightClub', maybeNightClub, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateNightClub = validateNightClub;
