 ...
 * etc.
 */
export declare type NotaryOrSubClass = Notary;
/**
 * schema:Notary - Validation schema (w/ JOI)
 */
export declare const NotaryJoiSchema: Joi.ObjectSchema;
/**
 * schema:Notary - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const NotaryOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateNotary(maybeNotary: unknown): Notary | OaValidationError;
