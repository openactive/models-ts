...
exports.validateNotary = exports.NotaryOrSubClassJoiSchema = exports.NotaryJoiSchema = void 0;
 ...
 */
exports.NotaryJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.NotaryOrSubClassJoiSchema = Joi.alternatives().try([
    exports.NotaryJoiSchema,
]);
/**
 ...
 * ```
 */
function validateNotary(maybeNotary) {
    const { value, error } = exports.NotaryJoiSchema.validate(maybeNotary);
    if (error) {
        return new oaValidationError_1.OaValidationError('Notary', maybeNotary, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateNotary = validateNotary;
