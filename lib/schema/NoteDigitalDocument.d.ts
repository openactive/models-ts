 ...
 * etc.
 */
export declare type NoteDigitalDocumentOrSubClass = NoteDigitalDocument;
/**
 * schema:NoteDigitalDocument - Validation schema (w/ JOI)
 */
export declare const NoteDigitalDocumentJoiSchema: Joi.ObjectSchema;
/**
 * schema:NoteDigitalDocument - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const NoteDigitalDocumentOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateNoteDigitalDocument(maybeNoteDigitalDocument: unknown): NoteDigitalDocument | OaValidationError;
