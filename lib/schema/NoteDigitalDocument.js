...
exports.validateNoteDigitalDocument = exports.NoteDigitalDocumentOrSubClassJoiSchema = exports.NoteDigitalDocumentJoiSchema = void 0;
 ...
 */
exports.NoteDigitalDocumentJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.NoteDigitalDocumentOrSubClassJoiSchema = Joi.alternatives().try([
    exports.NoteDigitalDocumentJoiSchema,
]);
/**
 ...
 * ```
 */
function validateNoteDigitalDocument(maybeNoteDigitalDocument) {
    const { value, error } = exports.NoteDigitalDocumentJoiSchema.validate(maybeNoteDigitalDocument);
    if (error) {
        return new oaValidationError_1.OaValidationError('NoteDigitalDocument', maybeNoteDigitalDocument, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateNoteDigitalDocument = validateNoteDigitalDocument;
