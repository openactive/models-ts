 ...
 * etc.
 */
export declare type OccupationalTherapyOrSubClass = OccupationalTherapy;
/**
 * schema:OccupationalTherapy - Validation schema (w/ JOI)
 */
export declare const OccupationalTherapyJoiSchema: Joi.ObjectSchema;
/**
 * schema:OccupationalTherapy - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const OccupationalTherapyOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateOccupationalTherapy(maybeOccupationalTherapy: unknown): OccupationalTherapy | OaValidationError;
