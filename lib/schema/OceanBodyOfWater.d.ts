 ...
 * etc.
 */
export declare type OceanBodyOfWaterOrSubClass = OceanBodyOfWater;
/**
 * schema:OceanBodyOfWater - Validation schema (w/ JOI)
 */
export declare const OceanBodyOfWaterJoiSchema: Joi.ObjectSchema;
/**
 * schema:OceanBodyOfWater - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const OceanBodyOfWaterOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateOceanBodyOfWater(maybeOceanBodyOfWater: unknown): OceanBodyOfWater | OaValidationError;
