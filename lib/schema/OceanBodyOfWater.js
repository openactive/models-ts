...
exports.validateOceanBodyOfWater = exports.OceanBodyOfWaterOrSubClassJoiSchema = exports.OceanBodyOfWaterJoiSchema = void 0;
 ...
 */
exports.OceanBodyOfWaterJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.OceanBodyOfWaterOrSubClassJoiSchema = Joi.alternatives().try([
    exports.OceanBodyOfWaterJoiSchema,
]);
/**
 ...
 * ```
 */
function validateOceanBodyOfWater(maybeOceanBodyOfWater) {
    const { value, error } = exports.OceanBodyOfWaterJoiSchema.validate(maybeOceanBodyOfWater);
    if (error) {
        return new oaValidationError_1.OaValidationError('OceanBodyOfWater', maybeOceanBodyOfWater, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateOceanBodyOfWater = validateOceanBodyOfWater;
