 ...
 * etc.
 */
export declare type OfferForPurchaseOrSubClass = OfferForPurchase;
/**
 * schema:OfferForPurchase - Validation schema (w/ JOI)
 */
export declare const OfferForPurchaseJoiSchema: Joi.ObjectSchema;
/**
 * schema:OfferForPurchase - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const OfferForPurchaseOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateOfferForPurchase(maybeOfferForPurchase: unknown): OfferForPurchase | OaValidationError;
