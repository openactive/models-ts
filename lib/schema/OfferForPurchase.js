...
exports.validateOfferForPurchase = exports.OfferForPurchaseOrSubClassJoiSchema = exports.OfferForPurchaseJoiSchema = void 0;
 ...
 */
exports.OfferForPurchaseJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.OfferForPurchaseOrSubClassJoiSchema = Joi.alternatives().try([
    exports.OfferForPurchaseJoiSchema,
]);
/**
 ...
 * ```
 */
function validateOfferForPurchase(maybeOfferForPurchase) {
    const { value, error } = exports.OfferForPurchaseJoiSchema.validate(maybeOfferForPurchase);
    if (error) {
        return new oaValidationError_1.OaValidationError('OfferForPurchase', maybeOfferForPurchase, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateOfferForPurchase = validateOfferForPurchase;
