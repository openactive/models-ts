 ...
 */
exports.OfferItemConditionJoiSchema = Joi.string().valid('https://schema.org/DamagedCondition', 'https://schema.org/UsedCondition', 'https://schema.org/NewCondition', 'https://schema.org/RefurbishedCondition');
/**
