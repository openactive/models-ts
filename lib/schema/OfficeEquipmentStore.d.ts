 ...
 * etc.
 */
export declare type OfficeEquipmentStoreOrSubClass = OfficeEquipmentStore;
/**
 * schema:OfficeEquipmentStore - Validation schema (w/ JOI)
 */
export declare const OfficeEquipmentStoreJoiSchema: Joi.ObjectSchema;
/**
 * schema:OfficeEquipmentStore - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const OfficeEquipmentStoreOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateOfficeEquipmentStore(maybeOfficeEquipmentStore: unknown): OfficeEquipmentStore | OaValidationError;
