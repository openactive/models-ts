...
exports.validateOfficeEquipmentStore = exports.OfficeEquipmentStoreOrSubClassJoiSchema = exports.OfficeEquipmentStoreJoiSchema = void 0;
 ...
 */
exports.OfficeEquipmentStoreJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.OfficeEquipmentStoreOrSubClassJoiSchema = Joi.alternatives().try([
    exports.OfficeEquipmentStoreJoiSchema,
]);
/**
 ...
 * ```
 */
function validateOfficeEquipmentStore(maybeOfficeEquipmentStore) {
    const { value, error } = exports.OfficeEquipmentStoreJoiSchema.validate(maybeOfficeEquipmentStore);
    if (error) {
        return new oaValidationError_1.OaValidationError('OfficeEquipmentStore', maybeOfficeEquipmentStore, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateOfficeEquipmentStore = validateOfficeEquipmentStore;
