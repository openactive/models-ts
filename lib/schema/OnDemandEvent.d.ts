 ...
 * etc.
 */
export declare type OnDemandEventOrSubClass = OnDemandEvent;
/**
 * schema:OnDemandEvent - Validation schema (w/ JOI)
 */
export declare const OnDemandEventJoiSchema: Joi.ObjectSchema;
/**
 * schema:OnDemandEvent - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const OnDemandEventOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateOnDemandEvent(maybeOnDemandEvent: unknown): OnDemandEvent | OaValidationError;
