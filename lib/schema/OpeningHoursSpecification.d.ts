 ...
 * etc.
 */
export declare type OpeningHoursSpecificationOrSubClass = OpeningHoursSpecification;
/**
 * schema:OpeningHoursSpecification - Validation schema (w/ JOI)
 */
export declare const OpeningHoursSpecificationJoiSchema: Joi.ObjectSchema;
/**
 * schema:OpeningHoursSpecification - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const OpeningHoursSpecificationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateOpeningHoursSpecification(maybeOpeningHoursSpecification: unknown): OpeningHoursSpecification | OaValidationError;
