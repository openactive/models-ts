 ...
 * etc.
 */
export declare type OpinionNewsArticleOrSubClass = OpinionNewsArticle;
/**
 * schema:OpinionNewsArticle - Validation schema (w/ JOI)
 */
export declare const OpinionNewsArticleJoiSchema: Joi.ObjectSchema;
/**
 * schema:OpinionNewsArticle - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const OpinionNewsArticleOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateOpinionNewsArticle(maybeOpinionNewsArticle: unknown): OpinionNewsArticle | OaValidationError;
