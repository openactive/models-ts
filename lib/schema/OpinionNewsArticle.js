...
exports.validateOpinionNewsArticle = exports.OpinionNewsArticleOrSubClassJoiSchema = exports.OpinionNewsArticleJoiSchema = void 0;
 ...
 */
exports.OpinionNewsArticleJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.OpinionNewsArticleOrSubClassJoiSchema = Joi.alternatives().try([
    exports.OpinionNewsArticleJoiSchema,
]);
/**
 ...
 * ```
 */
function validateOpinionNewsArticle(maybeOpinionNewsArticle) {
    const { value, error } = exports.OpinionNewsArticleJoiSchema.validate(maybeOpinionNewsArticle);
    if (error) {
        return new oaValidationError_1.OaValidationError('OpinionNewsArticle', maybeOpinionNewsArticle, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateOpinionNewsArticle = validateOpinionNewsArticle;
