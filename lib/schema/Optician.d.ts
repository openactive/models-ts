 ...
 * etc.
 */
export declare type OpticianOrSubClass = Optician;
/**
 * schema:Optician - Validation schema (w/ JOI)
 */
export declare const OpticianJoiSchema: Joi.ObjectSchema;
/**
 * schema:Optician - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const OpticianOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateOptician(maybeOptician: unknown): Optician | OaValidationError;
