...
exports.validateOptician = exports.OpticianOrSubClassJoiSchema = exports.OpticianJoiSchema = void 0;
 ...
 */
exports.OpticianJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.OpticianOrSubClassJoiSchema = Joi.alternatives().try([
    exports.OpticianJoiSchema,
]);
/**
 ...
 * ```
 */
function validateOptician(maybeOptician) {
    const { value, error } = exports.OpticianJoiSchema.validate(maybeOptician);
    if (error) {
        return new oaValidationError_1.OaValidationError('Optician', maybeOptician, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateOptician = validateOptician;
