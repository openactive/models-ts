 ...
 * etc.
 */
export declare type OrderActionOrSubClass = OrderAction;
/**
 * schema:OrderAction - Validation schema (w/ JOI)
 */
export declare const OrderActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:OrderAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const OrderActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateOrderAction(maybeOrderAction: unknown): OrderAction | OaValidationError;
