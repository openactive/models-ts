...
exports.validateOrderStatus = exports.OrderStatusOrSubClassJoiSchema = exports.OrderStatusJoiSchema = void 0;
 ...
 */
exports.OrderStatusJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.OrderStatusOrSubClassJoiSchema = Joi.alternatives().try([
    exports.OrderStatusJoiSchema,
]);
/**
 ...
 * ```
 */
function validateOrderStatus(maybeOrderStatus) {
    const { value, error } = exports.OrderStatusJoiSchema.validate(maybeOrderStatus);
    if (error) {
        return new oaValidationError_1.OaValidationError('OrderStatus', maybeOrderStatus, error);
    }
