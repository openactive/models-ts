 ...
 * etc.
 */
export declare type OrganizationOrSubClass = Organization | schema.PerformingGroupOrSubClass | schema.EducationalOrganizationOrSubClass | schema.ProjectOrSubClass | schema.LocalBusinessOrSubClass | schema.GovernmentOrganizationOrSubClass | schema.NewsMediaOrganizationOrSubClass | schema.AirlineOrSubClass | schema.WorkersUnionOrSubClass | schema.CorporationOrSubClass | schema.MedicalOrganizationOrSubClass | schema.ConsortiumOrSubClass | schema.SportsOrganizationOrSubClass | schema.FundingSchemeOrSubClass | schema.NGOOrSubClass | schema.LibrarySystemOrSubClass;
/**
