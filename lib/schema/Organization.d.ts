 ...
 * etc.
 */
export declare type OrganizationOrSubClass = Organization | schema.NewsMediaOrganizationOrSubClass | schema.FundingSchemeOrSubClass | schema.WorkersUnionOrSubClass | schema.LocalBusinessOrSubClass | schema.SportsOrganizationOrSubClass | schema.EducationalOrganizationOrSubClass | schema.PerformingGroupOrSubClass | schema.NGOOrSubClass | schema.AirlineOrSubClass | schema.ResearchOrganizationOrSubClass | schema.MedicalOrganizationOrSubClass | schema.ConsortiumOrSubClass | schema.CorporationOrSubClass | schema.GovernmentOrganizationOrSubClass | schema.LibrarySystemOrSubClass | schema.ProjectOrSubClass;
/**
