 ...
 * etc.
 */
export declare type OrganizationRoleOrSubClass = OrganizationRole | schema.EmployeeRoleOrSubClass;
/**
 * schema:OrganizationRole - Validation schema (w/ JOI)
 */
export declare const OrganizationRoleJoiSchema: Joi.ObjectSchema;
/**
 * schema:OrganizationRole - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const OrganizationRoleOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateOrganizationRole(maybeOrganizationRole: unknown): OrganizationRole | OaValidationError;
