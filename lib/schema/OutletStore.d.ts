 ...
 * etc.
 */
export declare type OutletStoreOrSubClass = OutletStore;
/**
 * schema:OutletStore - Validation schema (w/ JOI)
 */
export declare const OutletStoreJoiSchema: Joi.ObjectSchema;
/**
 * schema:OutletStore - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const OutletStoreOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateOutletStore(maybeOutletStore: unknown): OutletStore | OaValidationError;
