...
exports.validateOutletStore = exports.OutletStoreOrSubClassJoiSchema = exports.OutletStoreJoiSchema = void 0;
 ...
 */
exports.OutletStoreJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.OutletStoreOrSubClassJoiSchema = Joi.alternatives().try([
    exports.OutletStoreJoiSchema,
]);
/**
 ...
 * ```
 */
function validateOutletStore(maybeOutletStore) {
    const { value, error } = exports.OutletStoreJoiSchema.validate(maybeOutletStore);
    if (error) {
        return new oaValidationError_1.OaValidationError('OutletStore', maybeOutletStore, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateOutletStore = validateOutletStore;
