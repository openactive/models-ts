 ...
 * etc.
 */
export declare type OwnershipInfoOrSubClass = OwnershipInfo;
/**
 * schema:OwnershipInfo - Validation schema (w/ JOI)
 */
export declare const OwnershipInfoJoiSchema: Joi.ObjectSchema;
/**
 * schema:OwnershipInfo - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const OwnershipInfoOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateOwnershipInfo(maybeOwnershipInfo: unknown): OwnershipInfo | OaValidationError;
