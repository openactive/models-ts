 ...
 * etc.
 */
export declare type PaintingOrSubClass = Painting;
/**
 * schema:Painting - Validation schema (w/ JOI)
 */
export declare const PaintingJoiSchema: Joi.ObjectSchema;
/**
 * schema:Painting - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PaintingOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePainting(maybePainting: unknown): Painting | OaValidationError;
