...
exports.validatePainting = exports.PaintingOrSubClassJoiSchema = exports.PaintingJoiSchema = void 0;
 ...
 */
exports.PaintingJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.PaintingOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PaintingJoiSchema,
]);
/**
 ...
 * ```
 */
function validatePainting(maybePainting) {
    const { value, error } = exports.PaintingJoiSchema.validate(maybePainting);
    if (error) {
        return new oaValidationError_1.OaValidationError('Painting', maybePainting, error);
    }
