...
exports.validatePalliativeProcedure = exports.PalliativeProcedureOrSubClassJoiSchema = exports.PalliativeProcedureJoiSchema = void 0;
 ...
 */
exports.PalliativeProcedureJoiSchema = Joi.object({
    '@type': Joi.string().valid('PalliativeProcedure').required(),
 ...
 * `SessionSeries`, etc.
 */
exports.PalliativeProcedureOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PalliativeProcedureJoiSchema,
]);
/**
 ...
 * ```
 */
function validatePalliativeProcedure(maybePalliativeProcedure) {
    const { value, error } = exports.PalliativeProcedureJoiSchema.validate(maybePalliativeProcedure);
    if (error) {
        return new oaValidationError_1.OaValidationError('PalliativeProcedure', maybePalliativeProcedure, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validatePalliativeProcedure = validatePalliativeProcedure;
