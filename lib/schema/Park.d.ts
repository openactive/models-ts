 ...
 * etc.
 */
export declare type ParkOrSubClass = Park;
/**
 * schema:Park - Validation schema (w/ JOI)
 */
export declare const ParkJoiSchema: Joi.ObjectSchema;
/**
 * schema:Park - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ParkOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePark(maybePark: unknown): Park | OaValidationError;
