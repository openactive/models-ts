...
exports.validatePark = exports.ParkOrSubClassJoiSchema = exports.ParkJoiSchema = void 0;
 ...
 */
exports.ParkJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ParkOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ParkJoiSchema,
]);
/**
 ...
 * ```
 */
function validatePark(maybePark) {
    const { value, error } = exports.ParkJoiSchema.validate(maybePark);
    if (error) {
        return new oaValidationError_1.OaValidationError('Park', maybePark, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validatePark = validatePark;
