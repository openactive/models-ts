 ...
 * etc.
 */
export declare type ParkingFacilityOrSubClass = ParkingFacility;
/**
 * schema:ParkingFacility - Validation schema (w/ JOI)
 */
export declare const ParkingFacilityJoiSchema: Joi.ObjectSchema;
/**
 * schema:ParkingFacility - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ParkingFacilityOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateParkingFacility(maybeParkingFacility: unknown): ParkingFacility | OaValidationError;
