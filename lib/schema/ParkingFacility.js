...
exports.validateParkingFacility = exports.ParkingFacilityOrSubClassJoiSchema = exports.ParkingFacilityJoiSchema = void 0;
 ...
 */
exports.ParkingFacilityJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ParkingFacilityOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ParkingFacilityJoiSchema,
]);
/**
 ...
 * ```
 */
function validateParkingFacility(maybeParkingFacility) {
    const { value, error } = exports.ParkingFacilityJoiSchema.validate(maybeParkingFacility);
    if (error) {
        return new oaValidationError_1.OaValidationError('ParkingFacility', maybeParkingFacility, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateParkingFacility = validateParkingFacility;
