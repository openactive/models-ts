 ...
 * etc.
 */
export declare type PathologyTestOrSubClass = PathologyTest;
/**
 * schema:PathologyTest - Validation schema (w/ JOI)
 */
export declare const PathologyTestJoiSchema: Joi.ObjectSchema;
/**
 * schema:PathologyTest - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PathologyTestOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePathologyTest(maybePathologyTest: unknown): PathologyTest | OaValidationError;
