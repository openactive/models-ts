 ...
 * etc.
 */
export declare type PawnShopOrSubClass = PawnShop;
/**
 * schema:PawnShop - Validation schema (w/ JOI)
 */
export declare const PawnShopJoiSchema: Joi.ObjectSchema;
/**
 * schema:PawnShop - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PawnShopOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePawnShop(maybePawnShop: unknown): PawnShop | OaValidationError;
