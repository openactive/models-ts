...
exports.validatePawnShop = exports.PawnShopOrSubClassJoiSchema = exports.PawnShopJoiSchema = void 0;
 ...
 */
exports.PawnShopJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.PawnShopOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PawnShopJoiSchema,
]);
/**
 ...
 * ```
 */
function validatePawnShop(maybePawnShop) {
    const { value, error } = exports.PawnShopJoiSchema.validate(maybePawnShop);
    if (error) {
        return new oaValidationError_1.OaValidationError('PawnShop', maybePawnShop, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validatePawnShop = validatePawnShop;
