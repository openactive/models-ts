...
exports.validatePayAction = exports.PayActionOrSubClassJoiSchema = exports.PayActionJoiSchema = void 0;
 ...
 */
exports.PayActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.PayActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PayActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validatePayAction(maybePayAction) {
    const { value, error } = exports.PayActionJoiSchema.validate(maybePayAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('PayAction', maybePayAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validatePayAction = validatePayAction;
