 ...
 * etc.
 */
export declare type PaymentCardOrSubClass = PaymentCard | schema.CreditCardOrSubClass;
/**
 * schema:PaymentCard - Validation schema (w/ JOI)
 */
export declare const PaymentCardJoiSchema: Joi.ObjectSchema;
/**
 * schema:PaymentCard - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PaymentCardOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePaymentCard(maybePaymentCard: unknown): PaymentCard | OaValidationError;
