 ...
 * etc.
 */
export declare type PaymentChargeSpecificationOrSubClass = PaymentChargeSpecification;
/**
 * schema:PaymentChargeSpecification - Validation schema (w/ JOI)
 */
export declare const PaymentChargeSpecificationJoiSchema: Joi.ObjectSchema;
/**
 * schema:PaymentChargeSpecification - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PaymentChargeSpecificationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePaymentChargeSpecification(maybePaymentChargeSpecification: unknown): PaymentChargeSpecification | OaValidationError;
