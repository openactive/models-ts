 ...
 * etc.
 */
export declare type PaymentServiceOrSubClass = PaymentService;
/**
 * schema:PaymentService - Validation schema (w/ JOI)
 */
export declare const PaymentServiceJoiSchema: Joi.ObjectSchema;
/**
 * schema:PaymentService - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PaymentServiceOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePaymentService(maybePaymentService: unknown): PaymentService | OaValidationError;
