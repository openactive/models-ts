...
exports.validatePaymentStatusType = exports.PaymentStatusTypeOrSubClassJoiSchema = exports.PaymentStatusTypeJoiSchema = void 0;
 ...
 */
exports.PaymentStatusTypeJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.PaymentStatusTypeOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PaymentStatusTypeJoiSchema,
]);
/**
 ...
 * ```
 */
function validatePaymentStatusType(maybePaymentStatusType) {
    const { value, error } = exports.PaymentStatusTypeJoiSchema.validate(maybePaymentStatusType);
    if (error) {
        return new oaValidationError_1.OaValidationError('PaymentStatusType', maybePaymentStatusType, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validatePaymentStatusType = validatePaymentStatusType;
