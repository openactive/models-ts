 ...
 * etc.
 */
export declare type PerformingArtsTheaterOrSubClass = PerformingArtsTheater;
/**
 * schema:PerformingArtsTheater - Validation schema (w/ JOI)
 */
export declare const PerformingArtsTheaterJoiSchema: Joi.ObjectSchema;
/**
 * schema:PerformingArtsTheater - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PerformingArtsTheaterOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePerformingArtsTheater(maybePerformingArtsTheater: unknown): PerformingArtsTheater | OaValidationError;
