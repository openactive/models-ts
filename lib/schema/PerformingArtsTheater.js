...
exports.validatePerformingArtsTheater = exports.PerformingArtsTheaterOrSubClassJoiSchema = exports.PerformingArtsTheaterJoiSchema = void 0;
 ...
 */
exports.PerformingArtsTheaterJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.PerformingArtsTheaterOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PerformingArtsTheaterJoiSchema,
]);
/**
 ...
 * ```
 */
function validatePerformingArtsTheater(maybePerformingArtsTheater) {
    const { value, error } = exports.PerformingArtsTheaterJoiSchema.validate(maybePerformingArtsTheater);
    if (error) {
        return new oaValidationError_1.OaValidationError('PerformingArtsTheater', maybePerformingArtsTheater, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validatePerformingArtsTheater = validatePerformingArtsTheater;
