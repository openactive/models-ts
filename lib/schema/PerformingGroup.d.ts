 ...
 * etc.
 */
export declare type PerformingGroupOrSubClass = PerformingGroup | schema.MusicGroupOrSubClass | schema.TheaterGroupOrSubClass | schema.DanceGroupOrSubClass;
/**
 * schema:PerformingGroup - Validation schema (w/ JOI)
 */
export declare const PerformingGroupJoiSchema: Joi.ObjectSchema;
/**
 * schema:PerformingGroup - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PerformingGroupOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePerformingGroup(maybePerformingGroup: unknown): PerformingGroup | OaValidationError;
