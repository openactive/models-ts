 ...
 * etc.
 */
export declare type PeriodicalOrSubClass = Periodical | schema.ComicSeriesOrSubClass | schema.NewspaperOrSubClass;
/**
 * schema:Periodical - Validation schema (w/ JOI)
 */
export declare const PeriodicalJoiSchema: Joi.ObjectSchema;
/**
 * schema:Periodical - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PeriodicalOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePeriodical(maybePeriodical: unknown): Periodical | OaValidationError;
