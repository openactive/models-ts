...
exports.validatePeriodical = exports.PeriodicalOrSubClassJoiSchema = exports.PeriodicalJoiSchema = void 0;
 ...
 */
exports.PeriodicalJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.PeriodicalOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PeriodicalJoiSchema,
 ...
 * ```
 */
function validatePeriodical(maybePeriodical) {
    const { value, error } = exports.PeriodicalJoiSchema.validate(maybePeriodical);
    if (error) {
        return new oaValidationError_1.OaValidationError('Periodical', maybePeriodical, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validatePeriodical = validatePeriodical;
