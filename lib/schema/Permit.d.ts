 ...
 * etc.
 */
export declare type PermitOrSubClass = Permit | schema.GovernmentPermitOrSubClass;
/**
 * schema:Permit - Validation schema (w/ JOI)
 */
export declare const PermitJoiSchema: Joi.ObjectSchema;
/**
 * schema:Permit - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PermitOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 *
 * ```ts
 * const maybePermit = Permit.validate(req.body); // `req.body` will have type `any` or `unknown`
 ...
 * ```
 */
export declare function validatePermit(maybePermit: unknown): Permit | OaValidationError;
