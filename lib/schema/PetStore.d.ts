 ...
 * etc.
 */
export declare type PetStoreOrSubClass = PetStore;
/**
 * schema:PetStore - Validation schema (w/ JOI)
 */
export declare const PetStoreJoiSchema: Joi.ObjectSchema;
/**
 * schema:PetStore - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PetStoreOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePetStore(maybePetStore: unknown): PetStore | OaValidationError;
