...
exports.validatePetStore = exports.PetStoreOrSubClassJoiSchema = exports.PetStoreJoiSchema = void 0;
 ...
 */
exports.PetStoreJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.PetStoreOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PetStoreJoiSchema,
]);
/**
 ...
 * ```
 */
function validatePetStore(maybePetStore) {
    const { value, error } = exports.PetStoreJoiSchema.validate(maybePetStore);
    if (error) {
        return new oaValidationError_1.OaValidationError('PetStore', maybePetStore, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validatePetStore = validatePetStore;
