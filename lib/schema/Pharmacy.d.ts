 ...
 * etc.
 */
export declare type PharmacyOrSubClass = Pharmacy;
/**
 * schema:Pharmacy - Validation schema (w/ JOI)
 */
export declare const PharmacyJoiSchema: Joi.ObjectSchema;
/**
 * schema:Pharmacy - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PharmacyOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePharmacy(maybePharmacy: unknown): Pharmacy | OaValidationError;
