...
exports.validatePharmacy = exports.PharmacyOrSubClassJoiSchema = exports.PharmacyJoiSchema = void 0;
 ...
 */
exports.PharmacyJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.PharmacyOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PharmacyJoiSchema,
]);
/**
 ...
 * ```
 */
function validatePharmacy(maybePharmacy) {
    const { value, error } = exports.PharmacyJoiSchema.validate(maybePharmacy);
    if (error) {
        return new oaValidationError_1.OaValidationError('Pharmacy', maybePharmacy, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validatePharmacy = validatePharmacy;
