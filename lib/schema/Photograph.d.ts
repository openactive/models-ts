 ...
 * etc.
 */
export declare type PhotographOrSubClass = Photograph;
/**
 * schema:Photograph - Validation schema (w/ JOI)
 */
export declare const PhotographJoiSchema: Joi.ObjectSchema;
/**
 * schema:Photograph - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PhotographOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePhotograph(maybePhotograph: unknown): Photograph | OaValidationError;
