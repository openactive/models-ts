...
exports.validatePhotograph = exports.PhotographOrSubClassJoiSchema = exports.PhotographJoiSchema = void 0;
 ...
 */
exports.PhotographJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.PhotographOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PhotographJoiSchema,
]);
/**
 ...
 * ```
 */
function validatePhotograph(maybePhotograph) {
    const { value, error } = exports.PhotographJoiSchema.validate(maybePhotograph);
    if (error) {
        return new oaValidationError_1.OaValidationError('Photograph', maybePhotograph, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validatePhotograph = validatePhotograph;
