 ...
 * schema:PhysicalExam
 */
export declare type PhysicalExam = {
    '@type': 'PhysicalExam';
 ...
 * etc.
 */
export declare type PhysicalExamOrSubClass = PhysicalExam;
/**
 * schema:PhysicalExam - Validation schema (w/ JOI)
 */
export declare const PhysicalExamJoiSchema: Joi.ObjectSchema;
/**
 * schema:PhysicalExam - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PhysicalExamOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePhysicalExam(maybePhysicalExam: unknown): PhysicalExam | OaValidationError;
