...
exports.validatePhysicalTherapy = exports.PhysicalTherapyOrSubClassJoiSchema = exports.PhysicalTherapyJoiSchema = void 0;
 ...
 */
exports.PhysicalTherapyJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.PhysicalTherapyOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PhysicalTherapyJoiSchema,
]);
/**
 ...
 * ```
 */
function validatePhysicalTherapy(maybePhysicalTherapy) {
    const { value, error } = exports.PhysicalTherapyJoiSchema.validate(maybePhysicalTherapy);
    if (error) {
        return new oaValidationError_1.OaValidationError('PhysicalTherapy', maybePhysicalTherapy, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validatePhysicalTherapy = validatePhysicalTherapy;
