 ...
 * etc.
 */
export declare type PhysicianOrSubClass = Physician;
/**
 * schema:Physician - Validation schema (w/ JOI)
 */
export declare const PhysicianJoiSchema: Joi.ObjectSchema;
/**
 * schema:Physician - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PhysicianOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePhysician(maybePhysician: unknown): Physician | OaValidationError;
