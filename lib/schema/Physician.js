...
exports.validatePhysician = exports.PhysicianOrSubClassJoiSchema = exports.PhysicianJoiSchema = void 0;
 ...
 */
exports.PhysicianJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.PhysicianOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PhysicianJoiSchema,
]);
/**
 ...
 * ```
 */
function validatePhysician(maybePhysician) {
    const { value, error } = exports.PhysicianJoiSchema.validate(maybePhysician);
    if (error) {
        return new oaValidationError_1.OaValidationError('Physician', maybePhysician, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validatePhysician = validatePhysician;
