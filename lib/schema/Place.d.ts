 ...
 * etc.
 */
export declare type PlaceOrSubClass = Place | schema.ResidenceOrSubClass | schema.AccommodationOrSubClass | schema.LocalBusinessOrSubClass | schema.AdministrativeAreaOrSubClass | schema.CivicStructureOrSubClass | schema.TouristAttractionOrSubClass | schema.TouristDestinationOrSubClass | schema.LandmarksOrHistoricalBuildingsOrSubClass | schema.LandformOrSubClass;
/**
