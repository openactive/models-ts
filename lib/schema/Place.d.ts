 ...
 * etc.
 */
export declare type PlaceOrSubClass = Place | schema.TouristAttractionOrSubClass | schema.LandmarksOrHistoricalBuildingsOrSubClass | schema.LocalBusinessOrSubClass | schema.AccommodationOrSubClass | schema.CivicStructureOrSubClass | schema.AdministrativeAreaOrSubClass | schema.TouristDestinationOrSubClass | schema.LandformOrSubClass | schema.ResidenceOrSubClass;
/**
