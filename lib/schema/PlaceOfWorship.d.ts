 ...
 * etc.
 */
export declare type PlaceOfWorshipOrSubClass = PlaceOfWorship | schema.SynagogueOrSubClass | schema.HinduTempleOrSubClass | schema.MosqueOrSubClass | schema.ChurchOrSubClass | schema.BuddhistTempleOrSubClass;
/**
 * schema:PlaceOfWorship - Validation schema (w/ JOI)
 */
export declare const PlaceOfWorshipJoiSchema: Joi.ObjectSchema;
/**
 * schema:PlaceOfWorship - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PlaceOfWorshipOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePlaceOfWorship(maybePlaceOfWorship: unknown): PlaceOfWorship | OaValidationError;
