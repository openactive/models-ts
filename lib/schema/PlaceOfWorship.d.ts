 ...
 * etc.
 */
export declare type PlaceOfWorshipOrSubClass = PlaceOfWorship | schema.SynagogueOrSubClass | schema.HinduTempleOrSubClass | schema.BuddhistTempleOrSubClass | schema.MosqueOrSubClass | schema.ChurchOrSubClass;
/**
