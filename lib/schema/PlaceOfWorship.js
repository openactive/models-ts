...
exports.validatePlaceOfWorship = exports.PlaceOfWorshipOrSubClassJoiSchema = exports.PlaceOfWorshipJoiSchema = void 0;
 ...
 */
exports.PlaceOfWorshipJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.PlaceOfWorshipOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PlaceOfWorshipJoiSchema,
 ...
 * ```
 */
function validatePlaceOfWorship(maybePlaceOfWorship) {
    const { value, error } = exports.PlaceOfWorshipJoiSchema.validate(maybePlaceOfWorship);
    if (error) {
        return new oaValidationError_1.OaValidationError('PlaceOfWorship', maybePlaceOfWorship, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validatePlaceOfWorship = validatePlaceOfWorship;
