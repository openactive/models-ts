 ...
 * etc.
 */
export declare type PlayOrSubClass = Play;
/**
 * schema:Play - Validation schema (w/ JOI)
 */
export declare const PlayJoiSchema: Joi.ObjectSchema;
/**
 * schema:Play - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PlayOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePlay(maybePlay: unknown): Play | OaValidationError;
