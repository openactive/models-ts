...
exports.validatePlay = exports.PlayOrSubClassJoiSchema = exports.PlayJoiSchema = void 0;
 ...
 */
exports.PlayJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.PlayOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PlayJoiSchema,
]);
/**
 ...
 * ```
 */
function validatePlay(maybePlay) {
    const { value, error } = exports.PlayJoiSchema.validate(maybePlay);
    if (error) {
        return new oaValidationError_1.OaValidationError('Play', maybePlay, error);
    }
