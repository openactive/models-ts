 ...
 * etc.
 */
export declare type PlaygroundOrSubClass = Playground;
/**
 * schema:Playground - Validation schema (w/ JOI)
 */
export declare const PlaygroundJoiSchema: Joi.ObjectSchema;
/**
 * schema:Playground - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PlaygroundOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePlayground(maybePlayground: unknown): Playground | OaValidationError;
