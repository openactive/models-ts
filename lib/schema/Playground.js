...
exports.validatePlayground = exports.PlaygroundOrSubClassJoiSchema = exports.PlaygroundJoiSchema = void 0;
 ...
 */
exports.PlaygroundJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.PlaygroundOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PlaygroundJoiSchema,
]);
/**
 ...
 * ```
 */
function validatePlayground(maybePlayground) {
    const { value, error } = exports.PlaygroundJoiSchema.validate(maybePlayground);
    if (error) {
        return new oaValidationError_1.OaValidationError('Playground', maybePlayground, error);
    }
