 ...
 * etc.
 */
export declare type PlumberOrSubClass = Plumber;
/**
 * schema:Plumber - Validation schema (w/ JOI)
 */
export declare const PlumberJoiSchema: Joi.ObjectSchema;
/**
 * schema:Plumber - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PlumberOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePlumber(maybePlumber: unknown): Plumber | OaValidationError;
