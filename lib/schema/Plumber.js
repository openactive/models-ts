...
exports.validatePlumber = exports.PlumberOrSubClassJoiSchema = exports.PlumberJoiSchema = void 0;
 ...
 */
exports.PlumberJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.PlumberOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PlumberJoiSchema,
]);
/**
 ...
 * ```
 */
function validatePlumber(maybePlumber) {
    const { value, error } = exports.PlumberJoiSchema.validate(maybePlumber);
    if (error) {
        return new oaValidationError_1.OaValidationError('Plumber', maybePlumber, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validatePlumber = validatePlumber;
