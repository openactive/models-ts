 ...
 * etc.
 */
export declare type PodcastEpisodeOrSubClass = PodcastEpisode;
/**
 * schema:PodcastEpisode - Validation schema (w/ JOI)
 */
export declare const PodcastEpisodeJoiSchema: Joi.ObjectSchema;
/**
 * schema:PodcastEpisode - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PodcastEpisodeOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePodcastEpisode(maybePodcastEpisode: unknown): PodcastEpisode | OaValidationError;
