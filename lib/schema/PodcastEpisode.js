...
exports.validatePodcastEpisode = exports.PodcastEpisodeOrSubClassJoiSchema = exports.PodcastEpisodeJoiSchema = void 0;
 ...
 */
exports.PodcastEpisodeJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.PodcastEpisodeOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PodcastEpisodeJoiSchema,
]);
/**
 ...
 * ```
 */
function validatePodcastEpisode(maybePodcastEpisode) {
    const { value, error } = exports.PodcastEpisodeJoiSchema.validate(maybePodcastEpisode);
    if (error) {
        return new oaValidationError_1.OaValidationError('PodcastEpisode', maybePodcastEpisode, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validatePodcastEpisode = validatePodcastEpisode;
