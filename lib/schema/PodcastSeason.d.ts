 ...
 * etc.
 */
export declare type PodcastSeasonOrSubClass = PodcastSeason;
/**
 * schema:PodcastSeason - Validation schema (w/ JOI)
 */
export declare const PodcastSeasonJoiSchema: Joi.ObjectSchema;
/**
 * schema:PodcastSeason - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PodcastSeasonOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePodcastSeason(maybePodcastSeason: unknown): PodcastSeason | OaValidationError;
