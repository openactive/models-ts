...
exports.validatePodcastSeason = exports.PodcastSeasonOrSubClassJoiSchema = exports.PodcastSeasonJoiSchema = void 0;
 ...
 */
exports.PodcastSeasonJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.PodcastSeasonOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PodcastSeasonJoiSchema,
]);
/**
 ...
 * ```
 */
function validatePodcastSeason(maybePodcastSeason) {
    const { value, error } = exports.PodcastSeasonJoiSchema.validate(maybePodcastSeason);
    if (error) {
        return new oaValidationError_1.OaValidationError('PodcastSeason', maybePodcastSeason, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validatePodcastSeason = validatePodcastSeason;
