 ...
 * etc.
 */
export declare type PodcastSeriesOrSubClass = PodcastSeries;
/**
 * schema:PodcastSeries - Validation schema (w/ JOI)
 */
export declare const PodcastSeriesJoiSchema: Joi.ObjectSchema;
/**
 * schema:PodcastSeries - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PodcastSeriesOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePodcastSeries(maybePodcastSeries: unknown): PodcastSeries | OaValidationError;
