...
exports.validatePodcastSeries = exports.PodcastSeriesOrSubClassJoiSchema = exports.PodcastSeriesJoiSchema = void 0;
 ...
 */
exports.PodcastSeriesJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.PodcastSeriesOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PodcastSeriesJoiSchema,
]);
/**
 ...
 * ```
 */
function validatePodcastSeries(maybePodcastSeries) {
    const { value, error } = exports.PodcastSeriesJoiSchema.validate(maybePodcastSeries);
    if (error) {
        return new oaValidationError_1.OaValidationError('PodcastSeries', maybePodcastSeries, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validatePodcastSeries = validatePodcastSeries;
