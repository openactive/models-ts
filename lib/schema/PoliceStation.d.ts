 ...
 * etc.
 */
export declare type PoliceStationOrSubClass = PoliceStation;
/**
 * schema:PoliceStation - Validation schema (w/ JOI)
 */
export declare const PoliceStationJoiSchema: Joi.ObjectSchema;
/**
 * schema:PoliceStation - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PoliceStationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePoliceStation(maybePoliceStation: unknown): PoliceStation | OaValidationError;
