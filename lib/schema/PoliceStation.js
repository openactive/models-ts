...
exports.validatePoliceStation = exports.PoliceStationOrSubClassJoiSchema = exports.PoliceStationJoiSchema = void 0;
 ...
 */
exports.PoliceStationJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.PoliceStationOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PoliceStationJoiSchema,
]);
/**
 ...
 * ```
 */
function validatePoliceStation(maybePoliceStation) {
    const { value, error } = exports.PoliceStationJoiSchema.validate(maybePoliceStation);
    if (error) {
        return new oaValidationError_1.OaValidationError('PoliceStation', maybePoliceStation, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validatePoliceStation = validatePoliceStation;
