 ...
 * etc.
 */
export declare type PondOrSubClass = Pond;
/**
 * schema:Pond - Validation schema (w/ JOI)
 */
export declare const PondJoiSchema: Joi.ObjectSchema;
/**
 * schema:Pond - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PondOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePond(maybePond: unknown): Pond | OaValidationError;
