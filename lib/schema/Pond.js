...
exports.validatePond = exports.PondOrSubClassJoiSchema = exports.PondJoiSchema = void 0;
 ...
 */
exports.PondJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.PondOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PondJoiSchema,
]);
/**
 ...
 * ```
 */
function validatePond(maybePond) {
    const { value, error } = exports.PondJoiSchema.validate(maybePond);
    if (error) {
        return new oaValidationError_1.OaValidationError('Pond', maybePond, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validatePond = validatePond;
