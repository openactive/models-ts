 ...
 * etc.
 */
export declare type PostOfficeOrSubClass = PostOffice;
/**
 * schema:PostOffice - Validation schema (w/ JOI)
 */
export declare const PostOfficeJoiSchema: Joi.ObjectSchema;
/**
 * schema:PostOffice - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PostOfficeOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePostOffice(maybePostOffice: unknown): PostOffice | OaValidationError;
