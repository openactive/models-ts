...
exports.validatePostOffice = exports.PostOfficeOrSubClassJoiSchema = exports.PostOfficeJoiSchema = void 0;
 ...
 */
exports.PostOfficeJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.PostOfficeOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PostOfficeJoiSchema,
]);
/**
 ...
 * ```
 */
function validatePostOffice(maybePostOffice) {
    const { value, error } = exports.PostOfficeJoiSchema.validate(maybePostOffice);
    if (error) {
        return new oaValidationError_1.OaValidationError('PostOffice', maybePostOffice, error);
    }
