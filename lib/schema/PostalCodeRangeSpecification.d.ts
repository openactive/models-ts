 ...
 */
export declare type PostalCodeRangeSpecification = {
 ...
 * etc.
 */
export declare type PostalCodeRangeSpecificationOrSubClass = PostalCodeRangeSpecification;
/**
 * schema:PostalCodeRangeSpecification - Validation schema (w/ JOI)
 */
export declare const PostalCodeRangeSpecificationJoiSchema: Joi.ObjectSchema;
/**
 * schema:PostalCodeRangeSpecification - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PostalCodeRangeSpecificationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePostalCodeRangeSpecification(maybePostalCodeRangeSpecification: unknown): PostalCodeRangeSpecification | OaValidationError;
