 ...
 * etc.
 */
export declare type PosterOrSubClass = Poster;
/**
 * schema:Poster - Validation schema (w/ JOI)
 */
export declare const PosterJoiSchema: Joi.ObjectSchema;
/**
 * schema:Poster - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PosterOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePoster(maybePoster: unknown): Poster | OaValidationError;
