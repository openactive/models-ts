...
exports.validatePrependAction = exports.PrependActionOrSubClassJoiSchema = exports.PrependActionJoiSchema = void 0;
 ...
 */
exports.PrependActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.PrependActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PrependActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validatePrependAction(maybePrependAction) {
    const { value, error } = exports.PrependActionJoiSchema.validate(maybePrependAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('PrependAction', maybePrependAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validatePrependAction = validatePrependAction;
