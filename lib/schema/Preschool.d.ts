 ...
 * etc.
 */
export declare type PreschoolOrSubClass = Preschool;
/**
 * schema:Preschool - Validation schema (w/ JOI)
 */
export declare const PreschoolJoiSchema: Joi.ObjectSchema;
/**
 * schema:Preschool - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PreschoolOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePreschool(maybePreschool: unknown): Preschool | OaValidationError;
