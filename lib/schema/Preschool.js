...
exports.validatePreschool = exports.PreschoolOrSubClassJoiSchema = exports.PreschoolJoiSchema = void 0;
 ...
 */
exports.PreschoolJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.PreschoolOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PreschoolJoiSchema,
]);
/**
 ...
 * ```
 */
function validatePreschool(maybePreschool) {
    const { value, error } = exports.PreschoolJoiSchema.validate(maybePreschool);
    if (error) {
        return new oaValidationError_1.OaValidationError('Preschool', maybePreschool, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validatePreschool = validatePreschool;
