 ...
 * etc.
 */
export declare type PresentationDigitalDocumentOrSubClass = PresentationDigitalDocument;
/**
 * schema:PresentationDigitalDocument - Validation schema (w/ JOI)
 */
export declare const PresentationDigitalDocumentJoiSchema: Joi.ObjectSchema;
/**
 * schema:PresentationDigitalDocument - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PresentationDigitalDocumentOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePresentationDigitalDocument(maybePresentationDigitalDocument: unknown): PresentationDigitalDocument | OaValidationError;
