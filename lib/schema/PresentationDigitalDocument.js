...
exports.validatePresentationDigitalDocument = exports.PresentationDigitalDocumentOrSubClassJoiSchema = exports.PresentationDigitalDocumentJoiSchema = void 0;
 ...
 */
exports.PresentationDigitalDocumentJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.PresentationDigitalDocumentOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PresentationDigitalDocumentJoiSchema,
]);
/**
 ...
 * ```
 */
function validatePresentationDigitalDocument(maybePresentationDigitalDocument) {
    const { value, error } = exports.PresentationDigitalDocumentJoiSchema.validate(maybePresentationDigitalDocument);
    if (error) {
        return new oaValidationError_1.OaValidationError('PresentationDigitalDocument', maybePresentationDigitalDocument, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validatePresentationDigitalDocument = validatePresentationDigitalDocument;
