 ...
 * etc.
 */
export declare type PreventionIndicationOrSubClass = PreventionIndication;
/**
 * schema:PreventionIndication - Validation schema (w/ JOI)
 */
export declare const PreventionIndicationJoiSchema: Joi.ObjectSchema;
/**
 * schema:PreventionIndication - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PreventionIndicationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePreventionIndication(maybePreventionIndication: unknown): PreventionIndication | OaValidationError;
