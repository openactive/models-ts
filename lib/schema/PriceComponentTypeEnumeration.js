 ...
 */
exports.PriceComponentTypeEnumerationJoiSchema = Joi.string().valid('https://schema.org/DistanceFee', 'https://schema.org/ActivationFee', 'https://schema.org/CleaningFee', 'https://schema.org/Installment', 'https://schema.org/Subscription', 'https://schema.org/Downpayment');
/**
