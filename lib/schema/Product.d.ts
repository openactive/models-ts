 ...
 * etc.
 */
export declare type ProductOrSubClass = Product | oa.FacilityUseOrSubClass | schema.IndividualProductOrSubClass | schema.SomeProductsOrSubClass | schema.VehicleOrSubClass | schema.ProductCollectionOrSubClass | schema.ProductModelOrSubClass | schema.ProductGroupOrSubClass;
/**
 * schema:Product - Validation schema (w/ JOI)
 */
export declare const ProductJoiSchema: Joi.ObjectSchema;
/**
 * schema:Product - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ProductOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateProduct(maybeProduct: unknown): Product | OaValidationError;
