 ...
 * etc.
 */
export declare type ProductOrSubClass = Product | oa.FacilityUseOrSubClass | schema.SomeProductsOrSubClass | schema.ProductModelOrSubClass | schema.VehicleOrSubClass | schema.ProductGroupOrSubClass | schema.IndividualProductOrSubClass | schema.ProductCollectionOrSubClass;
/**
