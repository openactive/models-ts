...
exports.validateProduct = exports.ProductOrSubClassJoiSchema = exports.ProductJoiSchema = void 0;
 ...
 * `SessionSeries`, etc.
 */
exports.ProductOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ProductJoiSchema,
 ...
 * ```
 */
function validateProduct(maybeProduct) {
    const { value, error } = exports.ProductJoiSchema.validate(maybeProduct);
    if (error) {
        return new oaValidationError_1.OaValidationError('Product', maybeProduct, error);
    }
