 ...
 * schema:ProductGroup
 */
export declare type ProductGroup = {
    '@type': 'ProductGroup';
 ...
 * etc.
 */
export declare type ProductGroupOrSubClass = ProductGroup;
/**
 * schema:ProductGroup - Validation schema (w/ JOI)
 */
export declare const ProductGroupJoiSchema: Joi.ObjectSchema;
/**
 * schema:ProductGroup - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ProductGroupOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateProductGroup(maybeProductGroup: unknown): ProductGroup | OaValidationError;
