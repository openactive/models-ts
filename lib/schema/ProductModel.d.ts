 ...
 * etc.
 */
export declare type ProductModelOrSubClass = ProductModel;
/**
 * schema:ProductModel - Validation schema (w/ JOI)
 */
export declare const ProductModelJoiSchema: Joi.ObjectSchema;
/**
 * schema:ProductModel - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ProductModelOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateProductModel(maybeProductModel: unknown): ProductModel | OaValidationError;
