 ...
 * etc.
 */
export declare type ProfessionalServiceOrSubClass = ProfessionalService;
/**
 * schema:ProfessionalService - Validation schema (w/ JOI)
 */
export declare const ProfessionalServiceJoiSchema: Joi.ObjectSchema;
/**
 * schema:ProfessionalService - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ProfessionalServiceOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateProfessionalService(maybeProfessionalService: unknown): ProfessionalService | OaValidationError;
