...
exports.validateProfessionalService = exports.ProfessionalServiceOrSubClassJoiSchema = exports.ProfessionalServiceJoiSchema = void 0;
 ...
 */
exports.ProfessionalServiceJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ProfessionalServiceOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ProfessionalServiceJoiSchema,
]);
/**
 ...
 * ```
 */
function validateProfessionalService(maybeProfessionalService) {
    const { value, error } = exports.ProfessionalServiceJoiSchema.validate(maybeProfessionalService);
    if (error) {
        return new oaValidationError_1.OaValidationError('ProfessionalService', maybeProfessionalService, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateProfessionalService = validateProfessionalService;
