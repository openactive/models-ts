 ...
 * etc.
 */
export declare type ProfilePageOrSubClass = ProfilePage;
/**
 * schema:ProfilePage - Validation schema (w/ JOI)
 */
export declare const ProfilePageJoiSchema: Joi.ObjectSchema;
/**
 * schema:ProfilePage - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ProfilePageOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateProfilePage(maybeProfilePage: unknown): ProfilePage | OaValidationError;
