...
exports.validateProfilePage = exports.ProfilePageOrSubClassJoiSchema = exports.ProfilePageJoiSchema = void 0;
 ...
 */
exports.ProfilePageJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ProfilePageOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ProfilePageJoiSchema,
]);
/**
 ...
 * ```
 */
function validateProfilePage(maybeProfilePage) {
    const { value, error } = exports.ProfilePageJoiSchema.validate(maybeProfilePage);
    if (error) {
        return new oaValidationError_1.OaValidationError('ProfilePage', maybeProfilePage, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateProfilePage = validateProfilePage;
