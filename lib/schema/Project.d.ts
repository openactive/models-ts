 ...
 * etc.
 */
export declare type ProjectOrSubClass = Project | schema.ResearchProjectOrSubClass | schema.FundingAgencyOrSubClass;
/**
 * schema:Project - Validation schema (w/ JOI)
 */
export declare const ProjectJoiSchema: Joi.ObjectSchema;
/**
 * schema:Project - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ProjectOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateProject(maybeProject: unknown): Project | OaValidationError;
