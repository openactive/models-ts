...
exports.validateProject = exports.ProjectOrSubClassJoiSchema = exports.ProjectJoiSchema = void 0;
 ...
 */
exports.ProjectJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ProjectOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ProjectJoiSchema,
 ...
 * ```
 */
function validateProject(maybeProject) {
    const { value, error } = exports.ProjectJoiSchema.validate(maybeProject);
    if (error) {
        return new oaValidationError_1.OaValidationError('Project', maybeProject, error);
    }
