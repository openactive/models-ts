 ...
 * etc.
 */
export declare type PropertyOrSubClass = Property;
/**
 * schema:Property - Validation schema (w/ JOI)
 */
export declare const PropertyJoiSchema: Joi.ObjectSchema;
/**
 * schema:Property - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PropertyOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateProperty(maybeProperty: unknown): Property | OaValidationError;
