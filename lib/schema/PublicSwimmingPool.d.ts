 ...
 * etc.
 */
export declare type PublicSwimmingPoolOrSubClass = PublicSwimmingPool;
/**
 * schema:PublicSwimmingPool - Validation schema (w/ JOI)
 */
export declare const PublicSwimmingPoolJoiSchema: Joi.ObjectSchema;
/**
 * schema:PublicSwimmingPool - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PublicSwimmingPoolOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePublicSwimmingPool(maybePublicSwimmingPool: unknown): PublicSwimmingPool | OaValidationError;
