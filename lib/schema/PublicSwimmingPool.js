...
exports.validatePublicSwimmingPool = exports.PublicSwimmingPoolOrSubClassJoiSchema = exports.PublicSwimmingPoolJoiSchema = void 0;
 ...
 */
exports.PublicSwimmingPoolJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.PublicSwimmingPoolOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PublicSwimmingPoolJoiSchema,
]);
/**
 ...
 * ```
 */
function validatePublicSwimmingPool(maybePublicSwimmingPool) {
    const { value, error } = exports.PublicSwimmingPoolJoiSchema.validate(maybePublicSwimmingPool);
    if (error) {
        return new oaValidationError_1.OaValidationError('PublicSwimmingPool', maybePublicSwimmingPool, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validatePublicSwimmingPool = validatePublicSwimmingPool;
