 ...
 * etc.
 */
export declare type PublicToiletOrSubClass = PublicToilet;
/**
 * schema:PublicToilet - Validation schema (w/ JOI)
 */
export declare const PublicToiletJoiSchema: Joi.ObjectSchema;
/**
 * schema:PublicToilet - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PublicToiletOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePublicToilet(maybePublicToilet: unknown): PublicToilet | OaValidationError;
