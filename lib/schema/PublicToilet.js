...
exports.validatePublicToilet = exports.PublicToiletOrSubClassJoiSchema = exports.PublicToiletJoiSchema = void 0;
 ...
 */
exports.PublicToiletJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.PublicToiletOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PublicToiletJoiSchema,
]);
/**
 ...
 * ```
 */
function validatePublicToilet(maybePublicToilet) {
    const { value, error } = exports.PublicToiletJoiSchema.validate(maybePublicToilet);
    if (error) {
        return new oaValidationError_1.OaValidationError('PublicToilet', maybePublicToilet, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validatePublicToilet = validatePublicToilet;
