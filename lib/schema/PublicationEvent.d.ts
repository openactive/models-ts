 ...
 * etc.
 */
export declare type PublicationEventOrSubClass = PublicationEvent | schema.OnDemandEventOrSubClass | schema.BroadcastEventOrSubClass;
/**
 * schema:PublicationEvent - Validation schema (w/ JOI)
 */
export declare const PublicationEventJoiSchema: Joi.ObjectSchema;
/**
 * schema:PublicationEvent - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PublicationEventOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePublicationEvent(maybePublicationEvent: unknown): PublicationEvent | OaValidationError;
