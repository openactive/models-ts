...
exports.validatePublicationEvent = exports.PublicationEventOrSubClassJoiSchema = exports.PublicationEventJoiSchema = void 0;
 ...
 */
exports.PublicationEventJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.PublicationEventOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PublicationEventJoiSchema,
 ...
 * ```
 */
function validatePublicationEvent(maybePublicationEvent) {
    const { value, error } = exports.PublicationEventJoiSchema.validate(maybePublicationEvent);
    if (error) {
        return new oaValidationError_1.OaValidationError('PublicationEvent', maybePublicationEvent, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validatePublicationEvent = validatePublicationEvent;
