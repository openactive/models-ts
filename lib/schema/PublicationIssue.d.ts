 ...
 * etc.
 */
export declare type PublicationIssueOrSubClass = PublicationIssue | schema.ComicIssueOrSubClass;
/**
 * schema:PublicationIssue - Validation schema (w/ JOI)
 */
export declare const PublicationIssueJoiSchema: Joi.ObjectSchema;
/**
 * schema:PublicationIssue - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PublicationIssueOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePublicationIssue(maybePublicationIssue: unknown): PublicationIssue | OaValidationError;
