...
exports.validatePublicationIssue = exports.PublicationIssueOrSubClassJoiSchema = exports.PublicationIssueJoiSchema = void 0;
 ...
 */
exports.PublicationIssueJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.PublicationIssueOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PublicationIssueJoiSchema,
 ...
 * ```
 */
function validatePublicationIssue(maybePublicationIssue) {
    const { value, error } = exports.PublicationIssueJoiSchema.validate(maybePublicationIssue);
    if (error) {
        return new oaValidationError_1.OaValidationError('PublicationIssue', maybePublicationIssue, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validatePublicationIssue = validatePublicationIssue;
