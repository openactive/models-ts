 ...
 * etc.
 */
export declare type PublicationVolumeOrSubClass = PublicationVolume;
/**
 * schema:PublicationVolume - Validation schema (w/ JOI)
 */
export declare const PublicationVolumeJoiSchema: Joi.ObjectSchema;
/**
 * schema:PublicationVolume - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const PublicationVolumeOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validatePublicationVolume(maybePublicationVolume: unknown): PublicationVolume | OaValidationError;
