...
exports.validatePublicationVolume = exports.PublicationVolumeOrSubClassJoiSchema = exports.PublicationVolumeJoiSchema = void 0;
 ...
 */
exports.PublicationVolumeJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.PublicationVolumeOrSubClassJoiSchema = Joi.alternatives().try([
    exports.PublicationVolumeJoiSchema,
]);
/**
 ...
 * ```
 */
function validatePublicationVolume(maybePublicationVolume) {
    const { value, error } = exports.PublicationVolumeJoiSchema.validate(maybePublicationVolume);
    if (error) {
        return new oaValidationError_1.OaValidationError('PublicationVolume', maybePublicationVolume, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validatePublicationVolume = validatePublicationVolume;
