 ...
 * etc.
 */
export declare type QAPageOrSubClass = QAPage;
/**
 * schema:QAPage - Validation schema (w/ JOI)
 */
export declare const QAPageJoiSchema: Joi.ObjectSchema;
/**
 * schema:QAPage - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const QAPageOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateQAPage(maybeQAPage: unknown): QAPage | OaValidationError;
