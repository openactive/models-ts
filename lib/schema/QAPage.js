...
exports.validateQAPage = exports.QAPageOrSubClassJoiSchema = exports.QAPageJoiSchema = void 0;
 ...
 */
exports.QAPageJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.QAPageOrSubClassJoiSchema = Joi.alternatives().try([
    exports.QAPageJoiSchema,
]);
/**
 ...
 * ```
 */
function validateQAPage(maybeQAPage) {
    const { value, error } = exports.QAPageJoiSchema.validate(maybeQAPage);
    if (error) {
        return new oaValidationError_1.OaValidationError('QAPage', maybeQAPage, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateQAPage = validateQAPage;
