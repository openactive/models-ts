 ...
 * etc.
 */
export declare type QuantitativeValueOrSubClass = QuantitativeValue;
/**
 * schema:QuantitativeValue - Validation schema (w/ JOI)
 */
export declare const QuantitativeValueJoiSchema: Joi.ObjectSchema;
/**
 * schema:QuantitativeValue - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const QuantitativeValueOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateQuantitativeValue(maybeQuantitativeValue: unknown): QuantitativeValue | OaValidationError;
