...
exports.validateQuantitativeValueDistribution = exports.QuantitativeValueDistributionOrSubClassJoiSchema = exports.QuantitativeValueDistributionJoiSchema = void 0;
 ...
 */
exports.QuantitativeValueDistributionJoiSchema = Joi.object({
    '@type': Joi.string().valid('QuantitativeValueDistribution').required(),
 ...
 * `SessionSeries`, etc.
 */
exports.QuantitativeValueDistributionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.QuantitativeValueDistributionJoiSchema,
    Joi.lazy(() => schema.MonetaryAmountDistributionOrSubClassJoiSchema),
]);
/**
 ...
 * ```
 */
function validateQuantitativeValueDistribution(maybeQuantitativeValueDistribution) {
    const { value, error } = exports.QuantitativeValueDistributionJoiSchema.validate(maybeQuantitativeValueDistribution);
    if (error) {
        return new oaValidationError_1.OaValidationError('QuantitativeValueDistribution', maybeQuantitativeValueDistribution, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateQuantitativeValueDistribution = validateQuantitativeValueDistribution;
