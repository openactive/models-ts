 ...
 * etc.
 */
export declare type QuestionOrSubClass = Question;
/**
 * schema:Question - Validation schema (w/ JOI)
 */
export declare const QuestionJoiSchema: Joi.ObjectSchema;
/**
 * schema:Question - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const QuestionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateQuestion(maybeQuestion: unknown): Question | OaValidationError;
