...
exports.validateQuestion = exports.QuestionOrSubClassJoiSchema = exports.QuestionJoiSchema = void 0;
 ...
 */
exports.QuestionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.QuestionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.QuestionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateQuestion(maybeQuestion) {
    const { value, error } = exports.QuestionJoiSchema.validate(maybeQuestion);
    if (error) {
        return new oaValidationError_1.OaValidationError('Question', maybeQuestion, error);
    }
