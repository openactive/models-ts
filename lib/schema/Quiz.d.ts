 ...
 * etc.
 */
export declare type QuizOrSubClass = Quiz;
/**
 * schema:Quiz - Validation schema (w/ JOI)
 */
export declare const QuizJoiSchema: Joi.ObjectSchema;
/**
 * schema:Quiz - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const QuizOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateQuiz(maybeQuiz: unknown): Quiz | OaValidationError;
