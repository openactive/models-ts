...
exports.validateQuiz = exports.QuizOrSubClassJoiSchema = exports.QuizJoiSchema = void 0;
 ...
 */
exports.QuizJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.QuizOrSubClassJoiSchema = Joi.alternatives().try([
    exports.QuizJoiSchema,
]);
/**
 ...
 * ```
 */
function validateQuiz(maybeQuiz) {
    const { value, error } = exports.QuizJoiSchema.validate(maybeQuiz);
    if (error) {
        return new oaValidationError_1.OaValidationError('Quiz', maybeQuiz, error);
    }
