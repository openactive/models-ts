 ...
 * etc.
 */
export declare type QuotationOrSubClass = Quotation;
/**
 * schema:Quotation - Validation schema (w/ JOI)
 */
export declare const QuotationJoiSchema: Joi.ObjectSchema;
/**
 * schema:Quotation - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const QuotationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateQuotation(maybeQuotation: unknown): Quotation | OaValidationError;
