...
exports.validateQuotation = exports.QuotationOrSubClassJoiSchema = exports.QuotationJoiSchema = void 0;
 ...
 */
exports.QuotationJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.QuotationOrSubClassJoiSchema = Joi.alternatives().try([
    exports.QuotationJoiSchema,
]);
/**
 ...
 * ```
 */
function validateQuotation(maybeQuotation) {
    const { value, error } = exports.QuotationJoiSchema.validate(maybeQuotation);
    if (error) {
        return new oaValidationError_1.OaValidationError('Quotation', maybeQuotation, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateQuotation = validateQuotation;
