 ...
 * etc.
 */
export declare type QuoteActionOrSubClass = QuoteAction;
/**
 * schema:QuoteAction - Validation schema (w/ JOI)
 */
export declare const QuoteActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:QuoteAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const QuoteActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateQuoteAction(maybeQuoteAction: unknown): QuoteAction | OaValidationError;
