...
exports.validateRVPark = exports.RVParkOrSubClassJoiSchema = exports.RVParkJoiSchema = void 0;
 ...
 */
exports.RVParkJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.RVParkOrSubClassJoiSchema = Joi.alternatives().try([
    exports.RVParkJoiSchema,
]);
/**
 ...
 * ```
 */
function validateRVPark(maybeRVPark) {
    const { value, error } = exports.RVParkJoiSchema.validate(maybeRVPark);
    if (error) {
        return new oaValidationError_1.OaValidationError('RVPark', maybeRVPark, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateRVPark = validateRVPark;
