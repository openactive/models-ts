 ...
 * etc.
 */
export declare type RadiationTherapyOrSubClass = RadiationTherapy;
/**
 * schema:RadiationTherapy - Validation schema (w/ JOI)
 */
export declare const RadiationTherapyJoiSchema: Joi.ObjectSchema;
/**
 * schema:RadiationTherapy - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const RadiationTherapyOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateRadiationTherapy(maybeRadiationTherapy: unknown): RadiationTherapy | OaValidationError;
