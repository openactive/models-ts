 ...
 * etc.
 */
export declare type RadioClipOrSubClass = RadioClip;
/**
 * schema:RadioClip - Validation schema (w/ JOI)
 */
export declare const RadioClipJoiSchema: Joi.ObjectSchema;
/**
 * schema:RadioClip - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const RadioClipOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateRadioClip(maybeRadioClip: unknown): RadioClip | OaValidationError;
