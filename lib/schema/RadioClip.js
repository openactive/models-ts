...
exports.validateRadioClip = exports.RadioClipOrSubClassJoiSchema = exports.RadioClipJoiSchema = void 0;
 ...
 */
exports.RadioClipJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.RadioClipOrSubClassJoiSchema = Joi.alternatives().try([
    exports.RadioClipJoiSchema,
]);
/**
 ...
 * ```
 */
function validateRadioClip(maybeRadioClip) {
    const { value, error } = exports.RadioClipJoiSchema.validate(maybeRadioClip);
    if (error) {
        return new oaValidationError_1.OaValidationError('RadioClip', maybeRadioClip, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateRadioClip = validateRadioClip;
