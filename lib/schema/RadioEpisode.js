...
exports.validateRadioEpisode = exports.RadioEpisodeOrSubClassJoiSchema = exports.RadioEpisodeJoiSchema = void 0;
 ...
 */
exports.RadioEpisodeJoiSchema = Joi.object({
    '@type': Joi.string().valid('RadioEpisode').required(),
 ...
 * `SessionSeries`, etc.
 */
exports.RadioEpisodeOrSubClassJoiSchema = Joi.alternatives().try([
    exports.RadioEpisodeJoiSchema,
]);
/**
 ...
 *
 * ```ts
 * const maybeRadioEpisode = RadioEpisode.validate(req.body); // `req.body` will have type `any` or `unknown`
 ...
 * ```
 */
function validateRadioEpisode(maybeRadioEpisode) {
    const { value, error } = exports.RadioEpisodeJoiSchema.validate(maybeRadioEpisode);
    if (error) {
        return new oaValidationError_1.OaValidationError('RadioEpisode', maybeRadioEpisode, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateRadioEpisode = validateRadioEpisode;
