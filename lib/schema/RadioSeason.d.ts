 ...
 * etc.
 */
export declare type RadioSeasonOrSubClass = RadioSeason;
/**
 * schema:RadioSeason - Validation schema (w/ JOI)
 */
export declare const RadioSeasonJoiSchema: Joi.ObjectSchema;
/**
 * schema:RadioSeason - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const RadioSeasonOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateRadioSeason(maybeRadioSeason: unknown): RadioSeason | OaValidationError;
