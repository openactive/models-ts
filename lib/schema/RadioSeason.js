...
exports.validateRadioSeason = exports.RadioSeasonOrSubClassJoiSchema = exports.RadioSeasonJoiSchema = void 0;
 ...
 */
exports.RadioSeasonJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.RadioSeasonOrSubClassJoiSchema = Joi.alternatives().try([
    exports.RadioSeasonJoiSchema,
]);
/**
 ...
 * ```
 */
function validateRadioSeason(maybeRadioSeason) {
    const { value, error } = exports.RadioSeasonJoiSchema.validate(maybeRadioSeason);
    if (error) {
        return new oaValidationError_1.OaValidationError('RadioSeason', maybeRadioSeason, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateRadioSeason = validateRadioSeason;
