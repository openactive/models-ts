 ...
 * etc.
 */
export declare type RadioSeriesOrSubClass = RadioSeries;
/**
 * schema:RadioSeries - Validation schema (w/ JOI)
 */
export declare const RadioSeriesJoiSchema: Joi.ObjectSchema;
/**
 * schema:RadioSeries - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const RadioSeriesOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateRadioSeries(maybeRadioSeries: unknown): RadioSeries | OaValidationError;
