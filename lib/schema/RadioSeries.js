...
exports.validateRadioSeries = exports.RadioSeriesOrSubClassJoiSchema = exports.RadioSeriesJoiSchema = void 0;
 ...
 */
exports.RadioSeriesJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.RadioSeriesOrSubClassJoiSchema = Joi.alternatives().try([
    exports.RadioSeriesJoiSchema,
]);
/**
 ...
 * ```
 */
function validateRadioSeries(maybeRadioSeries) {
    const { value, error } = exports.RadioSeriesJoiSchema.validate(maybeRadioSeries);
    if (error) {
        return new oaValidationError_1.OaValidationError('RadioSeries', maybeRadioSeries, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateRadioSeries = validateRadioSeries;
