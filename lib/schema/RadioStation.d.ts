 ...
 * etc.
 */
export declare type RadioStationOrSubClass = RadioStation;
/**
 * schema:RadioStation - Validation schema (w/ JOI)
 */
export declare const RadioStationJoiSchema: Joi.ObjectSchema;
/**
 * schema:RadioStation - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const RadioStationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateRadioStation(maybeRadioStation: unknown): RadioStation | OaValidationError;
