...
exports.validateRadioStation = exports.RadioStationOrSubClassJoiSchema = exports.RadioStationJoiSchema = void 0;
 ...
 */
exports.RadioStationJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.RadioStationOrSubClassJoiSchema = Joi.alternatives().try([
    exports.RadioStationJoiSchema,
]);
/**
 ...
 * ```
 */
function validateRadioStation(maybeRadioStation) {
    const { value, error } = exports.RadioStationJoiSchema.validate(maybeRadioStation);
    if (error) {
        return new oaValidationError_1.OaValidationError('RadioStation', maybeRadioStation, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateRadioStation = validateRadioStation;
