 ...
 * etc.
 */
export declare type ReadActionOrSubClass = ReadAction;
/**
 * schema:ReadAction - Validation schema (w/ JOI)
 */
export declare const ReadActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:ReadAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ReadActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateReadAction(maybeReadAction: unknown): ReadAction | OaValidationError;
