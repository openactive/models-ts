 ...
 * etc.
 */
export declare type RealEstateAgentOrSubClass = RealEstateAgent;
/**
 * schema:RealEstateAgent - Validation schema (w/ JOI)
 */
export declare const RealEstateAgentJoiSchema: Joi.ObjectSchema;
/**
 * schema:RealEstateAgent - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const RealEstateAgentOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateRealEstateAgent(maybeRealEstateAgent: unknown): RealEstateAgent | OaValidationError;
