...
exports.validateRealEstateAgent = exports.RealEstateAgentOrSubClassJoiSchema = exports.RealEstateAgentJoiSchema = void 0;
 ...
 */
exports.RealEstateAgentJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.RealEstateAgentOrSubClassJoiSchema = Joi.alternatives().try([
    exports.RealEstateAgentJoiSchema,
]);
/**
 ...
 * ```
 */
function validateRealEstateAgent(maybeRealEstateAgent) {
    const { value, error } = exports.RealEstateAgentJoiSchema.validate(maybeRealEstateAgent);
    if (error) {
        return new oaValidationError_1.OaValidationError('RealEstateAgent', maybeRealEstateAgent, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateRealEstateAgent = validateRealEstateAgent;
