 ...
 * etc.
 */
export declare type RealEstateListingOrSubClass = RealEstateListing;
/**
 * schema:RealEstateListing - Validation schema (w/ JOI)
 */
export declare const RealEstateListingJoiSchema: Joi.ObjectSchema;
/**
 * schema:RealEstateListing - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const RealEstateListingOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateRealEstateListing(maybeRealEstateListing: unknown): RealEstateListing | OaValidationError;
