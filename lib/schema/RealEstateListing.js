...
exports.validateRealEstateListing = exports.RealEstateListingOrSubClassJoiSchema = exports.RealEstateListingJoiSchema = void 0;
 ...
 */
exports.RealEstateListingJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.RealEstateListingOrSubClassJoiSchema = Joi.alternatives().try([
    exports.RealEstateListingJoiSchema,
]);
/**
 ...
 * ```
 */
function validateRealEstateListing(maybeRealEstateListing) {
    const { value, error } = exports.RealEstateListingJoiSchema.validate(maybeRealEstateListing);
    if (error) {
        return new oaValidationError_1.OaValidationError('RealEstateListing', maybeRealEstateListing, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateRealEstateListing = validateRealEstateListing;
