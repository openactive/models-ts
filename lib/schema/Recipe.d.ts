 ...
 * etc.
 */
export declare type RecipeOrSubClass = Recipe;
/**
 * schema:Recipe - Validation schema (w/ JOI)
 */
export declare const RecipeJoiSchema: Joi.ObjectSchema;
/**
 * schema:Recipe - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const RecipeOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateRecipe(maybeRecipe: unknown): Recipe | OaValidationError;
