...
exports.validateRecipe = exports.RecipeOrSubClassJoiSchema = exports.RecipeJoiSchema = void 0;
 ...
 */
exports.RecipeJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.RecipeOrSubClassJoiSchema = Joi.alternatives().try([
    exports.RecipeJoiSchema,
]);
/**
 ...
 * ```
 */
function validateRecipe(maybeRecipe) {
    const { value, error } = exports.RecipeJoiSchema.validate(maybeRecipe);
    if (error) {
        return new oaValidationError_1.OaValidationError('Recipe', maybeRecipe, error);
    }
