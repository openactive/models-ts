 ...
 * etc.
 */
export declare type RecommendationOrSubClass = Recommendation;
/**
 * schema:Recommendation - Validation schema (w/ JOI)
 */
export declare const RecommendationJoiSchema: Joi.ObjectSchema;
/**
 * schema:Recommendation - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const RecommendationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateRecommendation(maybeRecommendation: unknown): Recommendation | OaValidationError;
