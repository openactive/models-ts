...
exports.validateRecommendation = exports.RecommendationOrSubClassJoiSchema = exports.RecommendationJoiSchema = void 0;
 ...
 */
exports.RecommendationJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.RecommendationOrSubClassJoiSchema = Joi.alternatives().try([
    exports.RecommendationJoiSchema,
]);
/**
 ...
 * ```
 */
function validateRecommendation(maybeRecommendation) {
    const { value, error } = exports.RecommendationJoiSchema.validate(maybeRecommendation);
    if (error) {
        return new oaValidationError_1.OaValidationError('Recommendation', maybeRecommendation, error);
    }
