 ...
 * etc.
 */
export declare type RecommendedDoseScheduleOrSubClass = RecommendedDoseSchedule;
/**
 * schema:RecommendedDoseSchedule - Validation schema (w/ JOI)
 */
export declare const RecommendedDoseScheduleJoiSchema: Joi.ObjectSchema;
/**
 * schema:RecommendedDoseSchedule - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const RecommendedDoseScheduleOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateRecommendedDoseSchedule(maybeRecommendedDoseSchedule: unknown): RecommendedDoseSchedule | OaValidationError;
