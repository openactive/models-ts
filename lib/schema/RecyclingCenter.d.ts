 ...
 * etc.
 */
export declare type RecyclingCenterOrSubClass = RecyclingCenter;
/**
 * schema:RecyclingCenter - Validation schema (w/ JOI)
 */
export declare const RecyclingCenterJoiSchema: Joi.ObjectSchema;
/**
 * schema:RecyclingCenter - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const RecyclingCenterOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateRecyclingCenter(maybeRecyclingCenter: unknown): RecyclingCenter | OaValidationError;
