...
exports.validateRecyclingCenter = exports.RecyclingCenterOrSubClassJoiSchema = exports.RecyclingCenterJoiSchema = void 0;
 ...
 */
exports.RecyclingCenterJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.RecyclingCenterOrSubClassJoiSchema = Joi.alternatives().try([
    exports.RecyclingCenterJoiSchema,
]);
/**
 ...
 * ```
 */
function validateRecyclingCenter(maybeRecyclingCenter) {
    const { value, error } = exports.RecyclingCenterJoiSchema.validate(maybeRecyclingCenter);
    if (error) {
        return new oaValidationError_1.OaValidationError('RecyclingCenter', maybeRecyclingCenter, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateRecyclingCenter = validateRecyclingCenter;
