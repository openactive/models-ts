...
exports.validateRegisterAction = exports.RegisterActionOrSubClassJoiSchema = exports.RegisterActionJoiSchema = void 0;
 ...
 */
exports.RegisterActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.RegisterActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.RegisterActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateRegisterAction(maybeRegisterAction) {
    const { value, error } = exports.RegisterActionJoiSchema.validate(maybeRegisterAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('RegisterAction', maybeRegisterAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateRegisterAction = validateRegisterAction;
