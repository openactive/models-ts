 ...
 * etc.
 */
export declare type RentActionOrSubClass = RentAction;
/**
 * schema:RentAction - Validation schema (w/ JOI)
 */
export declare const RentActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:RentAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const RentActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateRentAction(maybeRentAction: unknown): RentAction | OaValidationError;
