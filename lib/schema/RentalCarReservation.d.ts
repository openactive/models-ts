 ...
 * etc.
 */
export declare type RentalCarReservationOrSubClass = RentalCarReservation;
/**
 * schema:RentalCarReservation - Validation schema (w/ JOI)
 */
export declare const RentalCarReservationJoiSchema: Joi.ObjectSchema;
/**
 * schema:RentalCarReservation - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const RentalCarReservationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateRentalCarReservation(maybeRentalCarReservation: unknown): RentalCarReservation | OaValidationError;
