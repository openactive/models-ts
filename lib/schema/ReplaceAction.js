...
exports.validateReplaceAction = exports.ReplaceActionOrSubClassJoiSchema = exports.ReplaceActionJoiSchema = void 0;
 ...
 */
exports.ReplaceActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ReplaceActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ReplaceActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateReplaceAction(maybeReplaceAction) {
    const { value, error } = exports.ReplaceActionJoiSchema.validate(maybeReplaceAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('ReplaceAction', maybeReplaceAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateReplaceAction = validateReplaceAction;
