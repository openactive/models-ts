 ...
 * etc.
 */
export declare type ReplyActionOrSubClass = ReplyAction;
/**
 * schema:ReplyAction - Validation schema (w/ JOI)
 */
export declare const ReplyActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:ReplyAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ReplyActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateReplyAction(maybeReplyAction: unknown): ReplyAction | OaValidationError;
