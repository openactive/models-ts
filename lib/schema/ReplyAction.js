...
exports.validateReplyAction = exports.ReplyActionOrSubClassJoiSchema = exports.ReplyActionJoiSchema = void 0;
 ...
 */
exports.ReplyActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ReplyActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ReplyActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateReplyAction(maybeReplyAction) {
    const { value, error } = exports.ReplyActionJoiSchema.validate(maybeReplyAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('ReplyAction', maybeReplyAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateReplyAction = validateReplyAction;
