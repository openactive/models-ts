 ...
 * etc.
 */
export declare type ReportOrSubClass = Report;
/**
 * schema:Report - Validation schema (w/ JOI)
 */
export declare const ReportJoiSchema: Joi.ObjectSchema;
/**
 * schema:Report - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ReportOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateReport(maybeReport: unknown): Report | OaValidationError;
