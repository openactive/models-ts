...
exports.validateReport = exports.ReportOrSubClassJoiSchema = exports.ReportJoiSchema = void 0;
 ...
 */
exports.ReportJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ReportOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ReportJoiSchema,
]);
/**
 ...
 * ```
 */
function validateReport(maybeReport) {
    const { value, error } = exports.ReportJoiSchema.validate(maybeReport);
    if (error) {
        return new oaValidationError_1.OaValidationError('Report', maybeReport, error);
    }
