 ...
 * etc.
 */
export declare type ReportageNewsArticleOrSubClass = ReportageNewsArticle;
/**
 * schema:ReportageNewsArticle - Validation schema (w/ JOI)
 */
export declare const ReportageNewsArticleJoiSchema: Joi.ObjectSchema;
/**
 * schema:ReportageNewsArticle - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ReportageNewsArticleOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateReportageNewsArticle(maybeReportageNewsArticle: unknown): ReportageNewsArticle | OaValidationError;
