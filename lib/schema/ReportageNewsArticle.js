...
exports.validateReportageNewsArticle = exports.ReportageNewsArticleOrSubClassJoiSchema = exports.ReportageNewsArticleJoiSchema = void 0;
 ...
 */
exports.ReportageNewsArticleJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ReportageNewsArticleOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ReportageNewsArticleJoiSchema,
]);
/**
 ...
 * ```
 */
function validateReportageNewsArticle(maybeReportageNewsArticle) {
    const { value, error } = exports.ReportageNewsArticleJoiSchema.validate(maybeReportageNewsArticle);
    if (error) {
        return new oaValidationError_1.OaValidationError('ReportageNewsArticle', maybeReportageNewsArticle, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateReportageNewsArticle = validateReportageNewsArticle;
