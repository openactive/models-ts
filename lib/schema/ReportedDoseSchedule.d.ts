 ...
 * etc.
 */
export declare type ReportedDoseScheduleOrSubClass = ReportedDoseSchedule;
/**
 * schema:ReportedDoseSchedule - Validation schema (w/ JOI)
 */
export declare const ReportedDoseScheduleJoiSchema: Joi.ObjectSchema;
/**
 * schema:ReportedDoseSchedule - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ReportedDoseScheduleOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateReportedDoseSchedule(maybeReportedDoseSchedule: unknown): ReportedDoseSchedule | OaValidationError;
