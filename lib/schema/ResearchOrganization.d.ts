 ...
 */
export declare type ResearchOrganization = {
 ...
 * etc.
 */
export declare type ResearchOrganizationOrSubClass = ResearchOrganization;
/**
 * schema:ResearchOrganization - Validation schema (w/ JOI)
 */
export declare const ResearchOrganizationJoiSchema: Joi.ObjectSchema;
/**
 * schema:ResearchOrganization - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ResearchOrganizationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateResearchOrganization(maybeResearchOrganization: unknown): ResearchOrganization | OaValidationError;
