...
exports.validateResearchOrganization = exports.ResearchOrganizationOrSubClassJoiSchema = exports.ResearchOrganizationJoiSchema = void 0;
 ...
 */
exports.ResearchOrganizationJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ResearchOrganizationOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ResearchOrganizationJoiSchema,
]);
/**
 ...
 * ```
 */
function validateResearchOrganization(maybeResearchOrganization) {
    const { value, error } = exports.ResearchOrganizationJoiSchema.validate(maybeResearchOrganization);
    if (error) {
        return new oaValidationError_1.OaValidationError('ResearchOrganization', maybeResearchOrganization, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateResearchOrganization = validateResearchOrganization;
