...
exports.validateResearchProject = exports.ResearchProjectOrSubClassJoiSchema = exports.ResearchProjectJoiSchema = void 0;
 ...
 */
exports.ResearchProjectJoiSchema = Joi.object({
    '@type': Joi.string().valid('ResearchProject').required(),
 ...
 * `SessionSeries`, etc.
 */
exports.ResearchProjectOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ResearchProjectJoiSchema,
]);
/**
 ...
 *
 * ```ts
 * const maybeResearchProject = ResearchProject.validate(req.body); // `req.body` will have type `any` or `unknown`
 ...
 * ```
 */
function validateResearchProject(maybeResearchProject) {
    const { value, error } = exports.ResearchProjectJoiSchema.validate(maybeResearchProject);
    if (error) {
        return new oaValidationError_1.OaValidationError('ResearchProject', maybeResearchProject, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateResearchProject = validateResearchProject;
