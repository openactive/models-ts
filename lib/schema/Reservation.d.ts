 ...
 * etc.
 */
export declare type ReservationOrSubClass = Reservation | schema.RentalCarReservationOrSubClass | schema.TaxiReservationOrSubClass | schema.ReservationPackageOrSubClass | schema.BoatReservationOrSubClass | schema.FoodEstablishmentReservationOrSubClass | schema.EventReservationOrSubClass | schema.FlightReservationOrSubClass | schema.BusReservationOrSubClass | schema.TrainReservationOrSubClass | schema.LodgingReservationOrSubClass;
/**
 * schema:Reservation - Validation schema (w/ JOI)
 */
export declare const ReservationJoiSchema: Joi.ObjectSchema;
/**
 * schema:Reservation - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ReservationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateReservation(maybeReservation: unknown): Reservation | OaValidationError;
