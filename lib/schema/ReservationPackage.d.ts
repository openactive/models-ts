 ...
 * etc.
 */
export declare type ReservationPackageOrSubClass = ReservationPackage;
/**
 * schema:ReservationPackage - Validation schema (w/ JOI)
 */
export declare const ReservationPackageJoiSchema: Joi.ObjectSchema;
/**
 * schema:ReservationPackage - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ReservationPackageOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 *
 * ```ts
 * const maybeReservationPackage = ReservationPackage.validate(req.body); // `req.body` will have type `any` or `unknown`
 ...
 * ```
 */
export declare function validateReservationPackage(maybeReservationPackage: unknown): ReservationPackage | OaValidationError;
