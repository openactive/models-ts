 ...
 * etc.
 */
export declare type ReserveActionOrSubClass = ReserveAction;
/**
 * schema:ReserveAction - Validation schema (w/ JOI)
 */
export declare const ReserveActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:ReserveAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ReserveActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateReserveAction(maybeReserveAction: unknown): ReserveAction | OaValidationError;
