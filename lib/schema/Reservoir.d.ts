 ...
 * etc.
 */
export declare type ReservoirOrSubClass = Reservoir;
/**
 * schema:Reservoir - Validation schema (w/ JOI)
 */
export declare const ReservoirJoiSchema: Joi.ObjectSchema;
/**
 * schema:Reservoir - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ReservoirOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateReservoir(maybeReservoir: unknown): Reservoir | OaValidationError;
