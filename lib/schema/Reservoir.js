...
exports.validateReservoir = exports.ReservoirOrSubClassJoiSchema = exports.ReservoirJoiSchema = void 0;
 ...
 */
exports.ReservoirJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ReservoirOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ReservoirJoiSchema,
]);
/**
 ...
 * ```
 */
function validateReservoir(maybeReservoir) {
    const { value, error } = exports.ReservoirJoiSchema.validate(maybeReservoir);
    if (error) {
        return new oaValidationError_1.OaValidationError('Reservoir', maybeReservoir, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateReservoir = validateReservoir;
