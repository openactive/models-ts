 ...
 * etc.
 */
export declare type ResidenceOrSubClass = Residence | schema.ApartmentComplexOrSubClass | schema.GatedResidenceCommunityOrSubClass;
/**
 * schema:Residence - Validation schema (w/ JOI)
 */
export declare const ResidenceJoiSchema: Joi.ObjectSchema;
/**
 * schema:Residence - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ResidenceOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateResidence(maybeResidence: unknown): Residence | OaValidationError;
