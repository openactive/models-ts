...
exports.validateResidence = exports.ResidenceOrSubClassJoiSchema = exports.ResidenceJoiSchema = void 0;
 ...
 */
exports.ResidenceJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ResidenceOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ResidenceJoiSchema,
 ...
 * ```
 */
function validateResidence(maybeResidence) {
    const { value, error } = exports.ResidenceJoiSchema.validate(maybeResidence);
    if (error) {
        return new oaValidationError_1.OaValidationError('Residence', maybeResidence, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateResidence = validateResidence;
