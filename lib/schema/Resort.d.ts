 ...
 * etc.
 */
export declare type ResortOrSubClass = Resort | schema.SkiResortOrSubClass;
/**
 * schema:Resort - Validation schema (w/ JOI)
 */
export declare const ResortJoiSchema: Joi.ObjectSchema;
/**
 * schema:Resort - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ResortOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateResort(maybeResort: unknown): Resort | OaValidationError;
