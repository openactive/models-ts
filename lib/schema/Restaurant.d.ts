 ...
 * etc.
 */
export declare type RestaurantOrSubClass = Restaurant;
/**
 * schema:Restaurant - Validation schema (w/ JOI)
 */
export declare const RestaurantJoiSchema: Joi.ObjectSchema;
/**
 * schema:Restaurant - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const RestaurantOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateRestaurant(maybeRestaurant: unknown): Restaurant | OaValidationError;
