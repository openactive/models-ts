...
exports.validateRestaurant = exports.RestaurantOrSubClassJoiSchema = exports.RestaurantJoiSchema = void 0;
 ...
 */
exports.RestaurantJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.RestaurantOrSubClassJoiSchema = Joi.alternatives().try([
    exports.RestaurantJoiSchema,
]);
/**
 ...
 * ```
 */
function validateRestaurant(maybeRestaurant) {
    const { value, error } = exports.RestaurantJoiSchema.validate(maybeRestaurant);
    if (error) {
        return new oaValidationError_1.OaValidationError('Restaurant', maybeRestaurant, error);
    }
