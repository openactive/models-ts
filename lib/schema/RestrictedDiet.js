 ...
 */
exports.RestrictedDietJoiSchema = Joi.string().valid('https://schema.org/VegetarianDiet', 'https://schema.org/LowCalorieDiet', 'https://schema.org/GlutenFreeDiet', 'https://schema.org/KosherDiet', 'https://schema.org/VeganDiet', 'https://schema.org/LowFatDiet', 'https://schema.org/LowLactoseDiet', 'https://schema.org/DiabeticDiet', 'https://schema.org/HinduDiet', 'https://schema.org/LowSaltDiet', 'https://schema.org/HalalDiet');
/**
