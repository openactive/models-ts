...
exports.validateReturnAction = exports.ReturnActionOrSubClassJoiSchema = exports.ReturnActionJoiSchema = void 0;
 ...
 */
exports.ReturnActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ReturnActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ReturnActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateReturnAction(maybeReturnAction) {
    const { value, error } = exports.ReturnActionJoiSchema.validate(maybeReturnAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('ReturnAction', maybeReturnAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateReturnAction = validateReturnAction;
