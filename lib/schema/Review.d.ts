 ...
 * etc.
 */
export declare type ReviewOrSubClass = Review | schema.MediaReviewOrSubClass | schema.UserReviewOrSubClass | schema.RecommendationOrSubClass | schema.EmployerReviewOrSubClass | schema.ClaimReviewOrSubClass | schema.CriticReviewOrSubClass;
/**
 * schema:Review - Validation schema (w/ JOI)
 */
export declare const ReviewJoiSchema: Joi.ObjectSchema;
/**
 * schema:Review - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ReviewOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateReview(maybeReview: unknown): Review | OaValidationError;
