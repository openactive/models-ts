...
exports.validateReview = exports.ReviewOrSubClassJoiSchema = exports.ReviewJoiSchema = void 0;
 ...
 * `SessionSeries`, etc.
 */
exports.ReviewOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ReviewJoiSchema,
 ...
 * ```
 */
function validateReview(maybeReview) {
    const { value, error } = exports.ReviewJoiSchema.validate(maybeReview);
    if (error) {
        return new oaValidationError_1.OaValidationError('Review', maybeReview, error);
    }
