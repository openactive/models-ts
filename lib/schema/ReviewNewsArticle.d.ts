 ...
 * etc.
 */
export declare type ReviewNewsArticleOrSubClass = ReviewNewsArticle;
/**
 * schema:ReviewNewsArticle - Validation schema (w/ JOI)
 */
export declare const ReviewNewsArticleJoiSchema: Joi.ObjectSchema;
/**
 * schema:ReviewNewsArticle - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ReviewNewsArticleOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateReviewNewsArticle(maybeReviewNewsArticle: unknown): ReviewNewsArticle | OaValidationError;
