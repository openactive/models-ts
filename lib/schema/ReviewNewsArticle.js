...
exports.validateReviewNewsArticle = exports.ReviewNewsArticleOrSubClassJoiSchema = exports.ReviewNewsArticleJoiSchema = void 0;
 ...
 */
exports.ReviewNewsArticleJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ReviewNewsArticleOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ReviewNewsArticleJoiSchema,
]);
/**
 ...
 * ```
 */
function validateReviewNewsArticle(maybeReviewNewsArticle) {
    const { value, error } = exports.ReviewNewsArticleJoiSchema.validate(maybeReviewNewsArticle);
    if (error) {
        return new oaValidationError_1.OaValidationError('ReviewNewsArticle', maybeReviewNewsArticle, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateReviewNewsArticle = validateReviewNewsArticle;
