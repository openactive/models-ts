 ...
 * etc.
 */
export declare type RiverBodyOfWaterOrSubClass = RiverBodyOfWater;
/**
 * schema:RiverBodyOfWater - Validation schema (w/ JOI)
 */
export declare const RiverBodyOfWaterJoiSchema: Joi.ObjectSchema;
/**
 * schema:RiverBodyOfWater - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const RiverBodyOfWaterOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateRiverBodyOfWater(maybeRiverBodyOfWater: unknown): RiverBodyOfWater | OaValidationError;
