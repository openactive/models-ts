 ...
 * etc.
 */
export declare type RoofingContractorOrSubClass = RoofingContractor;
/**
 * schema:RoofingContractor - Validation schema (w/ JOI)
 */
export declare const RoofingContractorJoiSchema: Joi.ObjectSchema;
/**
 * schema:RoofingContractor - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const RoofingContractorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateRoofingContractor(maybeRoofingContractor: unknown): RoofingContractor | OaValidationError;
