...
exports.validateRoofingContractor = exports.RoofingContractorOrSubClassJoiSchema = exports.RoofingContractorJoiSchema = void 0;
 ...
 */
exports.RoofingContractorJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.RoofingContractorOrSubClassJoiSchema = Joi.alternatives().try([
    exports.RoofingContractorJoiSchema,
]);
/**
 ...
 * ```
 */
function validateRoofingContractor(maybeRoofingContractor) {
    const { value, error } = exports.RoofingContractorJoiSchema.validate(maybeRoofingContractor);
    if (error) {
        return new oaValidationError_1.OaValidationError('RoofingContractor', maybeRoofingContractor, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateRoofingContractor = validateRoofingContractor;
