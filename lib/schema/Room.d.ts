 ...
 * etc.
 */
export declare type RoomOrSubClass = Room | schema.MeetingRoomOrSubClass | schema.HotelRoomOrSubClass;
/**
 * schema:Room - Validation schema (w/ JOI)
 */
export declare const RoomJoiSchema: Joi.ObjectSchema;
/**
 * schema:Room - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const RoomOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateRoom(maybeRoom: unknown): Room | OaValidationError;
