...
exports.validateRoom = exports.RoomOrSubClassJoiSchema = exports.RoomJoiSchema = void 0;
 ...
 */
exports.RoomJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.RoomOrSubClassJoiSchema = Joi.alternatives().try([
    exports.RoomJoiSchema,
 ...
 * ```
 */
function validateRoom(maybeRoom) {
    const { value, error } = exports.RoomJoiSchema.validate(maybeRoom);
    if (error) {
        return new oaValidationError_1.OaValidationError('Room', maybeRoom, error);
    }
