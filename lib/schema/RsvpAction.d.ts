 ...
 * etc.
 */
export declare type RsvpActionOrSubClass = RsvpAction;
/**
 * schema:RsvpAction - Validation schema (w/ JOI)
 */
export declare const RsvpActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:RsvpAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const RsvpActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateRsvpAction(maybeRsvpAction: unknown): RsvpAction | OaValidationError;
