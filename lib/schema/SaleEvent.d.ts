 ...
 * etc.
 */
export declare type SaleEventOrSubClass = SaleEvent;
/**
 * schema:SaleEvent - Validation schema (w/ JOI)
 */
export declare const SaleEventJoiSchema: Joi.ObjectSchema;
/**
 * schema:SaleEvent - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SaleEventOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSaleEvent(maybeSaleEvent: unknown): SaleEvent | OaValidationError;
