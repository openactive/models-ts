...
exports.validateSaleEvent = exports.SaleEventOrSubClassJoiSchema = exports.SaleEventJoiSchema = void 0;
 ...
 */
exports.SaleEventJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.SaleEventOrSubClassJoiSchema = Joi.alternatives().try([
    exports.SaleEventJoiSchema,
]);
/**
 ...
 * ```
 */
function validateSaleEvent(maybeSaleEvent) {
    const { value, error } = exports.SaleEventJoiSchema.validate(maybeSaleEvent);
    if (error) {
        return new oaValidationError_1.OaValidationError('SaleEvent', maybeSaleEvent, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateSaleEvent = validateSaleEvent;
