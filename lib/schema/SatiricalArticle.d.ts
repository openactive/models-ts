 ...
 * etc.
 */
export declare type SatiricalArticleOrSubClass = SatiricalArticle;
/**
 * schema:SatiricalArticle - Validation schema (w/ JOI)
 */
export declare const SatiricalArticleJoiSchema: Joi.ObjectSchema;
/**
 * schema:SatiricalArticle - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SatiricalArticleOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSatiricalArticle(maybeSatiricalArticle: unknown): SatiricalArticle | OaValidationError;
