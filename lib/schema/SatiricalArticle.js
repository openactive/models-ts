...
exports.validateSatiricalArticle = exports.SatiricalArticleOrSubClassJoiSchema = exports.SatiricalArticleJoiSchema = void 0;
 ...
 */
exports.SatiricalArticleJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.SatiricalArticleOrSubClassJoiSchema = Joi.alternatives().try([
    exports.SatiricalArticleJoiSchema,
]);
/**
 ...
 * ```
 */
function validateSatiricalArticle(maybeSatiricalArticle) {
    const { value, error } = exports.SatiricalArticleJoiSchema.validate(maybeSatiricalArticle);
    if (error) {
        return new oaValidationError_1.OaValidationError('SatiricalArticle', maybeSatiricalArticle, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateSatiricalArticle = validateSatiricalArticle;
