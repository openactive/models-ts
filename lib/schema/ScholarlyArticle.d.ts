 ...
 * etc.
 */
export declare type ScholarlyArticleOrSubClass = ScholarlyArticle | schema.MedicalScholarlyArticleOrSubClass;
/**
 * schema:ScholarlyArticle - Validation schema (w/ JOI)
 */
export declare const ScholarlyArticleJoiSchema: Joi.ObjectSchema;
/**
 * schema:ScholarlyArticle - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ScholarlyArticleOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateScholarlyArticle(maybeScholarlyArticle: unknown): ScholarlyArticle | OaValidationError;
