...
exports.validateScholarlyArticle = exports.ScholarlyArticleOrSubClassJoiSchema = exports.ScholarlyArticleJoiSchema = void 0;
 ...
 */
exports.ScholarlyArticleJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ScholarlyArticleOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ScholarlyArticleJoiSchema,
 ...
 * ```
 */
function validateScholarlyArticle(maybeScholarlyArticle) {
    const { value, error } = exports.ScholarlyArticleJoiSchema.validate(maybeScholarlyArticle);
    if (error) {
        return new oaValidationError_1.OaValidationError('ScholarlyArticle', maybeScholarlyArticle, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateScholarlyArticle = validateScholarlyArticle;
