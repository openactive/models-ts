 ...
 */
export declare type SchoolDistrict = {
    '@type': 'SchoolDistrict';
 ...
 * etc.
 */
export declare type SchoolDistrictOrSubClass = SchoolDistrict;
/**
 * schema:SchoolDistrict - Validation schema (w/ JOI)
 */
export declare const SchoolDistrictJoiSchema: Joi.ObjectSchema;
/**
 * schema:SchoolDistrict - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SchoolDistrictOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSchoolDistrict(maybeSchoolDistrict: unknown): SchoolDistrict | OaValidationError;
