...
exports.validateSchoolDistrict = exports.SchoolDistrictOrSubClassJoiSchema = exports.SchoolDistrictJoiSchema = void 0;
 ...
 */
exports.SchoolDistrictJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.SchoolDistrictOrSubClassJoiSchema = Joi.alternatives().try([
    exports.SchoolDistrictJoiSchema,
]);
/**
 ...
 * ```
 */
function validateSchoolDistrict(maybeSchoolDistrict) {
    const { value, error } = exports.SchoolDistrictJoiSchema.validate(maybeSchoolDistrict);
    if (error) {
        return new oaValidationError_1.OaValidationError('SchoolDistrict', maybeSchoolDistrict, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateSchoolDistrict = validateSchoolDistrict;
