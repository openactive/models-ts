 ...
 * etc.
 */
export declare type ScreeningEventOrSubClass = ScreeningEvent;
/**
 * schema:ScreeningEvent - Validation schema (w/ JOI)
 */
export declare const ScreeningEventJoiSchema: Joi.ObjectSchema;
/**
 * schema:ScreeningEvent - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ScreeningEventOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateScreeningEvent(maybeScreeningEvent: unknown): ScreeningEvent | OaValidationError;
