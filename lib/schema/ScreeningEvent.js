...
exports.validateScreeningEvent = exports.ScreeningEventOrSubClassJoiSchema = exports.ScreeningEventJoiSchema = void 0;
 ...
 */
exports.ScreeningEventJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ScreeningEventOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ScreeningEventJoiSchema,
]);
/**
 ...
 * ```
 */
function validateScreeningEvent(maybeScreeningEvent) {
    const { value, error } = exports.ScreeningEventJoiSchema.validate(maybeScreeningEvent);
    if (error) {
        return new oaValidationError_1.OaValidationError('ScreeningEvent', maybeScreeningEvent, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateScreeningEvent = validateScreeningEvent;
