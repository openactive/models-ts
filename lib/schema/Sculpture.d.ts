 ...
 * etc.
 */
export declare type SculptureOrSubClass = Sculpture;
/**
 * schema:Sculpture - Validation schema (w/ JOI)
 */
export declare const SculptureJoiSchema: Joi.ObjectSchema;
/**
 * schema:Sculpture - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SculptureOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSculpture(maybeSculpture: unknown): Sculpture | OaValidationError;
