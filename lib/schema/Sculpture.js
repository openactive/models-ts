...
exports.validateSculpture = exports.SculptureOrSubClassJoiSchema = exports.SculptureJoiSchema = void 0;
 ...
 */
exports.SculptureJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.SculptureOrSubClassJoiSchema = Joi.alternatives().try([
    exports.SculptureJoiSchema,
]);
/**
 ...
 * ```
 */
function validateSculpture(maybeSculpture) {
    const { value, error } = exports.SculptureJoiSchema.validate(maybeSculpture);
    if (error) {
        return new oaValidationError_1.OaValidationError('Sculpture', maybeSculpture, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateSculpture = validateSculpture;
