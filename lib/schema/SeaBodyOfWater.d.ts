 ...
 * etc.
 */
export declare type SeaBodyOfWaterOrSubClass = SeaBodyOfWater;
/**
 * schema:SeaBodyOfWater - Validation schema (w/ JOI)
 */
export declare const SeaBodyOfWaterJoiSchema: Joi.ObjectSchema;
/**
 * schema:SeaBodyOfWater - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SeaBodyOfWaterOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSeaBodyOfWater(maybeSeaBodyOfWater: unknown): SeaBodyOfWater | OaValidationError;
