...
exports.validateSeaBodyOfWater = exports.SeaBodyOfWaterOrSubClassJoiSchema = exports.SeaBodyOfWaterJoiSchema = void 0;
 ...
 */
exports.SeaBodyOfWaterJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.SeaBodyOfWaterOrSubClassJoiSchema = Joi.alternatives().try([
    exports.SeaBodyOfWaterJoiSchema,
]);
/**
 ...
 * ```
 */
function validateSeaBodyOfWater(maybeSeaBodyOfWater) {
    const { value, error } = exports.SeaBodyOfWaterJoiSchema.validate(maybeSeaBodyOfWater);
    if (error) {
        return new oaValidationError_1.OaValidationError('SeaBodyOfWater', maybeSeaBodyOfWater, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateSeaBodyOfWater = validateSeaBodyOfWater;
