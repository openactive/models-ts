 ...
 * etc.
 */
export declare type SearchResultsPageOrSubClass = SearchResultsPage;
/**
 * schema:SearchResultsPage - Validation schema (w/ JOI)
 */
export declare const SearchResultsPageJoiSchema: Joi.ObjectSchema;
/**
 * schema:SearchResultsPage - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SearchResultsPageOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSearchResultsPage(maybeSearchResultsPage: unknown): SearchResultsPage | OaValidationError;
