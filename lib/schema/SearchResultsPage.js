...
exports.validateSearchResultsPage = exports.SearchResultsPageOrSubClassJoiSchema = exports.SearchResultsPageJoiSchema = void 0;
 ...
 */
exports.SearchResultsPageJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.SearchResultsPageOrSubClassJoiSchema = Joi.alternatives().try([
    exports.SearchResultsPageJoiSchema,
]);
/**
 ...
 * ```
 */
function validateSearchResultsPage(maybeSearchResultsPage) {
    const { value, error } = exports.SearchResultsPageJoiSchema.validate(maybeSearchResultsPage);
    if (error) {
        return new oaValidationError_1.OaValidationError('SearchResultsPage', maybeSearchResultsPage, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateSearchResultsPage = validateSearchResultsPage;
