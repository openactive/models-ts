 ...
 * etc.
 */
export declare type SeasonOrSubClass = Season;
/**
 * schema:Season - Validation schema (w/ JOI)
 */
export declare const SeasonJoiSchema: Joi.ObjectSchema;
/**
 * schema:Season - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SeasonOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSeason(maybeSeason: unknown): Season | OaValidationError;
