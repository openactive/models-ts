...
exports.validateSeason = exports.SeasonOrSubClassJoiSchema = exports.SeasonJoiSchema = void 0;
 ...
 */
exports.SeasonJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.SeasonOrSubClassJoiSchema = Joi.alternatives().try([
    exports.SeasonJoiSchema,
]);
/**
 ...
 * ```
 */
function validateSeason(maybeSeason) {
    const { value, error } = exports.SeasonJoiSchema.validate(maybeSeason);
    if (error) {
        return new oaValidationError_1.OaValidationError('Season', maybeSeason, error);
    }
