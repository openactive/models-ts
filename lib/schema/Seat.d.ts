 ...
 * etc.
 */
export declare type SeatOrSubClass = Seat;
/**
 * schema:Seat - Validation schema (w/ JOI)
 */
export declare const SeatJoiSchema: Joi.ObjectSchema;
/**
 * schema:Seat - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SeatOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSeat(maybeSeat: unknown): Seat | OaValidationError;
