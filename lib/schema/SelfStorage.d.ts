 ...
 * etc.
 */
export declare type SelfStorageOrSubClass = SelfStorage;
/**
 * schema:SelfStorage - Validation schema (w/ JOI)
 */
export declare const SelfStorageJoiSchema: Joi.ObjectSchema;
/**
 * schema:SelfStorage - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SelfStorageOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSelfStorage(maybeSelfStorage: unknown): SelfStorage | OaValidationError;
