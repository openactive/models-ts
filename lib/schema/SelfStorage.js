...
exports.validateSelfStorage = exports.SelfStorageOrSubClassJoiSchema = exports.SelfStorageJoiSchema = void 0;
 ...
 */
exports.SelfStorageJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.SelfStorageOrSubClassJoiSchema = Joi.alternatives().try([
    exports.SelfStorageJoiSchema,
]);
/**
 ...
 * ```
 */
function validateSelfStorage(maybeSelfStorage) {
    const { value, error } = exports.SelfStorageJoiSchema.validate(maybeSelfStorage);
    if (error) {
        return new oaValidationError_1.OaValidationError('SelfStorage', maybeSelfStorage, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateSelfStorage = validateSelfStorage;
