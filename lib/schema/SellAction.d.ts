 ...
 * etc.
 */
export declare type SellActionOrSubClass = SellAction;
/**
 * schema:SellAction - Validation schema (w/ JOI)
 */
export declare const SellActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:SellAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SellActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSellAction(maybeSellAction: unknown): SellAction | OaValidationError;
