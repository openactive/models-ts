 ...
 * etc.
 */
export declare type SendActionOrSubClass = SendAction;
/**
 * schema:SendAction - Validation schema (w/ JOI)
 */
export declare const SendActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:SendAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SendActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSendAction(maybeSendAction: unknown): SendAction | OaValidationError;
