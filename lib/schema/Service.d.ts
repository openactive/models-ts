 ...
 * etc.
 */
export declare type ServiceOrSubClass = Service | oa.BookingServiceOrSubClass | schema.FinancialProductOrSubClass | schema.TaxiServiceOrSubClass | schema.BroadcastServiceOrSubClass | schema.CableOrSatelliteServiceOrSubClass | schema.TaxiOrSubClass | schema.WebAPIOrSubClass | schema.FoodServiceOrSubClass | schema.GovernmentServiceOrSubClass;
/**
 * schema:Service - Validation schema (w/ JOI)
 */
export declare const ServiceJoiSchema: Joi.ObjectSchema;
/**
 * schema:Service - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ServiceOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateService(maybeService: unknown): Service | OaValidationError;
