 ...
 * etc.
 */
export declare type ServiceOrSubClass = Service | oa.BookingServiceOrSubClass | schema.FinancialProductOrSubClass | schema.FoodServiceOrSubClass | schema.CableOrSatelliteServiceOrSubClass | schema.BroadcastServiceOrSubClass | schema.TaxiOrSubClass | schema.GovernmentServiceOrSubClass | schema.WebAPIOrSubClass | schema.TaxiServiceOrSubClass;
/**
