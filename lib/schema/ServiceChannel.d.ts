 ...
 * etc.
 */
export declare type ServiceChannelOrSubClass = ServiceChannel;
/**
 * schema:ServiceChannel - Validation schema (w/ JOI)
 */
export declare const ServiceChannelJoiSchema: Joi.ObjectSchema;
/**
 * schema:ServiceChannel - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ServiceChannelOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateServiceChannel(maybeServiceChannel: unknown): ServiceChannel | OaValidationError;
