...
exports.validateServiceChannel = exports.ServiceChannelOrSubClassJoiSchema = exports.ServiceChannelJoiSchema = void 0;
 ...
 */
exports.ServiceChannelJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ServiceChannelOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ServiceChannelJoiSchema,
]);
/**
 ...
 *
 * ```ts
 * const maybeServiceChannel = validateServiceChannel(req.body); // `req.body` will have type `any` or `unknown`
 ...
 * ```
 */
function validateServiceChannel(maybeServiceChannel) {
    const { value, error } = exports.ServiceChannelJoiSchema.validate(maybeServiceChannel);
    if (error) {
        return new oaValidationError_1.OaValidationError('ServiceChannel', maybeServiceChannel, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateServiceChannel = validateServiceChannel;
