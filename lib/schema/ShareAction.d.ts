 ...
 * etc.
 */
export declare type ShareActionOrSubClass = ShareAction;
/**
 * schema:ShareAction - Validation schema (w/ JOI)
 */
export declare const ShareActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:ShareAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ShareActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateShareAction(maybeShareAction: unknown): ShareAction | OaValidationError;
