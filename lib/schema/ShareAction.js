...
exports.validateShareAction = exports.ShareActionOrSubClassJoiSchema = exports.ShareActionJoiSchema = void 0;
 ...
 */
exports.ShareActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ShareActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ShareActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateShareAction(maybeShareAction) {
    const { value, error } = exports.ShareActionJoiSchema.validate(maybeShareAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('ShareAction', maybeShareAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateShareAction = validateShareAction;
