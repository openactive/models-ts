 ...
 * etc.
 */
export declare type SheetMusicOrSubClass = SheetMusic;
/**
 * schema:SheetMusic - Validation schema (w/ JOI)
 */
export declare const SheetMusicJoiSchema: Joi.ObjectSchema;
/**
 * schema:SheetMusic - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SheetMusicOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSheetMusic(maybeSheetMusic: unknown): SheetMusic | OaValidationError;
