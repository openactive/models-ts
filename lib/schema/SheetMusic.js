...
exports.validateSheetMusic = exports.SheetMusicOrSubClassJoiSchema = exports.SheetMusicJoiSchema = void 0;
 ...
 */
exports.SheetMusicJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.SheetMusicOrSubClassJoiSchema = Joi.alternatives().try([
    exports.SheetMusicJoiSchema,
]);
/**
 ...
 * ```
 */
function validateSheetMusic(maybeSheetMusic) {
    const { value, error } = exports.SheetMusicJoiSchema.validate(maybeSheetMusic);
    if (error) {
        return new oaValidationError_1.OaValidationError('SheetMusic', maybeSheetMusic, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateSheetMusic = validateSheetMusic;
