 ...
 */
export declare type ShippingRateSettings = {
     ...
     */
    freeShippingThreshold?: schema.MonetaryAmountOrSubClass | schema.DeliveryChargeSpecificationOrSubClass | string;
    /**
 ...
 * etc.
 */
export declare type ShippingRateSettingsOrSubClass = ShippingRateSettings;
/**
 * schema:ShippingRateSettings - Validation schema (w/ JOI)
 */
export declare const ShippingRateSettingsJoiSchema: Joi.ObjectSchema;
/**
 * schema:ShippingRateSettings - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ShippingRateSettingsOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateShippingRateSettings(maybeShippingRateSettings: unknown): ShippingRateSettings | OaValidationError;
