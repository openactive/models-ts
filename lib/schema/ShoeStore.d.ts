 ...
 * etc.
 */
export declare type ShoeStoreOrSubClass = ShoeStore;
/**
 * schema:ShoeStore - Validation schema (w/ JOI)
 */
export declare const ShoeStoreJoiSchema: Joi.ObjectSchema;
/**
 * schema:ShoeStore - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ShoeStoreOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateShoeStore(maybeShoeStore: unknown): ShoeStore | OaValidationError;
