...
exports.validateShoeStore = exports.ShoeStoreOrSubClassJoiSchema = exports.ShoeStoreJoiSchema = void 0;
 ...
 */
exports.ShoeStoreJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ShoeStoreOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ShoeStoreJoiSchema,
]);
/**
 ...
 * ```
 */
function validateShoeStore(maybeShoeStore) {
    const { value, error } = exports.ShoeStoreJoiSchema.validate(maybeShoeStore);
    if (error) {
        return new oaValidationError_1.OaValidationError('ShoeStore', maybeShoeStore, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateShoeStore = validateShoeStore;
