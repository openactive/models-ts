 ...
 * etc.
 */
export declare type ShoppingCenterOrSubClass = ShoppingCenter;
/**
 * schema:ShoppingCenter - Validation schema (w/ JOI)
 */
export declare const ShoppingCenterJoiSchema: Joi.ObjectSchema;
/**
 * schema:ShoppingCenter - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ShoppingCenterOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateShoppingCenter(maybeShoppingCenter: unknown): ShoppingCenter | OaValidationError;
