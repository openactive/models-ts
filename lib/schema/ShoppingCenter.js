...
exports.validateShoppingCenter = exports.ShoppingCenterOrSubClassJoiSchema = exports.ShoppingCenterJoiSchema = void 0;
 ...
 */
exports.ShoppingCenterJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ShoppingCenterOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ShoppingCenterJoiSchema,
]);
/**
 ...
 * ```
 */
function validateShoppingCenter(maybeShoppingCenter) {
    const { value, error } = exports.ShoppingCenterJoiSchema.validate(maybeShoppingCenter);
    if (error) {
        return new oaValidationError_1.OaValidationError('ShoppingCenter', maybeShoppingCenter, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateShoppingCenter = validateShoppingCenter;
