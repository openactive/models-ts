 ...
 * etc.
 */
export declare type ShortStoryOrSubClass = ShortStory;
/**
 * schema:ShortStory - Validation schema (w/ JOI)
 */
export declare const ShortStoryJoiSchema: Joi.ObjectSchema;
/**
 * schema:ShortStory - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ShortStoryOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateShortStory(maybeShortStory: unknown): ShortStory | OaValidationError;
