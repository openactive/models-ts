...
exports.validateShortStory = exports.ShortStoryOrSubClassJoiSchema = exports.ShortStoryJoiSchema = void 0;
 ...
 */
exports.ShortStoryJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ShortStoryOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ShortStoryJoiSchema,
]);
/**
 ...
 * ```
 */
function validateShortStory(maybeShortStory) {
    const { value, error } = exports.ShortStoryJoiSchema.validate(maybeShortStory);
    if (error) {
        return new oaValidationError_1.OaValidationError('ShortStory', maybeShortStory, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateShortStory = validateShortStory;
