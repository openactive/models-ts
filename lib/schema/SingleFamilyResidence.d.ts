 ...
 * etc.
 */
export declare type SingleFamilyResidenceOrSubClass = SingleFamilyResidence;
/**
 * schema:SingleFamilyResidence - Validation schema (w/ JOI)
 */
export declare const SingleFamilyResidenceJoiSchema: Joi.ObjectSchema;
/**
 * schema:SingleFamilyResidence - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SingleFamilyResidenceOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSingleFamilyResidence(maybeSingleFamilyResidence: unknown): SingleFamilyResidence | OaValidationError;
