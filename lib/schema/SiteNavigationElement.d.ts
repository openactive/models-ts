 ...
 * etc.
 */
export declare type SiteNavigationElementOrSubClass = SiteNavigationElement;
/**
 * schema:SiteNavigationElement - Validation schema (w/ JOI)
 */
export declare const SiteNavigationElementJoiSchema: Joi.ObjectSchema;
/**
 * schema:SiteNavigationElement - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SiteNavigationElementOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSiteNavigationElement(maybeSiteNavigationElement: unknown): SiteNavigationElement | OaValidationError;
