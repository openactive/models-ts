...
exports.validateSiteNavigationElement = exports.SiteNavigationElementOrSubClassJoiSchema = exports.SiteNavigationElementJoiSchema = void 0;
 ...
 */
exports.SiteNavigationElementJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.SiteNavigationElementOrSubClassJoiSchema = Joi.alternatives().try([
    exports.SiteNavigationElementJoiSchema,
]);
/**
 ...
 * ```
 */
function validateSiteNavigationElement(maybeSiteNavigationElement) {
    const { value, error } = exports.SiteNavigationElementJoiSchema.validate(maybeSiteNavigationElement);
    if (error) {
        return new oaValidationError_1.OaValidationError('SiteNavigationElement', maybeSiteNavigationElement, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateSiteNavigationElement = validateSiteNavigationElement;
