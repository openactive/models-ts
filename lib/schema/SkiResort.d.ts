 ...
 * etc.
 */
export declare type SkiResortOrSubClass = SkiResort;
/**
 * schema:SkiResort - Validation schema (w/ JOI)
 */
export declare const SkiResortJoiSchema: Joi.ObjectSchema;
/**
 * schema:SkiResort - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SkiResortOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSkiResort(maybeSkiResort: unknown): SkiResort | OaValidationError;
