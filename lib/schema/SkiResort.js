...
exports.validateSkiResort = exports.SkiResortOrSubClassJoiSchema = exports.SkiResortJoiSchema = void 0;
 ...
 */
exports.SkiResortJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.SkiResortOrSubClassJoiSchema = Joi.alternatives().try([
    exports.SkiResortJoiSchema,
]);
/**
 ...
 * ```
 */
function validateSkiResort(maybeSkiResort) {
    const { value, error } = exports.SkiResortJoiSchema.validate(maybeSkiResort);
    if (error) {
        return new oaValidationError_1.OaValidationError('SkiResort', maybeSkiResort, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateSkiResort = validateSkiResort;
