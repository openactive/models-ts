 ...
 * etc.
 */
export declare type SocialEventOrSubClass = SocialEvent;
/**
 * schema:SocialEvent - Validation schema (w/ JOI)
 */
export declare const SocialEventJoiSchema: Joi.ObjectSchema;
/**
 * schema:SocialEvent - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SocialEventOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSocialEvent(maybeSocialEvent: unknown): SocialEvent | OaValidationError;
