 ...
 * etc.
 */
export declare type SocialMediaPostingOrSubClass = SocialMediaPosting | schema.BlogPostingOrSubClass | schema.DiscussionForumPostingOrSubClass;
/**
 * schema:SocialMediaPosting - Validation schema (w/ JOI)
 */
export declare const SocialMediaPostingJoiSchema: Joi.ObjectSchema;
/**
 * schema:SocialMediaPosting - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SocialMediaPostingOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSocialMediaPosting(maybeSocialMediaPosting: unknown): SocialMediaPosting | OaValidationError;
