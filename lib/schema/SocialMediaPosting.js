...
exports.validateSocialMediaPosting = exports.SocialMediaPostingOrSubClassJoiSchema = exports.SocialMediaPostingJoiSchema = void 0;
 ...
 */
exports.SocialMediaPostingJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.SocialMediaPostingOrSubClassJoiSchema = Joi.alternatives().try([
    exports.SocialMediaPostingJoiSchema,
 ...
 * ```
 */
function validateSocialMediaPosting(maybeSocialMediaPosting) {
    const { value, error } = exports.SocialMediaPostingJoiSchema.validate(maybeSocialMediaPosting);
    if (error) {
        return new oaValidationError_1.OaValidationError('SocialMediaPosting', maybeSocialMediaPosting, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateSocialMediaPosting = validateSocialMediaPosting;
