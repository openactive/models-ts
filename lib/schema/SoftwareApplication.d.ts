 ...
 * etc.
 */
export declare type SoftwareApplicationOrSubClass = SoftwareApplication | schema.MobileApplicationOrSubClass | schema.WebApplicationOrSubClass | schema.VideoGameOrSubClass;
/**
