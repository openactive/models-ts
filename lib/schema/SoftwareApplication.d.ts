 ...
 * etc.
 */
export declare type SoftwareApplicationOrSubClass = SoftwareApplication | schema.WebApplicationOrSubClass | schema.VideoGameOrSubClass | schema.MobileApplicationOrSubClass;
/**
 * schema:SoftwareApplication - Validation schema (w/ JOI)
 */
export declare const SoftwareApplicationJoiSchema: Joi.ObjectSchema;
/**
 * schema:SoftwareApplication - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SoftwareApplicationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSoftwareApplication(maybeSoftwareApplication: unknown): SoftwareApplication | OaValidationError;
