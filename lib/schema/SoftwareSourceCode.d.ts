 ...
 * etc.
 */
export declare type SoftwareSourceCodeOrSubClass = SoftwareSourceCode;
/**
 * schema:SoftwareSourceCode - Validation schema (w/ JOI)
 */
export declare const SoftwareSourceCodeJoiSchema: Joi.ObjectSchema;
/**
 * schema:SoftwareSourceCode - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SoftwareSourceCodeOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSoftwareSourceCode(maybeSoftwareSourceCode: unknown): SoftwareSourceCode | OaValidationError;
