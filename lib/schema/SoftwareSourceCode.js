...
exports.validateSoftwareSourceCode = exports.SoftwareSourceCodeOrSubClassJoiSchema = exports.SoftwareSourceCodeJoiSchema = void 0;
 ...
 */
exports.SoftwareSourceCodeJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.SoftwareSourceCodeOrSubClassJoiSchema = Joi.alternatives().try([
    exports.SoftwareSourceCodeJoiSchema,
]);
/**
 ...
 * ```
 */
function validateSoftwareSourceCode(maybeSoftwareSourceCode) {
    const { value, error } = exports.SoftwareSourceCodeJoiSchema.validate(maybeSoftwareSourceCode);
    if (error) {
        return new oaValidationError_1.OaValidationError('SoftwareSourceCode', maybeSoftwareSourceCode, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateSoftwareSourceCode = validateSoftwareSourceCode;
