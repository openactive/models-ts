 ...
 */
export declare type SolveMathAction = {
 ...
 * etc.
 */
export declare type SolveMathActionOrSubClass = SolveMathAction;
/**
 * schema:SolveMathAction - Validation schema (w/ JOI)
 */
export declare const SolveMathActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:SolveMathAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SolveMathActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSolveMathAction(maybeSolveMathAction: unknown): SolveMathAction | OaValidationError;
