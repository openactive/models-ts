 ...
 * etc.
 */
export declare type SomeProductsOrSubClass = SomeProducts;
/**
 * schema:SomeProducts - Validation schema (w/ JOI)
 */
export declare const SomeProductsJoiSchema: Joi.ObjectSchema;
/**
 * schema:SomeProducts - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SomeProductsOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSomeProducts(maybeSomeProducts: unknown): SomeProducts | OaValidationError;
