...
exports.validateSomeProducts = exports.SomeProductsOrSubClassJoiSchema = exports.SomeProductsJoiSchema = void 0;
 ...
 */
exports.SomeProductsJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.SomeProductsOrSubClassJoiSchema = Joi.alternatives().try([
    exports.SomeProductsJoiSchema,
]);
/**
 ...
 * ```
 */
function validateSomeProducts(maybeSomeProducts) {
    const { value, error } = exports.SomeProductsJoiSchema.validate(maybeSomeProducts);
    if (error) {
        return new oaValidationError_1.OaValidationError('SomeProducts', maybeSomeProducts, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateSomeProducts = validateSomeProducts;
