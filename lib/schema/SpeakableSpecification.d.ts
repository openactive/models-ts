 ...
 * etc.
 */
export declare type SpeakableSpecificationOrSubClass = SpeakableSpecification;
/**
 * schema:SpeakableSpecification - Validation schema (w/ JOI)
 */
export declare const SpeakableSpecificationJoiSchema: Joi.ObjectSchema;
/**
 * schema:SpeakableSpecification - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SpeakableSpecificationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSpeakableSpecification(maybeSpeakableSpecification: unknown): SpeakableSpecification | OaValidationError;
