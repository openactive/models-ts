 ...
 */
export declare type SpecialAnnouncement = {
 ...
 * etc.
 */
export declare type SpecialAnnouncementOrSubClass = SpecialAnnouncement;
/**
 * schema:SpecialAnnouncement - Validation schema (w/ JOI)
 */
export declare const SpecialAnnouncementJoiSchema: Joi.ObjectSchema;
/**
 * schema:SpecialAnnouncement - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SpecialAnnouncementOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSpecialAnnouncement(maybeSpecialAnnouncement: unknown): SpecialAnnouncement | OaValidationError;
