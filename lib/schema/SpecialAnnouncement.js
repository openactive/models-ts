...
exports.validateSpecialAnnouncement = exports.SpecialAnnouncementOrSubClassJoiSchema = exports.SpecialAnnouncementJoiSchema = void 0;
 ...
 */
exports.SpecialAnnouncementJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.SpecialAnnouncementOrSubClassJoiSchema = Joi.alternatives().try([
    exports.SpecialAnnouncementJoiSchema,
]);
/**
 ...
 * ```
 */
function validateSpecialAnnouncement(maybeSpecialAnnouncement) {
    const { value, error } = exports.SpecialAnnouncementJoiSchema.validate(maybeSpecialAnnouncement);
    if (error) {
        return new oaValidationError_1.OaValidationError('SpecialAnnouncement', maybeSpecialAnnouncement, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateSpecialAnnouncement = validateSpecialAnnouncement;
