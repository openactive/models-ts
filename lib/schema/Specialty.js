...
exports.validateSpecialty = exports.SpecialtyJoiSchema = void 0;
 ...
 */
exports.SpecialtyJoiSchema = Joi.string().valid();
/**
 ...
 * ```
 */
function validateSpecialty(maybeSpecialty) {
    const { value, error } = exports.SpecialtyJoiSchema.validate(maybeSpecialty);
    if (error) {
        return new oaValidationError_1.OaValidationError('Specialty', maybeSpecialty, error);
    }
