 ...
 * etc.
 */
export declare type SportingGoodsStoreOrSubClass = SportingGoodsStore;
/**
 * schema:SportingGoodsStore - Validation schema (w/ JOI)
 */
export declare const SportingGoodsStoreJoiSchema: Joi.ObjectSchema;
/**
 * schema:SportingGoodsStore - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SportingGoodsStoreOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSportingGoodsStore(maybeSportingGoodsStore: unknown): SportingGoodsStore | OaValidationError;
