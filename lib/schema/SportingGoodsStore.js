...
exports.validateSportingGoodsStore = exports.SportingGoodsStoreOrSubClassJoiSchema = exports.SportingGoodsStoreJoiSchema = void 0;
 ...
 */
exports.SportingGoodsStoreJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.SportingGoodsStoreOrSubClassJoiSchema = Joi.alternatives().try([
    exports.SportingGoodsStoreJoiSchema,
]);
/**
 ...
 * ```
 */
function validateSportingGoodsStore(maybeSportingGoodsStore) {
    const { value, error } = exports.SportingGoodsStoreJoiSchema.validate(maybeSportingGoodsStore);
    if (error) {
        return new oaValidationError_1.OaValidationError('SportingGoodsStore', maybeSportingGoodsStore, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateSportingGoodsStore = validateSportingGoodsStore;
