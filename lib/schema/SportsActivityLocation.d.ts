 ...
 * etc.
 */
export declare type SportsActivityLocationOrSubClass = SportsActivityLocation | schema.TennisComplexOrSubClass | schema.BowlingAlleyOrSubClass | schema.GolfCourseOrSubClass | schema.SportsClubOrSubClass | schema.ExerciseGymOrSubClass | schema.HealthClubOrSubClass | schema.StadiumOrArenaOrSubClass | schema.SkiResortOrSubClass | schema.PublicSwimmingPoolOrSubClass;
/**
 * schema:SportsActivityLocation - Validation schema (w/ JOI)
 */
export declare const SportsActivityLocationJoiSchema: Joi.ObjectSchema;
/**
 * schema:SportsActivityLocation - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SportsActivityLocationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSportsActivityLocation(maybeSportsActivityLocation: unknown): SportsActivityLocation | OaValidationError;
