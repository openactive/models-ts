 ...
 * etc.
 */
export declare type SportsActivityLocationOrSubClass = SportsActivityLocation | schema.TennisComplexOrSubClass | schema.BowlingAlleyOrSubClass | schema.HealthClubOrSubClass | schema.SkiResortOrSubClass | schema.ExerciseGymOrSubClass | schema.StadiumOrArenaOrSubClass | schema.PublicSwimmingPoolOrSubClass | schema.SportsClubOrSubClass | schema.GolfCourseOrSubClass;
/**
