 ...
 * etc.
 */
export declare type SportsClubOrSubClass = SportsClub;
/**
 * schema:SportsClub - Validation schema (w/ JOI)
 */
export declare const SportsClubJoiSchema: Joi.ObjectSchema;
/**
 * schema:SportsClub - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SportsClubOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSportsClub(maybeSportsClub: unknown): SportsClub | OaValidationError;
