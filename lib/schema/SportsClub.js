...
exports.validateSportsClub = exports.SportsClubOrSubClassJoiSchema = exports.SportsClubJoiSchema = void 0;
 ...
 */
exports.SportsClubJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.SportsClubOrSubClassJoiSchema = Joi.alternatives().try([
    exports.SportsClubJoiSchema,
]);
/**
 ...
 * ```
 */
function validateSportsClub(maybeSportsClub) {
    const { value, error } = exports.SportsClubJoiSchema.validate(maybeSportsClub);
    if (error) {
        return new oaValidationError_1.OaValidationError('SportsClub', maybeSportsClub, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateSportsClub = validateSportsClub;
