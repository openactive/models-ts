 ...
 * etc.
 */
export declare type SportsEventOrSubClass = SportsEvent;
/**
 * schema:SportsEvent - Validation schema (w/ JOI)
 */
export declare const SportsEventJoiSchema: Joi.ObjectSchema;
/**
 * schema:SportsEvent - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SportsEventOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSportsEvent(maybeSportsEvent: unknown): SportsEvent | OaValidationError;
