...
exports.validateSportsEvent = exports.SportsEventOrSubClassJoiSchema = exports.SportsEventJoiSchema = void 0;
 ...
 */
exports.SportsEventJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.SportsEventOrSubClassJoiSchema = Joi.alternatives().try([
    exports.SportsEventJoiSchema,
]);
/**
 ...
 * ```
 */
function validateSportsEvent(maybeSportsEvent) {
    const { value, error } = exports.SportsEventJoiSchema.validate(maybeSportsEvent);
    if (error) {
        return new oaValidationError_1.OaValidationError('SportsEvent', maybeSportsEvent, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateSportsEvent = validateSportsEvent;
