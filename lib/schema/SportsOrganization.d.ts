 ...
 * etc.
 */
export declare type SportsOrganizationOrSubClass = SportsOrganization | schema.SportsTeamOrSubClass;
/**
 * schema:SportsOrganization - Validation schema (w/ JOI)
 */
export declare const SportsOrganizationJoiSchema: Joi.ObjectSchema;
/**
 * schema:SportsOrganization - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SportsOrganizationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSportsOrganization(maybeSportsOrganization: unknown): SportsOrganization | OaValidationError;
