 ...
 * etc.
 */
export declare type SportsTeamOrSubClass = SportsTeam;
/**
 * schema:SportsTeam - Validation schema (w/ JOI)
 */
export declare const SportsTeamJoiSchema: Joi.ObjectSchema;
/**
 * schema:SportsTeam - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SportsTeamOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSportsTeam(maybeSportsTeam: unknown): SportsTeam | OaValidationError;
