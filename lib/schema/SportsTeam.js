...
exports.validateSportsTeam = exports.SportsTeamOrSubClassJoiSchema = exports.SportsTeamJoiSchema = void 0;
 ...
 */
exports.SportsTeamJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.SportsTeamOrSubClassJoiSchema = Joi.alternatives().try([
    exports.SportsTeamJoiSchema,
]);
/**
 ...
 * ```
 */
function validateSportsTeam(maybeSportsTeam) {
    const { value, error } = exports.SportsTeamJoiSchema.validate(maybeSportsTeam);
    if (error) {
        return new oaValidationError_1.OaValidationError('SportsTeam', maybeSportsTeam, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateSportsTeam = validateSportsTeam;
