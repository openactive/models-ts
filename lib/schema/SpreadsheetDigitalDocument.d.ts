 ...
 * etc.
 */
export declare type SpreadsheetDigitalDocumentOrSubClass = SpreadsheetDigitalDocument;
/**
 * schema:SpreadsheetDigitalDocument - Validation schema (w/ JOI)
 */
export declare const SpreadsheetDigitalDocumentJoiSchema: Joi.ObjectSchema;
/**
 * schema:SpreadsheetDigitalDocument - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SpreadsheetDigitalDocumentOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSpreadsheetDigitalDocument(maybeSpreadsheetDigitalDocument: unknown): SpreadsheetDigitalDocument | OaValidationError;
