...
exports.validateSpreadsheetDigitalDocument = exports.SpreadsheetDigitalDocumentOrSubClassJoiSchema = exports.SpreadsheetDigitalDocumentJoiSchema = void 0;
 ...
 */
exports.SpreadsheetDigitalDocumentJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.SpreadsheetDigitalDocumentOrSubClassJoiSchema = Joi.alternatives().try([
    exports.SpreadsheetDigitalDocumentJoiSchema,
]);
/**
 ...
 * ```
 */
function validateSpreadsheetDigitalDocument(maybeSpreadsheetDigitalDocument) {
    const { value, error } = exports.SpreadsheetDigitalDocumentJoiSchema.validate(maybeSpreadsheetDigitalDocument);
    if (error) {
        return new oaValidationError_1.OaValidationError('SpreadsheetDigitalDocument', maybeSpreadsheetDigitalDocument, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateSpreadsheetDigitalDocument = validateSpreadsheetDigitalDocument;
