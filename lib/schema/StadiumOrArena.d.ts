 ...
 * etc.
 */
export declare type StadiumOrArenaOrSubClass = StadiumOrArena;
/**
 * schema:StadiumOrArena - Validation schema (w/ JOI)
 */
export declare const StadiumOrArenaJoiSchema: Joi.ObjectSchema;
/**
 * schema:StadiumOrArena - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const StadiumOrArenaOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateStadiumOrArena(maybeStadiumOrArena: unknown): StadiumOrArena | OaValidationError;
