...
exports.validateStadiumOrArena = exports.StadiumOrArenaOrSubClassJoiSchema = exports.StadiumOrArenaJoiSchema = void 0;
 ...
 */
exports.StadiumOrArenaJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.StadiumOrArenaOrSubClassJoiSchema = Joi.alternatives().try([
    exports.StadiumOrArenaJoiSchema,
]);
/**
 ...
 * ```
 */
function validateStadiumOrArena(maybeStadiumOrArena) {
    const { value, error } = exports.StadiumOrArenaJoiSchema.validate(maybeStadiumOrArena);
    if (error) {
        return new oaValidationError_1.OaValidationError('StadiumOrArena', maybeStadiumOrArena, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateStadiumOrArena = validateStadiumOrArena;
