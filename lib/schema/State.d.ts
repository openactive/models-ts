 ...
 * etc.
 */
export declare type StateOrSubClass = State;
/**
 * schema:State - Validation schema (w/ JOI)
 */
export declare const StateJoiSchema: Joi.ObjectSchema;
/**
 * schema:State - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const StateOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateState(maybeState: unknown): State | OaValidationError;
