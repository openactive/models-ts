 ...
 * etc.
 */
export declare type StatementOrSubClass = Statement;
/**
 * schema:Statement - Validation schema (w/ JOI)
 */
export declare const StatementJoiSchema: Joi.ObjectSchema;
/**
 * schema:Statement - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const StatementOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateStatement(maybeStatement: unknown): Statement | OaValidationError;
