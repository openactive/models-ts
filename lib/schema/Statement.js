...
exports.validateStatement = exports.StatementOrSubClassJoiSchema = exports.StatementJoiSchema = void 0;
 ...
 */
exports.StatementJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.StatementOrSubClassJoiSchema = Joi.alternatives().try([
    exports.StatementJoiSchema,
]);
/**
 ...
 * ```
 */
function validateStatement(maybeStatement) {
    const { value, error } = exports.StatementJoiSchema.validate(maybeStatement);
    if (error) {
        return new oaValidationError_1.OaValidationError('Statement', maybeStatement, error);
    }
