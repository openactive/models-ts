 ...
 * etc.
 */
export declare type StoreOrSubClass = Store | schema.BikeStoreOrSubClass | schema.BookStoreOrSubClass | schema.AutoPartsStoreOrSubClass | schema.WholesaleStoreOrSubClass | schema.LiquorStoreOrSubClass | schema.TireShopOrSubClass | schema.ComputerStoreOrSubClass | schema.DepartmentStoreOrSubClass | schema.ClothingStoreOrSubClass | schema.MusicStoreOrSubClass | schema.ShoeStoreOrSubClass | schema.MovieRentalStoreOrSubClass | schema.GardenStoreOrSubClass | schema.PetStoreOrSubClass | schema.GroceryStoreOrSubClass | schema.MobilePhoneStoreOrSubClass | schema.JewelryStoreOrSubClass | schema.PawnShopOrSubClass | schema.ConvenienceStoreOrSubClass | schema.OutletStoreOrSubClass | schema.HardwareStoreOrSubClass | schema.FurnitureStoreOrSubClass | schema.HobbyShopOrSubClass | schema.ElectronicsStoreOrSubClass | schema.MensClothingStoreOrSubClass | schema.SportingGoodsStoreOrSubClass | schema.ToyStoreOrSubClass | schema.HomeGoodsStoreOrSubClass | schema.FloristOrSubClass | schema.OfficeEquipmentStoreOrSubClass;
/**
