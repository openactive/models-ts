 ...
 * etc.
 */
export declare type StoreOrSubClass = Store | schema.WholesaleStoreOrSubClass | schema.OfficeEquipmentStoreOrSubClass | schema.LiquorStoreOrSubClass | schema.PetStoreOrSubClass | schema.ToyStoreOrSubClass | schema.ConvenienceStoreOrSubClass | schema.OutletStoreOrSubClass | schema.MusicStoreOrSubClass | schema.HobbyShopOrSubClass | schema.MovieRentalStoreOrSubClass | schema.FloristOrSubClass | schema.ComputerStoreOrSubClass | schema.AutoPartsStoreOrSubClass | schema.PawnShopOrSubClass | schema.BookStoreOrSubClass | schema.JewelryStoreOrSubClass | schema.MobilePhoneStoreOrSubClass | schema.ClothingStoreOrSubClass | schema.DepartmentStoreOrSubClass | schema.ShoeStoreOrSubClass | schema.HomeGoodsStoreOrSubClass | schema.ElectronicsStoreOrSubClass | schema.TireShopOrSubClass | schema.SportingGoodsStoreOrSubClass | schema.BikeStoreOrSubClass | schema.GardenStoreOrSubClass | schema.MensClothingStoreOrSubClass | schema.HardwareStoreOrSubClass | schema.GroceryStoreOrSubClass | schema.FurnitureStoreOrSubClass;
/**
 * schema:Store - Validation schema (w/ JOI)
 */
export declare const StoreJoiSchema: Joi.ObjectSchema;
/**
 * schema:Store - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const StoreOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateStore(maybeStore: unknown): Store | OaValidationError;
