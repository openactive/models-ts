...
exports.validateStore = exports.StoreOrSubClassJoiSchema = exports.StoreJoiSchema = void 0;
 ...
 */
exports.StoreJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.StoreOrSubClassJoiSchema = Joi.alternatives().try([
    exports.StoreJoiSchema,
 ...
 * ```
 */
function validateStore(maybeStore) {
    const { value, error } = exports.StoreJoiSchema.validate(maybeStore);
    if (error) {
        return new oaValidationError_1.OaValidationError('Store', maybeStore, error);
    }
