 ...
 * etc.
 */
export declare type SubscribeActionOrSubClass = SubscribeAction;
/**
 * schema:SubscribeAction - Validation schema (w/ JOI)
 */
export declare const SubscribeActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:SubscribeAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SubscribeActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSubscribeAction(maybeSubscribeAction: unknown): SubscribeAction | OaValidationError;
