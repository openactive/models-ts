 ...
 * etc.
 */
export declare type SubwayStationOrSubClass = SubwayStation;
/**
 * schema:SubwayStation - Validation schema (w/ JOI)
 */
export declare const SubwayStationJoiSchema: Joi.ObjectSchema;
/**
 * schema:SubwayStation - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SubwayStationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSubwayStation(maybeSubwayStation: unknown): SubwayStation | OaValidationError;
