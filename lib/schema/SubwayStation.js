...
exports.validateSubwayStation = exports.SubwayStationOrSubClassJoiSchema = exports.SubwayStationJoiSchema = void 0;
 ...
 */
exports.SubwayStationJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.SubwayStationOrSubClassJoiSchema = Joi.alternatives().try([
    exports.SubwayStationJoiSchema,
]);
/**
 ...
 * ```
 */
function validateSubwayStation(maybeSubwayStation) {
    const { value, error } = exports.SubwayStationJoiSchema.validate(maybeSubwayStation);
    if (error) {
        return new oaValidationError_1.OaValidationError('SubwayStation', maybeSubwayStation, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateSubwayStation = validateSubwayStation;
