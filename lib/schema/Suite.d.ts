 ...
 * etc.
 */
export declare type SuiteOrSubClass = Suite;
/**
 * schema:Suite - Validation schema (w/ JOI)
 */
export declare const SuiteJoiSchema: Joi.ObjectSchema;
/**
 * schema:Suite - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SuiteOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSuite(maybeSuite: unknown): Suite | OaValidationError;
