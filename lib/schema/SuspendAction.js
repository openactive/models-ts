...
exports.validateSuspendAction = exports.SuspendActionOrSubClassJoiSchema = exports.SuspendActionJoiSchema = void 0;
 ...
 */
exports.SuspendActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.SuspendActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.SuspendActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateSuspendAction(maybeSuspendAction) {
    const { value, error } = exports.SuspendActionJoiSchema.validate(maybeSuspendAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('SuspendAction', maybeSuspendAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateSuspendAction = validateSuspendAction;
