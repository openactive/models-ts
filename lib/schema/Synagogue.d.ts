 ...
 * etc.
 */
export declare type SynagogueOrSubClass = Synagogue;
/**
 * schema:Synagogue - Validation schema (w/ JOI)
 */
export declare const SynagogueJoiSchema: Joi.ObjectSchema;
/**
 * schema:Synagogue - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const SynagogueOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateSynagogue(maybeSynagogue: unknown): Synagogue | OaValidationError;
