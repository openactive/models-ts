...
exports.validateSynagogue = exports.SynagogueOrSubClassJoiSchema = exports.SynagogueJoiSchema = void 0;
 ...
 */
exports.SynagogueJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.SynagogueOrSubClassJoiSchema = Joi.alternatives().try([
    exports.SynagogueJoiSchema,
]);
/**
 ...
 * ```
 */
function validateSynagogue(maybeSynagogue) {
    const { value, error } = exports.SynagogueJoiSchema.validate(maybeSynagogue);
    if (error) {
        return new oaValidationError_1.OaValidationError('Synagogue', maybeSynagogue, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateSynagogue = validateSynagogue;
