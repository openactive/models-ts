 ...
 * etc.
 */
export declare type TVClipOrSubClass = TVClip;
/**
 * schema:TVClip - Validation schema (w/ JOI)
 */
export declare const TVClipJoiSchema: Joi.ObjectSchema;
/**
 * schema:TVClip - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TVClipOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTVClip(maybeTVClip: unknown): TVClip | OaValidationError;
