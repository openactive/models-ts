...
exports.validateTVClip = exports.TVClipOrSubClassJoiSchema = exports.TVClipJoiSchema = void 0;
 ...
 */
exports.TVClipJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.TVClipOrSubClassJoiSchema = Joi.alternatives().try([
    exports.TVClipJoiSchema,
]);
/**
 ...
 * ```
 */
function validateTVClip(maybeTVClip) {
    const { value, error } = exports.TVClipJoiSchema.validate(maybeTVClip);
    if (error) {
        return new oaValidationError_1.OaValidationError('TVClip', maybeTVClip, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateTVClip = validateTVClip;
