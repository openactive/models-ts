 ...
 * etc.
 */
export declare type TVEpisodeOrSubClass = TVEpisode;
/**
 * schema:TVEpisode - Validation schema (w/ JOI)
 */
export declare const TVEpisodeJoiSchema: Joi.ObjectSchema;
/**
 * schema:TVEpisode - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TVEpisodeOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTVEpisode(maybeTVEpisode: unknown): TVEpisode | OaValidationError;
