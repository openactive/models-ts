...
exports.validateTVEpisode = exports.TVEpisodeOrSubClassJoiSchema = exports.TVEpisodeJoiSchema = void 0;
 ...
 */
exports.TVEpisodeJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.TVEpisodeOrSubClassJoiSchema = Joi.alternatives().try([
    exports.TVEpisodeJoiSchema,
]);
/**
 ...
 * ```
 */
function validateTVEpisode(maybeTVEpisode) {
    const { value, error } = exports.TVEpisodeJoiSchema.validate(maybeTVEpisode);
    if (error) {
        return new oaValidationError_1.OaValidationError('TVEpisode', maybeTVEpisode, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateTVEpisode = validateTVEpisode;
