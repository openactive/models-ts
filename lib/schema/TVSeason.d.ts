 ...
 * etc.
 */
export declare type TVSeasonOrSubClass = TVSeason;
/**
 * schema:TVSeason - Validation schema (w/ JOI)
 */
export declare const TVSeasonJoiSchema: Joi.ObjectSchema;
/**
 * schema:TVSeason - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TVSeasonOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTVSeason(maybeTVSeason: unknown): TVSeason | OaValidationError;
