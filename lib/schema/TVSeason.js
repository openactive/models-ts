...
exports.validateTVSeason = exports.TVSeasonOrSubClassJoiSchema = exports.TVSeasonJoiSchema = void 0;
 ...
 */
exports.TVSeasonJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.TVSeasonOrSubClassJoiSchema = Joi.alternatives().try([
    exports.TVSeasonJoiSchema,
]);
/**
 ...
 * ```
 */
function validateTVSeason(maybeTVSeason) {
    const { value, error } = exports.TVSeasonJoiSchema.validate(maybeTVSeason);
    if (error) {
        return new oaValidationError_1.OaValidationError('TVSeason', maybeTVSeason, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateTVSeason = validateTVSeason;
