 ...
 * etc.
 */
export declare type TVSeriesOrSubClass = TVSeries;
/**
 * schema:TVSeries - Validation schema (w/ JOI)
 */
export declare const TVSeriesJoiSchema: Joi.ObjectSchema;
/**
 * schema:TVSeries - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TVSeriesOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTVSeries(maybeTVSeries: unknown): TVSeries | OaValidationError;
