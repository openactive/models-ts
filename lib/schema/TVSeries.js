...
exports.validateTVSeries = exports.TVSeriesOrSubClassJoiSchema = exports.TVSeriesJoiSchema = void 0;
 ...
 */
exports.TVSeriesJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.TVSeriesOrSubClassJoiSchema = Joi.alternatives().try([
    exports.TVSeriesJoiSchema,
]);
/**
 ...
 * ```
 */
function validateTVSeries(maybeTVSeries) {
    const { value, error } = exports.TVSeriesJoiSchema.validate(maybeTVSeries);
    if (error) {
        return new oaValidationError_1.OaValidationError('TVSeries', maybeTVSeries, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateTVSeries = validateTVSeries;
