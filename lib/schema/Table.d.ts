 ...
 * etc.
 */
export declare type TableOrSubClass = Table;
/**
 * schema:Table - Validation schema (w/ JOI)
 */
export declare const TableJoiSchema: Joi.ObjectSchema;
/**
 * schema:Table - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TableOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTable(maybeTable: unknown): Table | OaValidationError;
