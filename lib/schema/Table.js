...
exports.validateTable = exports.TableOrSubClassJoiSchema = exports.TableJoiSchema = void 0;
 ...
 */
exports.TableJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.TableOrSubClassJoiSchema = Joi.alternatives().try([
    exports.TableJoiSchema,
]);
/**
 ...
 * ```
 */
function validateTable(maybeTable) {
    const { value, error } = exports.TableJoiSchema.validate(maybeTable);
    if (error) {
        return new oaValidationError_1.OaValidationError('Table', maybeTable, error);
    }
