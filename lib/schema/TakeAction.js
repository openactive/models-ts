...
exports.validateTakeAction = exports.TakeActionOrSubClassJoiSchema = exports.TakeActionJoiSchema = void 0;
 ...
 */
exports.TakeActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.TakeActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.TakeActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateTakeAction(maybeTakeAction) {
    const { value, error } = exports.TakeActionJoiSchema.validate(maybeTakeAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('TakeAction', maybeTakeAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateTakeAction = validateTakeAction;
