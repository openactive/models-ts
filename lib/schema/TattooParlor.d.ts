 ...
 * etc.
 */
export declare type TattooParlorOrSubClass = TattooParlor;
/**
 * schema:TattooParlor - Validation schema (w/ JOI)
 */
export declare const TattooParlorJoiSchema: Joi.ObjectSchema;
/**
 * schema:TattooParlor - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TattooParlorOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTattooParlor(maybeTattooParlor: unknown): TattooParlor | OaValidationError;
