...
exports.validateTattooParlor = exports.TattooParlorOrSubClassJoiSchema = exports.TattooParlorJoiSchema = void 0;
 ...
 */
exports.TattooParlorJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.TattooParlorOrSubClassJoiSchema = Joi.alternatives().try([
    exports.TattooParlorJoiSchema,
]);
/**
 ...
 * ```
 */
function validateTattooParlor(maybeTattooParlor) {
    const { value, error } = exports.TattooParlorJoiSchema.validate(maybeTattooParlor);
    if (error) {
        return new oaValidationError_1.OaValidationError('TattooParlor', maybeTattooParlor, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateTattooParlor = validateTattooParlor;
