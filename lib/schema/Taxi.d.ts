 ...
 * etc.
 */
export declare type TaxiOrSubClass = Taxi;
/**
 * schema:Taxi - Validation schema (w/ JOI)
 */
export declare const TaxiJoiSchema: Joi.ObjectSchema;
/**
 * schema:Taxi - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TaxiOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTaxi(maybeTaxi: unknown): Taxi | OaValidationError;
