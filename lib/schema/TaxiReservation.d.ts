 ...
 * etc.
 */
export declare type TaxiReservationOrSubClass = TaxiReservation;
/**
 * schema:TaxiReservation - Validation schema (w/ JOI)
 */
export declare const TaxiReservationJoiSchema: Joi.ObjectSchema;
/**
 * schema:TaxiReservation - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TaxiReservationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTaxiReservation(maybeTaxiReservation: unknown): TaxiReservation | OaValidationError;
