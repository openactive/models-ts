 ...
 * etc.
 */
export declare type TaxiServiceOrSubClass = TaxiService;
/**
 * schema:TaxiService - Validation schema (w/ JOI)
 */
export declare const TaxiServiceJoiSchema: Joi.ObjectSchema;
/**
 * schema:TaxiService - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TaxiServiceOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTaxiService(maybeTaxiService: unknown): TaxiService | OaValidationError;
