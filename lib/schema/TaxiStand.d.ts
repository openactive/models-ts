 ...
 * etc.
 */
export declare type TaxiStandOrSubClass = TaxiStand;
/**
 * schema:TaxiStand - Validation schema (w/ JOI)
 */
export declare const TaxiStandJoiSchema: Joi.ObjectSchema;
/**
 * schema:TaxiStand - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TaxiStandOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTaxiStand(maybeTaxiStand: unknown): TaxiStand | OaValidationError;
