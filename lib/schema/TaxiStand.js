...
exports.validateTaxiStand = exports.TaxiStandOrSubClassJoiSchema = exports.TaxiStandJoiSchema = void 0;
 ...
 */
exports.TaxiStandJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.TaxiStandOrSubClassJoiSchema = Joi.alternatives().try([
    exports.TaxiStandJoiSchema,
]);
/**
 ...
 * ```
 */
function validateTaxiStand(maybeTaxiStand) {
    const { value, error } = exports.TaxiStandJoiSchema.validate(maybeTaxiStand);
    if (error) {
        return new oaValidationError_1.OaValidationError('TaxiStand', maybeTaxiStand, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateTaxiStand = validateTaxiStand;
