 ...
 * etc.
 */
export declare type TaxonOrSubClass = Taxon;
/**
 * schema:Taxon - Validation schema (w/ JOI)
 */
export declare const TaxonJoiSchema: Joi.ObjectSchema;
/**
 * schema:Taxon - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TaxonOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTaxon(maybeTaxon: unknown): Taxon | OaValidationError;
