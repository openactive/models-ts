 ...
 * etc.
 */
export declare type TechArticleOrSubClass = TechArticle | schema.APIReferenceOrSubClass;
/**
 * schema:TechArticle - Validation schema (w/ JOI)
 */
export declare const TechArticleJoiSchema: Joi.ObjectSchema;
/**
 * schema:TechArticle - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TechArticleOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTechArticle(maybeTechArticle: unknown): TechArticle | OaValidationError;
