...
exports.validateTechArticle = exports.TechArticleOrSubClassJoiSchema = exports.TechArticleJoiSchema = void 0;
 ...
 */
exports.TechArticleJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.TechArticleOrSubClassJoiSchema = Joi.alternatives().try([
    exports.TechArticleJoiSchema,
 ...
 * ```
 */
function validateTechArticle(maybeTechArticle) {
    const { value, error } = exports.TechArticleJoiSchema.validate(maybeTechArticle);
    if (error) {
        return new oaValidationError_1.OaValidationError('TechArticle', maybeTechArticle, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateTechArticle = validateTechArticle;
