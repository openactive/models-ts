 ...
 * etc.
 */
export declare type TelevisionStationOrSubClass = TelevisionStation;
/**
 * schema:TelevisionStation - Validation schema (w/ JOI)
 */
export declare const TelevisionStationJoiSchema: Joi.ObjectSchema;
/**
 * schema:TelevisionStation - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TelevisionStationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTelevisionStation(maybeTelevisionStation: unknown): TelevisionStation | OaValidationError;
