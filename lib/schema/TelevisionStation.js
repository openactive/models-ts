...
exports.validateTelevisionStation = exports.TelevisionStationOrSubClassJoiSchema = exports.TelevisionStationJoiSchema = void 0;
 ...
 */
exports.TelevisionStationJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.TelevisionStationOrSubClassJoiSchema = Joi.alternatives().try([
    exports.TelevisionStationJoiSchema,
]);
/**
 ...
 * ```
 */
function validateTelevisionStation(maybeTelevisionStation) {
    const { value, error } = exports.TelevisionStationJoiSchema.validate(maybeTelevisionStation);
    if (error) {
        return new oaValidationError_1.OaValidationError('TelevisionStation', maybeTelevisionStation, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateTelevisionStation = validateTelevisionStation;
