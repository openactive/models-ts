 ...
 * etc.
 */
export declare type TennisComplexOrSubClass = TennisComplex;
/**
 * schema:TennisComplex - Validation schema (w/ JOI)
 */
export declare const TennisComplexJoiSchema: Joi.ObjectSchema;
/**
 * schema:TennisComplex - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TennisComplexOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTennisComplex(maybeTennisComplex: unknown): TennisComplex | OaValidationError;
