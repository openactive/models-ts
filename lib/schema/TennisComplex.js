...
exports.validateTennisComplex = exports.TennisComplexOrSubClassJoiSchema = exports.TennisComplexJoiSchema = void 0;
 ...
 */
exports.TennisComplexJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.TennisComplexOrSubClassJoiSchema = Joi.alternatives().try([
    exports.TennisComplexJoiSchema,
]);
/**
 ...
 * ```
 */
function validateTennisComplex(maybeTennisComplex) {
    const { value, error } = exports.TennisComplexJoiSchema.validate(maybeTennisComplex);
    if (error) {
        return new oaValidationError_1.OaValidationError('TennisComplex', maybeTennisComplex, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateTennisComplex = validateTennisComplex;
