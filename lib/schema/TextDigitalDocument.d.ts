 ...
 * etc.
 */
export declare type TextDigitalDocumentOrSubClass = TextDigitalDocument;
/**
 * schema:TextDigitalDocument - Validation schema (w/ JOI)
 */
export declare const TextDigitalDocumentJoiSchema: Joi.ObjectSchema;
/**
 * schema:TextDigitalDocument - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TextDigitalDocumentOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTextDigitalDocument(maybeTextDigitalDocument: unknown): TextDigitalDocument | OaValidationError;
