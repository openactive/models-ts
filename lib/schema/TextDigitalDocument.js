...
exports.validateTextDigitalDocument = exports.TextDigitalDocumentOrSubClassJoiSchema = exports.TextDigitalDocumentJoiSchema = void 0;
 ...
 */
exports.TextDigitalDocumentJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.TextDigitalDocumentOrSubClassJoiSchema = Joi.alternatives().try([
    exports.TextDigitalDocumentJoiSchema,
]);
/**
 ...
 * ```
 */
function validateTextDigitalDocument(maybeTextDigitalDocument) {
    const { value, error } = exports.TextDigitalDocumentJoiSchema.validate(maybeTextDigitalDocument);
    if (error) {
        return new oaValidationError_1.OaValidationError('TextDigitalDocument', maybeTextDigitalDocument, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateTextDigitalDocument = validateTextDigitalDocument;
