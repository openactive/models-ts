 ...
 * etc.
 */
export declare type TheaterEventOrSubClass = TheaterEvent;
/**
 * schema:TheaterEvent - Validation schema (w/ JOI)
 */
export declare const TheaterEventJoiSchema: Joi.ObjectSchema;
/**
 * schema:TheaterEvent - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TheaterEventOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTheaterEvent(maybeTheaterEvent: unknown): TheaterEvent | OaValidationError;
