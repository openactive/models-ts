...
exports.validateTheaterEvent = exports.TheaterEventOrSubClassJoiSchema = exports.TheaterEventJoiSchema = void 0;
 ...
 */
exports.TheaterEventJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.TheaterEventOrSubClassJoiSchema = Joi.alternatives().try([
    exports.TheaterEventJoiSchema,
]);
/**
 ...
 * ```
 */
function validateTheaterEvent(maybeTheaterEvent) {
    const { value, error } = exports.TheaterEventJoiSchema.validate(maybeTheaterEvent);
    if (error) {
        return new oaValidationError_1.OaValidationError('TheaterEvent', maybeTheaterEvent, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateTheaterEvent = validateTheaterEvent;
