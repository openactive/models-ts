 ...
 * etc.
 */
export declare type TheaterGroupOrSubClass = TheaterGroup;
/**
 * schema:TheaterGroup - Validation schema (w/ JOI)
 */
export declare const TheaterGroupJoiSchema: Joi.ObjectSchema;
/**
 * schema:TheaterGroup - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TheaterGroupOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTheaterGroup(maybeTheaterGroup: unknown): TheaterGroup | OaValidationError;
