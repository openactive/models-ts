...
exports.validateTheaterGroup = exports.TheaterGroupOrSubClassJoiSchema = exports.TheaterGroupJoiSchema = void 0;
 ...
 */
exports.TheaterGroupJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.TheaterGroupOrSubClassJoiSchema = Joi.alternatives().try([
    exports.TheaterGroupJoiSchema,
]);
/**
 ...
 * ```
 */
function validateTheaterGroup(maybeTheaterGroup) {
    const { value, error } = exports.TheaterGroupJoiSchema.validate(maybeTheaterGroup);
    if (error) {
        return new oaValidationError_1.OaValidationError('TheaterGroup', maybeTheaterGroup, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateTheaterGroup = validateTheaterGroup;
