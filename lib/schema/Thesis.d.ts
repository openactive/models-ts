 ...
 * etc.
 */
export declare type ThesisOrSubClass = Thesis;
/**
 * schema:Thesis - Validation schema (w/ JOI)
 */
export declare const ThesisJoiSchema: Joi.ObjectSchema;
/**
 * schema:Thesis - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ThesisOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateThesis(maybeThesis: unknown): Thesis | OaValidationError;
