...
exports.validateThesis = exports.ThesisOrSubClassJoiSchema = exports.ThesisJoiSchema = void 0;
 ...
 */
exports.ThesisJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ThesisOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ThesisJoiSchema,
]);
/**
 ...
 * ```
 */
function validateThesis(maybeThesis) {
    const { value, error } = exports.ThesisJoiSchema.validate(maybeThesis);
    if (error) {
        return new oaValidationError_1.OaValidationError('Thesis', maybeThesis, error);
    }
