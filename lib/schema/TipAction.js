...
exports.validateTipAction = exports.TipActionOrSubClassJoiSchema = exports.TipActionJoiSchema = void 0;
 ...
 */
exports.TipActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.TipActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.TipActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateTipAction(maybeTipAction) {
    const { value, error } = exports.TipActionJoiSchema.validate(maybeTipAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('TipAction', maybeTipAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateTipAction = validateTipAction;
