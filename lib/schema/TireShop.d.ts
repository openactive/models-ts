 ...
 * etc.
 */
export declare type TireShopOrSubClass = TireShop;
/**
 * schema:TireShop - Validation schema (w/ JOI)
 */
export declare const TireShopJoiSchema: Joi.ObjectSchema;
/**
 * schema:TireShop - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TireShopOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTireShop(maybeTireShop: unknown): TireShop | OaValidationError;
