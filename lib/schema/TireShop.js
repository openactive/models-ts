...
exports.validateTireShop = exports.TireShopOrSubClassJoiSchema = exports.TireShopJoiSchema = void 0;
 ...
 */
exports.TireShopJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.TireShopOrSubClassJoiSchema = Joi.alternatives().try([
    exports.TireShopJoiSchema,
]);
/**
 ...
 * ```
 */
function validateTireShop(maybeTireShop) {
    const { value, error } = exports.TireShopJoiSchema.validate(maybeTireShop);
    if (error) {
        return new oaValidationError_1.OaValidationError('TireShop', maybeTireShop, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateTireShop = validateTireShop;
