 ...
 * etc.
 */
export declare type TouristAttractionOrSubClass = TouristAttraction;
/**
 * schema:TouristAttraction - Validation schema (w/ JOI)
 */
export declare const TouristAttractionJoiSchema: Joi.ObjectSchema;
/**
 * schema:TouristAttraction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TouristAttractionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTouristAttraction(maybeTouristAttraction: unknown): TouristAttraction | OaValidationError;
