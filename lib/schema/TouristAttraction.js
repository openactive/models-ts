...
exports.validateTouristAttraction = exports.TouristAttractionOrSubClassJoiSchema = exports.TouristAttractionJoiSchema = void 0;
 ...
 */
exports.TouristAttractionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.TouristAttractionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.TouristAttractionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateTouristAttraction(maybeTouristAttraction) {
    const { value, error } = exports.TouristAttractionJoiSchema.validate(maybeTouristAttraction);
    if (error) {
        return new oaValidationError_1.OaValidationError('TouristAttraction', maybeTouristAttraction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateTouristAttraction = validateTouristAttraction;
