 ...
 * etc.
 */
export declare type TouristDestinationOrSubClass = TouristDestination;
/**
 * schema:TouristDestination - Validation schema (w/ JOI)
 */
export declare const TouristDestinationJoiSchema: Joi.ObjectSchema;
/**
 * schema:TouristDestination - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TouristDestinationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTouristDestination(maybeTouristDestination: unknown): TouristDestination | OaValidationError;
