 ...
 * etc.
 */
export declare type TouristInformationCenterOrSubClass = TouristInformationCenter;
/**
 * schema:TouristInformationCenter - Validation schema (w/ JOI)
 */
export declare const TouristInformationCenterJoiSchema: Joi.ObjectSchema;
/**
 * schema:TouristInformationCenter - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TouristInformationCenterOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTouristInformationCenter(maybeTouristInformationCenter: unknown): TouristInformationCenter | OaValidationError;
