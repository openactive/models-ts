...
exports.validateTouristInformationCenter = exports.TouristInformationCenterOrSubClassJoiSchema = exports.TouristInformationCenterJoiSchema = void 0;
 ...
 */
exports.TouristInformationCenterJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.TouristInformationCenterOrSubClassJoiSchema = Joi.alternatives().try([
    exports.TouristInformationCenterJoiSchema,
]);
/**
 ...
 * ```
 */
function validateTouristInformationCenter(maybeTouristInformationCenter) {
    const { value, error } = exports.TouristInformationCenterJoiSchema.validate(maybeTouristInformationCenter);
    if (error) {
        return new oaValidationError_1.OaValidationError('TouristInformationCenter', maybeTouristInformationCenter, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateTouristInformationCenter = validateTouristInformationCenter;
