 ...
 * etc.
 */
export declare type TouristTripOrSubClass = TouristTrip;
/**
 * schema:TouristTrip - Validation schema (w/ JOI)
 */
export declare const TouristTripJoiSchema: Joi.ObjectSchema;
/**
 * schema:TouristTrip - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TouristTripOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTouristTrip(maybeTouristTrip: unknown): TouristTrip | OaValidationError;
