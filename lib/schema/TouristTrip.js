...
exports.validateTouristTrip = exports.TouristTripOrSubClassJoiSchema = exports.TouristTripJoiSchema = void 0;
 ...
 */
exports.TouristTripJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.TouristTripOrSubClassJoiSchema = Joi.alternatives().try([
    exports.TouristTripJoiSchema,
]);
/**
 ...
 *
 * ```ts
 * const maybeTouristTrip = TouristTrip.validate(req.body); // `req.body` will have type `any` or `unknown`
 ...
 * ```
 */
function validateTouristTrip(maybeTouristTrip) {
    const { value, error } = exports.TouristTripJoiSchema.validate(maybeTouristTrip);
    if (error) {
        return new oaValidationError_1.OaValidationError('TouristTrip', maybeTouristTrip, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateTouristTrip = validateTouristTrip;
