 ...
 * etc.
 */
export declare type ToyStoreOrSubClass = ToyStore;
/**
 * schema:ToyStore - Validation schema (w/ JOI)
 */
export declare const ToyStoreJoiSchema: Joi.ObjectSchema;
/**
 * schema:ToyStore - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ToyStoreOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateToyStore(maybeToyStore: unknown): ToyStore | OaValidationError;
