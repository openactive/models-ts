...
exports.validateToyStore = exports.ToyStoreOrSubClassJoiSchema = exports.ToyStoreJoiSchema = void 0;
 ...
 */
exports.ToyStoreJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ToyStoreOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ToyStoreJoiSchema,
]);
/**
 ...
 * ```
 */
function validateToyStore(maybeToyStore) {
    const { value, error } = exports.ToyStoreJoiSchema.validate(maybeToyStore);
    if (error) {
        return new oaValidationError_1.OaValidationError('ToyStore', maybeToyStore, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateToyStore = validateToyStore;
