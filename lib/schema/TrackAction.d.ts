 ...
 * etc.
 */
export declare type TrackActionOrSubClass = TrackAction;
/**
 * schema:TrackAction - Validation schema (w/ JOI)
 */
export declare const TrackActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:TrackAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TrackActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTrackAction(maybeTrackAction: unknown): TrackAction | OaValidationError;
