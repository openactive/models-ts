...
exports.validateTrackAction = exports.TrackActionOrSubClassJoiSchema = exports.TrackActionJoiSchema = void 0;
 ...
 */
exports.TrackActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.TrackActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.TrackActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateTrackAction(maybeTrackAction) {
    const { value, error } = exports.TrackActionJoiSchema.validate(maybeTrackAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('TrackAction', maybeTrackAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateTrackAction = validateTrackAction;
