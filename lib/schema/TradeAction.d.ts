 ...
 */
export declare const TradeActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:TradeAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TradeActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTradeAction(maybeTradeAction: unknown): TradeAction | OaValidationError;
