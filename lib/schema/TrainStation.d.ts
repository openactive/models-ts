 ...
 * etc.
 */
export declare type TrainStationOrSubClass = TrainStation;
/**
 * schema:TrainStation - Validation schema (w/ JOI)
 */
export declare const TrainStationJoiSchema: Joi.ObjectSchema;
/**
 * schema:TrainStation - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TrainStationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTrainStation(maybeTrainStation: unknown): TrainStation | OaValidationError;
