...
exports.validateTrainStation = exports.TrainStationOrSubClassJoiSchema = exports.TrainStationJoiSchema = void 0;
 ...
 */
exports.TrainStationJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.TrainStationOrSubClassJoiSchema = Joi.alternatives().try([
    exports.TrainStationJoiSchema,
]);
/**
 ...
 * ```
 */
function validateTrainStation(maybeTrainStation) {
    const { value, error } = exports.TrainStationJoiSchema.validate(maybeTrainStation);
    if (error) {
        return new oaValidationError_1.OaValidationError('TrainStation', maybeTrainStation, error);
    }
