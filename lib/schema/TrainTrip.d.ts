 ...
 * etc.
 */
export declare type TrainTripOrSubClass = TrainTrip;
/**
 * schema:TrainTrip - Validation schema (w/ JOI)
 */
export declare const TrainTripJoiSchema: Joi.ObjectSchema;
/**
 * schema:TrainTrip - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TrainTripOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTrainTrip(maybeTrainTrip: unknown): TrainTrip | OaValidationError;
