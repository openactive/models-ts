 ...
 * etc.
 */
export declare type TravelActionOrSubClass = TravelAction;
/**
 * schema:TravelAction - Validation schema (w/ JOI)
 */
export declare const TravelActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:TravelAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TravelActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTravelAction(maybeTravelAction: unknown): TravelAction | OaValidationError;
