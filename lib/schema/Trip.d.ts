 ...
 * etc.
 */
export declare type TripOrSubClass = Trip | schema.BusTripOrSubClass | schema.BoatTripOrSubClass | schema.FlightOrSubClass | schema.TrainTripOrSubClass | schema.TouristTripOrSubClass;
/**
 * schema:Trip - Validation schema (w/ JOI)
 */
export declare const TripJoiSchema: Joi.ObjectSchema;
/**
 * schema:Trip - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TripOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 *
 * ```ts
 * const maybeTrip = Trip.validate(req.body); // `req.body` will have type `any` or `unknown`
 ...
 * ```
 */
export declare function validateTrip(maybeTrip: unknown): Trip | OaValidationError;
