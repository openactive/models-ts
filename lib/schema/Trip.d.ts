 ...
 * etc.
 */
export declare type TripOrSubClass = Trip | schema.TrainTripOrSubClass | schema.BoatTripOrSubClass | schema.FlightOrSubClass | schema.BusTripOrSubClass | schema.TouristTripOrSubClass;
/**
