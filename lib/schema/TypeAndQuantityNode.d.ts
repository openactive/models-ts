 ...
 * etc.
 */
export declare type TypeAndQuantityNodeOrSubClass = TypeAndQuantityNode;
/**
 * schema:TypeAndQuantityNode - Validation schema (w/ JOI)
 */
export declare const TypeAndQuantityNodeJoiSchema: Joi.ObjectSchema;
/**
 * schema:TypeAndQuantityNode - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const TypeAndQuantityNodeOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateTypeAndQuantityNode(maybeTypeAndQuantityNode: unknown): TypeAndQuantityNode | OaValidationError;
