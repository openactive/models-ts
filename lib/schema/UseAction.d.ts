 ...
 * etc.
 */
export declare type UseActionOrSubClass = UseAction | schema.WearActionOrSubClass;
/**
 * schema:UseAction - Validation schema (w/ JOI)
 */
export declare const UseActionJoiSchema: Joi.ObjectSchema;
/**
 * schema:UseAction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const UseActionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateUseAction(maybeUseAction: unknown): UseAction | OaValidationError;
