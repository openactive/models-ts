 ...
 * etc.
 */
export declare type UserBlocksOrSubClass = UserBlocks;
/**
 * schema:UserBlocks - Validation schema (w/ JOI)
 */
export declare const UserBlocksJoiSchema: Joi.ObjectSchema;
/**
 * schema:UserBlocks - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const UserBlocksOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateUserBlocks(maybeUserBlocks: unknown): UserBlocks | OaValidationError;
