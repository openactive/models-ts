...
exports.validateUserBlocks = exports.UserBlocksOrSubClassJoiSchema = exports.UserBlocksJoiSchema = void 0;
 ...
 */
exports.UserBlocksJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.UserBlocksOrSubClassJoiSchema = Joi.alternatives().try([
    exports.UserBlocksJoiSchema,
]);
/**
 ...
 * ```
 */
function validateUserBlocks(maybeUserBlocks) {
    const { value, error } = exports.UserBlocksJoiSchema.validate(maybeUserBlocks);
    if (error) {
        return new oaValidationError_1.OaValidationError('UserBlocks', maybeUserBlocks, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateUserBlocks = validateUserBlocks;
