 ...
 * etc.
 */
export declare type UserCheckinsOrSubClass = UserCheckins;
/**
 * schema:UserCheckins - Validation schema (w/ JOI)
 */
export declare const UserCheckinsJoiSchema: Joi.ObjectSchema;
/**
 * schema:UserCheckins - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const UserCheckinsOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateUserCheckins(maybeUserCheckins: unknown): UserCheckins | OaValidationError;
