...
exports.validateUserCheckins = exports.UserCheckinsOrSubClassJoiSchema = exports.UserCheckinsJoiSchema = void 0;
 ...
 */
exports.UserCheckinsJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.UserCheckinsOrSubClassJoiSchema = Joi.alternatives().try([
    exports.UserCheckinsJoiSchema,
]);
/**
 ...
 * ```
 */
function validateUserCheckins(maybeUserCheckins) {
    const { value, error } = exports.UserCheckinsJoiSchema.validate(maybeUserCheckins);
    if (error) {
        return new oaValidationError_1.OaValidationError('UserCheckins', maybeUserCheckins, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateUserCheckins = validateUserCheckins;
