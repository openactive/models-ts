 ...
 * etc.
 */
export declare type UserCommentsOrSubClass = UserComments;
/**
 * schema:UserComments - Validation schema (w/ JOI)
 */
export declare const UserCommentsJoiSchema: Joi.ObjectSchema;
/**
 * schema:UserComments - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const UserCommentsOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateUserComments(maybeUserComments: unknown): UserComments | OaValidationError;
