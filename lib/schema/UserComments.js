...
exports.validateUserComments = exports.UserCommentsOrSubClassJoiSchema = exports.UserCommentsJoiSchema = void 0;
 ...
 */
exports.UserCommentsJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.UserCommentsOrSubClassJoiSchema = Joi.alternatives().try([
    exports.UserCommentsJoiSchema,
]);
/**
 ...
 * ```
 */
function validateUserComments(maybeUserComments) {
    const { value, error } = exports.UserCommentsJoiSchema.validate(maybeUserComments);
    if (error) {
        return new oaValidationError_1.OaValidationError('UserComments', maybeUserComments, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateUserComments = validateUserComments;
