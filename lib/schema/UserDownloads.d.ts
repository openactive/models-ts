 ...
 * etc.
 */
export declare type UserDownloadsOrSubClass = UserDownloads;
/**
 * schema:UserDownloads - Validation schema (w/ JOI)
 */
export declare const UserDownloadsJoiSchema: Joi.ObjectSchema;
/**
 * schema:UserDownloads - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const UserDownloadsOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateUserDownloads(maybeUserDownloads: unknown): UserDownloads | OaValidationError;
