...
exports.validateUserDownloads = exports.UserDownloadsOrSubClassJoiSchema = exports.UserDownloadsJoiSchema = void 0;
 ...
 */
exports.UserDownloadsJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.UserDownloadsOrSubClassJoiSchema = Joi.alternatives().try([
    exports.UserDownloadsJoiSchema,
]);
/**
 ...
 * ```
 */
function validateUserDownloads(maybeUserDownloads) {
    const { value, error } = exports.UserDownloadsJoiSchema.validate(maybeUserDownloads);
    if (error) {
        return new oaValidationError_1.OaValidationError('UserDownloads', maybeUserDownloads, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateUserDownloads = validateUserDownloads;
