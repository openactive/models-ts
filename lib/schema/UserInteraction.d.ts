 ...
 * etc.
 */
export declare type UserInteractionOrSubClass = UserInteraction | schema.UserPlaysOrSubClass | schema.UserBlocksOrSubClass | schema.UserPageVisitsOrSubClass | schema.UserPlusOnesOrSubClass | schema.UserCheckinsOrSubClass | schema.UserDownloadsOrSubClass | schema.UserCommentsOrSubClass | schema.UserTweetsOrSubClass | schema.UserLikesOrSubClass;
/**
 * schema:UserInteraction - Validation schema (w/ JOI)
 */
export declare const UserInteractionJoiSchema: Joi.ObjectSchema;
/**
 * schema:UserInteraction - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const UserInteractionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateUserInteraction(maybeUserInteraction: unknown): UserInteraction | OaValidationError;
