...
exports.validateUserInteraction = exports.UserInteractionOrSubClassJoiSchema = exports.UserInteractionJoiSchema = void 0;
 ...
 */
exports.UserInteractionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.UserInteractionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.UserInteractionJoiSchema,
 ...
 * ```
 */
function validateUserInteraction(maybeUserInteraction) {
    const { value, error } = exports.UserInteractionJoiSchema.validate(maybeUserInteraction);
    if (error) {
        return new oaValidationError_1.OaValidationError('UserInteraction', maybeUserInteraction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateUserInteraction = validateUserInteraction;
