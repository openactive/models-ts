 ...
 * etc.
 */
export declare type UserLikesOrSubClass = UserLikes;
/**
 * schema:UserLikes - Validation schema (w/ JOI)
 */
export declare const UserLikesJoiSchema: Joi.ObjectSchema;
/**
 * schema:UserLikes - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const UserLikesOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateUserLikes(maybeUserLikes: unknown): UserLikes | OaValidationError;
