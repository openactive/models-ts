...
exports.validateUserLikes = exports.UserLikesOrSubClassJoiSchema = exports.UserLikesJoiSchema = void 0;
 ...
 */
exports.UserLikesJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.UserLikesOrSubClassJoiSchema = Joi.alternatives().try([
    exports.UserLikesJoiSchema,
]);
/**
 ...
 * ```
 */
function validateUserLikes(maybeUserLikes) {
    const { value, error } = exports.UserLikesJoiSchema.validate(maybeUserLikes);
    if (error) {
        return new oaValidationError_1.OaValidationError('UserLikes', maybeUserLikes, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateUserLikes = validateUserLikes;
