 ...
 * etc.
 */
export declare type UserPageVisitsOrSubClass = UserPageVisits;
/**
 * schema:UserPageVisits - Validation schema (w/ JOI)
 */
export declare const UserPageVisitsJoiSchema: Joi.ObjectSchema;
/**
 * schema:UserPageVisits - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const UserPageVisitsOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateUserPageVisits(maybeUserPageVisits: unknown): UserPageVisits | OaValidationError;
