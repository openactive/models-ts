...
exports.validateUserPageVisits = exports.UserPageVisitsOrSubClassJoiSchema = exports.UserPageVisitsJoiSchema = void 0;
 ...
 */
exports.UserPageVisitsJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.UserPageVisitsOrSubClassJoiSchema = Joi.alternatives().try([
    exports.UserPageVisitsJoiSchema,
]);
/**
 ...
 * ```
 */
function validateUserPageVisits(maybeUserPageVisits) {
    const { value, error } = exports.UserPageVisitsJoiSchema.validate(maybeUserPageVisits);
    if (error) {
        return new oaValidationError_1.OaValidationError('UserPageVisits', maybeUserPageVisits, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateUserPageVisits = validateUserPageVisits;
