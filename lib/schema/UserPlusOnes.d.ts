 ...
 * etc.
 */
export declare type UserPlusOnesOrSubClass = UserPlusOnes;
/**
 * schema:UserPlusOnes - Validation schema (w/ JOI)
 */
export declare const UserPlusOnesJoiSchema: Joi.ObjectSchema;
/**
 * schema:UserPlusOnes - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const UserPlusOnesOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateUserPlusOnes(maybeUserPlusOnes: unknown): UserPlusOnes | OaValidationError;
