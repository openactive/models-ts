...
exports.validateUserPlusOnes = exports.UserPlusOnesOrSubClassJoiSchema = exports.UserPlusOnesJoiSchema = void 0;
 ...
 */
exports.UserPlusOnesJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.UserPlusOnesOrSubClassJoiSchema = Joi.alternatives().try([
    exports.UserPlusOnesJoiSchema,
]);
/**
 ...
 * ```
 */
function validateUserPlusOnes(maybeUserPlusOnes) {
    const { value, error } = exports.UserPlusOnesJoiSchema.validate(maybeUserPlusOnes);
    if (error) {
        return new oaValidationError_1.OaValidationError('UserPlusOnes', maybeUserPlusOnes, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateUserPlusOnes = validateUserPlusOnes;
