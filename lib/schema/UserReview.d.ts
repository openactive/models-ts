 ...
 * etc.
 */
export declare type UserReviewOrSubClass = UserReview;
/**
 * schema:UserReview - Validation schema (w/ JOI)
 */
export declare const UserReviewJoiSchema: Joi.ObjectSchema;
/**
 * schema:UserReview - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const UserReviewOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateUserReview(maybeUserReview: unknown): UserReview | OaValidationError;
