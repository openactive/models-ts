...
exports.validateUserReview = exports.UserReviewOrSubClassJoiSchema = exports.UserReviewJoiSchema = void 0;
 ...
 */
exports.UserReviewJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.UserReviewOrSubClassJoiSchema = Joi.alternatives().try([
    exports.UserReviewJoiSchema,
]);
/**
 ...
 * ```
 */
function validateUserReview(maybeUserReview) {
    const { value, error } = exports.UserReviewJoiSchema.validate(maybeUserReview);
    if (error) {
        return new oaValidationError_1.OaValidationError('UserReview', maybeUserReview, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateUserReview = validateUserReview;
