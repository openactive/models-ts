 ...
 * etc.
 */
export declare type UserTweetsOrSubClass = UserTweets;
/**
 * schema:UserTweets - Validation schema (w/ JOI)
 */
export declare const UserTweetsJoiSchema: Joi.ObjectSchema;
/**
 * schema:UserTweets - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const UserTweetsOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateUserTweets(maybeUserTweets: unknown): UserTweets | OaValidationError;
