...
exports.validateUserTweets = exports.UserTweetsOrSubClassJoiSchema = exports.UserTweetsJoiSchema = void 0;
 ...
 */
exports.UserTweetsJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.UserTweetsOrSubClassJoiSchema = Joi.alternatives().try([
    exports.UserTweetsJoiSchema,
]);
/**
 ...
 * ```
 */
function validateUserTweets(maybeUserTweets) {
    const { value, error } = exports.UserTweetsJoiSchema.validate(maybeUserTweets);
    if (error) {
        return new oaValidationError_1.OaValidationError('UserTweets', maybeUserTweets, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateUserTweets = validateUserTweets;
