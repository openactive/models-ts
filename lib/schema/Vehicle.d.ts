 ...
 * etc.
 */
export declare type VehicleOrSubClass = Vehicle | schema.CarOrSubClass | schema.BusOrCoachOrSubClass | schema.MotorcycleOrSubClass | schema.MotorizedBicycleOrSubClass;
/**
 * schema:Vehicle - Validation schema (w/ JOI)
 */
export declare const VehicleJoiSchema: Joi.ObjectSchema;
/**
 * schema:Vehicle - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const VehicleOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateVehicle(maybeVehicle: unknown): Vehicle | OaValidationError;
