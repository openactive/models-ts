 ...
 * etc.
 */
export declare type VehicleOrSubClass = Vehicle | schema.MotorcycleOrSubClass | schema.MotorizedBicycleOrSubClass | schema.BusOrCoachOrSubClass | schema.CarOrSubClass;
/**
