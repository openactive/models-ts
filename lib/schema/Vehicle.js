...
exports.validateVehicle = exports.VehicleOrSubClassJoiSchema = exports.VehicleJoiSchema = void 0;
 ...
 */
exports.VehicleJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.VehicleOrSubClassJoiSchema = Joi.alternatives().try([
    exports.VehicleJoiSchema,
 ...
 *
 * ```ts
 * const maybeVehicle = validateVehicle(req.body); // `req.body` will have type `any` or `unknown`
 ...
 * ```
 */
function validateVehicle(maybeVehicle) {
    const { value, error } = exports.VehicleJoiSchema.validate(maybeVehicle);
    if (error) {
        return new oaValidationError_1.OaValidationError('Vehicle', maybeVehicle, error);
    }
