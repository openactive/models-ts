...
exports.validateVein = exports.VeinOrSubClassJoiSchema = exports.VeinJoiSchema = void 0;
 ...
 */
exports.VeinJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.VeinOrSubClassJoiSchema = Joi.alternatives().try([
    exports.VeinJoiSchema,
]);
/**
 ...
 * ```
 */
function validateVein(maybeVein) {
    const { value, error } = exports.VeinJoiSchema.validate(maybeVein);
    if (error) {
        return new oaValidationError_1.OaValidationError('Vein', maybeVein, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateVein = validateVein;
