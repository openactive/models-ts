 ...
 * etc.
 */
export declare type VesselOrSubClass = Vessel | schema.ArteryOrSubClass | schema.LymphaticVesselOrSubClass | schema.VeinOrSubClass;
/**
 * schema:Vessel - Validation schema (w/ JOI)
 */
export declare const VesselJoiSchema: Joi.ObjectSchema;
/**
 * schema:Vessel - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const VesselOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateVessel(maybeVessel: unknown): Vessel | OaValidationError;
