 ...
 * etc.
 */
export declare type VeterinaryCareOrSubClass = VeterinaryCare;
/**
 * schema:VeterinaryCare - Validation schema (w/ JOI)
 */
export declare const VeterinaryCareJoiSchema: Joi.ObjectSchema;
/**
 * schema:VeterinaryCare - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const VeterinaryCareOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateVeterinaryCare(maybeVeterinaryCare: unknown): VeterinaryCare | OaValidationError;
