...
exports.validateVeterinaryCare = exports.VeterinaryCareOrSubClassJoiSchema = exports.VeterinaryCareJoiSchema = void 0;
 ...
 */
exports.VeterinaryCareJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.VeterinaryCareOrSubClassJoiSchema = Joi.alternatives().try([
    exports.VeterinaryCareJoiSchema,
]);
/**
 ...
 * ```
 */
function validateVeterinaryCare(maybeVeterinaryCare) {
    const { value, error } = exports.VeterinaryCareJoiSchema.validate(maybeVeterinaryCare);
    if (error) {
        return new oaValidationError_1.OaValidationError('VeterinaryCare', maybeVeterinaryCare, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateVeterinaryCare = validateVeterinaryCare;
