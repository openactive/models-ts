 ...
 * etc.
 */
export declare type VideoGalleryOrSubClass = VideoGallery;
/**
 * schema:VideoGallery - Validation schema (w/ JOI)
 */
export declare const VideoGalleryJoiSchema: Joi.ObjectSchema;
/**
 * schema:VideoGallery - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const VideoGalleryOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateVideoGallery(maybeVideoGallery: unknown): VideoGallery | OaValidationError;
