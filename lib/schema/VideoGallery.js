...
exports.validateVideoGallery = exports.VideoGalleryOrSubClassJoiSchema = exports.VideoGalleryJoiSchema = void 0;
 ...
 */
exports.VideoGalleryJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.VideoGalleryOrSubClassJoiSchema = Joi.alternatives().try([
    exports.VideoGalleryJoiSchema,
]);
/**
 ...
 * ```
 */
function validateVideoGallery(maybeVideoGallery) {
    const { value, error } = exports.VideoGalleryJoiSchema.validate(maybeVideoGallery);
    if (error) {
        return new oaValidationError_1.OaValidationError('VideoGallery', maybeVideoGallery, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateVideoGallery = validateVideoGallery;
