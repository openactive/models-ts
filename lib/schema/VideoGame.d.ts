 ...
 * etc.
 */
export declare type VideoGameOrSubClass = VideoGame;
/**
 * schema:VideoGame - Validation schema (w/ JOI)
 */
export declare const VideoGameJoiSchema: Joi.ObjectSchema;
/**
 * schema:VideoGame - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const VideoGameOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateVideoGame(maybeVideoGame: unknown): VideoGame | OaValidationError;
