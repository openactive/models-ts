...
exports.validateVideoGame = exports.VideoGameOrSubClassJoiSchema = exports.VideoGameJoiSchema = void 0;
 ...
 */
exports.VideoGameJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.VideoGameOrSubClassJoiSchema = Joi.alternatives().try([
    exports.VideoGameJoiSchema,
]);
/**
 ...
 * ```
 */
function validateVideoGame(maybeVideoGame) {
    const { value, error } = exports.VideoGameJoiSchema.validate(maybeVideoGame);
    if (error) {
        return new oaValidationError_1.OaValidationError('VideoGame', maybeVideoGame, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateVideoGame = validateVideoGame;
