 ...
 * etc.
 */
export declare type VideoGameClipOrSubClass = VideoGameClip;
/**
 * schema:VideoGameClip - Validation schema (w/ JOI)
 */
export declare const VideoGameClipJoiSchema: Joi.ObjectSchema;
/**
 * schema:VideoGameClip - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const VideoGameClipOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateVideoGameClip(maybeVideoGameClip: unknown): VideoGameClip | OaValidationError;
