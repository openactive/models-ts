...
exports.validateVideoGameClip = exports.VideoGameClipOrSubClassJoiSchema = exports.VideoGameClipJoiSchema = void 0;
 ...
 */
exports.VideoGameClipJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.VideoGameClipOrSubClassJoiSchema = Joi.alternatives().try([
    exports.VideoGameClipJoiSchema,
]);
/**
 ...
 * ```
 */
function validateVideoGameClip(maybeVideoGameClip) {
    const { value, error } = exports.VideoGameClipJoiSchema.validate(maybeVideoGameClip);
    if (error) {
        return new oaValidationError_1.OaValidationError('VideoGameClip', maybeVideoGameClip, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateVideoGameClip = validateVideoGameClip;
