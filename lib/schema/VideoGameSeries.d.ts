 ...
 * etc.
 */
export declare type VideoGameSeriesOrSubClass = VideoGameSeries;
/**
 * schema:VideoGameSeries - Validation schema (w/ JOI)
 */
export declare const VideoGameSeriesJoiSchema: Joi.ObjectSchema;
/**
 * schema:VideoGameSeries - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const VideoGameSeriesOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateVideoGameSeries(maybeVideoGameSeries: unknown): VideoGameSeries | OaValidationError;
