...
exports.validateVideoGameSeries = exports.VideoGameSeriesOrSubClassJoiSchema = exports.VideoGameSeriesJoiSchema = void 0;
 ...
 */
exports.VideoGameSeriesJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.VideoGameSeriesOrSubClassJoiSchema = Joi.alternatives().try([
    exports.VideoGameSeriesJoiSchema,
]);
/**
 ...
 * ```
 */
function validateVideoGameSeries(maybeVideoGameSeries) {
    const { value, error } = exports.VideoGameSeriesJoiSchema.validate(maybeVideoGameSeries);
    if (error) {
        return new oaValidationError_1.OaValidationError('VideoGameSeries', maybeVideoGameSeries, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateVideoGameSeries = validateVideoGameSeries;
