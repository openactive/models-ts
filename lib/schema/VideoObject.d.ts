 ...
 * etc.
 */
export declare type VideoObjectOrSubClass = VideoObject | schema.VideoObjectSnapshotOrSubClass;
/**
 * schema:VideoObject - Validation schema (w/ JOI)
 */
export declare const VideoObjectJoiSchema: Joi.ObjectSchema;
/**
 * schema:VideoObject - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const VideoObjectOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateVideoObject(maybeVideoObject: unknown): VideoObject | OaValidationError;
