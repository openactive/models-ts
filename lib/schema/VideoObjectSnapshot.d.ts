 ...
 */
export declare type VideoObjectSnapshot = {
 ...
 * etc.
 */
export declare type VideoObjectSnapshotOrSubClass = VideoObjectSnapshot;
/**
 * schema:VideoObjectSnapshot - Validation schema (w/ JOI)
 */
export declare const VideoObjectSnapshotJoiSchema: Joi.ObjectSchema;
/**
 * schema:VideoObjectSnapshot - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const VideoObjectSnapshotOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateVideoObjectSnapshot(maybeVideoObjectSnapshot: unknown): VideoObjectSnapshot | OaValidationError;
