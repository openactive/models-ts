...
exports.validateVideoObjectSnapshot = exports.VideoObjectSnapshotOrSubClassJoiSchema = exports.VideoObjectSnapshotJoiSchema = void 0;
 ...
 */
exports.VideoObjectSnapshotJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.VideoObjectSnapshotOrSubClassJoiSchema = Joi.alternatives().try([
    exports.VideoObjectSnapshotJoiSchema,
]);
/**
 ...
 * ```
 */
function validateVideoObjectSnapshot(maybeVideoObjectSnapshot) {
    const { value, error } = exports.VideoObjectSnapshotJoiSchema.validate(maybeVideoObjectSnapshot);
    if (error) {
        return new oaValidationError_1.OaValidationError('VideoObjectSnapshot', maybeVideoObjectSnapshot, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateVideoObjectSnapshot = validateVideoObjectSnapshot;
