...
exports.validateViewAction = exports.ViewActionOrSubClassJoiSchema = exports.ViewActionJoiSchema = void 0;
 ...
 */
exports.ViewActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ViewActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ViewActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateViewAction(maybeViewAction) {
    const { value, error } = exports.ViewActionJoiSchema.validate(maybeViewAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('ViewAction', maybeViewAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateViewAction = validateViewAction;
