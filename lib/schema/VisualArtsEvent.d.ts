 ...
 * etc.
 */
export declare type VisualArtsEventOrSubClass = VisualArtsEvent;
/**
 * schema:VisualArtsEvent - Validation schema (w/ JOI)
 */
export declare const VisualArtsEventJoiSchema: Joi.ObjectSchema;
/**
 * schema:VisualArtsEvent - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const VisualArtsEventOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateVisualArtsEvent(maybeVisualArtsEvent: unknown): VisualArtsEvent | OaValidationError;
