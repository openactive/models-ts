...
exports.validateVisualArtsEvent = exports.VisualArtsEventOrSubClassJoiSchema = exports.VisualArtsEventJoiSchema = void 0;
 ...
 */
exports.VisualArtsEventJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.VisualArtsEventOrSubClassJoiSchema = Joi.alternatives().try([
    exports.VisualArtsEventJoiSchema,
]);
/**
 ...
 * ```
 */
function validateVisualArtsEvent(maybeVisualArtsEvent) {
    const { value, error } = exports.VisualArtsEventJoiSchema.validate(maybeVisualArtsEvent);
    if (error) {
        return new oaValidationError_1.OaValidationError('VisualArtsEvent', maybeVisualArtsEvent, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateVisualArtsEvent = validateVisualArtsEvent;
