 ...
 * etc.
 */
export declare type VisualArtworkOrSubClass = VisualArtwork | schema.CoverArtOrSubClass;
/**
 * schema:VisualArtwork - Validation schema (w/ JOI)
 */
export declare const VisualArtworkJoiSchema: Joi.ObjectSchema;
/**
 * schema:VisualArtwork - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const VisualArtworkOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateVisualArtwork(maybeVisualArtwork: unknown): VisualArtwork | OaValidationError;
