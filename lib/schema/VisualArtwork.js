...
exports.validateVisualArtwork = exports.VisualArtworkOrSubClassJoiSchema = exports.VisualArtworkJoiSchema = void 0;
 ...
 */
exports.VisualArtworkJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.VisualArtworkOrSubClassJoiSchema = Joi.alternatives().try([
    exports.VisualArtworkJoiSchema,
 ...
 * ```
 */
function validateVisualArtwork(maybeVisualArtwork) {
    const { value, error } = exports.VisualArtworkJoiSchema.validate(maybeVisualArtwork);
    if (error) {
        return new oaValidationError_1.OaValidationError('VisualArtwork', maybeVisualArtwork, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateVisualArtwork = validateVisualArtwork;
