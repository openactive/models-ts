 ...
 * etc.
 */
export declare type VitalSignOrSubClass = VitalSign;
/**
 * schema:VitalSign - Validation schema (w/ JOI)
 */
export declare const VitalSignJoiSchema: Joi.ObjectSchema;
/**
 * schema:VitalSign - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const VitalSignOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateVitalSign(maybeVitalSign: unknown): VitalSign | OaValidationError;
