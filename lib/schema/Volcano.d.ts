 ...
 * etc.
 */
export declare type VolcanoOrSubClass = Volcano;
/**
 * schema:Volcano - Validation schema (w/ JOI)
 */
export declare const VolcanoJoiSchema: Joi.ObjectSchema;
/**
 * schema:Volcano - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const VolcanoOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateVolcano(maybeVolcano: unknown): Volcano | OaValidationError;
