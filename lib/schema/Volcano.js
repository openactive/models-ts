...
exports.validateVolcano = exports.VolcanoOrSubClassJoiSchema = exports.VolcanoJoiSchema = void 0;
 ...
 */
exports.VolcanoJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.VolcanoOrSubClassJoiSchema = Joi.alternatives().try([
    exports.VolcanoJoiSchema,
]);
/**
 ...
 * ```
 */
function validateVolcano(maybeVolcano) {
    const { value, error } = exports.VolcanoJoiSchema.validate(maybeVolcano);
    if (error) {
        return new oaValidationError_1.OaValidationError('Volcano', maybeVolcano, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateVolcano = validateVolcano;
