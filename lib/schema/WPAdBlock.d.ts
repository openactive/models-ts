 ...
 * etc.
 */
export declare type WPAdBlockOrSubClass = WPAdBlock;
/**
 * schema:WPAdBlock - Validation schema (w/ JOI)
 */
export declare const WPAdBlockJoiSchema: Joi.ObjectSchema;
/**
 * schema:WPAdBlock - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const WPAdBlockOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateWPAdBlock(maybeWPAdBlock: unknown): WPAdBlock | OaValidationError;
