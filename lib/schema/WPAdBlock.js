...
exports.validateWPAdBlock = exports.WPAdBlockOrSubClassJoiSchema = exports.WPAdBlockJoiSchema = void 0;
 ...
 */
exports.WPAdBlockJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.WPAdBlockOrSubClassJoiSchema = Joi.alternatives().try([
    exports.WPAdBlockJoiSchema,
]);
/**
 ...
 * ```
 */
function validateWPAdBlock(maybeWPAdBlock) {
    const { value, error } = exports.WPAdBlockJoiSchema.validate(maybeWPAdBlock);
    if (error) {
        return new oaValidationError_1.OaValidationError('WPAdBlock', maybeWPAdBlock, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateWPAdBlock = validateWPAdBlock;
