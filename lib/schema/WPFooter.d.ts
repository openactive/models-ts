 ...
 * etc.
 */
export declare type WPFooterOrSubClass = WPFooter;
/**
 * schema:WPFooter - Validation schema (w/ JOI)
 */
export declare const WPFooterJoiSchema: Joi.ObjectSchema;
/**
 * schema:WPFooter - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const WPFooterOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateWPFooter(maybeWPFooter: unknown): WPFooter | OaValidationError;
