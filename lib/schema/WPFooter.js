...
exports.validateWPFooter = exports.WPFooterOrSubClassJoiSchema = exports.WPFooterJoiSchema = void 0;
 ...
 */
exports.WPFooterJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.WPFooterOrSubClassJoiSchema = Joi.alternatives().try([
    exports.WPFooterJoiSchema,
]);
/**
 ...
 * ```
 */
function validateWPFooter(maybeWPFooter) {
    const { value, error } = exports.WPFooterJoiSchema.validate(maybeWPFooter);
    if (error) {
        return new oaValidationError_1.OaValidationError('WPFooter', maybeWPFooter, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateWPFooter = validateWPFooter;
