 ...
 * etc.
 */
export declare type WPHeaderOrSubClass = WPHeader;
/**
 * schema:WPHeader - Validation schema (w/ JOI)
 */
export declare const WPHeaderJoiSchema: Joi.ObjectSchema;
/**
 * schema:WPHeader - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const WPHeaderOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateWPHeader(maybeWPHeader: unknown): WPHeader | OaValidationError;
