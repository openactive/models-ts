...
exports.validateWPHeader = exports.WPHeaderOrSubClassJoiSchema = exports.WPHeaderJoiSchema = void 0;
 ...
 */
exports.WPHeaderJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.WPHeaderOrSubClassJoiSchema = Joi.alternatives().try([
    exports.WPHeaderJoiSchema,
]);
/**
 ...
 * ```
 */
function validateWPHeader(maybeWPHeader) {
    const { value, error } = exports.WPHeaderJoiSchema.validate(maybeWPHeader);
    if (error) {
        return new oaValidationError_1.OaValidationError('WPHeader', maybeWPHeader, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateWPHeader = validateWPHeader;
