 ...
 * etc.
 */
export declare type WPSideBarOrSubClass = WPSideBar;
/**
 * schema:WPSideBar - Validation schema (w/ JOI)
 */
export declare const WPSideBarJoiSchema: Joi.ObjectSchema;
/**
 * schema:WPSideBar - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const WPSideBarOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateWPSideBar(maybeWPSideBar: unknown): WPSideBar | OaValidationError;
