...
exports.validateWPSideBar = exports.WPSideBarOrSubClassJoiSchema = exports.WPSideBarJoiSchema = void 0;
 ...
 */
exports.WPSideBarJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.WPSideBarOrSubClassJoiSchema = Joi.alternatives().try([
    exports.WPSideBarJoiSchema,
]);
/**
 ...
 * ```
 */
function validateWPSideBar(maybeWPSideBar) {
    const { value, error } = exports.WPSideBarJoiSchema.validate(maybeWPSideBar);
    if (error) {
        return new oaValidationError_1.OaValidationError('WPSideBar', maybeWPSideBar, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateWPSideBar = validateWPSideBar;
