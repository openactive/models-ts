...
exports.validateWatchAction = exports.WatchActionOrSubClassJoiSchema = exports.WatchActionJoiSchema = void 0;
 ...
 */
exports.WatchActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.WatchActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.WatchActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateWatchAction(maybeWatchAction) {
    const { value, error } = exports.WatchActionJoiSchema.validate(maybeWatchAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('WatchAction', maybeWatchAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateWatchAction = validateWatchAction;
