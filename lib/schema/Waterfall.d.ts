 ...
 * etc.
 */
export declare type WaterfallOrSubClass = Waterfall;
/**
 * schema:Waterfall - Validation schema (w/ JOI)
 */
export declare const WaterfallJoiSchema: Joi.ObjectSchema;
/**
 * schema:Waterfall - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const WaterfallOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateWaterfall(maybeWaterfall: unknown): Waterfall | OaValidationError;
