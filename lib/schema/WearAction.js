...
exports.validateWearAction = exports.WearActionOrSubClassJoiSchema = exports.WearActionJoiSchema = void 0;
 ...
 */
exports.WearActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.WearActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.WearActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateWearAction(maybeWearAction) {
    const { value, error } = exports.WearActionJoiSchema.validate(maybeWearAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('WearAction', maybeWearAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateWearAction = validateWearAction;
