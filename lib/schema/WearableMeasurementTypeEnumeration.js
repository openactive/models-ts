...
exports.validateWearableMeasurementTypeEnumeration = exports.WearableMeasurementTypeEnumerationOrSubClassJoiSchema = exports.WearableMeasurementTypeEnumerationJoiSchema = void 0;
 ...
 */
exports.WearableMeasurementTypeEnumerationJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.WearableMeasurementTypeEnumerationOrSubClassJoiSchema = Joi.alternatives().try([
    exports.WearableMeasurementTypeEnumerationJoiSchema,
]);
/**
 ...
 * ```
 */
function validateWearableMeasurementTypeEnumeration(maybeWearableMeasurementTypeEnumeration) {
    const { value, error } = exports.WearableMeasurementTypeEnumerationJoiSchema.validate(maybeWearableMeasurementTypeEnumeration);
    if (error) {
        return new oaValidationError_1.OaValidationError('WearableMeasurementTypeEnumeration', maybeWearableMeasurementTypeEnumeration, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateWearableMeasurementTypeEnumeration = validateWearableMeasurementTypeEnumeration;
