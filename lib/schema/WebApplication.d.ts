 ...
 * etc.
 */
export declare type WebApplicationOrSubClass = WebApplication;
/**
 * schema:WebApplication - Validation schema (w/ JOI)
 */
export declare const WebApplicationJoiSchema: Joi.ObjectSchema;
/**
 * schema:WebApplication - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const WebApplicationOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateWebApplication(maybeWebApplication: unknown): WebApplication | OaValidationError;
