...
exports.validateWebApplication = exports.WebApplicationOrSubClassJoiSchema = exports.WebApplicationJoiSchema = void 0;
 ...
 */
exports.WebApplicationJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.WebApplicationOrSubClassJoiSchema = Joi.alternatives().try([
    exports.WebApplicationJoiSchema,
]);
/**
 ...
 * ```
 */
function validateWebApplication(maybeWebApplication) {
    const { value, error } = exports.WebApplicationJoiSchema.validate(maybeWebApplication);
    if (error) {
        return new oaValidationError_1.OaValidationError('WebApplication', maybeWebApplication, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateWebApplication = validateWebApplication;
