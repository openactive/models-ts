 ...
 * etc.
 */
export declare type WebContentOrSubClass = WebContent | schema.HealthTopicContentOrSubClass;
/**
 * schema:WebContent - Validation schema (w/ JOI)
 */
export declare const WebContentJoiSchema: Joi.ObjectSchema;
/**
 * schema:WebContent - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const WebContentOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateWebContent(maybeWebContent: unknown): WebContent | OaValidationError;
