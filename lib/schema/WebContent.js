...
exports.validateWebContent = exports.WebContentOrSubClassJoiSchema = exports.WebContentJoiSchema = void 0;
 ...
 */
exports.WebContentJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.WebContentOrSubClassJoiSchema = Joi.alternatives().try([
    exports.WebContentJoiSchema,
 ...
 * ```
 */
function validateWebContent(maybeWebContent) {
    const { value, error } = exports.WebContentJoiSchema.validate(maybeWebContent);
    if (error) {
        return new oaValidationError_1.OaValidationError('WebContent', maybeWebContent, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateWebContent = validateWebContent;
