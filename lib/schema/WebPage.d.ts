 ...
 * etc.
 */
export declare type WebPageOrSubClass = WebPage | schema.SearchResultsPageOrSubClass | schema.QAPageOrSubClass | schema.RealEstateListingOrSubClass | schema.FAQPageOrSubClass | schema.AboutPageOrSubClass | schema.CheckoutPageOrSubClass | schema.ContactPageOrSubClass | schema.ItemPageOrSubClass | schema.CollectionPageOrSubClass | schema.ProfilePageOrSubClass | schema.MedicalWebPageOrSubClass;
/**
 * schema:WebPage - Validation schema (w/ JOI)
 */
export declare const WebPageJoiSchema: Joi.ObjectSchema;
/**
 * schema:WebPage - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const WebPageOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateWebPage(maybeWebPage: unknown): WebPage | OaValidationError;
