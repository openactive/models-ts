...
exports.validateWebPage = exports.WebPageOrSubClassJoiSchema = exports.WebPageJoiSchema = void 0;
 ...
 */
exports.WebPageJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.WebPageOrSubClassJoiSchema = Joi.alternatives().try([
    exports.WebPageJoiSchema,
 ...
 * ```
 */
function validateWebPage(maybeWebPage) {
    const { value, error } = exports.WebPageJoiSchema.validate(maybeWebPage);
    if (error) {
        return new oaValidationError_1.OaValidationError('WebPage', maybeWebPage, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateWebPage = validateWebPage;
