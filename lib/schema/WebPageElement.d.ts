 ...
 * etc.
 */
export declare type WebPageElementOrSubClass = WebPageElement | schema.WPAdBlockOrSubClass | schema.TableOrSubClass | schema.WPFooterOrSubClass | schema.WPSideBarOrSubClass | schema.SiteNavigationElementOrSubClass | schema.WPHeaderOrSubClass;
/**
 * schema:WebPageElement - Validation schema (w/ JOI)
 */
export declare const WebPageElementJoiSchema: Joi.ObjectSchema;
/**
 * schema:WebPageElement - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const WebPageElementOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateWebPageElement(maybeWebPageElement: unknown): WebPageElement | OaValidationError;
