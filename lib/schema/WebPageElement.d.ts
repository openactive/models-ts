 ...
 * etc.
 */
export declare type WebPageElementOrSubClass = WebPageElement | schema.SiteNavigationElementOrSubClass | schema.WPHeaderOrSubClass | schema.WPSideBarOrSubClass | schema.TableOrSubClass | schema.WPAdBlockOrSubClass | schema.WPFooterOrSubClass;
/**
