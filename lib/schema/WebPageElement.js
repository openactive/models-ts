...
exports.validateWebPageElement = exports.WebPageElementOrSubClassJoiSchema = exports.WebPageElementJoiSchema = void 0;
 ...
 */
exports.WebPageElementJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.WebPageElementOrSubClassJoiSchema = Joi.alternatives().try([
    exports.WebPageElementJoiSchema,
 ...
 * ```
 */
function validateWebPageElement(maybeWebPageElement) {
    const { value, error } = exports.WebPageElementJoiSchema.validate(maybeWebPageElement);
    if (error) {
        return new oaValidationError_1.OaValidationError('WebPageElement', maybeWebPageElement, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateWebPageElement = validateWebPageElement;
