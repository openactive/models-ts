 ...
 * etc.
 */
export declare type WebSiteOrSubClass = WebSite;
/**
 * schema:WebSite - Validation schema (w/ JOI)
 */
export declare const WebSiteJoiSchema: Joi.ObjectSchema;
/**
 * schema:WebSite - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const WebSiteOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateWebSite(maybeWebSite: unknown): WebSite | OaValidationError;
