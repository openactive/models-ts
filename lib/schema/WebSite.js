...
exports.validateWebSite = exports.WebSiteOrSubClassJoiSchema = exports.WebSiteJoiSchema = void 0;
 ...
 */
exports.WebSiteJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.WebSiteOrSubClassJoiSchema = Joi.alternatives().try([
    exports.WebSiteJoiSchema,
]);
/**
 ...
 * ```
 */
function validateWebSite(maybeWebSite) {
    const { value, error } = exports.WebSiteJoiSchema.validate(maybeWebSite);
    if (error) {
        return new oaValidationError_1.OaValidationError('WebSite', maybeWebSite, error);
    }
