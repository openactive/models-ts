...
exports.validateWholesaleStore = exports.WholesaleStoreOrSubClassJoiSchema = exports.WholesaleStoreJoiSchema = void 0;
 ...
 */
exports.WholesaleStoreJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.WholesaleStoreOrSubClassJoiSchema = Joi.alternatives().try([
    exports.WholesaleStoreJoiSchema,
]);
/**
 ...
 * ```
 */
function validateWholesaleStore(maybeWholesaleStore) {
    const { value, error } = exports.WholesaleStoreJoiSchema.validate(maybeWholesaleStore);
    if (error) {
        return new oaValidationError_1.OaValidationError('WholesaleStore', maybeWholesaleStore, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateWholesaleStore = validateWholesaleStore;
