...
exports.validateWinAction = exports.WinActionOrSubClassJoiSchema = exports.WinActionJoiSchema = void 0;
 ...
 */
exports.WinActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.WinActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.WinActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateWinAction(maybeWinAction) {
    const { value, error } = exports.WinActionJoiSchema.validate(maybeWinAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('WinAction', maybeWinAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateWinAction = validateWinAction;
