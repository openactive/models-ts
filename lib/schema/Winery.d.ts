 ...
 * etc.
 */
export declare type WineryOrSubClass = Winery;
/**
 * schema:Winery - Validation schema (w/ JOI)
 */
export declare const WineryJoiSchema: Joi.ObjectSchema;
/**
 * schema:Winery - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const WineryOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateWinery(maybeWinery: unknown): Winery | OaValidationError;
