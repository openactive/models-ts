...
exports.validateWinery = exports.WineryOrSubClassJoiSchema = exports.WineryJoiSchema = void 0;
 ...
 */
exports.WineryJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.WineryOrSubClassJoiSchema = Joi.alternatives().try([
    exports.WineryJoiSchema,
]);
/**
 ...
 * ```
 */
function validateWinery(maybeWinery) {
    const { value, error } = exports.WineryJoiSchema.validate(maybeWinery);
    if (error) {
        return new oaValidationError_1.OaValidationError('Winery', maybeWinery, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateWinery = validateWinery;
