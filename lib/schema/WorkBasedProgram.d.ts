 ...
 * etc.
 */
export declare type WorkBasedProgramOrSubClass = WorkBasedProgram;
/**
 * schema:WorkBasedProgram - Validation schema (w/ JOI)
 */
export declare const WorkBasedProgramJoiSchema: Joi.ObjectSchema;
/**
 * schema:WorkBasedProgram - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const WorkBasedProgramOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateWorkBasedProgram(maybeWorkBasedProgram: unknown): WorkBasedProgram | OaValidationError;
