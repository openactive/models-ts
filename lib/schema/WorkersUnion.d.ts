 ...
 * etc.
 */
export declare type WorkersUnionOrSubClass = WorkersUnion;
/**
 * schema:WorkersUnion - Validation schema (w/ JOI)
 */
export declare const WorkersUnionJoiSchema: Joi.ObjectSchema;
/**
 * schema:WorkersUnion - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const WorkersUnionOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateWorkersUnion(maybeWorkersUnion: unknown): WorkersUnion | OaValidationError;
