...
exports.validateWorkersUnion = exports.WorkersUnionOrSubClassJoiSchema = exports.WorkersUnionJoiSchema = void 0;
 ...
 */
exports.WorkersUnionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.WorkersUnionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.WorkersUnionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateWorkersUnion(maybeWorkersUnion) {
    const { value, error } = exports.WorkersUnionJoiSchema.validate(maybeWorkersUnion);
    if (error) {
        return new oaValidationError_1.OaValidationError('WorkersUnion', maybeWorkersUnion, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateWorkersUnion = validateWorkersUnion;
