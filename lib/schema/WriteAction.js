...
exports.validateWriteAction = exports.WriteActionOrSubClassJoiSchema = exports.WriteActionJoiSchema = void 0;
 ...
 */
exports.WriteActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.WriteActionOrSubClassJoiSchema = Joi.alternatives().try([
    exports.WriteActionJoiSchema,
]);
/**
 ...
 * ```
 */
function validateWriteAction(maybeWriteAction) {
    const { value, error } = exports.WriteActionJoiSchema.validate(maybeWriteAction);
    if (error) {
        return new oaValidationError_1.OaValidationError('WriteAction', maybeWriteAction, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateWriteAction = validateWriteAction;
