...
exports.validateXPathType = exports.XPathTypeOrSubClassJoiSchema = exports.XPathTypeJoiSchema = void 0;
 ...
 */
exports.XPathTypeJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.XPathTypeOrSubClassJoiSchema = Joi.alternatives().try([
    exports.XPathTypeJoiSchema,
]);
/**
 ...
 * ```
 */
function validateXPathType(maybeXPathType) {
    const { value, error } = exports.XPathTypeJoiSchema.validate(maybeXPathType);
    if (error) {
        return new oaValidationError_1.OaValidationError('XPathType', maybeXPathType, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateXPathType = validateXPathType;
