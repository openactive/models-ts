 ...
 * etc.
 */
export declare type ZooOrSubClass = Zoo;
/**
 * schema:Zoo - Validation schema (w/ JOI)
 */
export declare const ZooJoiSchema: Joi.ObjectSchema;
/**
 * schema:Zoo - Validation schema (w/ JOI)
 *
 ...
 * `SessionSeries`, etc.
 */
export declare const ZooOrSubClassJoiSchema: Joi.AlternativesSchema;
/**
 ...
 * ```
 */
export declare function validateZoo(maybeZoo: unknown): Zoo | OaValidationError;
