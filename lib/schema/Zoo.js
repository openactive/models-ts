...
exports.validateZoo = exports.ZooOrSubClassJoiSchema = exports.ZooJoiSchema = void 0;
 ...
 */
exports.ZooJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
exports.ZooOrSubClassJoiSchema = Joi.alternatives().try([
    exports.ZooJoiSchema,
]);
/**
 ...
 * ```
 */
function validateZoo(maybeZoo) {
    const { value, error } = exports.ZooJoiSchema.validate(maybeZoo);
    if (error) {
        return new oaValidationError_1.OaValidationError('Zoo', maybeZoo, error);
    }
    /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
    to have the right type. Therefore, we just cast it to the right type. */
    return value;
}
exports.validateZoo = validateZoo;
