...
/**
 * AudioObject - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/AudioObject, which means that any of this type's properties within schema.org may also be used.
 */
...
/**
 * Runtime validator for AudioObject.
 *
 * If some data has a structure which matches a AudioObject, it will be returned with the correct type.
