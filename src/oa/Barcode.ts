...
export type Barcode = {
   ...
   */
  thumbnail?: oa.ImageObjectOrSubClass[];
  /**
...
/**
 * Barcode - Validation schema (w/ JOI)
 *
 * This type is derived from https://schema.org/Barcode, which means that any of this type's properties within schema.org may also be used.
 */
...
/**
 * Runtime validator for Barcode.
 *
 * If some data has a structure which matches a Barcode, it will be returned with the correct type.
