 ...
 */
export type DropdownFormFieldSpecification = {
 ...
 * etc.
 */
export type DropdownFormFieldSpecificationOrSubClass =
  | DropdownFormFieldSpecification
  ;
 ...
 * This type is derived from https://schema.org/PropertyValueSpecification, which means that any of this type's properties within schema.org may also be used.
 */
export const DropdownFormFieldSpecificationJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
export const DropdownFormFieldSpecificationOrSubClassJoiSchema = Joi.alternatives().try([
  DropdownFormFieldSpecificationJoiSchema,
]);
 ...
 * ```
 */
export function validateDropdownFormFieldSpecification(maybeDropdownFormFieldSpecification: unknown): DropdownFormFieldSpecification | OaValidationError {
  const { value, error } = DropdownFormFieldSpecificationJoiSchema.validate(maybeDropdownFormFieldSpecification);
  if (error) {
    return new OaValidationError('DropdownFormFieldSpecification', maybeDropdownFormFieldSpecification, error);
  }
  /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
  to have the right type. Therefore, we just cast it to the right type. */
  return value as DropdownFormFieldSpecification;
}
