...
export type Event_OrSubClass =
  | Event_
  | oa.CourseInstanceOrSubClass
  | oa.EventSeriesOrSubClass
  | oa.HeadlineEventOrSubClass
  | oa.OnDemandEventOrSubClass
  | oa.ScheduledSessionOrSubClass
  | oa.SessionSeriesOrSubClass
  | oa.SlotOrSubClass
  ;
