...
/**
 * EventSeries - Validation schema (w/ JOI)
 *
 * This type is derived from https://pending.schema.org/EventSeries.
 */
...
/**
 * Runtime validator for EventSeries.
 *
 * If some data has a structure which matches a EventSeries, it will be returned with the correct type.
