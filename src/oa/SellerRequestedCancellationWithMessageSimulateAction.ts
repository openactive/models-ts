 ...
 */
export type SellerRequestedCancellationWithMessageSimulateAction = {
  '@type': 'SellerRequestedCancellationWithMessageSimulateAction';
 ...
 * This type is derived from https://schema.org/Action, which means that any of this type's properties within schema.org may also be used.
 *
 * This differs from SellerRequestedCancellationWithMessageSimulateAction because it also allows for objects that have the type of a model that
 * sub-classes this model. e.g. `Event_OrSubClass` allows `Event`s as well as `ScheduledSession`s, `SessionSeries`,
 * etc.
 */
export type SellerRequestedCancellationWithMessageSimulateActionOrSubClass =
 ...
 * This type is derived from https://schema.org/Action, which means that any of this type's properties within schema.org may also be used.
 */
export const SellerRequestedCancellationWithMessageSimulateActionJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
export const SellerRequestedCancellationWithMessageSimulateActionOrSubClassJoiSchema = Joi.alternatives().try([
  SellerRequestedCancellationWithMessageSimulateActionJoiSchema,
]);
 ...
 * ```
 */
export function validateSellerRequestedCancellationWithMessageSimulateAction(maybeSellerRequestedCancellationWithMessageSimulateAction: unknown): SellerRequestedCancellationWithMessageSimulateAction | OaValidationError {
  const { value, error } = SellerRequestedCancellationWithMessageSimulateActionJoiSchema.validate(maybeSellerRequestedCancellationWithMessageSimulateAction);
  if (error) {
    return new OaValidationError('SellerRequestedCancellationWithMessageSimulateAction', maybeSellerRequestedCancellationWithMessageSimulateAction, error);
  }
  /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
  to have the right type. Therefore, we just cast it to the right type. */
  return value as SellerRequestedCancellationWithMessageSimulateAction;
}
