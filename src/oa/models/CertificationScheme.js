 ...
 */
const CertificationScheme = s.intersection([
  s.type({'@type': s.literal('CertificationScheme')}),
  s.partial({
      /**
      ...
      */
      certificationLevel: oa.CertificationLevel,
      /**
      * [NOTICE: This is a beta property, and is highly likely to change in future versions of this library.]
      ...
      * If you are using this property, please join the discussion at proposal [#217](https://github.com/openactive/modelling-opportunity-data/issues/217).
      */
      trustedCertificationSchemes: s.urlString,
      /**
