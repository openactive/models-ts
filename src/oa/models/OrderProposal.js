 ...
 */
const OrderProposal = s.intersection([
  s.type({'@type': s.literal('OrderProposal')}),
  s.partial({
      /**
      ...
      */
      ...
      orderProposalStatus: oa.enums.OrderProposalStatus,
      /**
