...
export type ArchiveComponent = {
   ...
   * [object Object]
   */
  itemLocation?: schema.PostalAddressOrSubClass | string | schema.PlaceOrSubClass;
  /**
   * [object Object]
   */
...
export const ArchiveComponentJoiSchema = Joi.object({
  ...
  '@id': Joi.string().uri(),
  itemLocation: Joi.alternatives().try(Joi.lazy(() => schema.PostalAddressOrSubClassJoiSchema), Joi.string(), Joi.lazy(() => schema.PlaceOrSubClassJoiSchema), Joi.string().uri()),
