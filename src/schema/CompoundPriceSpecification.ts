 ...
 */
export type CompoundPriceSpecification = {
 ...
 * etc.
 */
export type CompoundPriceSpecificationOrSubClass =
 ...
 */
export const CompoundPriceSpecificationJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
export const CompoundPriceSpecificationOrSubClassJoiSchema = Joi.alternatives().try([
  CompoundPriceSpecificationJoiSchema,
]);
 ...
 * ```
 */
export function validateCompoundPriceSpecification(maybeCompoundPriceSpecification: unknown): CompoundPriceSpecification | OaValidationError {
  const { value, error } = CompoundPriceSpecificationJoiSchema.validate(maybeCompoundPriceSpecification);
  if (error) {
    return new OaValidationError('CompoundPriceSpecification', maybeCompoundPriceSpecification, error);
  }
  /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
  to have the right type. Therefore, we just cast it to the right type. */
  return value as CompoundPriceSpecification;
}
