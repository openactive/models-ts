...
export type CovidTestingFacility = {
   ...
   */
  availableService?: schema.MedicalTestOrSubClass | schema.MedicalTherapyOrSubClass | schema.MedicalProcedureOrSubClass | string;
  /**
 ...
 *
 * ```ts
 * const maybeCovidTestingFacility = CovidTestingFacility.validate(req.body); // `req.body` will have type `any` or `unknown`
