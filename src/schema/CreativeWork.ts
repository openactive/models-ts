 ...
 * etc.
 */
export type CreativeWorkOrSubClass =
  | CreativeWork
  | oa.ConceptCollectionOrSubClass
  | schema.SpecialAnnouncementOrSubClass
  | schema.AmpStoryOrSubClass
  | schema.DefinedTermSetOrSubClass
  | schema.PhotographOrSubClass
  | schema.CourseOrSubClass
  | schema.ClipOrSubClass
  | schema.CommentOrSubClass
  | schema.HyperTocEntryOrSubClass
  | schema.MusicCompositionOrSubClass
  | schema.WebPageOrSubClass
  | schema.DrawingOrSubClass
  | schema.CodeOrSubClass
  | schema.HowToStepOrSubClass
  | schema.MathSolverOrSubClass
  | schema.LegislationOrSubClass
  | schema.CreativeWorkSeriesOrSubClass
  | schema.HowToOrSubClass
  | schema.ThesisOrSubClass
  | schema.EducationalOccupationalCredentialOrSubClass
  | schema.WebPageElementOrSubClass
  | schema.VisualArtworkOrSubClass
  | schema.SheetMusicOrSubClass
  | schema.ChapterOrSubClass
  | schema.MusicPlaylistOrSubClass
  | schema.BookOrSubClass
  | schema.SculptureOrSubClass
  | schema.HowToSectionOrSubClass
  | schema.ComicStoryOrSubClass
  | schema.ArchiveComponentOrSubClass
  | schema.MapOrSubClass
  | schema.GameOrSubClass
  | schema.CollectionOrSubClass
  | schema.SeasonOrSubClass
  | schema.MenuSectionOrSubClass
  | schema.WebContentOrSubClass
  | schema.MovieOrSubClass
  | schema.ArticleOrSubClass
  | schema.PlayOrSubClass
  | schema.ReviewOrSubClass
  | schema.DatasetOrSubClass
  | schema.LearningResourceOrSubClass
  | schema.DietOrSubClass
  | schema.DataCatalogOrSubClass
  | schema.PublicationIssueOrSubClass
  | schema.AtlasOrSubClass
  | schema.PublicationVolumeOrSubClass
  | schema.MenuOrSubClass
  | schema.QuotationOrSubClass
  | schema.ConversationOrSubClass
  | schema.MusicRecordingOrSubClass
  | schema.ExercisePlanOrSubClass
  | schema.ClaimOrSubClass
  | schema.PaintingOrSubClass
  | schema.BlogOrSubClass
  | schema.HowToDirectionOrSubClass
  | schema.SoftwareApplicationOrSubClass
  | schema.SoftwareSourceCodeOrSubClass
  | schema.MessageOrSubClass
  | schema.GuideOrSubClass
  | schema.PosterOrSubClass
  | schema.TVSeriesOrSubClass
  | schema.HowToTipOrSubClass
  | schema.WebSiteOrSubClass
  | schema.EpisodeOrSubClass
  | schema.HyperTocOrSubClass
  | schema.ManuscriptOrSubClass
  | schema.ShortStoryOrSubClass
  | schema.TVSeasonOrSubClass
  | schema.DigitalDocumentOrSubClass
  | schema.CreativeWorkSeasonOrSubClass
  | schema.MediaObjectOrSubClass
  ;

/**
 * schema:CreativeWork - Validation schema (w/ JOI)
 */
export const CreativeWorkJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
export const CreativeWorkOrSubClassJoiSchema = Joi.alternatives().try([
  CreativeWorkJoiSchema,
 ...
 * ```
 */
export function validateCreativeWork(maybeCreativeWork: unknown): CreativeWork | OaValidationError {
  const { value, error } = CreativeWorkJoiSchema.validate(maybeCreativeWork);
  if (error) {
    return new OaValidationError('CreativeWork', maybeCreativeWork, error);
  }
  /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
  to have the right type. Therefore, we just cast it to the right type. */
  return value as CreativeWork;
}
