...
/**
 * schema:DataDownload - Validation schema (w/ JOI)
 */
...
/**
 * Runtime validator for schema:DataDownload.
 *
 * If some data has a structure which matches a schema:DataDownload, it will be returned with the correct type.
