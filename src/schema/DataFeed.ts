...
export type DataFeed = {
   ...
   */
  dataFeedElement?: schema.ThingOrSubClass | string | schema.DataFeedItemOrSubClass;
  /**
   ...
   */
  variableMeasured?: string | schema.PropertyValueOrSubClass;
  /**
...
export const DataFeedJoiSchema = Joi.object({
  ...
  '@id': Joi.string().uri(),
  dataFeedElement: Joi.alternatives().try(Joi.lazy(() => schema.ThingOrSubClassJoiSchema), Joi.string(), Joi.lazy(() => schema.DataFeedItemOrSubClassJoiSchema), Joi.string().uri()),
 ...
 *
 * ```ts
 * const maybeDataFeed = DataFeed.validate(req.body); // `req.body` will have type `any` or `unknown`
