...
export const EducationalOccupationalCredentialJoiSchema = Joi.object({
  ...
  credentialCategory: Joi.alternatives().try(Joi.lazy(() => schema.DefinedTermOrSubClassJoiSchema), Joi.string(), Joi.string().uri()),
 ...
 *
 * ```ts
 * const maybeEducationalOccupationalCredential = validateEducationalOccupationalCredential(req.body); // `req.body` will have type `any` or `unknown`
