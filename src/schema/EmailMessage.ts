...
export type EmailMessage = {
   ...
   */
  sender?: schema.OrganizationOrSubClass | schema.AudienceOrSubClass | schema.PersonOrSubClass | string;
  /**
   * A sub property of recipient. The recipient copied on a message.
   */
  ccRecipient?: schema.OrganizationOrSubClass | schema.ContactPointOrSubClass | schema.PersonOrSubClass | string;
  /**
   * A sub property of recipient. The recipient who was directly sent the message.
   */
  toRecipient?: schema.ContactPointOrSubClass | schema.OrganizationOrSubClass | schema.PersonOrSubClass | schema.AudienceOrSubClass | string;
  /**
   ...
   */
  bccRecipient?: schema.OrganizationOrSubClass | schema.ContactPointOrSubClass | schema.PersonOrSubClass | string;
  /**
...
export const EmailMessageJoiSchema = Joi.object({
  ...
  '@id': Joi.string().uri(),
  sender: Joi.alternatives().try(Joi.lazy(() => schema.OrganizationOrSubClassJoiSchema), Joi.lazy(() => schema.AudienceOrSubClassJoiSchema), Joi.lazy(() => schema.PersonOrSubClassJoiSchema), Joi.string().uri()),
  ccRecipient: Joi.alternatives().try(Joi.lazy(() => schema.OrganizationOrSubClassJoiSchema), Joi.lazy(() => schema.ContactPointOrSubClassJoiSchema), Joi.lazy(() => schema.PersonOrSubClassJoiSchema), Joi.string().uri()),
  toRecipient: Joi.alternatives().try(Joi.lazy(() => schema.ContactPointOrSubClassJoiSchema), Joi.lazy(() => schema.OrganizationOrSubClassJoiSchema), Joi.lazy(() => schema.PersonOrSubClassJoiSchema), Joi.lazy(() => schema.AudienceOrSubClassJoiSchema), Joi.string().uri()),
  ...
  bccRecipient: Joi.alternatives().try(Joi.lazy(() => schema.OrganizationOrSubClassJoiSchema), Joi.lazy(() => schema.ContactPointOrSubClassJoiSchema), Joi.lazy(() => schema.PersonOrSubClassJoiSchema), Joi.string().uri()),
 ...
 *
 * ```ts
 * const maybeEmailMessage = validateEmailMessage(req.body); // `req.body` will have type `any` or `unknown`
