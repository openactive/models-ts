...
export type EndorseAction = {
   ...
   */
  endorsee?: schema.PersonOrSubClass | schema.OrganizationOrSubClass | string;
  /**
...
export const EndorseActionJoiSchema = Joi.object({
  ...
  '@id': Joi.string().uri(),
  endorsee: Joi.alternatives().try(Joi.lazy(() => schema.PersonOrSubClassJoiSchema), Joi.lazy(() => schema.OrganizationOrSubClassJoiSchema), Joi.string().uri()),
