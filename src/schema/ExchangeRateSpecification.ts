 ...
 */
export type ExchangeRateSpecification = {
 ...
 * etc.
 */
export type ExchangeRateSpecificationOrSubClass =
 ...
 */
export const ExchangeRateSpecificationJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
export const ExchangeRateSpecificationOrSubClassJoiSchema = Joi.alternatives().try([
  ExchangeRateSpecificationJoiSchema,
]);
 ...
 * ```
 */
export function validateExchangeRateSpecification(maybeExchangeRateSpecification: unknown): ExchangeRateSpecification | OaValidationError {
  const { value, error } = ExchangeRateSpecificationJoiSchema.validate(maybeExchangeRateSpecification);
  if (error) {
    return new OaValidationError('ExchangeRateSpecification', maybeExchangeRateSpecification, error);
  }
  /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
  to have the right type. Therefore, we just cast it to the right type. */
  return value as ExchangeRateSpecification;
}
