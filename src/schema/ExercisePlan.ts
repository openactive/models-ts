...
export type ExercisePlan = {
   ...
   */
  repetitions?: schema.QuantitativeValueOrSubClass | number | string;
  /**
   * How often one should break from the activity.
   */
  restPeriods?: schema.QuantitativeValueOrSubClass | string;
  /**
   * Quantitative measure gauging the degree of force involved in the exercise, for example, heartbeats per minute. May include the velocity of the movement.
   */
  intensity?: string | schema.QuantitativeValueOrSubClass;
  /**
...
export const ExercisePlanJoiSchema = Joi.object({
  ...
  '@id': Joi.string().uri(),
  repetitions: Joi.alternatives().try(Joi.lazy(() => schema.QuantitativeValueOrSubClassJoiSchema), Joi.number(), Joi.string().uri()),
  restPeriods: Joi.alternatives().try(Joi.lazy(() => schema.QuantitativeValueOrSubClassJoiSchema), Joi.string(), Joi.string().uri()),
  intensity: Joi.alternatives().try(Joi.string(), Joi.lazy(() => schema.QuantitativeValueOrSubClassJoiSchema), Joi.string().uri()),
