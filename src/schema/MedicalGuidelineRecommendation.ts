 ...
 */
export type MedicalGuidelineRecommendation = {
 ...
 * etc.
 */
export type MedicalGuidelineRecommendationOrSubClass =
 ...
 */
export const MedicalGuidelineRecommendationJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
export const MedicalGuidelineRecommendationOrSubClassJoiSchema = Joi.alternatives().try([
  MedicalGuidelineRecommendationJoiSchema,
]);
 ...
 *
 * ```ts
 * const maybeMedicalGuidelineRecommendation = MedicalGuidelineRecommendation.validate(req.body); // `req.body` will have type `any` or `unknown`
 ...
 * ```
 */
export function validateMedicalGuidelineRecommendation(maybeMedicalGuidelineRecommendation: unknown): MedicalGuidelineRecommendation | OaValidationError {
  const { value, error } = MedicalGuidelineRecommendationJoiSchema.validate(maybeMedicalGuidelineRecommendation);
  if (error) {
    return new OaValidationError('MedicalGuidelineRecommendation', maybeMedicalGuidelineRecommendation, error);
  }
  /* Joi does not implement TS Type Guards, so TS does not implicitly know that this has now been validated
  to have the right type. Therefore, we just cast it to the right type. */
  return value as MedicalGuidelineRecommendation;
}
