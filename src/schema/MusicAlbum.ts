...
export type MusicAlbum = {
   ...
   */
  track?: schema.MusicRecordingOrSubClass | schema.ItemListOrSubClass | string;
  /**
...
export const MusicAlbumJoiSchema = Joi.object({
  ...
  track: Joi.alternatives().try(Joi.lazy(() => schema.MusicRecordingOrSubClassJoiSchema), Joi.lazy(() => schema.ItemListOrSubClassJoiSchema), Joi.string().uri()),
 ...
 *
 * ```ts
 * const maybeMusicAlbum = validateMusicAlbum(req.body); // `req.body` will have type `any` or `unknown`
