...
export type NewsMediaOrganization = {
   ...
   */
  masthead?: schema.CreativeWorkOrSubClass | string;
  /**
   * For a [[NewsMediaOrganization]], a statement on coverage priorities, including any public agenda or stance on issues.
   */
  missionCoveragePrioritiesPolicy?: string | schema.CreativeWorkOrSubClass;
  /**
   ...
   */
  noBylinesPolicy?: schema.CreativeWorkOrSubClass | string;
  /**
 ...
 *
 * ```ts
 * const maybeNewsMediaOrganization = NewsMediaOrganization.validate(req.body); // `req.body` will have type `any` or `unknown`
