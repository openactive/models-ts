...
export type OwnershipInfo = {
   ...
   */
  acquiredFrom?: schema.OrganizationOrSubClass | schema.PersonOrSubClass | string;
  /**
 ...
 *
 * ```ts
 * const maybeOwnershipInfo = OwnershipInfo.validate(req.body); // `req.body` will have type `any` or `unknown`
