...
export type Question = {
   ...
   */
  acceptedAnswer?: schema.ItemListOrSubClass | schema.AnswerOrSubClass | string;
  /**
...
export const QuestionJoiSchema = Joi.object({
  ...
  acceptedAnswer: Joi.alternatives().try(Joi.lazy(() => schema.ItemListOrSubClassJoiSchema), Joi.lazy(() => schema.AnswerOrSubClassJoiSchema), Joi.string().uri()),
 ...
 *
 * ```ts
 * const maybeQuestion = validateQuestion(req.body); // `req.body` will have type `any` or `unknown`
