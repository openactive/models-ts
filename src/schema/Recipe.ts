...
export type Recipe = {
   ...
   */
  steps?: string | schema.ItemListOrSubClass | schema.CreativeWorkOrSubClass;
  /**
   * A sub-property of instrument. A supply consumed when performing instructions or a direction.
   */
  supply?: string | schema.HowToSupplyOrSubClass;
  /**
...
export const RecipeJoiSchema = Joi.object({
  ...
  steps: Joi.alternatives().try(Joi.string(), Joi.lazy(() => schema.ItemListOrSubClassJoiSchema), Joi.lazy(() => schema.CreativeWorkOrSubClassJoiSchema), Joi.string().uri()),
  supply: Joi.alternatives().try(Joi.string(), Joi.lazy(() => schema.HowToSupplyOrSubClassJoiSchema), Joi.string().uri()),
