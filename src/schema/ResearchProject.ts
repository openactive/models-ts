 ...
 * etc.
 */
export type ResearchProjectOrSubClass =
  | ResearchProject
  ;
 ...
 */
export const ResearchProjectJoiSchema = Joi.object({
 ...
 * `SessionSeries`, etc.
 */
export const ResearchProjectOrSubClassJoiSchema = Joi.alternatives().try([
  ResearchProjectJoiSchema,
]);
 ...
 * ```
 */
export function validateResearchProject(maybeResearchProject: unknown): ResearchProject | OaValidationError {
  const { value, error } = ResearchProjectJoiSchema.validate(maybeResearchProject);
  if (error) {
    return new OaValidationError('ResearchProject', maybeResearchProject, error);
  }
