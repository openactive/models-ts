...
export const ShippingRateSettingsJoiSchema = Joi.object({
  ...
  freeShippingThreshold: Joi.alternatives().try(Joi.lazy(() => schema.MonetaryAmountOrSubClassJoiSchema), Joi.lazy(() => schema.DeliveryChargeSpecificationOrSubClassJoiSchema), Joi.string().uri()),
