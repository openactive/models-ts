...
export type SoftwareSourceCode = {
   ...
   */
  programmingLanguage?: schema.ComputerLanguageOrSubClass | string;
  /**
   * Runtime platform or script interpreter dependencies (Example - Java v1, Python2.3, .Net Framework 3.0).
   */
  runtime?: string;
...
export const SoftwareSourceCodeJoiSchema = Joi.object({
  ...
  programmingLanguage: Joi.alternatives().try(Joi.lazy(() => schema.ComputerLanguageOrSubClassJoiSchema), Joi.string(), Joi.string().uri()),
  runtime: Joi.string(),
