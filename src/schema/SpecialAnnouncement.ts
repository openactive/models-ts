...
export type SpecialAnnouncement = {
   ...
   */
  diseaseSpreadStatistics?: schema.ObservationOrSubClass | schema.WebContentOrSubClass | string | schema.DatasetOrSubClass;
  /**
   ...
   */
  webFeed?: schema.DataFeedOrSubClass | string;
  /**
   * Information about getting tested (for a [[MedicalCondition]]), e.g. in the context of a pandemic.
   */
  gettingTestedInfo?: string | schema.WebContentOrSubClass;
  /**
   * Indicates a page with news updates and guidelines. This could often be (but is not required to be) the main page containing [[SpecialAnnouncement]] markup on a site.
   */
  newsUpdatesAndGuidelines?: string | schema.WebContentOrSubClass;
  /**
   * Information about public transport closures.
   */
  publicTransportClosuresInfo?: schema.WebContentOrSubClass | string;
  /**
...
export const SpecialAnnouncementJoiSchema = Joi.object({
  ...
  diseaseSpreadStatistics: Joi.alternatives().try(Joi.lazy(() => schema.ObservationOrSubClassJoiSchema), Joi.lazy(() => schema.WebContentOrSubClassJoiSchema), Joi.string().uri(), Joi.lazy(() => schema.DatasetOrSubClassJoiSchema)),
  ...
  webFeed: Joi.alternatives().try(Joi.lazy(() => schema.DataFeedOrSubClassJoiSchema), Joi.string().uri()),
  gettingTestedInfo: Joi.alternatives().try(Joi.string().uri(), Joi.lazy(() => schema.WebContentOrSubClassJoiSchema)),
  newsUpdatesAndGuidelines: Joi.alternatives().try(Joi.string().uri(), Joi.lazy(() => schema.WebContentOrSubClassJoiSchema)),
  publicTransportClosuresInfo: Joi.alternatives().try(Joi.lazy(() => schema.WebContentOrSubClassJoiSchema), Joi.string().uri()),
