...
export type VideoGameClip = {
   ...
   */
  startOffset?: number | schema.HyperTocEntryOrSubClass | string;
  /**
   ...
   */
  endOffset?: number | schema.HyperTocEntryOrSubClass | string;
  /**
...
export const VideoGameClipJoiSchema = Joi.object({
  ...
  startOffset: Joi.alternatives().try(Joi.number(), Joi.lazy(() => schema.HyperTocEntryOrSubClassJoiSchema), Joi.string().uri()),
  ...
  endOffset: Joi.alternatives().try(Joi.number(), Joi.lazy(() => schema.HyperTocEntryOrSubClassJoiSchema), Joi.string().uri()),
 ...
 *
 * ```ts
 * const maybeVideoGameClip = validateVideoGameClip(req.body); // `req.body` will have type `any` or `unknown`
