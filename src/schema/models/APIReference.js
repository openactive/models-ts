...
/**
 */
const APIReference = s.intersection([
  s.type({'@type': s.literal('APIReference')}),
  s.partial({
      /**
      ...
      * Library file name e.g., mscorlib.dll, system.web.dll.
      */
      executableLibraryName: s.string,
      /**
      * Associated product/technology version. e.g., .NET Framework 4.5.
      */
      assemblyVersion: s.string,
      /**
      * Proficiency needed for this content; expected values: 'Beginner', 'Expert'.
      */
      proficiencyLevel: s.string,
      /**
      ...
      */
      backstory: s.union([schema.CreativeWork,s.string]),
      /**
      ...
      */
      pageStart: s.union([s.string,s.nonNegativeInt]),
      /**
      * The page on which the work ends; for example "138" or "xvi".
      */
      pageEnd: s.union([s.string,s.nonNegativeInt]),
      /**
      ...
      */
      articleSection: s.string,
      /**
      * The actual body of the article.
      */
      articleBody: s.string,
      /**
