...
/**
 */
const AnatomicalSystem = s.intersection([
  s.type({'@type': s.literal('AnatomicalSystem')}),
  s.partial({
      /**
      ...
      */
      relatedStructure: schema.AnatomicalStructure,
      /**
      * Specifying something physically contained by something else. Typically used here for the underlying anatomical structures, such as organs, that comprise the anatomical system.
      */
      comprisedOf: s.union([schema.AnatomicalSystem,schema.AnatomicalStructure]),
      /**
