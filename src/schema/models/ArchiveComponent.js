...
/**
 */
const ArchiveComponent = s.intersection([
  s.type({'@type': s.literal('ArchiveComponent')}),
  s.partial({
      /**
      ...
      * [object Object]
      */
      holdingArchive: schema.ArchiveOrganization,
      /**
      * [object Object]
      */
      itemLocation: s.union([schema.PostalAddress,schema.Place,s.string]),
      /**
