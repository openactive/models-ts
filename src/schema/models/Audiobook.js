...
/**
 */
const Audiobook = s.intersection([
  s.type({'@type': s.literal('Audiobook')}),
  s.partial({
      /**
      ...
      */
      numberOfPages: s.nonNegativeInt,
      /**
      * The edition of the book.
      */
      bookEdition: s.string,
      /**
      * The format of the book.
      */
      bookFormat: schema.enums.BookFormatType,
      /**
