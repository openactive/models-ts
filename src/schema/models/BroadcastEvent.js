...
/**
 */
const BroadcastEvent = s.intersection([
  s.type({'@type': s.literal('BroadcastEvent')}),
  s.partial({
      /**
      ...
      */
      subtitleLanguage: s.union([s.string,schema.Language]),
      /**
      * The type of screening or video broadcast used (e.g. IMAX, 3D, SD, HD, etc.).
      */
      videoFormat: s.string,
      /**
      ...
      */
      publishedBy: s.union([schema.Person,schema.Organization]),
      /**
