...
/**
 */
const BroadcastFrequencySpecification = s.intersection([
  s.type({'@type': s.literal('BroadcastFrequencySpecification')}),
  s.partial({
      /**
      ...
      */
      broadcastSubChannel: s.string,
      /**
      * The modulation (e.g. FM, AM, etc) used by a particular broadcast service.
      */
      broadcastSignalModulation: s.union([s.string,schema.enums.QualitativeValue]),
      /**
      * The frequency in MHz for a particular broadcast.
      */
      broadcastFrequencyValue: s.union([schema.QuantitativeValue,s.nonNegativeFloat]),
      /**
