...
/**
 */
const BusTrip = s.intersection([
  s.type({'@type': s.literal('BusTrip')}),
  s.partial({
      /**
      ...
      */
      arrivalBusStop: s.union([schema.BusStop,schema.BusStation]),
      /**
      * The stop or station from which the bus departs.
      */
      departureBusStop: s.union([schema.BusStation,schema.BusStop]),
      /**
