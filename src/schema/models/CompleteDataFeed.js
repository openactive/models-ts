...
/**
 */
const CompleteDataFeed = s.intersection([
  s.type({'@type': s.literal('CompleteDataFeed')}),
  s.partial({
      /**
      ...
      */
      dataFeedElement: s.union([schema.Thing,s.string,schema.DataFeedItem]),
      /**
      * The range of temporal applicability of a dataset, e.g. for a 2011 census dataset, the year 2011 (in ISO 8601 time interval format).
      */
      datasetTimeInterval: s.isoDateTimeString,
      /**
      ...
      */
      variableMeasured: s.union([s.string,schema.PropertyValue]),
      /**
