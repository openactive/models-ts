...
/**
 */
const CovidTestingFacility = s.intersection([
  s.type({'@type': s.literal('CovidTestingFacility')}),
  s.partial({
      /**
      ...
      */
      availableService: s.union([schema.MedicalTest,schema.MedicalTherapy,schema.MedicalProcedure]),
      /**
      ...
      */
      healthPlanNetworkId: s.string,
      /**
      * Whether the provider is accepting new patients.
      */
      isAcceptingNewPatients: s.boolean,
      /**
