...
/**
 */
const DietarySupplement = s.intersection([
  s.type({'@type': s.literal('DietarySupplement')}),
  s.partial({
      /**
      ...
      * Recommended intake of this supplement for a given population as defined by a specific recommending authority.
      */
      recommendedIntake: schema.RecommendedDoseSchedule,
      /**
