...
/**
 */
const DigitalDocumentPermission = s.intersection([
  s.type({'@type': s.literal('DigitalDocumentPermission')}),
  s.partial({
      /**
      ...
      */
      grantee: s.union([schema.Organization,schema.Person,schema.Audience,schema.ContactPoint]),
      /**
      * The type of permission granted the person, organization, or audience.
      */
      permissionType: schema.enums.DigitalDocumentPermissionType,
      /**
