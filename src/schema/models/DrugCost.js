...
/**
 */
const DrugCost = s.intersection([
  s.type({'@type': s.literal('DrugCost')}),
  s.partial({
      /**
      ...
      */
      applicableLocation: schema.AdministrativeArea,
      /**
      ...
      */
      costCategory: schema.DrugCostCategory,
      /**
      * The cost per unit of the drug.
      */
      costPerUnit: s.union([s.string,schema.enums.QualitativeValue,s.nonNegativeFloat]),
      /**
