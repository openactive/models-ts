...
/**
 */
const DrugStrength = s.intersection([
  s.type({'@type': s.literal('DrugStrength')}),
  s.partial({
      /**
      ...
      */
      strengthValue: s.nonNegativeFloat,
      /**
      ...
      */
      availableIn: schema.AdministrativeArea,
      /**
