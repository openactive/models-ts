...
/**
 */
const EducationalOccupationalCredential = s.intersection([
  s.type({'@type': s.literal('EducationalOccupationalCredential')}),
  s.partial({
      /**
      ...
      */
      credentialCategory: s.union([schema.DefinedTerm,s.urlString,s.string]),
      /**
      ...
      */
      competencyRequired: s.union([s.string,s.urlString,schema.DefinedTerm]),
      /**
      * An organization that acknowledges the validity, value or utility of a credential. Note: recognition may include a process of quality assurance or accreditation.
      */
      recognizedBy: schema.Organization,
      /**
