...
/**
 */
const EmailMessage = s.intersection([
  s.type({'@type': s.literal('EmailMessage')}),
  s.partial({
      /**
      ...
      */
      sender: s.union([schema.Person,schema.Audience,schema.Organization]),
      /**
      * The date/time at which the message has been read by the recipient if a single recipient exists.
      */
      dateRead: s.union([s.isoDateTimeString,s.string]),
      /**
      * A sub property of recipient. The recipient who was directly sent the message.
      */
      toRecipient: s.union([schema.ContactPoint,schema.Audience,schema.Person,schema.Organization]),
      /**
      ...
      */
      recipient: s.union([schema.Organization,schema.ContactPoint,schema.Person,schema.Audience]),
      /**
      * A sub property of recipient. The recipient copied on a message.
      */
      ccRecipient: s.union([schema.ContactPoint,schema.Person,schema.Organization]),
      /**
      * The date/time at which the message was sent.
      */
      dateSent: s.isoDateTimeString,
      /**
      * The date/time the message was received if a single recipient exists.
      */
      dateReceived: s.isoDateTimeString,
      /**
      * A sub property of recipient. The recipient blind copied on a message.
      */
      bccRecipient: s.union([schema.Person,schema.Organization,schema.ContactPoint]),
      /**
