...
/**
 */
const ExchangeRateSpecification = s.intersection([
  s.type({'@type': s.literal('ExchangeRateSpecification')}),
  s.partial({
      /**
      ...
      */
      currentExchangeRate: schema.UnitPriceSpecification,
      /**
      * The difference between the price at which a broker or other intermediary buys and sells foreign currency.
      */
      exchangeRateSpread: s.union([schema.MonetaryAmount,s.nonNegativeFloat]),
      /**
