...
/**
 */
const ExercisePlan = s.intersection([
  s.type({'@type': s.literal('ExercisePlan')}),
  s.partial({
      /**
      ...
      */
      additionalVariable: s.string,
      /**
      * Quantitative measure of the physiologic output of the exercise; also referred to as energy expenditure.
      */
      workload: s.union([schema.Energy,schema.QuantitativeValue]),
      /**
      * How often one should engage in the activity.
      */
      activityFrequency: s.union([s.string,schema.QuantitativeValue]),
      /**
      * Quantitative measure gauging the degree of force involved in the exercise, for example, heartbeats per minute. May include the velocity of the movement.
      */
      intensity: s.union([schema.QuantitativeValue,s.string]),
      /**
      * Number of times one should repeat the activity.
      */
      repetitions: s.union([s.nonNegativeFloat,schema.QuantitativeValue]),
      /**
      * Length of time to engage in the activity.
      */
      activityDuration: s.union([schema.QuantitativeValue,s.string]),
      /**
      * How often one should break from the activity.
      */
      restPeriods: s.union([s.string,schema.QuantitativeValue]),
      /**
