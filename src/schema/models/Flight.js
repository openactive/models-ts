...
/**
 */
const Flight = s.intersection([
  s.type({'@type': s.literal('Flight')}),
  s.partial({
      /**
      ...
      */
      webCheckinTime: s.isoDateTimeString,
      /**
      * Identifier of the flight's departure gate.
      */
      departureGate: s.string,
      /**
      ...
      */
      mealService: s.string,
      /**
      * The kind of aircraft (e.g., "Boeing 747").
      */
      aircraft: s.union([schema.Vehicle,s.string]),
      /**
      * Identifier of the flight's arrival terminal.
      */
      arrivalTerminal: s.string,
      /**
      ...
      */
      arrivalGate: s.string,
      /**
      * Identifier of the flight's departure terminal.
      */
      departureTerminal: s.string,
      /**
      ...
      */
      boardingPolicy: schema.enums.BoardingPolicyType,
      /**
      ...
      */
      flightDistance: s.union([schema.Distance,s.string]),
      /**
      * The estimated time the flight will take.
      */
      estimatedFlightDuration: s.string,
      /**
