...
/**
 */
const FlightReservation = s.intersection([
  s.type({'@type': s.literal('FlightReservation')}),
  s.partial({
      /**
      ...
      */
      passengerPriorityStatus: s.union([schema.enums.QualitativeValue,s.string]),
      /**
      * The type of security screening the passenger is subject to.
      */
      securityScreening: s.string,
      /**
      * The airline-specific indicator of boarding order / preference.
      */
      boardingGroup: s.string,
      /**
      * The passenger's sequence number as assigned by the airline.
      */
      passengerSequenceNumber: s.string,
      /**
