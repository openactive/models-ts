...
/**
 */
const HealthInsurancePlan = s.intersection([
  s.type({'@type': s.literal('HealthInsurancePlan')}),
  s.partial({
      /**
      ...
      */
      usesHealthPlanIdStandard: s.union([s.string,s.urlString]),
      /**
      ...
      */
      healthPlanDrugTier: s.string,
      /**
      * Networks covered by this plan.
      */
      includesHealthPlanNetwork: schema.HealthPlanNetwork,
      /**
      * The URL that goes directly to the plan brochure for the specific standard plan or plan variation.
      */
      healthPlanMarketingUrl: s.urlString,
      /**
      * Formularies covered by this plan.
      */
      includesHealthPlanFormulary: schema.HealthPlanFormulary,
      /**
      * The URL that goes directly to the summary of benefits and coverage for the specific standard plan or plan variation.
      */
      benefitsSummaryUrl: s.urlString,
      /**
      * The 14-character, HIOS-generated Plan ID number. (Plan IDs must be unique, even across different markets.)
      */
      healthPlanId: s.string,
      /**
      * TODO.
      */
      healthPlanDrugOption: s.string,
      /**
