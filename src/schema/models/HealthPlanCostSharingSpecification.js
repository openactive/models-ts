...
/**
 */
const HealthPlanCostSharingSpecification = s.intersection([
  s.type({'@type': s.literal('HealthPlanCostSharingSpecification')}),
  s.partial({
      /**
      ...
      */
      healthPlanCopay: schema.PriceSpecification,
      /**
      * Whether the copay is before or after deductible, etc. TODO: Is this a closed set?
      */
      healthPlanCopayOption: s.string,
      /**
      * The category or type of pharmacy associated with this cost sharing.
      */
      healthPlanPharmacyCategory: s.string,
      /**
      * Whether The rate of coinsurance expressed as a number between 0.0 and 1.0.
      */
      healthPlanCoinsuranceRate: s.nonNegativeFloat,
      /**
      * Whether the coinsurance applies before or after deductible, etc. TODO: Is this a closed set?
      */
      healthPlanCoinsuranceOption: s.string,
      /**
