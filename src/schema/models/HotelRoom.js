...
/**
 */
const HotelRoom = s.intersection([
  s.type({'@type': s.literal('HotelRoom')}),
  s.partial({
      /**
      ...
      */
      bed: s.union([schema.BedDetails,s.string,schema.BedType]),
      /**
      ...
      */
      accommodationCategory: s.string,
      /**
      * A floorplan of some [[Accommodation]].
      */
      accommodationFloorPlan: schema.FloorPlan,
      /**
