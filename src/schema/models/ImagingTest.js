...
/**
 */
const ImagingTest = s.intersection([
  s.type({'@type': s.literal('ImagingTest')}),
  s.partial({
      /**
      ...
      */
      imagingTechnique: schema.MedicalImagingTechnique,
      /**
      * A condition the test is used to diagnose.
      */
      usedToDiagnose: schema.MedicalCondition,
      /**
      * Device used to perform the test.
      */
      usesDevice: schema.MedicalDevice,
      /**
      * Range of acceptable values for a typical patient, when applicable.
      */
      normalRange: s.union([schema.enums.MedicalEnumeration,s.string]),
      /**
      * Drugs that affect the test's results.
      */
      affectedBy: schema.Drug,
      /**
      * A sign detected by the test.
      */
      signDetected: schema.MedicalSign,
      /**
