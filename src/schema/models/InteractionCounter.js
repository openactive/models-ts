...
/**
 */
const InteractionCounter = s.intersection([
  s.type({'@type': s.literal('InteractionCounter')}),
  s.partial({
      /**
      ...
      */
      userInteractionCount: s.nonNegativeInt,
      /**
      * The WebSite or SoftwareApplication where the interactions took place.
      */
      interactionService: s.union([schema.SoftwareApplication,schema.WebSite]),
      /**
