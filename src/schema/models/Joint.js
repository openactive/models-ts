...
/**
 */
const Joint = s.intersection([
  s.type({'@type': s.literal('Joint')}),
  s.partial({
      /**
      ...
      */
      functionalClass: s.union([schema.MedicalEntity,s.string]),
      /**
      * The name given to how bone physically connects to each other.
      */
      structuralClass: s.string,
      /**
      * The biomechanical properties of the bone.
      */
      biomechnicalClass: s.string,
      /**
