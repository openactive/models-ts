...
/**
 */
const LymphaticVessel = s.intersection([
  s.type({'@type': s.literal('LymphaticVessel')}),
  s.partial({
      /**
      ...
      */
      regionDrained: s.union([schema.AnatomicalStructure,schema.AnatomicalSystem]),
      /**
      * The vasculature the lymphatic structure originates, or afferents, from.
      */
      originatesFrom: schema.Vessel,
      /**
      * The vasculature the lymphatic structure runs, or efferents, to.
      */
      runsTo: schema.Vessel,
      /**
