...
/**
 */
const MedicalCode = s.intersection([
  s.type({'@type': s.literal('MedicalCode')}),
  s.partial({
      /**
      ...
      */
      codingSystem: s.string,
      /**
      * A [[CategoryCodeSet]] that contains this category code.
      */
      inCodeSet: s.union([s.urlString,schema.CategoryCodeSet]),
      /**
      * A [[DefinedTermSet]] that contains this term.
      */
      inDefinedTermSet: s.union([schema.DefinedTermSet,s.urlString]),
      /**
