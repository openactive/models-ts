...
/**
 */
const MedicalObservationalStudy = s.intersection([
  s.type({'@type': s.literal('MedicalObservationalStudy')}),
  s.partial({
      /**
      ...
      */
      studyDesign: schema.MedicalObservationalStudyDesign,
      /**
      ...
      */
      studySubject: schema.MedicalEntity,
      /**
      ...
      */
      studyLocation: schema.AdministrativeArea,
      /**
