...
/**
 */
const MedicalRiskCalculator = s.intersection([
  s.type({'@type': s.literal('MedicalRiskCalculator')}),
  s.partial({
      /**
      ...
      */
      includedRiskFactor: schema.MedicalRiskFactor,
      /**
      * The condition, complication, or symptom whose risk is being estimated.
      */
      estimatesRiskOf: schema.MedicalEntity,
      /**
