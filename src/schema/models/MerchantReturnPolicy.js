...
/**
 */
const MerchantReturnPolicy = s.intersection([
  s.type({'@type': s.literal('MerchantReturnPolicy')}),
  s.partial({
      /**
      ...
      */
      returnPolicyCategory: schema.enums.MerchantReturnEnumeration,
      /**
      * A refundType, from an enumerated list.
      */
      refundType: schema.enums.RefundTypeEnumeration,
      /**
      * Indicates (via enumerated options) the return fees policy for a MerchantReturnPolicy
      */
      returnFees: schema.enums.ReturnFeesEnumeration,
      /**
      * Indicates a Web page or service by URL, for product return.
      */
      merchantReturnLink: s.urlString,
      /**
      ...
      */
      merchantReturnDays: s.nonNegativeInt,
      /**
      * Are in-store returns offered?
      */
      inStoreReturnsOffered: s.boolean,
      /**
