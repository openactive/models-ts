...
/**
 */
const MoneyTransfer = s.intersection([
  s.type({'@type': s.literal('MoneyTransfer')}),
  s.partial({
      /**
      ...
      */
      beneficiaryBank: s.union([s.string,schema.BankOrCreditUnion]),
      /**
      * The amount of money.
      */
      amount: s.union([s.nonNegativeFloat,schema.MonetaryAmount]),
      /**
