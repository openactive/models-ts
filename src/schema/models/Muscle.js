...
/**
 */
const Muscle = s.intersection([
  s.type({'@type': s.literal('Muscle')}),
  s.partial({
      /**
      ...
      */
      antagonist: schema.Muscle,
      /**
      * The movement the muscle generates.
      */
      muscleAction: s.string,
      /**
      * The blood vessel that carries blood from the heart to the muscle.
      */
      bloodSupply: schema.Vessel,
      /**
      * The place of attachment of a muscle, or what the muscle moves.
      */
      insertion: schema.AnatomicalStructure,
      /**
