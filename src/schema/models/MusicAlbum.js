...
/**
 */
const MusicAlbum = s.intersection([
  s.type({'@type': s.literal('MusicAlbum')}),
  s.partial({
      /**
      ...
      */
      albumProductionType: schema.enums.MusicAlbumProductionType,
      /**
      ...
      */
      byArtist: s.union([schema.MusicGroup,schema.Person]),
      /**
      * The kind of release which this album is: single, EP or album.
      */
      albumReleaseType: schema.enums.MusicAlbumReleaseType,
      /**
      * A music recording (track)&#x2014;usually a single song. If an ItemList is given, the list should contain items of type MusicRecording.
      */
      track: s.union([schema.ItemList,schema.MusicRecording]),
      /**
