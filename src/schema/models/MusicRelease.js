...
/**
 */
const MusicRelease = s.intersection([
  s.type({'@type': s.literal('MusicRelease')}),
  s.partial({
      /**
      ...
      */
      creditedTo: s.union([schema.Person,schema.Organization]),
      /**
      * Format of this release (the type of recording media used, ie. compact disc, digital media, LP, etc.).
      */
      musicReleaseFormat: schema.enums.MusicReleaseFormatType,
      /**
