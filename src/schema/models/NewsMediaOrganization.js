...
/**
 */
const NewsMediaOrganization = s.intersection([
  s.type({'@type': s.literal('NewsMediaOrganization')}),
  s.partial({
      /**
      ...
      */
      verificationFactCheckingPolicy: s.union([schema.CreativeWork,s.urlString]),
      /**
      * For a [[NewsMediaOrganization]], a link to the masthead page or a page listing top editorial management.
      */
      masthead: s.union([schema.CreativeWork,s.urlString]),
      /**
      * For a [[NewsMediaOrganization]], a statement on coverage priorities, including any public agenda or stance on issues.
      */
      missionCoveragePrioritiesPolicy: s.union([s.urlString,schema.CreativeWork]),
      /**
      ...
      */
      noBylinesPolicy: s.union([schema.CreativeWork,s.urlString]),
      /**
