...
/**
 */
const Observation = s.intersection([
  s.type({'@type': s.literal('Observation')}),
  s.partial({
      /**
      ...
      */
      marginOfError: schema.QuantitativeValue,
      /**
      * The observedNode of an [[Observation]], often a [[StatisticalPopulation]].
      */
      observedNode: schema.StatisticalPopulation,
      /**
      ...
      */
      measuredProperty: oa.enums.PropertyEnumeration,
      /**
      * The observationDate of an [[Observation]].
      */
      observationDate: s.isoDateTimeString,
      /**
      * The measuredValue of an [[Observation]].
      */
      measuredValue: schema.DataType,
      /**
