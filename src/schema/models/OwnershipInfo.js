...
/**
 */
const OwnershipInfo = s.intersection([
  s.type({'@type': s.literal('OwnershipInfo')}),
  s.partial({
      /**
      ...
      */
      ownedFrom: s.isoDateTimeString,
      /**
      * The date and time of giving up ownership on the product.
      */
      ownedThrough: s.isoDateTimeString,
      /**
      * The product that this structured value is referring to.
      */
      typeOfGood: s.union([schema.Service,schema.Product]),
      /**
      * The organization or person from which the product was acquired.
      */
      acquiredFrom: s.union([schema.Organization,schema.Person]),
      /**
