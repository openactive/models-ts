...
/**
 */
const ParentAudience = s.intersection([
  s.type({'@type': s.literal('ParentAudience')}),
  s.partial({
      /**
      ...
      */
      childMinAge: s.nonNegativeFloat,
      /**
      * Maximal age of the child.
      */
      childMaxAge: s.nonNegativeFloat,
      /**
      * Audiences defined by a person's maximum age.
      */
      requiredMaxAge: s.nonNegativeInt,
      /**
      ...
      */
      healthCondition: schema.MedicalCondition,
      /**
      * Audiences defined by a person's gender.
      */
      requiredGender: s.string,
      /**
      ...
      */
      suggestedMinAge: s.nonNegativeFloat,
      /**
      ...
      */
      requiredMinAge: s.nonNegativeInt,
      /**
      * Maximum recommended age in years for the audience or user.
      */
      suggestedMaxAge: s.nonNegativeFloat,
      /**
