...
/**
 */
const ProgramMembership = s.intersection([
  s.type({'@type': s.literal('ProgramMembership')}),
  s.partial({
      /**
      ...
      */
      membershipPointsEarned: s.union([schema.QuantitativeValue,s.nonNegativeFloat]),
      /**
