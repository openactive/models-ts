...
/**
 */
const QuantitativeValueDistribution = s.intersection([
  s.type({'@type': s.literal('QuantitativeValueDistribution')}),
  s.partial({
      /**
      ...
      * The median value.
      */
      median: s.nonNegativeFloat,
      /**
      * The 75th percentile value.
      */
      percentile75: s.nonNegativeFloat,
      /**
      * The 25th percentile value.
      */
      percentile25: s.nonNegativeFloat,
      /**
      * The 10th percentile value.
      */
      percentile10: s.nonNegativeFloat,
      /**
      * The 90th percentile value.
      */
      percentile90: s.nonNegativeFloat,
      /**
