...
/**
 */
const SportsEvent = s.intersection([
  s.type({'@type': s.literal('SportsEvent')}),
  s.partial({
      /**
      ...
      */
      competitor: s.union([schema.Person,schema.SportsTeam]),
      /**
      * The away team in a sports event.
      */
      awayTeam: s.union([schema.Person,schema.SportsTeam]),
      /**
      * The home team in a sports event.
      */
      homeTeam: s.union([schema.SportsTeam,schema.Person]),
      /**
      * A type of sport (e.g. Baseball).
      */
      sport: s.union([s.string,s.urlString]),
      /**
