...
/**
 */
const StatisticalPopulation = s.intersection([
  s.type({'@type': s.literal('StatisticalPopulation')}),
  s.partial({
      /**
      ...
      */
      numConstraints: s.nonNegativeInt,
      /**
