...
/**
 */
const SuperficialAnatomy = s.intersection([
  s.type({'@type': s.literal('SuperficialAnatomy')}),
  s.partial({
      /**
      ...
      */
      significance: s.string,
      /**
      * Anatomical systems or structures that relate to the superficial anatomy.
      */
      relatedAnatomy: s.union([schema.AnatomicalSystem,schema.AnatomicalStructure]),
      /**
