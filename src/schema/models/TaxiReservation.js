...
/**
 */
const TaxiReservation = s.intersection([
  s.type({'@type': s.literal('TaxiReservation')}),
  s.partial({
      /**
      ...
      */
      partySize: s.union([schema.QuantitativeValue,s.nonNegativeInt]),
      /**
      * When a taxi will pickup a passenger or a rental car can be picked up.
      */
      pickupTime: s.isoDateTimeString,
      /**
