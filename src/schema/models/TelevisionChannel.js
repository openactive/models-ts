...
/**
 */
const TelevisionChannel = s.intersection([
  s.type({'@type': s.literal('TelevisionChannel')}),
  s.partial({
      /**
      ...
      */
      broadcastFrequency: s.union([s.string,schema.BroadcastFrequencySpecification]),
      /**
      * The unique address by which the BroadcastService can be identified in a provider lineup. In US, this is typically a number.
      */
      broadcastChannelId: s.string,
      /**
      * The type of service required to have access to the channel (e.g. Standard or Premium).
      */
      broadcastServiceTier: s.string,
      /**
