...
/**
 */
const VideoGameClip = s.intersection([
  s.type({'@type': s.literal('VideoGameClip')}),
  s.partial({
      /**
      ...
      */
      clipNumber: s.union([s.nonNegativeInt,s.string]),
      /**
      ...
      */
      endOffset: s.union([schema.HyperTocEntry,s.nonNegativeFloat]),
      /**
      ...
      */
      startOffset: s.union([schema.HyperTocEntry,s.nonNegativeFloat]),
      /**
