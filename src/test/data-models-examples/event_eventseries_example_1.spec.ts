// This file was generated using the event_eventseries_example_1.json example from @openactive/data-models
import { expect } from 'chai';
import { Event_, validateEvent_, OaValidationError } from '../..';

describe('data-models example - event_eventseries_example_1.json', () => {
  ...
  it('should validate correctly', () => {
    const result = validateEvent_(example);
