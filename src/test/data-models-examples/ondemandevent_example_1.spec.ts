...
import { OnDemandEvent, validateOnDemandEvent, OaValidationError } from '../..';
...
describe('data-models example - ondemandevent_example_1.json', () => {
  ...
  const example: OnDemandEvent = {
  "@context": [
    "https://openactive.io/",
    "https://openactive.io/ns-beta"
  ],
  "@type": "OnDemandEvent",
  "@id": "https://id.bookingsystem.example.com/on-demand-events/158313",
  "identifier": 158313,
  ...
  it('should validate correctly', () => {
    const result = validateOnDemandEvent(example);
